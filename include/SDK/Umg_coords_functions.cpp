...
// Function umg_coords.umg_coords_C.gamemodePostKeys
// (Public, BlueprintCallable, BlueprintEvent)

void UUmg_coords_C::GamemodePostKeys()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("umg_coords_C", "gamemodePostKeys");

	UObject::ProcessEvent(Func, nullptr);
}


// Function umg_coords.umg_coords_C.NewFunction_3
// (Public, BlueprintCallable, BlueprintEvent)

void UUmg_coords_C::NewFunction_3()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("umg_coords_C", "NewFunction_3");

	UObject::ProcessEvent(Func, nullptr);
}


// Function umg_coords.umg_coords_C.NewFunction_2
// (Public, BlueprintCallable, BlueprintEvent)

void UUmg_coords_C::NewFunction_2()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("umg_coords_C", "NewFunction_2");
...
void UUmg_coords_C::TexturePickerApply(class UUmg_texturePicker_C* Picker, class UTexture2D* Texture, int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class APanel_coords_tutor2_C*           Panel_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UUmg_coords_C::InitTutor(class APanel_coords_tutor2_C* Panel_0)
{
	static class UFunction* Func = nullptr;
