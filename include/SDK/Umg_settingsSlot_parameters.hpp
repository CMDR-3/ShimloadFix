...
{
public:
	class UUmg_settings_C*                        Parent_0;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Umg_settingsSlot_C_begin, Parent_0) == 0x000000, "Member 'Umg_settingsSlot_C_begin::Parent_0' has a wrong offset!");
