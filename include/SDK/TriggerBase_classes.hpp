...
static_assert(sizeof(ATriggerBase_C) == 0x000290, "Wrong size on ATriggerBase_C");
...
static_assert(offsetof(ATriggerBase_C, GameMode) == 0x000288, "Member 'ATriggerBase_C::GameMode' has a wrong offset!");
