...
public:
	...
	struct FStruct_prop3                          CallFunc_GetDataTableRowFromName_OutRow;           // 0x02E8(0x0080)(HasGetValueTypeHash)
	...
	struct FStruct_food                           CallFunc_propToObject_foodData;                    // 0x0494(0x001C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FStruct_prop3                          CallFunc_propToObject_fuckYouRetard;               // 0x04C0(0x0080)(HasGetValueTypeHash)
...
static_assert(offsetof(FishingRodString_C_ExecuteUbergraph_fishingRodString, CallFunc_propToObject_fuckYouRetard) == 0x0004C0, "Member 'FishingRodString_C_ExecuteUbergraph_fishingRodString::CallFunc_propToObject_fuckYouRetard' has a wrong offset!");
...
public:
	...
	TArray<float>                                 CallFunc_Map_Values_Values;                        // 0x00E0(0x0010)(ReferenceParm)
	...
	struct FLinearColor                           Temp_struct_Variable_8;                            // 0x0184(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_weightedRandomV2_exponent_index;          // 0x0194(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                           Temp_struct_Variable_9;                            // 0x01C0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Map_Values_Values) == 0x0000E0, "Member 'FishingRodString_C_DebugRandom::CallFunc_Map_Values_Values' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Map_Keys_Keys) == 0x0000F0, "Member 'FishingRodString_C_DebugRandom::CallFunc_Map_Keys_Keys' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, Temp_int_Variable_3) == 0x000100, "Member 'FishingRodString_C_DebugRandom::Temp_int_Variable_3' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, Temp_struct_Variable_7) == 0x000104, "Member 'FishingRodString_C_DebugRandom::Temp_struct_Variable_7' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x000114, "Member 'FishingRodString_C_DebugRandom::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Array_Get_Item) == 0x000118, "Member 'FishingRodString_C_DebugRandom::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Array_Get_Item_1) == 0x000120, "Member 'FishingRodString_C_DebugRandom::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000130, "Member 'FishingRodString_C_DebugRandom::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Concat_StrStr_ReturnValue) == 0x000138, "Member 'FishingRodString_C_DebugRandom::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000148, "Member 'FishingRodString_C_DebugRandom::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Conv_IntToString_ReturnValue) == 0x000150, "Member 'FishingRodString_C_DebugRandom::CallFunc_Conv_IntToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_FTrunc_ReturnValue) == 0x000160, "Member 'FishingRodString_C_DebugRandom::CallFunc_FTrunc_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Concat_StrStr_ReturnValue_1) == 0x000168, "Member 'FishingRodString_C_DebugRandom::CallFunc_Concat_StrStr_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Clamp_ReturnValue) == 0x000178, "Member 'FishingRodString_C_DebugRandom::CallFunc_Clamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Array_Length_ReturnValue) == 0x00017C, "Member 'FishingRodString_C_DebugRandom::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Less_IntInt_ReturnValue) == 0x000180, "Member 'FishingRodString_C_DebugRandom::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, Temp_struct_Variable_8) == 0x000184, "Member 'FishingRodString_C_DebugRandom::Temp_struct_Variable_8' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_weightedRandomV2_exponent_index) == 0x000194, "Member 'FishingRodString_C_DebugRandom::CallFunc_weightedRandomV2_exponent_index' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Array_Get_Item_2) == 0x000198, "Member 'FishingRodString_C_DebugRandom::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Conv_NameToString_ReturnValue) == 0x0001A0, "Member 'FishingRodString_C_DebugRandom::CallFunc_Conv_NameToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Array_Add_ReturnValue) == 0x0001B0, "Member 'FishingRodString_C_DebugRandom::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Array_Add_ReturnValue_1) == 0x0001B4, "Member 'FishingRodString_C_DebugRandom::CallFunc_Array_Add_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Array_Find_ReturnValue) == 0x0001B8, "Member 'FishingRodString_C_DebugRandom::CallFunc_Array_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, CallFunc_Add_IntInt_ReturnValue_2) == 0x0001BC, "Member 'FishingRodString_C_DebugRandom::CallFunc_Add_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, Temp_struct_Variable_9) == 0x0001C0, "Member 'FishingRodString_C_DebugRandom::Temp_struct_Variable_9' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_DebugRandom, K2Node_Select_Default) == 0x0001D0, "Member 'FishingRodString_C_DebugRandom::K2Node_Select_Default' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_propToObject_ReturnValue;                 // 0x0090(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_91[0x3];                                       // 0x0091(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FStruct_food                           CallFunc_propToObject_foodData;                    // 0x0094(0x001C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FStruct_prop3                          CallFunc_propToObject_fuckYouRetard;               // 0x00C0(0x0080)(HasGetValueTypeHash)
	...
	class AProp_food_C*                           CallFunc_FinishSpawningActor_ReturnValue;          // 0x0148(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                 CallFunc_FinishSpawningActor_ReturnValue_1;        // 0x0160(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class IInt_player_C>         K2Node_DynamicCast_AsInt_Player;                   // 0x0168(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AProp_C*                                CallFunc_asProp_return;                            // 0x0188(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_NameToString_ReturnValue;            // 0x0190(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class AProp_C*                                CallFunc_FinishSpawningActor_ReturnValue_2;        // 0x01A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_Select_Default;                             // 0x01A8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AProp_fishbait_C*                       K2Node_DynamicCast_AsProp_Fishbait;                // 0x01B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<float>                                 CallFunc_Map_Values_Values_1;                      // 0x01D0(0x0010)(ReferenceParm)
	float                                         CallFunc_Array_Get_Item;                           // 0x01E0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Array_Get_Item_1;                         // 0x01E4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         Temp_int_Variable_4;                               // 0x0230(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_LessEqual_IntInt_ReturnValue_2;           // 0x0234(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TArray<EObjectTypeQuery>                      CallFunc_obj_trigger_obj;                          // 0x0240(0x0010)(ReferenceParm)
	...
	class AActor*                                 CallFunc_Array_Get_Item_4;                         // 0x0270(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AFishingDropSpot_C*                     K2Node_DynamicCast_AsFishing_Drop_Spot;            // 0x0278(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_2;                     // 0x0280(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_281[0x7];                                      // 0x0281(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FName, float>                      CallFunc_appendDrop_NewParam;                      // 0x0288(0x0050)()
};
static_assert(alignof(FishingRodString_C_ProcessDrops) == 0x000010, "Wrong alignment on FishingRodString_C_ProcessDrops");
static_assert(sizeof(FishingRodString_C_ProcessDrops) == 0x0002E0, "Wrong size on FishingRodString_C_ProcessDrops");
static_assert(offsetof(FishingRodString_C_ProcessDrops, Temp_int_Variable) == 0x000000, "Member 'FishingRodString_C_ProcessDrops::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, Temp_int_Variable_1) == 0x000004, "Member 'FishingRodString_C_ProcessDrops::Temp_int_Variable_1' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, Temp_int_Variable_2) == 0x000008, "Member 'FishingRodString_C_ProcessDrops::Temp_int_Variable_2' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, Temp_int_Loop_Counter_Variable) == 0x00000C, "Member 'FishingRodString_C_ProcessDrops::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Add_IntInt_ReturnValue) == 0x000010, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000014, "Member 'FishingRodString_C_ProcessDrops::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Add_IntInt_ReturnValue_1) == 0x000018, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, Temp_int_Array_Index_Variable) == 0x00001C, "Member 'FishingRodString_C_ProcessDrops::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, Temp_int_Loop_Counter_Variable_1) == 0x000020, "Member 'FishingRodString_C_ProcessDrops::Temp_int_Loop_Counter_Variable_1' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Add_IntInt_ReturnValue_2) == 0x000024, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Add_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, Temp_int_Array_Index_Variable_1) == 0x000028, "Member 'FishingRodString_C_ProcessDrops::Temp_int_Array_Index_Variable_1' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, Temp_object_Variable) == 0x000030, "Member 'FishingRodString_C_ProcessDrops::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, Temp_int_Variable_3) == 0x000040, "Member 'FishingRodString_C_ProcessDrops::Temp_int_Variable_3' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_LessEqual_IntInt_ReturnValue_1) == 0x000044, "Member 'FishingRodString_C_ProcessDrops::CallFunc_LessEqual_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Add_IntInt_ReturnValue_3) == 0x000048, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Add_IntInt_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, Temp_int_Loop_Counter_Variable_2) == 0x00004C, "Member 'FishingRodString_C_ProcessDrops::Temp_int_Loop_Counter_Variable_2' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Add_IntInt_ReturnValue_4) == 0x000050, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Add_IntInt_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, Temp_int_Array_Index_Variable_2) == 0x000054, "Member 'FishingRodString_C_ProcessDrops::Temp_int_Array_Index_Variable_2' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_NotEqual_NameName_ReturnValue) == 0x000058, "Member 'FishingRodString_C_ProcessDrops::CallFunc_NotEqual_NameName_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_GetTransform_ReturnValue) == 0x000060, "Member 'FishingRodString_C_ProcessDrops::CallFunc_GetTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_propToObject_ReturnValue) == 0x000090, "Member 'FishingRodString_C_ProcessDrops::CallFunc_propToObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_propToObject_foodData) == 0x000094, "Member 'FishingRodString_C_ProcessDrops::CallFunc_propToObject_foodData' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_propToObject_object) == 0x0000B0, "Member 'FishingRodString_C_ProcessDrops::CallFunc_propToObject_object' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_propToObject_isFood) == 0x0000B8, "Member 'FishingRodString_C_ProcessDrops::CallFunc_propToObject_isFood' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_propToObject_fuckYouRetard) == 0x0000C0, "Member 'FishingRodString_C_ProcessDrops::CallFunc_propToObject_fuckYouRetard' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x000140, "Member 'FishingRodString_C_ProcessDrops::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_FinishSpawningActor_ReturnValue) == 0x000148, "Member 'FishingRodString_C_ProcessDrops::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1) == 0x000150, "Member 'FishingRodString_C_ProcessDrops::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_IsValidClass_ReturnValue) == 0x000158, "Member 'FishingRodString_C_ProcessDrops::CallFunc_IsValidClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_FinishSpawningActor_ReturnValue_1) == 0x000160, "Member 'FishingRodString_C_ProcessDrops::CallFunc_FinishSpawningActor_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, K2Node_DynamicCast_AsInt_Player) == 0x000168, "Member 'FishingRodString_C_ProcessDrops::K2Node_DynamicCast_AsInt_Player' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, K2Node_DynamicCast_bSuccess) == 0x000178, "Member 'FishingRodString_C_ProcessDrops::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_2) == 0x000180, "Member 'FishingRodString_C_ProcessDrops::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_asProp_return) == 0x000188, "Member 'FishingRodString_C_ProcessDrops::CallFunc_asProp_return' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Conv_NameToString_ReturnValue) == 0x000190, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Conv_NameToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_FinishSpawningActor_ReturnValue_2) == 0x0001A0, "Member 'FishingRodString_C_ProcessDrops::CallFunc_FinishSpawningActor_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, K2Node_Select_Default) == 0x0001A8, "Member 'FishingRodString_C_ProcessDrops::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, K2Node_DynamicCast_AsProp_Fishbait) == 0x0001B0, "Member 'FishingRodString_C_ProcessDrops::K2Node_DynamicCast_AsProp_Fishbait' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, K2Node_DynamicCast_bSuccess_1) == 0x0001B8, "Member 'FishingRodString_C_ProcessDrops::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Map_Values_Values) == 0x0001C0, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Map_Values_Values' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Map_Values_Values_1) == 0x0001D0, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Map_Values_Values_1' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Array_Get_Item) == 0x0001E0, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Array_Get_Item_1) == 0x0001E4, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Map_Keys_Keys) == 0x0001E8, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Map_Keys_Keys' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Map_Keys_Keys_1) == 0x0001F8, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Map_Keys_Keys_1' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Array_Get_Item_2) == 0x000208, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Array_Get_Item_3) == 0x000210, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Array_Get_Item_3' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Array_Length_ReturnValue) == 0x000218, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Array_Length_ReturnValue_1) == 0x00021C, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Less_IntInt_ReturnValue) == 0x000220, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Less_IntInt_ReturnValue_1) == 0x000221, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_K2_GetComponentLocation_ReturnValue) == 0x000224, "Member 'FishingRodString_C_ProcessDrops::CallFunc_K2_GetComponentLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, Temp_int_Variable_4) == 0x000230, "Member 'FishingRodString_C_ProcessDrops::Temp_int_Variable_4' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_LessEqual_IntInt_ReturnValue_2) == 0x000234, "Member 'FishingRodString_C_ProcessDrops::CallFunc_LessEqual_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Add_IntInt_ReturnValue_5) == 0x000238, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Add_IntInt_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_obj_trigger_obj) == 0x000240, "Member 'FishingRodString_C_ProcessDrops::CallFunc_obj_trigger_obj' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_SphereOverlapActors_OutActors) == 0x000250, "Member 'FishingRodString_C_ProcessDrops::CallFunc_SphereOverlapActors_OutActors' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_SphereOverlapActors_ReturnValue) == 0x000260, "Member 'FishingRodString_C_ProcessDrops::CallFunc_SphereOverlapActors_ReturnValue' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Array_Length_ReturnValue_2) == 0x000264, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Array_Length_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Less_IntInt_ReturnValue_2) == 0x000268, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Less_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_Array_Get_Item_4) == 0x000270, "Member 'FishingRodString_C_ProcessDrops::CallFunc_Array_Get_Item_4' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, K2Node_DynamicCast_AsFishing_Drop_Spot) == 0x000278, "Member 'FishingRodString_C_ProcessDrops::K2Node_DynamicCast_AsFishing_Drop_Spot' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, K2Node_DynamicCast_bSuccess_2) == 0x000280, "Member 'FishingRodString_C_ProcessDrops::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(FishingRodString_C_ProcessDrops, CallFunc_appendDrop_NewParam) == 0x000288, "Member 'FishingRodString_C_ProcessDrops::CallFunc_appendDrop_NewParam' has a wrong offset!");
