...
{
public:
	class UArrowComponent*                        Dir;                                               // 0x0360(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AProp_wireComponent_laserDir_C) == 0x000368, "Wrong size on AProp_wireComponent_laserDir_C");
static_assert(offsetof(AProp_wireComponent_laserDir_C, Dir) == 0x000360, "Member 'AProp_wireComponent_laserDir_C::Dir' has a wrong offset!");
