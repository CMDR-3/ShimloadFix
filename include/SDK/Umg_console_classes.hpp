...
public:
	...
	void Init(const class FString& Name_0, bool Hide, class ADish_C* Dish_0);
	...
	void FindDish(const class FString& B, bool* Return, class ADish_C** Dish_0);
	void SetTickOff(const bool Tick_0);
	void Upd();
	void Enter();
	void OnKeyDown_0(const struct FKey& Key1);
	struct FEventReply OnMouseWheel(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent);
	void DingusLook(TSubclassOf<class AProp_dingus_C> ActorClass, const class FString& B, const class FString& b1, const class FString& b2);
...
static_assert(offsetof(UUmg_console_C, Name_0) == 0x000330, "Member 'UUmg_console_C::Name_0' has a wrong offset!");
