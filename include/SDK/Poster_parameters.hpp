...
public:
	...
	TArray<class UTexture2D*>                     K2Node_LowEntry_LocalVariable_Value__Object;       // 0x0008(0x0010)(ReferenceParm)
	...
	int32                                         CallFunc_VictoryIntPlusEquals_IntOut;              // 0x02B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Percent_IntInt_ReturnValue;               // 0x02BC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AProp_poster_C*                         CallFunc_FinishSpawningActor_ReturnValue;          // 0x02C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             CallFunc_MakeHitResult_ReturnValue;                // 0x02C8(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                          CallFunc_GreaterEqual_IntInt_ReturnValue;          // 0x0350(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_351[0x7];                                      // 0x0351(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FStruct_settings                       K2Node_Event_settings;                             // 0x0358(0x0100)(HasGetValueTypeHash)
};
static_assert(alignof(Poster_c_ExecuteUbergraph_poster) == 0x000010, "Wrong alignment on Poster_c_ExecuteUbergraph_poster");
static_assert(sizeof(Poster_c_ExecuteUbergraph_poster) == 0x000460, "Wrong size on Poster_c_ExecuteUbergraph_poster");
...
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_LowEntry_LocalVariable_Value__Object) == 0x000008, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_LowEntry_LocalVariable_Value__Object' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, CallFunc_Array_Length_ReturnValue) == 0x000018, "Member 'Poster_c_ExecuteUbergraph_poster::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_gamemode) == 0x000020, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_gamemode' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_key) == 0x000028, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_key' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_pressed) == 0x000040, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_pressed' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_color) == 0x000044, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_color' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_picker) == 0x000058, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_picker' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_texture) == 0x000060, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_texture' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_index) == 0x000068, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_index' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_player_6) == 0x000070, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_player_6' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_hit_2) == 0x000078, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_hit_2' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_kick) == 0x000100, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_kick' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_name) == 0x000104, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_name' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_player_5) == 0x000110, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_player_5' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_player_4) == 0x000118, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_player_4' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_hit_1) == 0x000120, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_hit_1' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_damage) == 0x0001A8, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_damage' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_player_3) == 0x0001B0, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_player_3' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_player_2) == 0x0001B8, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_player_2' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_player_1) == 0x0001C0, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_player_1' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_player) == 0x0001C8, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_hit) == 0x0001D0, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_action) == 0x000258, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_SwitchEnum_CmpSuccess) == 0x000259, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, CallFunc_K2_GetActorRotation_ReturnValue) == 0x00025C, "Member 'Poster_c_ExecuteUbergraph_poster::CallFunc_K2_GetActorRotation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000268, "Member 'Poster_c_ExecuteUbergraph_poster::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, CallFunc_MakeTransform_ReturnValue) == 0x000280, "Member 'Poster_c_ExecuteUbergraph_poster::CallFunc_MakeTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x0002B0, "Member 'Poster_c_ExecuteUbergraph_poster::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, CallFunc_VictoryIntPlusEquals_IntOut) == 0x0002B8, "Member 'Poster_c_ExecuteUbergraph_poster::CallFunc_VictoryIntPlusEquals_IntOut' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, CallFunc_Percent_IntInt_ReturnValue) == 0x0002BC, "Member 'Poster_c_ExecuteUbergraph_poster::CallFunc_Percent_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, CallFunc_FinishSpawningActor_ReturnValue) == 0x0002C0, "Member 'Poster_c_ExecuteUbergraph_poster::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, CallFunc_MakeHitResult_ReturnValue) == 0x0002C8, "Member 'Poster_c_ExecuteUbergraph_poster::CallFunc_MakeHitResult_ReturnValue' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x000350, "Member 'Poster_c_ExecuteUbergraph_poster::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Poster_c_ExecuteUbergraph_poster, K2Node_Event_settings) == 0x000358, "Member 'Poster_c_ExecuteUbergraph_poster::K2Node_Event_settings' has a wrong offset!");
...
static_assert(sizeof(Poster_c_SettingsApplied) == 0x000100, "Wrong size on Poster_c_SettingsApplied");
...
static_assert(offsetof(Poster_c_SendName, Name_0) == 0x000000, "Member 'Poster_c_SendName::Name_0' has a wrong offset!");
...
static_assert(offsetof(Poster_c_TexturePickerApply, Index_0) == 0x000010, "Member 'Poster_c_TexturePickerApply::Index_0' has a wrong offset!");
...
static_assert(offsetof(Poster_c_AnyKey, Key_0) == 0x000000, "Member 'Poster_c_AnyKey::Key_0' has a wrong offset!");
...
static_assert(offsetof(Poster_c_StuffUpgraded, GameMode_0) == 0x000000, "Member 'Poster_c_StuffUpgraded::GameMode_0' has a wrong offset!");
...
static_assert(sizeof(Poster_c_SetPoster) == 0x000020, "Wrong size on Poster_c_SetPoster");
static_assert(offsetof(Poster_c_SetPoster, CallFunc_getPosters_Output) == 0x000000, "Member 'Poster_c_SetPoster::CallFunc_getPosters_Output' has a wrong offset!");
static_assert(offsetof(Poster_c_SetPoster, CallFunc_CreateDynamicMaterialInstance_ReturnValue) == 0x000008, "Member 'Poster_c_SetPoster::CallFunc_CreateDynamicMaterialInstance_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Poster_c_SetPoster, CallFunc_Array_Get_Item) == 0x000018, "Member 'Poster_c_SetPoster::CallFunc_Array_Get_Item' has a wrong offset!");
...
static_assert(offsetof(Poster_c_NoRespawn, NoRespawn_0) == 0x000000, "Member 'Poster_c_NoRespawn::NoRespawn_0' has a wrong offset!");
...
static_assert(sizeof(Poster_c_UserConstructionScript) == 0x000020, "Wrong size on Poster_c_UserConstructionScript");
...
static_assert(offsetof(Poster_c_UserConstructionScript, CallFunc_Array_Get_Item) == 0x000018, "Member 'Poster_c_UserConstructionScript::CallFunc_Array_Get_Item' has a wrong offset!");
