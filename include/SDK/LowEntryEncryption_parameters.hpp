...
public:
	...
	int32                                         Index_0;                                           // 0x0020(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(LowEntryEncryptionLibrary_BytesToRsaPrivateKey, Index_0) == 0x000020, "Member 'LowEntryEncryptionLibrary_BytesToRsaPrivateKey::Index_0' has a wrong offset!");
...
static_assert(offsetof(LowEntryEncryptionLibrary_BytesToRsaPublicKey, Index_0) == 0x000020, "Member 'LowEntryEncryptionLibrary_BytesToRsaPublicKey::Index_0' has a wrong offset!");
