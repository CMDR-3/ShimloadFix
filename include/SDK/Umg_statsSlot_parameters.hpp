...
{
public:
	float                                         Stat_0;                                            // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Umg_statsSlot_C_Upd, Stat_0) == 0x000000, "Member 'Umg_statsSlot_C_Upd::Stat_0' has a wrong offset!");
