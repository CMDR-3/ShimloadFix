...
static_assert(offsetof(Woodchipper_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Woodchipper_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Woodchipper_C_ChippingSnd, Active_0) == 0x000000, "Member 'Woodchipper_C_ChippingSnd::Active_0' has a wrong offset!");
...
static_assert(offsetof(Woodchipper_C_Startup, Active_0) == 0x000000, "Member 'Woodchipper_C_Startup::Active_0' has a wrong offset!");
...
// Function woodchipper.woodchipper_C.loadData
// 0x00E0 (0x00E0 - 0x0000)
struct Woodchipper_C_LoadData final
{
public:
...
static_assert(alignof(Woodchipper_C_LoadData) == 0x000010, "Wrong alignment on Woodchipper_C_LoadData");
static_assert(sizeof(Woodchipper_C_LoadData) == 0x0000E0, "Wrong size on Woodchipper_C_LoadData");
static_assert(offsetof(Woodchipper_C_LoadData, Data) == 0x000000, "Member 'Woodchipper_C_LoadData::Data' has a wrong offset!");
static_assert(offsetof(Woodchipper_C_LoadData, Return) == 0x0000C0, "Member 'Woodchipper_C_LoadData::Return' has a wrong offset!");
static_assert(offsetof(Woodchipper_C_LoadData, CallFunc_loadData_return) == 0x0000C1, "Member 'Woodchipper_C_LoadData::CallFunc_loadData_return' has a wrong offset!");
static_assert(offsetof(Woodchipper_C_LoadData, CallFunc_Array_Get_Item) == 0x0000C8, "Member 'Woodchipper_C_LoadData::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Woodchipper_C_LoadData, CallFunc_Array_Get_Item_1) == 0x0000D8, "Member 'Woodchipper_C_LoadData::CallFunc_Array_Get_Item_1' has a wrong offset!");

// Function woodchipper.woodchipper_C.getData
// 0x0280 (0x0280 - 0x0000)
struct Woodchipper_C_GetData final
{
public:
...
static_assert(alignof(Woodchipper_C_GetData) == 0x000010, "Wrong alignment on Woodchipper_C_GetData");
static_assert(sizeof(Woodchipper_C_GetData) == 0x000280, "Wrong size on Woodchipper_C_GetData");
static_assert(offsetof(Woodchipper_C_GetData, Data) == 0x000000, "Member 'Woodchipper_C_GetData::Data' has a wrong offset!");
static_assert(offsetof(Woodchipper_C_GetData, CallFunc_getData_data) == 0x0000C0, "Member 'Woodchipper_C_GetData::CallFunc_getData_data' has a wrong offset!");
static_assert(offsetof(Woodchipper_C_GetData, K2Node_MakeArray_Array) == 0x000180, "Member 'Woodchipper_C_GetData::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(Woodchipper_C_GetData, K2Node_MakeStruct_struct_mFloat) == 0x000190, "Member 'Woodchipper_C_GetData::K2Node_MakeStruct_struct_mFloat' has a wrong offset!");
static_assert(offsetof(Woodchipper_C_GetData, CallFunc_Array_Get_Item) == 0x0001A0, "Member 'Woodchipper_C_GetData::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Woodchipper_C_GetData, K2Node_MakeArray_Array_1) == 0x0001B0, "Member 'Woodchipper_C_GetData::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(Woodchipper_C_GetData, K2Node_SetFieldsInStruct_StructOut) == 0x0001C0, "Member 'Woodchipper_C_GetData::K2Node_SetFieldsInStruct_StructOut' has a wrong offset!");
...
static_assert(offsetof(Woodchipper_C_LookAt, Hit_0) == 0x000008, "Member 'Woodchipper_C_LookAt::Hit_0' has a wrong offset!");
