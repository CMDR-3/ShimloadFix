...
public:
	...
	class ACordSocket_C*                          CallFunc_tryToConnect_AsCord_Socket;               // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          K2Node_Event_NewParam;                             // 0x003C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FVector                                CallFunc_GetActorRightVector_ReturnValue;          // 0x0050(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AProp_fridgeDoor_C*                     K2Node_DynamicCast_AsProp_Fridge_Door;             // 0x0070(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x0078(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_79[0x3];                                       // 0x0079(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                CallFunc_GetActorRightVector_ReturnValue_1;        // 0x007C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetActorForwardVector_ReturnValue_1;      // 0x0088(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AProp_fridgeDoor_C*                     K2Node_DynamicCast_AsProp_Fridge_Door_1;           // 0x00A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_2;                     // 0x00A8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPrimitiveComponent*                    K2Node_ComponentBoundEvent_OverlappedComponent_3;  // 0x00B0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_ComponentBoundEvent_OtherActor_3;           // 0x00B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPrimitiveComponent*                    K2Node_ComponentBoundEvent_OtherComp_3;            // 0x00C0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_ComponentBoundEvent_OtherBodyIndex_3;       // 0x00C8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UPrimitiveComponent*                    K2Node_ComponentBoundEvent_OverlappedComponent_2;  // 0x0158(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_ComponentBoundEvent_OtherActor_2;           // 0x0160(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPrimitiveComponent*                    K2Node_ComponentBoundEvent_OtherComp_2;            // 0x0168(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_Array_RemoveItem_ReturnValue_1;           // 0x0248(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TScriptInterface<class IInt_objects_C>        K2Node_DynamicCast_AsInt_Objects;                  // 0x0260(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_DynamicCast_bSuccess_3;                     // 0x0270(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_271[0x7];                                      // 0x0271(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TScriptInterface<class IInt_objects_C>        K2Node_DynamicCast_AsInt_Objects_1;                // 0x0278(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_Less_IntInt_ReturnValue_1;                // 0x0295(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_296[0x2];                                      // 0x0296(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class ACord_C*                                K2Node_Event_cord_1;                               // 0x0298(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACordSocket_C*                          K2Node_Event_socket_1;                             // 0x02A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACord_C*                                K2Node_Event_cord;                                 // 0x02A8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACordSocket_C*                          K2Node_Event_socket;                               // 0x02B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(Prop_fridge_C_ExecuteUbergraph_prop_fridge) == 0x0002B8, "Wrong size on Prop_fridge_C_ExecuteUbergraph_prop_fridge");
...
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_tryToConnect_AsCord_Socket) == 0x000028, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_tryToConnect_AsCord_Socket' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_Event_owner) == 0x000030, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_Event_owner' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_Event_index) == 0x000038, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_Event_index' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_Event_NewParam) == 0x00003C, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_Event_NewParam' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_Event_sentFrom) == 0x000040, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_Event_sentFrom' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_Event_active) == 0x000048, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_Event_active' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_Event_DeltaSeconds) == 0x00004C, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_GetActorRightVector_ReturnValue) == 0x000050, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_GetActorRightVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_GetActorForwardVector_ReturnValue) == 0x00005C, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_GetActorForwardVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_Dot_VectorVector_ReturnValue) == 0x000068, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_Dot_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_LessEqual_FloatFloat_ReturnValue) == 0x00006C, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_LessEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_DynamicCast_AsProp_Fridge_Door) == 0x000070, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_DynamicCast_AsProp_Fridge_Door' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_DynamicCast_bSuccess_1) == 0x000078, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_GetActorRightVector_ReturnValue_1) == 0x00007C, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_GetActorRightVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_GetActorForwardVector_ReturnValue_1) == 0x000088, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_GetActorForwardVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_Dot_VectorVector_ReturnValue_1) == 0x000094, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_Dot_VectorVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_LessEqual_FloatFloat_ReturnValue_1) == 0x000098, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_LessEqual_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_DynamicCast_AsProp_Fridge_Door_1) == 0x0000A0, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_DynamicCast_AsProp_Fridge_Door_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_DynamicCast_bSuccess_2) == 0x0000A8, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_OverlappedComponent_3) == 0x0000B0, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_OverlappedComponent_3' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_OtherActor_3) == 0x0000B8, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_OtherActor_3' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_OtherComp_3) == 0x0000C0, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_OtherComp_3' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_OtherBodyIndex_3) == 0x0000C8, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_OtherBodyIndex_3' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_bFromSweep_1) == 0x0000CC, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_bFromSweep_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_SweepResult_1) == 0x0000D0, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_SweepResult_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_OverlappedComponent_2) == 0x000158, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_OverlappedComponent_2' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_OtherActor_2) == 0x000160, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_OtherActor_2' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_OtherComp_2) == 0x000168, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_OtherComp_2' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_OtherBodyIndex_2) == 0x000170, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_OtherBodyIndex_2' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_Array_Add_ReturnValue) == 0x000174, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_Array_RemoveItem_ReturnValue) == 0x000178, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_Array_RemoveItem_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_OverlappedComponent_1) == 0x000180, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_OverlappedComponent_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_OtherActor_1) == 0x000188, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_OtherActor_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_OtherComp_1) == 0x000190, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_OtherComp_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_OtherBodyIndex_1) == 0x000198, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_OtherBodyIndex_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_bFromSweep) == 0x00019C, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_bFromSweep' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_SweepResult) == 0x0001A0, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_SweepResult' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_OverlappedComponent) == 0x000228, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_OverlappedComponent' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_OtherActor) == 0x000230, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_OtherActor' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_OtherComp) == 0x000238, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_OtherComp' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_ComponentBoundEvent_OtherBodyIndex) == 0x000240, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_ComponentBoundEvent_OtherBodyIndex' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_Array_Add_ReturnValue_1) == 0x000244, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_Array_Add_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_Array_RemoveItem_ReturnValue_1) == 0x000248, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_Array_RemoveItem_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_Array_Get_Item) == 0x000250, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_Array_Get_Item_1) == 0x000258, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_DynamicCast_AsInt_Objects) == 0x000260, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_DynamicCast_AsInt_Objects' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_DynamicCast_bSuccess_3) == 0x000270, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_DynamicCast_bSuccess_3' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_DynamicCast_AsInt_Objects_1) == 0x000278, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_DynamicCast_AsInt_Objects_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_DynamicCast_bSuccess_4) == 0x000288, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_DynamicCast_bSuccess_4' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_Array_Length_ReturnValue) == 0x00028C, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_Array_Length_ReturnValue_1) == 0x000290, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_Less_IntInt_ReturnValue) == 0x000294, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, CallFunc_Less_IntInt_ReturnValue_1) == 0x000295, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_Event_cord_1) == 0x000298, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_Event_cord_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_Event_socket_1) == 0x0002A0, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_Event_socket_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_Event_cord) == 0x0002A8, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_Event_cord' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_ExecuteUbergraph_prop_fridge, K2Node_Event_socket) == 0x0002B0, "Member 'Prop_fridge_C_ExecuteUbergraph_prop_fridge::K2Node_Event_socket' has a wrong offset!");
...
static_assert(offsetof(Prop_fridge_C_CordUnplugged, Cord_0) == 0x000000, "Member 'Prop_fridge_C_CordUnplugged::Cord_0' has a wrong offset!");
...
static_assert(offsetof(Prop_fridge_C_CordPlugged, Cord_0) == 0x000000, "Member 'Prop_fridge_C_CordPlugged::Cord_0' has a wrong offset!");
...
static_assert(offsetof(Prop_fridge_C_SetActiveTrigger, Active_0) == 0x000008, "Member 'Prop_fridge_C_SetActiveTrigger::Active_0' has a wrong offset!");
...
static_assert(offsetof(Prop_fridge_C_RunTrigger, Owner_0) == 0x000000, "Member 'Prop_fridge_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_RunTrigger, Index_0) == 0x000008, "Member 'Prop_fridge_C_RunTrigger::Index_0' has a wrong offset!");
...
public:
	...
	class ACordSocket_C*                          CallFunc_tryToConnect_AsCord_Socket;               // 0x00D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Array_Get_Item_1;                         // 0x00E0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_Array_Get_Item_2;                         // 0x00FC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_loadData_return;                          // 0x0194(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(Prop_fridge_C_LoadData) == 0x000010, "Wrong alignment on Prop_fridge_C_LoadData");
static_assert(sizeof(Prop_fridge_C_LoadData) == 0x0001A0, "Wrong size on Prop_fridge_C_LoadData");
...
static_assert(offsetof(Prop_fridge_C_LoadData, CallFunc_tryToConnect_AsCord_Socket) == 0x0000D8, "Member 'Prop_fridge_C_LoadData::CallFunc_tryToConnect_AsCord_Socket' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_LoadData, CallFunc_Array_Get_Item_1) == 0x0000E0, "Member 'Prop_fridge_C_LoadData::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_LoadData, CallFunc_IsValid_ReturnValue) == 0x0000EC, "Member 'Prop_fridge_C_LoadData::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_LoadData, CallFunc_Conv_VectorToRotator_ReturnValue) == 0x0000F0, "Member 'Prop_fridge_C_LoadData::CallFunc_Conv_VectorToRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_LoadData, CallFunc_Array_Get_Item_2) == 0x0000FC, "Member 'Prop_fridge_C_LoadData::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_LoadData, CallFunc_Array_IsValidIndex_ReturnValue) == 0x000108, "Member 'Prop_fridge_C_LoadData::CallFunc_Array_IsValidIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_LoadData, CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult) == 0x00010C, "Member 'Prop_fridge_C_LoadData::CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(Prop_fridge_C_LoadData, CallFunc_loadData_return) == 0x000194, "Member 'Prop_fridge_C_LoadData::CallFunc_loadData_return' has a wrong offset!");
...
static_assert(offsetof(Prop_fridge_C_IgnoreSave, Param_IgnoreSave_0) == 0x000000, "Member 'Prop_fridge_C_IgnoreSave::Param_IgnoreSave_0' has a wrong offset!");
