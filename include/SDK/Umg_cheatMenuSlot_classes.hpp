...
public:
	...
	class FName                                   Name_0;                                            // 0x027C(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
...
static_assert(offsetof(UUmg_cheatMenuSlot_C, Index_0) == 0x000278, "Member 'UUmg_cheatMenuSlot_C::Index_0' has a wrong offset!");
static_assert(offsetof(UUmg_cheatMenuSlot_C, Name_0) == 0x00027C, "Member 'UUmg_cheatMenuSlot_C::Name_0' has a wrong offset!");
