...
static_assert(offsetof(Prop_waterShooter_arir_C_PlayerHandUse_RMB, Player_0) == 0x000000, "Member 'Prop_waterShooter_arir_C_PlayerHandUse_RMB::Player_0' has a wrong offset!");
...
static_assert(offsetof(Prop_waterShooter_arir_C_PlayerHandUse_LMB, Player_0) == 0x000000, "Member 'Prop_waterShooter_arir_C_PlayerHandUse_LMB::Player_0' has a wrong offset!");
...
static_assert(offsetof(Prop_waterShooter_arir_C_PlayerHandRelease_LMB, Player_0) == 0x000000, "Member 'Prop_waterShooter_arir_C_PlayerHandRelease_LMB::Player_0' has a wrong offset!");
