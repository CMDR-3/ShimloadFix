...
public:
	...
	struct FStruct_signal_data1                   SingalPlayData;                                    // 0x02F0(0x01D0)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
...
public:
	...
	void SetPlayback(float Alpha_0);
	...
	void SetListLoc();
	void StopSounds();
	void CopySignal(const struct FStruct_signal_data1& SingalPlayData_0);
	void SetCanvas(bool VisMode_0);
	void EndCanvas();
