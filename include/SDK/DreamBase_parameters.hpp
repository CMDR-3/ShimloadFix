...
public:
	...
	class AMainPlayer_C*                          CallFunc_getMainPlayer_AsMain_Player_1;            // 0x0198(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_getEvent_isEventActive;                   // 0x01A0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_addFood_full;                             // 0x01A1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AMainGamemode_C*                        CallFunc_getMainGamemode_AsMain_Gamemode_2;        // 0x01A8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(DreamBase_C_ExecuteUbergraph_dreamBase) == 0x0001B8, "Wrong size on DreamBase_C_ExecuteUbergraph_dreamBase");
...
static_assert(offsetof(DreamBase_C_ExecuteUbergraph_dreamBase, K2Node_Event_gamemode) == 0x000008, "Member 'DreamBase_C_ExecuteUbergraph_dreamBase::K2Node_Event_gamemode' has a wrong offset!");
static_assert(offsetof(DreamBase_C_ExecuteUbergraph_dreamBase, K2Node_Event_settings) == 0x000010, "Member 'DreamBase_C_ExecuteUbergraph_dreamBase::K2Node_Event_settings' has a wrong offset!");
...
static_assert(offsetof(DreamBase_C_ExecuteUbergraph_dreamBase, CallFunc_getMainPlayer_AsMain_Player) == 0x000168, "Member 'DreamBase_C_ExecuteUbergraph_dreamBase::CallFunc_getMainPlayer_AsMain_Player' has a wrong offset!");
...
static_assert(offsetof(DreamBase_C_ExecuteUbergraph_dreamBase, CallFunc_getMainPlayer_AsMain_Player_1) == 0x000198, "Member 'DreamBase_C_ExecuteUbergraph_dreamBase::CallFunc_getMainPlayer_AsMain_Player_1' has a wrong offset!");
static_assert(offsetof(DreamBase_C_ExecuteUbergraph_dreamBase, CallFunc_getEvent_isEventActive) == 0x0001A0, "Member 'DreamBase_C_ExecuteUbergraph_dreamBase::CallFunc_getEvent_isEventActive' has a wrong offset!");
static_assert(offsetof(DreamBase_C_ExecuteUbergraph_dreamBase, CallFunc_addFood_full) == 0x0001A1, "Member 'DreamBase_C_ExecuteUbergraph_dreamBase::CallFunc_addFood_full' has a wrong offset!");
static_assert(offsetof(DreamBase_C_ExecuteUbergraph_dreamBase, CallFunc_BooleanOR_ReturnValue) == 0x0001A2, "Member 'DreamBase_C_ExecuteUbergraph_dreamBase::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(DreamBase_C_ExecuteUbergraph_dreamBase, CallFunc_getMainGamemode_AsMain_Gamemode_2) == 0x0001A8, "Member 'DreamBase_C_ExecuteUbergraph_dreamBase::CallFunc_getMainGamemode_AsMain_Gamemode_2' has a wrong offset!");
static_assert(offsetof(DreamBase_C_ExecuteUbergraph_dreamBase, CallFunc_IsValid_ReturnValue) == 0x0001B0, "Member 'DreamBase_C_ExecuteUbergraph_dreamBase::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(DreamBase_C_TexturePickerApply, Index_0) == 0x000010, "Member 'DreamBase_C_TexturePickerApply::Index_0' has a wrong offset!");
...
static_assert(sizeof(DreamBase_C_SettingsApplied) == 0x000100, "Wrong size on DreamBase_C_SettingsApplied");
...
static_assert(offsetof(DreamBase_C_StuffUpgraded, GameMode_0) == 0x000000, "Member 'DreamBase_C_StuffUpgraded::GameMode_0' has a wrong offset!");
