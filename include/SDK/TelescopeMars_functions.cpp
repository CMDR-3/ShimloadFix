...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Fast_0                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void ATelescopeMars_C::LaunchBuild(bool Fast_0)
{
	static class UFunction* Func = nullptr;
...
void ATelescopeMars_C::SendName(class FName Name_0)
{
	static class UFunction* Func = nullptr;
...
void ATelescopeMars_C::NoRespawn(bool NoRespawn_0, bool* Return)
{
	static class UFunction* Func = nullptr;
