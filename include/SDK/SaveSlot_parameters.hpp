...
public:
	...
	TArray<uint8>                                 CallFunc_getShot_ByteArray;                        // 0x0068(0x0010)(ReferenceParm)
	class FString                                 CallFunc_gameVer_version;                          // 0x0078(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	struct FStruct_mObject                        CallFunc_Array_Get_Item_1;                         // 0x0088(0x0010)(HasGetValueTypeHash)
...
static_assert(offsetof(SaveSlot_C_Save, CallFunc_EqualEqual_NameName_ReturnValue) == 0x000001, "Member 'SaveSlot_C_Save::CallFunc_EqualEqual_NameName_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(SaveSlot_C_Save, CallFunc_Array_Length_ReturnValue) == 0x00001C, "Member 'SaveSlot_C_Save::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(SaveSlot_C_Save, CallFunc_EqualEqual_NameName_ReturnValue_1) == 0x000020, "Member 'SaveSlot_C_Save::CallFunc_EqualEqual_NameName_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(SaveSlot_C_Save, CallFunc_Array_Get_Item) == 0x000028, "Member 'SaveSlot_C_Save::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(SaveSlot_C_Save, CallFunc_K2_GetComponentToWorld_ReturnValue) == 0x000030, "Member 'SaveSlot_C_Save::CallFunc_K2_GetComponentToWorld_ReturnValue' has a wrong offset!");
static_assert(offsetof(SaveSlot_C_Save, CallFunc_Array_Add_ReturnValue) == 0x000060, "Member 'SaveSlot_C_Save::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(SaveSlot_C_Save, CallFunc_getShot_ByteArray) == 0x000068, "Member 'SaveSlot_C_Save::CallFunc_getShot_ByteArray' has a wrong offset!");
static_assert(offsetof(SaveSlot_C_Save, CallFunc_gameVer_version) == 0x000078, "Member 'SaveSlot_C_Save::CallFunc_gameVer_version' has a wrong offset!");
static_assert(offsetof(SaveSlot_C_Save, CallFunc_Array_Get_Item_1) == 0x000088, "Member 'SaveSlot_C_Save::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(SaveSlot_C_Save, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000098, "Member 'SaveSlot_C_Save::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(SaveSlot_C_Save, CallFunc_GetTransform_ReturnValue) == 0x0000A0, "Member 'SaveSlot_C_Save::CallFunc_GetTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(SaveSlot_C_Save, CallFunc_GetTransform_ReturnValue_1) == 0x0000D0, "Member 'SaveSlot_C_Save::CallFunc_GetTransform_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(SaveSlot_C_Save, CallFunc_IsEmpty_ReturnValue) == 0x000100, "Member 'SaveSlot_C_Save::CallFunc_IsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(SaveSlot_C_Save, Temp_int_Loop_Counter_Variable) == 0x000104, "Member 'SaveSlot_C_Save::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(SaveSlot_C_Save, CallFunc_Less_IntInt_ReturnValue) == 0x000108, "Member 'SaveSlot_C_Save::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(SaveSlot_C_Save, CallFunc_Clamp_ReturnValue) == 0x00010C, "Member 'SaveSlot_C_Save::CallFunc_Clamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(SaveSlot_C_Save, CallFunc_Add_IntInt_ReturnValue) == 0x000110, "Member 'SaveSlot_C_Save::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(SaveSlot_C_SetGamemode, GameMode_0) == 0x000000, "Member 'SaveSlot_C_SetGamemode::GameMode_0' has a wrong offset!");
...
public:
	...
	class FName                                   Name_0;                                            // 0x000C(0x0008)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(SaveSlot_C_PrAdvanc, Name_0) == 0x00000C, "Member 'SaveSlot_C_PrAdvanc::Name_0' has a wrong offset!");
...
{
public:
	int32                                         Day_0;                                             // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(SaveSlot_C_Reset_days, Day_0) == 0x000000, "Member 'SaveSlot_C_Reset_days::Day_0' has a wrong offset!");
...
{
public:
	class UGameInst_C*                            GameInst_0;                                        // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(SaveSlot_C_SetGameinst, GameInst_0) == 0x000000, "Member 'SaveSlot_C_SetGameinst::GameInst_0' has a wrong offset!");
...
static_assert(offsetof(SaveSlot_C_Duplicate, Name_0) == 0x000000, "Member 'SaveSlot_C_Duplicate::Name_0' has a wrong offset!");
...
// Function saveSlot.saveSlot_C.addRecipe
// 0x0010 (0x0010 - 0x0000)
struct SaveSlot_C_AddRecipe final
{
public:
...
static_assert(alignof(SaveSlot_C_AddRecipe) == 0x000004, "Wrong alignment on SaveSlot_C_AddRecipe");
static_assert(sizeof(SaveSlot_C_AddRecipe) == 0x000010, "Wrong size on SaveSlot_C_AddRecipe");
static_assert(offsetof(SaveSlot_C_AddRecipe, ItemToFind) == 0x000000, "Member 'SaveSlot_C_AddRecipe::ItemToFind' has a wrong offset!");
static_assert(offsetof(SaveSlot_C_AddRecipe, CallFunc_Array_Add_ReturnValue) == 0x000008, "Member 'SaveSlot_C_AddRecipe::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(SaveSlot_C_AddRecipe, CallFunc_Array_Contains_ReturnValue) == 0x00000C, "Member 'SaveSlot_C_AddRecipe::CallFunc_Array_Contains_ReturnValue' has a wrong offset!");
