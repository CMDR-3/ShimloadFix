...
static_assert(offsetof(Prop_wireComponent_polarized_C_WirePass, Wire_0) == 0x000000, "Member 'Prop_wireComponent_polarized_C_WirePass::Wire_0' has a wrong offset!");
