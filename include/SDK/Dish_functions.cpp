...
// Function dish.dish_C.gamemodePostKeys
// (Public, BlueprintCallable, BlueprintEvent)

void ADish_C::GamemodePostKeys()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("dish_C", "gamemodePostKeys");

	UObject::ProcessEvent(Func, nullptr);
}


// Function dish.dish_C.NewFunction_3
// (Public, BlueprintCallable, BlueprintEvent)

void ADish_C::NewFunction_3()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("dish_C", "NewFunction_3");

	UObject::ProcessEvent(Func, nullptr);
}


// Function dish.dish_C.NewFunction_2
// (Public, BlueprintCallable, BlueprintEvent)

void ADish_C::NewFunction_2()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("dish_C", "NewFunction_2");
...
void ADish_C::TexturePickerApply(class UUmg_texturePicker_C* Picker, class UTexture2D* Texture, int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
void ADish_C::StuffUpgraded(class AMainGamemode_C* GameMode_0)
{
	static class UFunction* Func = nullptr;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FVector                          LookAt_0                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ADish_C::StartMovingTo(const struct FVector& LookAt_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.LookAt_0 = std::move(LookAt_0);
