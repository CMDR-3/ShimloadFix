...
public:
	...
	float                                         boyoancyForce_0;                                   // 0x0008(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(bpCodeLib_boyoancyForce, boyoancyForce_0) == 0x000008, "Member 'bpCodeLib_boyoancyForce::boyoancyForce_0' has a wrong offset!");
...
public:
	...
	struct FVector                                Small1;                                            // 0x000C(0x000C)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(bpCodeLib_CanBoxFitInBox, Small1) == 0x00000C, "Member 'bpCodeLib_CanBoxFitInBox::Small1' has a wrong offset!");
...
// Function VotV.bpCodeLib.returnMeshTemplateData
// 0x0018 (0x0018 - 0x0000)
struct bpCodeLib_ReturnMeshTemplateData final
{
public:
	int32                                         Indexer;                                           // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 Rstring;                                           // 0x0008(0x0010)(Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(bpCodeLib_ReturnMeshTemplateData) == 0x000008, "Wrong alignment on bpCodeLib_ReturnMeshTemplateData");
static_assert(sizeof(bpCodeLib_ReturnMeshTemplateData) == 0x000018, "Wrong size on bpCodeLib_ReturnMeshTemplateData");
static_assert(offsetof(bpCodeLib_ReturnMeshTemplateData, Indexer) == 0x000000, "Member 'bpCodeLib_ReturnMeshTemplateData::Indexer' has a wrong offset!");
static_assert(offsetof(bpCodeLib_ReturnMeshTemplateData, Rstring) == 0x000008, "Member 'bpCodeLib_ReturnMeshTemplateData::Rstring' has a wrong offset!");
...
static_assert(offsetof(bpCodeLib_WeightedRandomV2, Index_0) == 0x000010, "Member 'bpCodeLib_WeightedRandomV2::Index_0' has a wrong offset!");
...
public:
	...
	int32                                         Index_0;                                           // 0x0014(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(bpCodeLib_WeightedRandomV2_exponent, Index_0) == 0x000014, "Member 'bpCodeLib_WeightedRandomV2_exponent::Index_0' has a wrong offset!");
...
static_assert(offsetof(bpCodeLib_WeightedRandomV2_lerp, Index_0) == 0x000014, "Member 'bpCodeLib_WeightedRandomV2_lerp::Index_0' has a wrong offset!");
