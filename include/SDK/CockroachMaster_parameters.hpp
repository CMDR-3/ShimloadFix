...
public:
	...
	int32                                         Temp_int_Loop_Counter_Variable_1;                  // 0x0750(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_RandomBoolWithWeight_ReturnValue;         // 0x075C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TArray<class AActor*>                         CallFunc_SphereOverlapActors_OutActors;            // 0x0810(0x0010)(ReferenceParm)
	bool                                          CallFunc_SphereOverlapActors_ReturnValue;          // 0x0820(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	int32                                         CallFunc_Array_Length_ReturnValue_2;               // 0x0824(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<EObjectTypeQuery>                      CallFunc_obj_static_obj;                           // 0x0828(0x0010)(ReferenceParm)
	int32                                         CallFunc_RandomIntegerInRange_ReturnValue;         // 0x0838(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                 CallFunc_Array_Get_Item_2;                         // 0x0840(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetActorBounds_Origin;                    // 0x0848(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetActorBounds_BoxExtent;                 // 0x0854(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_RandomUnitVector_ReturnValue;             // 0x0860(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_Add_VectorVector_ReturnValue;             // 0x0878(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GreaterEqual_IntInt_ReturnValue;          // 0x0884(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_885[0x3];                                      // 0x0885(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHitResult                             CallFunc_SphereTraceSingleForObjects_OutHit;       // 0x0888(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                          CallFunc_SphereTraceSingleForObjects_ReturnValue;  // 0x0910(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BreakHitResult_bBlockingHit;              // 0x0911(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BreakHitResult_bInitialOverlap;           // 0x0912(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FVector                                CallFunc_BreakHitResult_Location;                  // 0x091C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_BreakHitResult_ImpactPoint;               // 0x0928(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_BreakHitResult_Normal;                    // 0x0934(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_BreakHitResult_ImpactNormal;              // 0x0940(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_94C[0x4];                                      // 0x094C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UPhysicalMaterial*                      CallFunc_BreakHitResult_PhysMat;                   // 0x0950(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 CallFunc_BreakHitResult_HitActor;                  // 0x0958(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPrimitiveComponent*                    CallFunc_BreakHitResult_HitComponent;              // 0x0960(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FName                                   CallFunc_BreakHitResult_HitBoneName;               // 0x0968(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_BreakHitResult_TraceStart;                // 0x097C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_BreakHitResult_TraceEnd;                  // 0x0988(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                               CallFunc_Conv_VectorToRotator_ReturnValue;         // 0x0994(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FStruct_settings                       K2Node_Event_settings;                             // 0x09A0(0x0100)(HasGetValueTypeHash)
	...
	int32                                         CallFunc_Max_ReturnValue;                          // 0x0AD8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_ADC[0x4];                                      // 0x0ADC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AProp_cockroachNest_C*                  CallFunc_FinishSpawningActor_ReturnValue;          // 0x0AE0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	const class UStaticMeshComponent*             Temp_object_Variable_5;                            // 0x0AE8(0x0008)(ConstParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UStaticMeshComponent*                   CallFunc_Array_Get_Item_3;                         // 0x0AF0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Array_RemoveItem_ReturnValue_1;           // 0x0AF8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AMainPlayer_C*                          K2Node_Event_player;                               // 0x0B00(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_Event_hit;                                  // 0x0B08(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	Enum_interactionActions                       K2Node_Event_action;                               // 0x0B90(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Less_IntInt_ReturnValue_1;                // 0x0B91(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_SwitchEnum_CmpSuccess;                      // 0x0B92(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BreakHitResult_bBlockingHit_1;            // 0x0B93(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BreakHitResult_bInitialOverlap_1;         // 0x0B94(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_B95[0x3];                                      // 0x0B95(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_BreakHitResult_Time_1;                    // 0x0B98(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_BreakHitResult_Distance_1;                // 0x0B9C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_BreakHitResult_Location_1;                // 0x0BA0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_BreakHitResult_ImpactPoint_1;             // 0x0BAC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_BreakHitResult_Normal_1;                  // 0x0BB8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_BreakHitResult_ImpactNormal_1;            // 0x0BC4(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	const class UStaticMeshComponent*             Temp_object_Variable_6;                            // 0x0C18(0x0008)(ConstParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_K2_GetComponentScale_ReturnValue_1;       // 0x0C20(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_VSize_ReturnValue_1;                      // 0x0C2C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UStaticMeshComponent*                   K2Node_DynamicCast_AsStatic_Mesh_Component;        // 0x0C30(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Multiply_FloatFloat_ReturnValue;          // 0x0C3C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Array_Find_ReturnValue_1;                 // 0x0C40(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_addFood_full;                             // 0x0C44(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_GreaterEqual_IntInt_ReturnValue_1;        // 0x0C45(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_C46[0x2];                                      // 0x0C46(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class USaveSlot_C*                            CallFunc_getSaveSlot_saveSlot;                     // 0x0C48(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_FClamp_ReturnValue;                       // 0x0C50(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_C54[0x4];                                      // 0x0C54(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UPrimitiveComponent*                    K2Node_Event_component;                            // 0x0C58(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_RandomBoolWithWeight_ReturnValue_1;       // 0x0C64(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_progressAdvancement_finished;             // 0x0C65(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_C66[0x2];                                      // 0x0C66(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   CallFunc_progressAdvancement_name;                 // 0x0C68(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UStaticMesh*                            K2Node_Select_Default;                             // 0x0C70(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UStaticMeshComponent*                   CallFunc_Array_Get_Item_4;                         // 0x0C78(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_SetStaticMesh_ReturnValue;                // 0x0C80(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_C81[0x3];                                      // 0x0C81(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Temp_int_Loop_Counter_Variable_2;                  // 0x0C84(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Less_IntInt_ReturnValue_2;                // 0x0C88(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_C89[0x3];                                      // 0x0C89(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_Add_IntInt_ReturnValue_3;                 // 0x0C8C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster) == 0x000C90, "Wrong size on CockroachMaster_C_ExecuteUbergraph_cockroachMaster");
...
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_getMainGamemode_AsMain_Gamemode) == 0x000008, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_getMainGamemode_AsMain_Gamemode' has a wrong offset!");
...
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, Temp_int_Loop_Counter_Variable) == 0x000018, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Add_IntInt_ReturnValue) == 0x00001C, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Add_IntInt_ReturnValue_1) == 0x00002C, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, Temp_int_Loop_Counter_Variable_1) == 0x000750, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::Temp_int_Loop_Counter_Variable_1' has a wrong offset!");
...
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Add_IntInt_ReturnValue_2) == 0x000758, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Add_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_RandomBoolWithWeight_ReturnValue) == 0x00075C, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_RandomBoolWithWeight_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Less_IntInt_ReturnValue) == 0x000768, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_SphereOverlapActors_OutActors) == 0x000810, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_SphereOverlapActors_OutActors' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_SphereOverlapActors_ReturnValue) == 0x000820, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_SphereOverlapActors_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, Temp_bool_Variable) == 0x000821, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Array_Length_ReturnValue_2) == 0x000824, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Array_Length_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_obj_static_obj) == 0x000828, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_obj_static_obj' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_RandomIntegerInRange_ReturnValue) == 0x000838, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_RandomIntegerInRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Greater_IntInt_ReturnValue) == 0x00083C, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Array_Get_Item_2) == 0x000840, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_GetActorBounds_Origin) == 0x000848, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_GetActorBounds_Origin' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_GetActorBounds_BoxExtent) == 0x000854, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_GetActorBounds_BoxExtent' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_RandomUnitVector_ReturnValue) == 0x000860, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_RandomUnitVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Multiply_VectorFloat_ReturnValue) == 0x00086C, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Multiply_VectorFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Add_VectorVector_ReturnValue) == 0x000878, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Add_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x000884, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_SphereTraceSingleForObjects_OutHit) == 0x000888, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_SphereTraceSingleForObjects_OutHit' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_SphereTraceSingleForObjects_ReturnValue) == 0x000910, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_SphereTraceSingleForObjects_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_bBlockingHit) == 0x000911, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_bBlockingHit' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_bInitialOverlap) == 0x000912, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_bInitialOverlap' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_Time) == 0x000914, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_Time' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_Distance) == 0x000918, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_Distance' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_Location) == 0x00091C, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_Location' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_ImpactPoint) == 0x000928, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_ImpactPoint' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_Normal) == 0x000934, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_Normal' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_ImpactNormal) == 0x000940, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_ImpactNormal' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_PhysMat) == 0x000950, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_PhysMat' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_HitActor) == 0x000958, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_HitActor' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_HitComponent) == 0x000960, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_HitComponent' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_HitBoneName) == 0x000968, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_HitBoneName' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_HitItem) == 0x000970, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_HitItem' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_ElementIndex) == 0x000974, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_ElementIndex' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_FaceIndex) == 0x000978, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_FaceIndex' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_TraceStart) == 0x00097C, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_TraceStart' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_TraceEnd) == 0x000988, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_TraceEnd' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Conv_VectorToRotator_ReturnValue) == 0x000994, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Conv_VectorToRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, K2Node_Event_settings) == 0x0009A0, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::K2Node_Event_settings' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_MakeTransform_ReturnValue) == 0x000AA0, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_MakeTransform_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Max_ReturnValue) == 0x000AD8, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Max_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_FinishSpawningActor_ReturnValue) == 0x000AE0, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, Temp_object_Variable_5) == 0x000AE8, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::Temp_object_Variable_5' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Array_Get_Item_3) == 0x000AF0, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Array_Get_Item_3' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Array_RemoveItem_ReturnValue_1) == 0x000AF8, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Array_RemoveItem_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Array_Length_ReturnValue_3) == 0x000AFC, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Array_Length_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, K2Node_Event_player) == 0x000B00, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, K2Node_Event_hit) == 0x000B08, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, K2Node_Event_action) == 0x000B90, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Less_IntInt_ReturnValue_1) == 0x000B91, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, K2Node_SwitchEnum_CmpSuccess) == 0x000B92, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_bBlockingHit_1) == 0x000B93, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_bBlockingHit_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_bInitialOverlap_1) == 0x000B94, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_bInitialOverlap_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_Time_1) == 0x000B98, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_Time_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_Distance_1) == 0x000B9C, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_Distance_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_Location_1) == 0x000BA0, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_Location_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_ImpactPoint_1) == 0x000BAC, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_ImpactPoint_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_Normal_1) == 0x000BB8, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_Normal_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_ImpactNormal_1) == 0x000BC4, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_ImpactNormal_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_PhysMat_1) == 0x000BD0, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_PhysMat_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_HitActor_1) == 0x000BD8, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_HitActor_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_HitComponent_1) == 0x000BE0, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_HitComponent_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_HitBoneName_1) == 0x000BE8, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_HitBoneName_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_HitItem_1) == 0x000BF0, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_HitItem_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_ElementIndex_1) == 0x000BF4, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_ElementIndex_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_FaceIndex_1) == 0x000BF8, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_FaceIndex_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_TraceStart_1) == 0x000BFC, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_TraceStart_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_BreakHitResult_TraceEnd_1) == 0x000C08, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_BreakHitResult_TraceEnd_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, Temp_object_Variable_6) == 0x000C18, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::Temp_object_Variable_6' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_K2_GetComponentScale_ReturnValue_1) == 0x000C20, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_K2_GetComponentScale_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_VSize_ReturnValue_1) == 0x000C2C, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_VSize_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, K2Node_DynamicCast_AsStatic_Mesh_Component) == 0x000C30, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::K2Node_DynamicCast_AsStatic_Mesh_Component' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, K2Node_DynamicCast_bSuccess) == 0x000C38, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x000C3C, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Array_Find_ReturnValue_1) == 0x000C40, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Array_Find_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_addFood_full) == 0x000C44, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_addFood_full' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_GreaterEqual_IntInt_ReturnValue_1) == 0x000C45, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_GreaterEqual_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_getSaveSlot_saveSlot) == 0x000C48, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_getSaveSlot_saveSlot' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_FClamp_ReturnValue) == 0x000C50, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_FClamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, K2Node_Event_component) == 0x000C58, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::K2Node_Event_component' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000C60, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_RandomBoolWithWeight_ReturnValue_1) == 0x000C64, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_RandomBoolWithWeight_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_progressAdvancement_finished) == 0x000C65, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_progressAdvancement_finished' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_progressAdvancement_name) == 0x000C68, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_progressAdvancement_name' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, K2Node_Select_Default) == 0x000C70, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Array_Get_Item_4) == 0x000C78, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Array_Get_Item_4' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_SetStaticMesh_ReturnValue) == 0x000C80, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_SetStaticMesh_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, Temp_int_Loop_Counter_Variable_2) == 0x000C84, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::Temp_int_Loop_Counter_Variable_2' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Less_IntInt_ReturnValue_2) == 0x000C88, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Less_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_ExecuteUbergraph_cockroachMaster, CallFunc_Add_IntInt_ReturnValue_3) == 0x000C8C, "Member 'CockroachMaster_C_ExecuteUbergraph_cockroachMaster::CallFunc_Add_IntInt_ReturnValue_3' has a wrong offset!");
...
static_assert(sizeof(CockroachMaster_C_SettingsApplied) == 0x000100, "Wrong size on CockroachMaster_C_SettingsApplied");
...
static_assert(offsetof(CockroachMaster_C_ActionName, Name_0) == 0x000090, "Member 'CockroachMaster_C_ActionName::Name_0' has a wrong offset!");
...
static_assert(offsetof(CockroachMaster_C_SendName, Name_0) == 0x000000, "Member 'CockroachMaster_C_SendName::Name_0' has a wrong offset!");
...
static_assert(offsetof(CockroachMaster_C_TexturePickerApply, Index_0) == 0x000010, "Member 'CockroachMaster_C_TexturePickerApply::Index_0' has a wrong offset!");
...
static_assert(offsetof(CockroachMaster_C_StuffUpgraded, GameMode_0) == 0x000000, "Member 'CockroachMaster_C_StuffUpgraded::GameMode_0' has a wrong offset!");
...
public:
	struct FVector                                Location;                                          // 0x0000(0x000C)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                Size_0;                                            // 0x000C(0x000C)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(CockroachMaster_C_AddRoach, Size_0) == 0x00000C, "Member 'CockroachMaster_C_AddRoach::Size_0' has a wrong offset!");
...
{
public:
	struct FVector                                Loc_0;                                             // 0x0000(0x000C)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(CockroachMaster_C_TryCrush, Loc_0) == 0x000000, "Member 'CockroachMaster_C_TryCrush::Loc_0' has a wrong offset!");
...
static_assert(offsetof(CockroachMaster_C_TryCrush, CallFunc_LessEqual_FloatFloat_ReturnValue) == 0x0000A0, "Member 'CockroachMaster_C_TryCrush::CallFunc_LessEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_TryCrush, CallFunc_Conv_FloatToString_ReturnValue) == 0x0000A8, "Member 'CockroachMaster_C_TryCrush::CallFunc_Conv_FloatToString_ReturnValue' has a wrong offset!");
...
public:
	...
	class AProp_food_C*                           CallFunc_Array_Get_Item;                           // 0x0018(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                K2Node_LowEntry_LocalVariable_Value__Object;       // 0x006C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AProp_food_C*                           K2Node_DynamicCast_AsProp_Food;                    // 0x00A8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_Array_LastIndex_ReturnValue) == 0x000010, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_Array_LastIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_RandomIntegerInRange_ReturnValue) == 0x000014, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_RandomIntegerInRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_Array_Get_Item) == 0x000018, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_GetActorBounds_Origin) == 0x000020, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_GetActorBounds_Origin' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_GetActorBounds_BoxExtent) == 0x00002C, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_GetActorBounds_BoxExtent' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_GetPlayerCameraManager_ReturnValue) == 0x000038, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_GetPlayerCameraManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000040, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, Temp_object_Variable) == 0x000050, "Member 'CockroachMaster_C_FoodRoachSpawn::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_RandomPointInBoundingBox_ReturnValue) == 0x000060, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_RandomPointInBoundingBox_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, K2Node_LowEntry_LocalVariable_Value__Object) == 0x00006C, "Member 'CockroachMaster_C_FoodRoachSpawn::K2Node_LowEntry_LocalVariable_Value__Object' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_SphereOverlapActors_OutActors) == 0x000078, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_SphereOverlapActors_OutActors' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_SphereOverlapActors_ReturnValue) == 0x000088, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_SphereOverlapActors_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_Array_Length_ReturnValue) == 0x00008C, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000090, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_Array_Get_Item_1) == 0x000098, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_Divide_FloatFloat_ReturnValue) == 0x0000A0, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, K2Node_DynamicCast_AsProp_Food) == 0x0000A8, "Member 'CockroachMaster_C_FoodRoachSpawn::K2Node_DynamicCast_AsProp_Food' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, K2Node_DynamicCast_bSuccess) == 0x0000B0, "Member 'CockroachMaster_C_FoodRoachSpawn::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_Conv_FloatToString_ReturnValue) == 0x0000B8, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_Conv_FloatToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_Concat_StrStr_ReturnValue) == 0x0000C8, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_Divide_FloatFloat_ReturnValue_1) == 0x0000D8, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_Divide_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_FClamp_ReturnValue) == 0x0000DC, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_FClamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_RandomBoolWithWeight_ReturnValue) == 0x0000E0, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_RandomBoolWithWeight_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_Subtract_FloatFloat_ReturnValue) == 0x0000E4, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_Subtract_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_VictoryFloatPlusEquals_FloatOut) == 0x0000E8, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_VictoryFloatPlusEquals_FloatOut' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_Array_Length_ReturnValue_1) == 0x0000EC, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CockroachMaster_C_FoodRoachSpawn, CallFunc_Less_IntInt_ReturnValue) == 0x0000F0, "Member 'CockroachMaster_C_FoodRoachSpawn::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(CockroachMaster_C_NoRespawn, NoRespawn_0) == 0x000000, "Member 'CockroachMaster_C_NoRespawn::NoRespawn_0' has a wrong offset!");
