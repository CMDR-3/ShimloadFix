...
public:
	...
	class FText                                   Name_0;                                            // 0x02A8(0x0018)(Edit, BlueprintVisible)
...
static_assert(sizeof(UUmg_upgradeSlot_C) == 0x0002E0, "Wrong size on UUmg_upgradeSlot_C");
...
static_assert(offsetof(UUmg_upgradeSlot_C, Index_0) == 0x0002A0, "Member 'UUmg_upgradeSlot_C::Index_0' has a wrong offset!");
static_assert(offsetof(UUmg_upgradeSlot_C, Name_0) == 0x0002A8, "Member 'UUmg_upgradeSlot_C::Name_0' has a wrong offset!");
...
static_assert(offsetof(UUmg_upgradeSlot_C, GameMode) == 0x0002D8, "Member 'UUmg_upgradeSlot_C::GameMode' has a wrong offset!");
