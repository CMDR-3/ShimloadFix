...
public:
	...
	struct FStruct_settings                       K2Node_Event_settings;                             // 0x0548(0x0100)(HasGetValueTypeHash)
	...
	class UUmg_texturePicker_C*                   K2Node_Event_picker;                               // 0x0678(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UTexture2D*                             K2Node_Event_texture;                              // 0x0680(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_Event_index;                                // 0x0688(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_68C[0x4];                                      // 0x068C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AMainPlayer_C*                          K2Node_Event_player_5;                             // 0x0690(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_Event_hit_1;                                // 0x0698(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                          K2Node_Event_kick;                                 // 0x0720(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_721[0x3];                                      // 0x0721(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   K2Node_Event_name;                                 // 0x0724(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AMainPlayer_C*                          K2Node_Event_player_3;                             // 0x0738(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AMainPlayer_C*                          K2Node_Event_player_2;                             // 0x07D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AMainPlayer_C*                          K2Node_Event_player_1;                             // 0x07D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AMainPlayer_C*                          K2Node_Event_player;                               // 0x07E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_CustomEvent_DestroyedActor;                 // 0x07E8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class AActor* DestroyedActor)> K2Node_CreateDelegate_OutputDelegate;              // 0x07F4(0x0010)(ZeroConstructor, NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue_1;                    // 0x0804(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_805[0x3];                                      // 0x0805(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class AProp_C*                                K2Node_DynamicCast_AsProp;                         // 0x0808(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_1;            // 0x0814(0x0010)(ZeroConstructor, NoDestructor)
};
...
static_assert(sizeof(Rope_broken_C_ExecuteUbergraph_rope_broken) == 0x000828, "Wrong size on Rope_broken_C_ExecuteUbergraph_rope_broken");
...
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_key) == 0x000648, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_key' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_pressed) == 0x000660, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_pressed' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_color) == 0x000664, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_color' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_picker) == 0x000678, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_picker' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_texture) == 0x000680, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_texture' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_index) == 0x000688, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_index' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_player_5) == 0x000690, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_player_5' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_hit_1) == 0x000698, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_hit_1' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_kick) == 0x000720, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_kick' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_name) == 0x000724, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_name' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_player_4) == 0x000730, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_player_4' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_player_3) == 0x000738, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_player_3' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_hit) == 0x000740, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_damage) == 0x0007C8, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_damage' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_player_2) == 0x0007D0, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_player_2' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_player_1) == 0x0007D8, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_player_1' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_Event_player) == 0x0007E0, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_CustomEvent_DestroyedActor) == 0x0007E8, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_CustomEvent_DestroyedActor' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, CallFunc_IsValid_ReturnValue) == 0x0007F0, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_CreateDelegate_OutputDelegate) == 0x0007F4, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, CallFunc_IsValid_ReturnValue_1) == 0x000804, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_DynamicCast_AsProp) == 0x000808, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_DynamicCast_AsProp' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_DynamicCast_bSuccess) == 0x000810, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Rope_broken_C_ExecuteUbergraph_rope_broken, K2Node_CreateDelegate_OutputDelegate_1) == 0x000814, "Member 'Rope_broken_C_ExecuteUbergraph_rope_broken::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
...
static_assert(offsetof(Rope_broken_C_SendName, Name_0) == 0x000000, "Member 'Rope_broken_C_SendName::Name_0' has a wrong offset!");
...
static_assert(offsetof(Rope_broken_C_TexturePickerApply, Index_0) == 0x000010, "Member 'Rope_broken_C_TexturePickerApply::Index_0' has a wrong offset!");
...
static_assert(sizeof(Rope_broken_C_SettingsApplied) == 0x000100, "Wrong size on Rope_broken_C_SettingsApplied");
...
static_assert(offsetof(Rope_broken_C_ActionName, Name_0) == 0x000090, "Member 'Rope_broken_C_ActionName::Name_0' has a wrong offset!");
...
public:
	...
	float                                         Dist_0;                                            // 0x0020(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Rope_broken_C_Attach_a, Dist_0) == 0x000020, "Member 'Rope_broken_C_Attach_a::Dist_0' has a wrong offset!");
...
static_assert(offsetof(Rope_broken_C_NoRespawn, NoRespawn_0) == 0x000000, "Member 'Rope_broken_C_NoRespawn::NoRespawn_0' has a wrong offset!");
