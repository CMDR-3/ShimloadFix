...
static_assert(offsetof(Panel_download_tutorial3_C_RunTrigger, Owner_0) == 0x000000, "Member 'Panel_download_tutorial3_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(Panel_download_tutorial3_C_RunTrigger, Index_0) == 0x000008, "Member 'Panel_download_tutorial3_C_RunTrigger::Index_0' has a wrong offset!");
