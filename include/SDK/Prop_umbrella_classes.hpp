...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Prop_umbrella_C;                    // 0x0358(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	...
	bool                                          Anim;                                              // 0x0369(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(AProp_umbrella_C) == 0x000370, "Wrong size on AProp_umbrella_C");
static_assert(offsetof(AProp_umbrella_C, UberGraphFrame_Prop_umbrella_C) == 0x000358, "Member 'AProp_umbrella_C::UberGraphFrame_Prop_umbrella_C' has a wrong offset!");
static_assert(offsetof(AProp_umbrella_C, SkeletalMesh) == 0x000360, "Member 'AProp_umbrella_C::SkeletalMesh' has a wrong offset!");
static_assert(offsetof(AProp_umbrella_C, Active) == 0x000368, "Member 'AProp_umbrella_C::Active' has a wrong offset!");
static_assert(offsetof(AProp_umbrella_C, Anim) == 0x000369, "Member 'AProp_umbrella_C::Anim' has a wrong offset!");
