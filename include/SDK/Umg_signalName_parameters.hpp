...
static_assert(sizeof(Umg_signalName_C_ExecuteUbergraph_umg_signalName) == 0x000068, "Wrong size on Umg_signalName_C_ExecuteUbergraph_umg_signalName");
...
static_assert(offsetof(Umg_signalName_C_ExecuteUbergraph_umg_signalName, CallFunc_GetText_ReturnValue) == 0x000008, "Member 'Umg_signalName_C_ExecuteUbergraph_umg_signalName::CallFunc_GetText_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_signalName_C_ExecuteUbergraph_umg_signalName, CallFunc_Conv_TextToString_ReturnValue) == 0x000020, "Member 'Umg_signalName_C_ExecuteUbergraph_umg_signalName::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_signalName_C_ExecuteUbergraph_umg_signalName, CallFunc_GetPlayerController_ReturnValue) == 0x000030, "Member 'Umg_signalName_C_ExecuteUbergraph_umg_signalName::CallFunc_GetPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_signalName_C_ExecuteUbergraph_umg_signalName, K2Node_ComponentBoundEvent_Text) == 0x000038, "Member 'Umg_signalName_C_ExecuteUbergraph_umg_signalName::K2Node_ComponentBoundEvent_Text' has a wrong offset!");
static_assert(offsetof(Umg_signalName_C_ExecuteUbergraph_umg_signalName, K2Node_ComponentBoundEvent_CommitMethod) == 0x000050, "Member 'Umg_signalName_C_ExecuteUbergraph_umg_signalName::K2Node_ComponentBoundEvent_CommitMethod' has a wrong offset!");
static_assert(offsetof(Umg_signalName_C_ExecuteUbergraph_umg_signalName, CallFunc_getMainPlayer_AsMain_Player) == 0x000058, "Member 'Umg_signalName_C_ExecuteUbergraph_umg_signalName::CallFunc_getMainPlayer_AsMain_Player' has a wrong offset!");
static_assert(offsetof(Umg_signalName_C_ExecuteUbergraph_umg_signalName, K2Node_Event_InFocusEvent) == 0x000060, "Member 'Umg_signalName_C_ExecuteUbergraph_umg_signalName::K2Node_Event_InFocusEvent' has a wrong offset!");
...
{
public:
	class USignalSlot_C*                          Rename_0;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Umg_signalName_C_Init, Rename_0) == 0x000000, "Member 'Umg_signalName_C_Init::Rename_0' has a wrong offset!");
