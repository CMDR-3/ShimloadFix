...
// Parameters:
// float                                   Level_0                                                (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AProp_waterShooter_C::Get(float* Level_0)
{
	static class UFunction* Func = nullptr;
...
void AProp_waterShooter_C::PlayerHandUse_LMB(class AMainPlayer_C* Player_0)
{
	static class UFunction* Func = nullptr;
...
void AProp_waterShooter_C::PlayerHandRelease_LMB(class AMainPlayer_C* Player_0)
{
	static class UFunction* Func = nullptr;
...
void AProp_waterShooter_C::PlayerHandUse_RMB(class AMainPlayer_C* Player_0)
{
	static class UFunction* Func = nullptr;
