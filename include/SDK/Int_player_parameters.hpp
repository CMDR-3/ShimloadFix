...
static_assert(offsetof(Int_player_C_NoRespawn, NoRespawn_0) == 0x000000, "Member 'Int_player_C_NoRespawn::NoRespawn_0' has a wrong offset!");
...
static_assert(offsetof(Int_player_C_SendName, Name_0) == 0x000000, "Member 'Int_player_C_SendName::Name_0' has a wrong offset!");
