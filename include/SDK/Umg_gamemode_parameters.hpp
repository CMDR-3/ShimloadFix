...
public:
	...
	bool                                          CallFunc_hasAchievement_ReturnValue;               // 0x0160(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_hasAchievement_ReturnValue_1;             // 0x0161(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_hasAchievement_ReturnValue_2;             // 0x0162(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(Umg_gamemode_C_ExecuteUbergraph_umg_gamemode, K2Node_Event_key) == 0x000110, "Member 'Umg_gamemode_C_ExecuteUbergraph_umg_gamemode::K2Node_Event_key' has a wrong offset!");
static_assert(offsetof(Umg_gamemode_C_ExecuteUbergraph_umg_gamemode, K2Node_Event_pressed) == 0x000128, "Member 'Umg_gamemode_C_ExecuteUbergraph_umg_gamemode::K2Node_Event_pressed' has a wrong offset!");
static_assert(offsetof(Umg_gamemode_C_ExecuteUbergraph_umg_gamemode, K2Node_Event_color) == 0x00012C, "Member 'Umg_gamemode_C_ExecuteUbergraph_umg_gamemode::K2Node_Event_color' has a wrong offset!");
static_assert(offsetof(Umg_gamemode_C_ExecuteUbergraph_umg_gamemode, K2Node_Event_picker) == 0x000140, "Member 'Umg_gamemode_C_ExecuteUbergraph_umg_gamemode::K2Node_Event_picker' has a wrong offset!");
static_assert(offsetof(Umg_gamemode_C_ExecuteUbergraph_umg_gamemode, K2Node_Event_texture) == 0x000148, "Member 'Umg_gamemode_C_ExecuteUbergraph_umg_gamemode::K2Node_Event_texture' has a wrong offset!");
static_assert(offsetof(Umg_gamemode_C_ExecuteUbergraph_umg_gamemode, K2Node_Event_index) == 0x000150, "Member 'Umg_gamemode_C_ExecuteUbergraph_umg_gamemode::K2Node_Event_index' has a wrong offset!");
static_assert(offsetof(Umg_gamemode_C_ExecuteUbergraph_umg_gamemode, CallFunc_GetPlayerController_ReturnValue) == 0x000158, "Member 'Umg_gamemode_C_ExecuteUbergraph_umg_gamemode::CallFunc_GetPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_gamemode_C_ExecuteUbergraph_umg_gamemode, CallFunc_hasAchievement_ReturnValue) == 0x000160, "Member 'Umg_gamemode_C_ExecuteUbergraph_umg_gamemode::CallFunc_hasAchievement_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_gamemode_C_ExecuteUbergraph_umg_gamemode, CallFunc_hasAchievement_ReturnValue_1) == 0x000161, "Member 'Umg_gamemode_C_ExecuteUbergraph_umg_gamemode::CallFunc_hasAchievement_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Umg_gamemode_C_ExecuteUbergraph_umg_gamemode, CallFunc_hasAchievement_ReturnValue_2) == 0x000162, "Member 'Umg_gamemode_C_ExecuteUbergraph_umg_gamemode::CallFunc_hasAchievement_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Umg_gamemode_C_ExecuteUbergraph_umg_gamemode, CallFunc_getMainGamemode_AsMain_Gamemode) == 0x000168, "Member 'Umg_gamemode_C_ExecuteUbergraph_umg_gamemode::CallFunc_getMainGamemode_AsMain_Gamemode' has a wrong offset!");
static_assert(offsetof(Umg_gamemode_C_ExecuteUbergraph_umg_gamemode, CallFunc_IsValid_ReturnValue) == 0x000170, "Member 'Umg_gamemode_C_ExecuteUbergraph_umg_gamemode::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Umg_gamemode_C_TexturePickerApply, Index_0) == 0x000010, "Member 'Umg_gamemode_C_TexturePickerApply::Index_0' has a wrong offset!");
...
static_assert(sizeof(Umg_gamemode_C_SettingsApplied) == 0x000100, "Wrong size on Umg_gamemode_C_SettingsApplied");
...
static_assert(offsetof(Umg_gamemode_C_StuffUpgraded, GameMode_0) == 0x000000, "Member 'Umg_gamemode_C_StuffUpgraded::GameMode_0' has a wrong offset!");
...
static_assert(offsetof(Umg_gamemode_C_SetDesc, Index_0) == 0x000000, "Member 'Umg_gamemode_C_SetDesc::Index_0' has a wrong offset!");
