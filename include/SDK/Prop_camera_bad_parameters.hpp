...
static_assert(offsetof(Prop_camera_bad_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_camera_bad_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(sizeof(Prop_camera_bad_C_SaveInit) == 0x000058, "Wrong size on Prop_camera_bad_C_SaveInit");
...
static_assert(offsetof(Prop_camera_bad_C_SaveInit, CallFunc_Conv_TextToString_ReturnValue) == 0x000018, "Member 'Prop_camera_bad_C_SaveInit::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_camera_bad_C_SaveInit, CallFunc_Concat_StrStr_ReturnValue) == 0x000028, "Member 'Prop_camera_bad_C_SaveInit::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_camera_bad_C_SaveInit, CallFunc_Conv_StringToText_ReturnValue) == 0x000038, "Member 'Prop_camera_bad_C_SaveInit::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_camera_bad_C_SaveInit, CallFunc_TextIsEmpty_ReturnValue) == 0x000050, "Member 'Prop_camera_bad_C_SaveInit::CallFunc_TextIsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_camera_bad_C_SaveInit, CallFunc_Less_IntInt_ReturnValue) == 0x000051, "Member 'Prop_camera_bad_C_SaveInit::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_camera_bad_C_SaveInit, CallFunc_Array_Add_ReturnValue) == 0x000054, "Member 'Prop_camera_bad_C_SaveInit::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
...
{
public:
	float                                         Rot_X_0;                                           // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Rot_Y_0;                                           // 0x0004(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Zoom_0;                                            // 0x0008(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(Prop_camera_bad_C_SetAngle, Rot_X_0) == 0x000000, "Member 'Prop_camera_bad_C_SetAngle::Rot_X_0' has a wrong offset!");
static_assert(offsetof(Prop_camera_bad_C_SetAngle, Rot_Y_0) == 0x000004, "Member 'Prop_camera_bad_C_SetAngle::Rot_Y_0' has a wrong offset!");
static_assert(offsetof(Prop_camera_bad_C_SetAngle, Zoom_0) == 0x000008, "Member 'Prop_camera_bad_C_SetAngle::Zoom_0' has a wrong offset!");
...
{
public:
	struct FIntPoint                              Res_0;                                             // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         UpdRate_0;                                         // 0x0008(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Rot_X_0;                                           // 0x000C(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Rot_Y_0;                                           // 0x0010(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Zoom_0;                                            // 0x0014(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(Prop_camera_bad_C_GetInfo, Res_0) == 0x000000, "Member 'Prop_camera_bad_C_GetInfo::Res_0' has a wrong offset!");
static_assert(offsetof(Prop_camera_bad_C_GetInfo, UpdRate_0) == 0x000008, "Member 'Prop_camera_bad_C_GetInfo::UpdRate_0' has a wrong offset!");
static_assert(offsetof(Prop_camera_bad_C_GetInfo, Rot_X_0) == 0x00000C, "Member 'Prop_camera_bad_C_GetInfo::Rot_X_0' has a wrong offset!");
static_assert(offsetof(Prop_camera_bad_C_GetInfo, Rot_Y_0) == 0x000010, "Member 'Prop_camera_bad_C_GetInfo::Rot_Y_0' has a wrong offset!");
static_assert(offsetof(Prop_camera_bad_C_GetInfo, Zoom_0) == 0x000014, "Member 'Prop_camera_bad_C_GetInfo::Zoom_0' has a wrong offset!");
...
static_assert(offsetof(Prop_camera_bad_C_LookAt, Hit_0) == 0x000008, "Member 'Prop_camera_bad_C_LookAt::Hit_0' has a wrong offset!");
