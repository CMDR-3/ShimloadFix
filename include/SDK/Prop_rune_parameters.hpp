...
static_assert(offsetof(Prop_rune_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_rune_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_rune_C_SetActive, Active_0) == 0x000000, "Member 'Prop_rune_C_SetActive::Active_0' has a wrong offset!");
