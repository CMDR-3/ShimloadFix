...
public:
	...
	bool                                          CallFunc_LessEqual_FloatFloat_ReturnValue;         // 0x00AA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(bed_C_ExecuteUbergraph_bed) == 0x000008, "Wrong alignment on bed_C_ExecuteUbergraph_bed");
static_assert(sizeof(bed_C_ExecuteUbergraph_bed) == 0x0000B0, "Wrong size on bed_C_ExecuteUbergraph_bed");
...
static_assert(offsetof(bed_C_ExecuteUbergraph_bed, CallFunc_GetActorUpVector_ReturnValue) == 0x000004, "Member 'bed_C_ExecuteUbergraph_bed::CallFunc_GetActorUpVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(bed_C_ExecuteUbergraph_bed, CallFunc_Dot_VectorVector_ReturnValue) == 0x000010, "Member 'bed_C_ExecuteUbergraph_bed::CallFunc_Dot_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(bed_C_ExecuteUbergraph_bed, CallFunc_Greater_FloatFloat_ReturnValue) == 0x000014, "Member 'bed_C_ExecuteUbergraph_bed::CallFunc_Greater_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(bed_C_ExecuteUbergraph_bed, K2Node_Event_player) == 0x000018, "Member 'bed_C_ExecuteUbergraph_bed::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(bed_C_ExecuteUbergraph_bed, K2Node_Event_hit) == 0x000020, "Member 'bed_C_ExecuteUbergraph_bed::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(bed_C_ExecuteUbergraph_bed, K2Node_Event_action) == 0x0000A8, "Member 'bed_C_ExecuteUbergraph_bed::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(bed_C_ExecuteUbergraph_bed, K2Node_SwitchEnum_CmpSuccess) == 0x0000A9, "Member 'bed_C_ExecuteUbergraph_bed::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(bed_C_ExecuteUbergraph_bed, CallFunc_LessEqual_FloatFloat_ReturnValue) == 0x0000AA, "Member 'bed_C_ExecuteUbergraph_bed::CallFunc_LessEqual_FloatFloat_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(bed_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'bed_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(offsetof(bed_C_LookAt, Hit_0) == 0x000008, "Member 'bed_C_LookAt::Hit_0' has a wrong offset!");
...
static_assert(offsetof(bed_C_NoRespawn, Param_NoRespawn_0) == 0x000000, "Member 'bed_C_NoRespawn::Param_NoRespawn_0' has a wrong offset!");
