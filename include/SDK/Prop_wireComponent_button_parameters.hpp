...
static_assert(offsetof(Prop_wireComponent_button_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_wireComponent_button_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_wireComponent_button_C_WireConnected, Wire_0) == 0x000000, "Member 'Prop_wireComponent_button_C_WireConnected::Wire_0' has a wrong offset!");
