...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_UfoDropper_tank_C;                  // 0x02C0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(AUfoDropper_tank_C) == 0x0002C8, "Wrong size on AUfoDropper_tank_C");
static_assert(offsetof(AUfoDropper_tank_C, UberGraphFrame_UfoDropper_tank_C) == 0x0002C0, "Member 'AUfoDropper_tank_C::UberGraphFrame_UfoDropper_tank_C' has a wrong offset!");
