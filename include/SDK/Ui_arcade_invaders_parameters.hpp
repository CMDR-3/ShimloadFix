...
static_assert(sizeof(Ui_arcade_invaders_C_ExecuteUbergraph_ui_arcade_invaders) == 0x000160, "Wrong size on Ui_arcade_invaders_C_ExecuteUbergraph_ui_arcade_invaders");
...
static_assert(offsetof(Ui_arcade_invaders_C_ExecuteUbergraph_ui_arcade_invaders, K2Node_Event_key) == 0x000118, "Member 'Ui_arcade_invaders_C_ExecuteUbergraph_ui_arcade_invaders::K2Node_Event_key' has a wrong offset!");
static_assert(offsetof(Ui_arcade_invaders_C_ExecuteUbergraph_ui_arcade_invaders, K2Node_Event_pressed) == 0x000130, "Member 'Ui_arcade_invaders_C_ExecuteUbergraph_ui_arcade_invaders::K2Node_Event_pressed' has a wrong offset!");
static_assert(offsetof(Ui_arcade_invaders_C_ExecuteUbergraph_ui_arcade_invaders, K2Node_Event_color) == 0x000134, "Member 'Ui_arcade_invaders_C_ExecuteUbergraph_ui_arcade_invaders::K2Node_Event_color' has a wrong offset!");
static_assert(offsetof(Ui_arcade_invaders_C_ExecuteUbergraph_ui_arcade_invaders, K2Node_Event_picker) == 0x000148, "Member 'Ui_arcade_invaders_C_ExecuteUbergraph_ui_arcade_invaders::K2Node_Event_picker' has a wrong offset!");
static_assert(offsetof(Ui_arcade_invaders_C_ExecuteUbergraph_ui_arcade_invaders, K2Node_Event_texture) == 0x000150, "Member 'Ui_arcade_invaders_C_ExecuteUbergraph_ui_arcade_invaders::K2Node_Event_texture' has a wrong offset!");
static_assert(offsetof(Ui_arcade_invaders_C_ExecuteUbergraph_ui_arcade_invaders, K2Node_Event_index) == 0x000158, "Member 'Ui_arcade_invaders_C_ExecuteUbergraph_ui_arcade_invaders::K2Node_Event_index' has a wrong offset!");
...
static_assert(offsetof(Ui_arcade_invaders_C_TexturePickerApply, Index_0) == 0x000010, "Member 'Ui_arcade_invaders_C_TexturePickerApply::Index_0' has a wrong offset!");
...
static_assert(sizeof(Ui_arcade_invaders_C_SettingsApplied) == 0x000100, "Wrong size on Ui_arcade_invaders_C_SettingsApplied");
