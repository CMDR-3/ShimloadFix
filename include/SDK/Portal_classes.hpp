...
public:
	...
	class AMainGamemode_C*                        GameMode;                                          // 0x02A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(APortal_C) == 0x0002A8, "Wrong size on APortal_C");
...
static_assert(offsetof(APortal_C, GameMode) == 0x0002A0, "Member 'APortal_C::GameMode' has a wrong offset!");
