...
// BlueprintGeneratedClass wisp_red.wisp_red_C
// 0x0080 (0x0540 - 0x04C0)
class AWisp_red_C final : public ACharacter
{
public:
	...
	float                                         A_a_7107563D453E612D1DA1A4BC2957E20F;              // 0x0508(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ETimelineDirection                            A__Direction_7107563D453E612D1DA1A4BC2957E20F;     // 0x050C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          Landed;                                            // 0x0530(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	void OnSuccess_1172D1954A36992A7F896C8D82E5F562(EPathFollowingResult MovementResult);
	void OnFail_1172D1954A36992A7F896C8D82E5F562(EPathFollowingResult MovementResult);
	void A__UpdateFunc();
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"wisp_red_C">();
	}
	static class AWisp_red_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AWisp_red_C>();
	}
};
static_assert(alignof(AWisp_red_C) == 0x000010, "Wrong alignment on AWisp_red_C");
static_assert(sizeof(AWisp_red_C) == 0x000540, "Wrong size on AWisp_red_C");
static_assert(offsetof(AWisp_red_C, UberGraphFrame) == 0x0004C0, "Member 'AWisp_red_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AWisp_red_C, Dooropener) == 0x0004C8, "Member 'AWisp_red_C::Dooropener' has a wrong offset!");
static_assert(offsetof(AWisp_red_C, Gravigun_object_hold_loop) == 0x0004D0, "Member 'AWisp_red_C::Gravigun_object_hold_loop' has a wrong offset!");
static_assert(offsetof(AWisp_red_C, Sphere) == 0x0004D8, "Member 'AWisp_red_C::Sphere' has a wrong offset!");
static_assert(offsetof(AWisp_red_C, RadarPoint) == 0x0004E0, "Member 'AWisp_red_C::RadarPoint' has a wrong offset!");
static_assert(offsetof(AWisp_red_C, NavigationInvoker) == 0x0004E8, "Member 'AWisp_red_C::NavigationInvoker' has a wrong offset!");
static_assert(offsetof(AWisp_red_C, Arg) == 0x0004F0, "Member 'AWisp_red_C::Arg' has a wrong offset!");
static_assert(offsetof(AWisp_red_C, PointLight) == 0x0004F8, "Member 'AWisp_red_C::PointLight' has a wrong offset!");
static_assert(offsetof(AWisp_red_C, Eff_wisp) == 0x000500, "Member 'AWisp_red_C::Eff_wisp' has a wrong offset!");
static_assert(offsetof(AWisp_red_C, A_a_7107563D453E612D1DA1A4BC2957E20F) == 0x000508, "Member 'AWisp_red_C::A_a_7107563D453E612D1DA1A4BC2957E20F' has a wrong offset!");
static_assert(offsetof(AWisp_red_C, A__Direction_7107563D453E612D1DA1A4BC2957E20F) == 0x00050C, "Member 'AWisp_red_C::A__Direction_7107563D453E612D1DA1A4BC2957E20F' has a wrong offset!");
static_assert(offsetof(AWisp_red_C, A) == 0x000510, "Member 'AWisp_red_C::A' has a wrong offset!");
static_assert(offsetof(AWisp_red_C, Ime) == 0x000518, "Member 'AWisp_red_C::Ime' has a wrong offset!");
static_assert(offsetof(AWisp_red_C, Disappearing) == 0x00051C, "Member 'AWisp_red_C::Disappearing' has a wrong offset!");
static_assert(offsetof(AWisp_red_C, Obj) == 0x000520, "Member 'AWisp_red_C::Obj' has a wrong offset!");
static_assert(offsetof(AWisp_red_C, Landed) == 0x000530, "Member 'AWisp_red_C::Landed' has a wrong offset!");
static_assert(offsetof(AWisp_red_C, Last) == 0x000534, "Member 'AWisp_red_C::Last' has a wrong offset!");
