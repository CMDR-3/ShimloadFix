...
static_assert(offsetof(TriggerBase_skeleChair_C_RunTrigger, Owner_0) == 0x000000, "Member 'TriggerBase_skeleChair_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(TriggerBase_skeleChair_C_RunTrigger, Index_0) == 0x000008, "Member 'TriggerBase_skeleChair_C_RunTrigger::Index_0' has a wrong offset!");
