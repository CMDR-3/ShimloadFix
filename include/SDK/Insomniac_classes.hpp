...
public:
	...
	class AMainGamemode_C*                        GameMode;                                          // 0x0528(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(AInsomniac_C, GameMode) == 0x000528, "Member 'AInsomniac_C::GameMode' has a wrong offset!");
