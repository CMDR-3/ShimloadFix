...
void USaveSlot_C::SetGamemode(class AMainGamemode_C* GameMode_0)
{
	static class UFunction* Func = nullptr;
...
void USaveSlot_C::PrAdvanc(const class FName& InputPin, bool DisablePopup, bool* Finished, class FName* Name_0)
{
	static class UFunction* Func = nullptr;
...
void USaveSlot_C::Reset_days(int32 Day_0)
{
	static class UFunction* Func = nullptr;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UGameInst_C*                      GameInst_0                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void USaveSlot_C::SetGameinst(class UGameInst_C* GameInst_0)
{
	static class UFunction* Func = nullptr;
...
void USaveSlot_C::Duplicate(const class FString& Name_0)
{
	static class UFunction* Func = nullptr;
...
void USaveSlot_C::AddRecipe(const class FName& ItemToFind)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("saveSlot_C", "addRecipe");

	Params::SaveSlot_C_AddRecipe Parms{};
