...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Prop_screwdriver_C;                 // 0x0358(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(AProp_screwdriver_C) == 0x000368, "Wrong size on AProp_screwdriver_C");
static_assert(offsetof(AProp_screwdriver_C, UberGraphFrame_Prop_screwdriver_C) == 0x000358, "Member 'AProp_screwdriver_C::UberGraphFrame_Prop_screwdriver_C' has a wrong offset!");
static_assert(offsetof(AProp_screwdriver_C, VelocityStuck) == 0x000360, "Member 'AProp_screwdriver_C::VelocityStuck' has a wrong offset!");
