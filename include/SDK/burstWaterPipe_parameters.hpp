...
{
public:
	bool                                          Damaged_0;                                         // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(burstWaterPipe_C_State, Damaged_0) == 0x000000, "Member 'burstWaterPipe_C_State::Damaged_0' has a wrong offset!");
