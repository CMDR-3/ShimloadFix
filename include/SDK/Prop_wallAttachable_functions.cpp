...
void AProp_wallAttachable_C::ActionOptionIndex(class AMainPlayer_C* Player, const struct FHitResult& Hit_0, Enum_interactionActions Action)
{
	static class UFunction* Func = nullptr;
...
void AProp_wallAttachable_C::SetPropProps(bool Static_0, bool Frozen_0, bool Active)
{
	static class UFunction* Func = nullptr;
...
void AProp_wallAttachable_C::LookAt(class AMainPlayer_C* Player, const struct FHitResult& Hit_0, bool* Return, class FString* Text, class UPrimitiveComponent** boundObjectReplace, uint8* Number)
{
	static class UFunction* Func = nullptr;
