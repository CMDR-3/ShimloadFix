...
static_assert(offsetof(Prop_kerfurOmega_col_gamer_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_kerfurOmega_col_gamer_C_ActionOptionIndex::Hit_0' has a wrong offset!");
