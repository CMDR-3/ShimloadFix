...
public:
	...
	void AddObj(const float& Depth, const class AActor*& Obj, bool* Repeats_0);
	void RemoveObj(const class AActor*& Find, bool* Repeats_0);
...
static_assert(sizeof(AWaterFloatMaster_C) == 0x000338, "Wrong size on AWaterFloatMaster_C");
...
static_assert(offsetof(AWaterFloatMaster_C, GameMode) == 0x000330, "Member 'AWaterFloatMaster_C::GameMode' has a wrong offset!");
