...
static_assert(sizeof(AUfoDropper_C) == 0x0002C0, "Wrong size on AUfoDropper_C");
...
static_assert(offsetof(AUfoDropper_C, GameMode) == 0x0002B8, "Member 'AUfoDropper_C::GameMode' has a wrong offset!");
