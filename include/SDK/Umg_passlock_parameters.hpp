...
public:
	...
	bool                                          CallFunc_Text_IsNumeric_ReturnValue;               // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(Umg_passlock_C_ExecuteUbergraph_umg_passlock) == 0x000068, "Wrong size on Umg_passlock_C_ExecuteUbergraph_umg_passlock");
...
static_assert(offsetof(Umg_passlock_C_ExecuteUbergraph_umg_passlock, K2Node_ComponentBoundEvent_Text) == 0x000020, "Member 'Umg_passlock_C_ExecuteUbergraph_umg_passlock::K2Node_ComponentBoundEvent_Text' has a wrong offset!");
static_assert(offsetof(Umg_passlock_C_ExecuteUbergraph_umg_passlock, K2Node_ComponentBoundEvent_CommitMethod) == 0x000038, "Member 'Umg_passlock_C_ExecuteUbergraph_umg_passlock::K2Node_ComponentBoundEvent_CommitMethod' has a wrong offset!");
static_assert(offsetof(Umg_passlock_C_ExecuteUbergraph_umg_passlock, CallFunc_Conv_TextToString_ReturnValue) == 0x000040, "Member 'Umg_passlock_C_ExecuteUbergraph_umg_passlock::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_passlock_C_ExecuteUbergraph_umg_passlock, K2Node_SwitchEnum_CmpSuccess) == 0x000050, "Member 'Umg_passlock_C_ExecuteUbergraph_umg_passlock::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Umg_passlock_C_ExecuteUbergraph_umg_passlock, CallFunc_Conv_StringToInt_ReturnValue) == 0x000054, "Member 'Umg_passlock_C_ExecuteUbergraph_umg_passlock::CallFunc_Conv_StringToInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_passlock_C_ExecuteUbergraph_umg_passlock, CallFunc_Text_IsNumeric_ReturnValue) == 0x000058, "Member 'Umg_passlock_C_ExecuteUbergraph_umg_passlock::CallFunc_Text_IsNumeric_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_passlock_C_ExecuteUbergraph_umg_passlock, K2Node_Event_InFocusEvent) == 0x00005C, "Member 'Umg_passlock_C_ExecuteUbergraph_umg_passlock::K2Node_Event_InFocusEvent' has a wrong offset!");
...
static_assert(offsetof(Umg_passlock_C_Init, Password_0) == 0x000000, "Member 'Umg_passlock_C_Init::Password_0' has a wrong offset!");
