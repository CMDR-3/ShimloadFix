...
public:
	...
	struct FHitResult                             CallFunc_K2_AddActorLocalOffset_SweepHitResult;    // 0x001C(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FHitResult                             K2Node_ComponentBoundEvent_Hit;                    // 0x00CC(0x0088)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                          K2Node_Event_kick;                                 // 0x0154(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AMainPlayer_C*                          K2Node_Event_player;                               // 0x01F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Prop_drive_C_ExecuteUbergraph_prop_drive) == 0x000208, "Wrong size on Prop_drive_C_ExecuteUbergraph_prop_drive");
...
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, K2Node_DynamicCast_AsInt_Player) == 0x000008, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::K2Node_DynamicCast_AsInt_Player' has a wrong offset!");
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, CallFunc_IsValid_ReturnValue) == 0x000019, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, CallFunc_K2_AddActorLocalOffset_SweepHitResult) == 0x00001C, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::CallFunc_K2_AddActorLocalOffset_SweepHitResult' has a wrong offset!");
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, K2Node_ComponentBoundEvent_HitComponent) == 0x0000A8, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::K2Node_ComponentBoundEvent_HitComponent' has a wrong offset!");
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, K2Node_ComponentBoundEvent_OtherActor) == 0x0000B0, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::K2Node_ComponentBoundEvent_OtherActor' has a wrong offset!");
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, K2Node_ComponentBoundEvent_OtherComp) == 0x0000B8, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::K2Node_ComponentBoundEvent_OtherComp' has a wrong offset!");
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, K2Node_ComponentBoundEvent_NormalImpulse) == 0x0000C0, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::K2Node_ComponentBoundEvent_NormalImpulse' has a wrong offset!");
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, K2Node_ComponentBoundEvent_Hit) == 0x0000CC, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::K2Node_ComponentBoundEvent_Hit' has a wrong offset!");
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, K2Node_Event_kick) == 0x000154, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::K2Node_Event_kick' has a wrong offset!");
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, K2Node_Event_player_2) == 0x000158, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::K2Node_Event_player_2' has a wrong offset!");
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, K2Node_Event_hit) == 0x000160, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, K2Node_Event_action) == 0x0001E8, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, CallFunc_Array_RemoveItem_ReturnValue) == 0x0001E9, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::CallFunc_Array_RemoveItem_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, K2Node_Event_player_1) == 0x0001F0, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::K2Node_Event_player_1' has a wrong offset!");
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, K2Node_Event_player) == 0x0001F8, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(Prop_drive_C_ExecuteUbergraph_prop_drive, CallFunc_Array_Add_ReturnValue) == 0x000200, "Member 'Prop_drive_C_ExecuteUbergraph_prop_drive::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Prop_drive_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_drive_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_drive_C_BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature, Hit_0) == 0x000024, "Member 'Prop_drive_C_BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_drive_C_LookAt, Hit_0) == 0x000008, "Member 'Prop_drive_C_LookAt::Hit_0' has a wrong offset!");
