...
public:
	...
	float                                         K2Node_Event_damage_1;                             // 0x0040(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Prop_goose_C_ExecuteUbergraph_prop_goose, K2Node_Event_damage) == 0x000004, "Member 'Prop_goose_C_ExecuteUbergraph_prop_goose::K2Node_Event_damage' has a wrong offset!");
static_assert(offsetof(Prop_goose_C_ExecuteUbergraph_prop_goose, Temp_int_Variable) == 0x000008, "Member 'Prop_goose_C_ExecuteUbergraph_prop_goose::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(Prop_goose_C_ExecuteUbergraph_prop_goose, CallFunc_Conv_IntToFloat_ReturnValue) == 0x00000C, "Member 'Prop_goose_C_ExecuteUbergraph_prop_goose::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_goose_C_ExecuteUbergraph_prop_goose, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000010, "Member 'Prop_goose_C_ExecuteUbergraph_prop_goose::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_goose_C_ExecuteUbergraph_prop_goose, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000014, "Member 'Prop_goose_C_ExecuteUbergraph_prop_goose::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_goose_C_ExecuteUbergraph_prop_goose, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x000018, "Member 'Prop_goose_C_ExecuteUbergraph_prop_goose::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_goose_C_ExecuteUbergraph_prop_goose, CallFunc_RotateAngleAxis_ReturnValue) == 0x00001C, "Member 'Prop_goose_C_ExecuteUbergraph_prop_goose::CallFunc_RotateAngleAxis_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_goose_C_ExecuteUbergraph_prop_goose, CallFunc_Add_IntInt_ReturnValue) == 0x000028, "Member 'Prop_goose_C_ExecuteUbergraph_prop_goose::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_goose_C_ExecuteUbergraph_prop_goose, CallFunc_K2_GetActorLocation_ReturnValue) == 0x00002C, "Member 'Prop_goose_C_ExecuteUbergraph_prop_goose::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Prop_goose_C_ExecuteUbergraph_prop_goose, K2Node_Event_damage_1) == 0x000040, "Member 'Prop_goose_C_ExecuteUbergraph_prop_goose::K2Node_Event_damage_1' has a wrong offset!");
...
struct Prop_goose_C_FireDamage final
{
public:
	float                                         Damage;                                            // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(Prop_goose_C_FireDamage) == 0x000004, "Wrong alignment on Prop_goose_C_FireDamage");
static_assert(sizeof(Prop_goose_C_FireDamage) == 0x000004, "Wrong size on Prop_goose_C_FireDamage");
static_assert(offsetof(Prop_goose_C_FireDamage, Damage) == 0x000000, "Member 'Prop_goose_C_FireDamage::Damage' has a wrong offset!");
...
static_assert(offsetof(Prop_goose_C_AddDamage, Hit_0) == 0x00000C, "Member 'Prop_goose_C_AddDamage::Hit_0' has a wrong offset!");
