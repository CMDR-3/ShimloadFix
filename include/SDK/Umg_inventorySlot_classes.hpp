...
public:
	...
	void Construct();
	void Set(const class FString& Name_0);
...
static_assert(offsetof(UUmg_inventorySlot_C, Index_0) == 0x000278, "Member 'UUmg_inventorySlot_C::Index_0' has a wrong offset!");
static_assert(offsetof(UUmg_inventorySlot_C, Dynmat) == 0x000280, "Member 'UUmg_inventorySlot_C::Dynmat' has a wrong offset!");
static_assert(offsetof(UUmg_inventorySlot_C, Name_0) == 0x000288, "Member 'UUmg_inventorySlot_C::Name_0' has a wrong offset!");
