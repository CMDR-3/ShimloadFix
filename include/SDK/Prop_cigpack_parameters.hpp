...
public:
	...
	struct FStruct_food                           CallFunc_propToObject_foodData;                    // 0x00D4(0x001C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FStruct_prop3                          CallFunc_propToObject_fuckYouRetard;               // 0x0100(0x0080)(HasGetValueTypeHash)
...
static_assert(offsetof(Prop_cigpack_C_ExecuteUbergraph_prop_cigpack, CallFunc_propToObject_fuckYouRetard) == 0x000100, "Member 'Prop_cigpack_C_ExecuteUbergraph_prop_cigpack::CallFunc_propToObject_fuckYouRetard' has a wrong offset!");
