...
public:
	...
	TArray<class AWaterVolume_C*>                 CallFunc_GetAllActorsOfClass_OutActors;            // 0x0170(0x0010)(ReferenceParm)
	...
	class AWaterVolume_C*                         CallFunc_Array_Get_Item;                           // 0x0188(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<bool>                                  CallFunc_boyoancy_centerUnderwaterCopy;            // 0x0240(0x0010)(ReferenceParm)
	...
	class ARiverFlow_C*                           CallFunc_Array_Get_Item_1;                         // 0x0268(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_Array_Add_ReturnValue_3;                  // 0x027C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster) == 0x000290, "Wrong size on WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster");
...
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_GetWorldDeltaSeconds_ReturnValue) == 0x000004, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_GetWorldDeltaSeconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x000008, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Add_FloatFloat_ReturnValue) == 0x00000C, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, K2Node_Event_gamemode) == 0x000010, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::K2Node_Event_gamemode' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, K2Node_Event_settings) == 0x000018, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::K2Node_Event_settings' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, K2Node_Event_key) == 0x000118, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::K2Node_Event_key' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, K2Node_Event_pressed) == 0x000130, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::K2Node_Event_pressed' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, K2Node_Event_color) == 0x000134, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::K2Node_Event_color' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, K2Node_Event_picker) == 0x000148, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::K2Node_Event_picker' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, K2Node_Event_texture) == 0x000150, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::K2Node_Event_texture' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, K2Node_Event_index) == 0x000158, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::K2Node_Event_index' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, Temp_int_Loop_Counter_Variable) == 0x00015C, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, Temp_int_Array_Index_Variable) == 0x000160, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Add_IntInt_ReturnValue) == 0x000164, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, Temp_int_Array_Index_Variable_1) == 0x000168, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::Temp_int_Array_Index_Variable_1' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_GetAllActorsOfClass_OutActors) == 0x000170, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_GetAllActorsOfClass_OutActors' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, Temp_int_Loop_Counter_Variable_1) == 0x000180, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::Temp_int_Loop_Counter_Variable_1' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Array_Get_Item) == 0x000188, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_GetTransform_ReturnValue) == 0x000190, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_GetTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_BreakTransform_Location) == 0x0001C0, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_BreakTransform_Location' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_BreakTransform_Rotation) == 0x0001CC, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_BreakTransform_Rotation' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_BreakTransform_Scale) == 0x0001D8, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_BreakTransform_Scale' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Add_IntInt_ReturnValue_1) == 0x0001E4, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Multiply_VectorVector_ReturnValue) == 0x0001E8, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Multiply_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_MakeTransform_ReturnValue) == 0x000200, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_MakeTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Array_Length_ReturnValue) == 0x000230, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Less_IntInt_ReturnValue) == 0x000234, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Array_Add_ReturnValue) == 0x000238, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, K2Node_Event_DeltaSeconds) == 0x00023C, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_boyoancy_centerUnderwaterCopy) == 0x000240, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_boyoancy_centerUnderwaterCopy' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_getMainGamemode_AsMain_Gamemode) == 0x000250, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_getMainGamemode_AsMain_Gamemode' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_IsValid_ReturnValue) == 0x000258, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Array_Length_ReturnValue_1) == 0x00025C, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Array_Length_ReturnValue_2) == 0x000260, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Array_Length_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Array_Get_Item_1) == 0x000268, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Less_IntInt_ReturnValue_1) == 0x000270, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Array_Add_ReturnValue_1) == 0x000274, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Array_Add_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Array_Add_ReturnValue_2) == 0x000278, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Array_Add_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Array_Add_ReturnValue_3) == 0x00027C, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Array_Add_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster, CallFunc_Array_Add_ReturnValue_4) == 0x000280, "Member 'WaterFloatMaster_C_ExecuteUbergraph_waterFloatMaster::CallFunc_Array_Add_ReturnValue_4' has a wrong offset!");
...
static_assert(offsetof(WaterFloatMaster_C_TexturePickerApply, Index_0) == 0x000010, "Member 'WaterFloatMaster_C_TexturePickerApply::Index_0' has a wrong offset!");
...
static_assert(sizeof(WaterFloatMaster_C_SettingsApplied) == 0x000100, "Wrong size on WaterFloatMaster_C_SettingsApplied");
...
static_assert(offsetof(WaterFloatMaster_C_StuffUpgraded, GameMode_0) == 0x000000, "Member 'WaterFloatMaster_C_StuffUpgraded::GameMode_0' has a wrong offset!");
...
public:
	...
	bool                                          Repeats_0;                                         // 0x0010(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UClass*                                 K2Node_ClassDynamicCast_AsSkinned_Mesh_Component;  // 0x0058(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_getBoyoancy_Value;                        // 0x0070(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WaterFloatMaster_C_AddObj) == 0x000088, "Wrong size on WaterFloatMaster_C_AddObj");
...
static_assert(offsetof(WaterFloatMaster_C_AddObj, Repeats_0) == 0x000010, "Member 'WaterFloatMaster_C_AddObj::Repeats_0' has a wrong offset!");
...
static_assert(offsetof(WaterFloatMaster_C_AddObj, CallFunc_GetObjectClass_ReturnValue) == 0x000048, "Member 'WaterFloatMaster_C_AddObj::CallFunc_GetObjectClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_AddObj, CallFunc_GetMaterial_ReturnValue) == 0x000050, "Member 'WaterFloatMaster_C_AddObj::CallFunc_GetMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_AddObj, K2Node_ClassDynamicCast_AsSkinned_Mesh_Component) == 0x000058, "Member 'WaterFloatMaster_C_AddObj::K2Node_ClassDynamicCast_AsSkinned_Mesh_Component' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_AddObj, K2Node_ClassDynamicCast_bSuccess) == 0x000060, "Member 'WaterFloatMaster_C_AddObj::K2Node_ClassDynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_AddObj, CallFunc_GetPhysicalMaterial_ReturnValue) == 0x000068, "Member 'WaterFloatMaster_C_AddObj::CallFunc_GetPhysicalMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_AddObj, CallFunc_getBoyoancy_Value) == 0x000070, "Member 'WaterFloatMaster_C_AddObj::CallFunc_getBoyoancy_Value' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_AddObj, CallFunc_FMax_ReturnValue) == 0x000074, "Member 'WaterFloatMaster_C_AddObj::CallFunc_FMax_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_AddObj, CallFunc_Array_Contains_ReturnValue) == 0x000078, "Member 'WaterFloatMaster_C_AddObj::CallFunc_Array_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_AddObj, CallFunc_Array_Add_ReturnValue) == 0x00007C, "Member 'WaterFloatMaster_C_AddObj::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_AddObj, CallFunc_Array_Add_ReturnValue_1) == 0x000080, "Member 'WaterFloatMaster_C_AddObj::CallFunc_Array_Add_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_AddObj, CallFunc_Array_Add_ReturnValue_2) == 0x000084, "Member 'WaterFloatMaster_C_AddObj::CallFunc_Array_Add_ReturnValue_2' has a wrong offset!");
...
public:
	...
	bool                                          Repeats_0;                                         // 0x0008(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(WaterFloatMaster_C_RemoveObj) == 0x000028, "Wrong size on WaterFloatMaster_C_RemoveObj");
...
static_assert(offsetof(WaterFloatMaster_C_RemoveObj, Repeats_0) == 0x000008, "Member 'WaterFloatMaster_C_RemoveObj::Repeats_0' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_RemoveObj, R) == 0x000009, "Member 'WaterFloatMaster_C_RemoveObj::R' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_RemoveObj, CallFunc_K2_GetRootComponent_ReturnValue) == 0x000010, "Member 'WaterFloatMaster_C_RemoveObj::CallFunc_K2_GetRootComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_RemoveObj, K2Node_DynamicCast_AsPrimitive_Component) == 0x000018, "Member 'WaterFloatMaster_C_RemoveObj::K2Node_DynamicCast_AsPrimitive_Component' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_RemoveObj, K2Node_DynamicCast_bSuccess) == 0x000020, "Member 'WaterFloatMaster_C_RemoveObj::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_RemoveObj, CallFunc_Array_Contains_ReturnValue) == 0x000021, "Member 'WaterFloatMaster_C_RemoveObj::CallFunc_Array_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaterFloatMaster_C_RemoveObj, CallFunc_Array_Find_ReturnValue) == 0x000024, "Member 'WaterFloatMaster_C_RemoveObj::CallFunc_Array_Find_ReturnValue' has a wrong offset!");
