...
static_assert(offsetof(Trigger_lightRoot_C_RunTrigger, Owner_0) == 0x000000, "Member 'Trigger_lightRoot_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(Trigger_lightRoot_C_RunTrigger, Index_0) == 0x000008, "Member 'Trigger_lightRoot_C_RunTrigger::Index_0' has a wrong offset!");
...
static_assert(offsetof(Trigger_lightRoot_C_SetActive, Active_0) == 0x000000, "Member 'Trigger_lightRoot_C_SetActive::Active_0' has a wrong offset!");
...
public:
	...
	class AActor*                                 CallFunc_getObjectFromKey_Output;                  // 0x0048(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 CallFunc_getObjectFromKey_Output_1;                // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACeilingLamp_C*                         K2Node_DynamicCast_AsCeiling_Lamp;                 // 0x0058(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AAmbLigh_C*                             K2Node_DynamicCast_AsAmb_Ligh;                     // 0x0068(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Trigger_lightRoot_C_ProcessKeys) == 0x000088, "Wrong size on Trigger_lightRoot_C_ProcessKeys");
...
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, CallFunc_Array_Length_ReturnValue) == 0x000010, "Member 'Trigger_lightRoot_C_ProcessKeys::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, Temp_int_Loop_Counter_Variable_1) == 0x000014, "Member 'Trigger_lightRoot_C_ProcessKeys::Temp_int_Loop_Counter_Variable_1' has a wrong offset!");
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, CallFunc_processKeys_return) == 0x000018, "Member 'Trigger_lightRoot_C_ProcessKeys::CallFunc_processKeys_return' has a wrong offset!");
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, CallFunc_Less_IntInt_ReturnValue) == 0x000019, "Member 'Trigger_lightRoot_C_ProcessKeys::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, CallFunc_Add_IntInt_ReturnValue_1) == 0x00001C, "Member 'Trigger_lightRoot_C_ProcessKeys::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, Temp_int_Array_Index_Variable_1) == 0x000020, "Member 'Trigger_lightRoot_C_ProcessKeys::Temp_int_Array_Index_Variable_1' has a wrong offset!");
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, CallFunc_Array_Get_Item) == 0x000028, "Member 'Trigger_lightRoot_C_ProcessKeys::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, CallFunc_Array_Get_Item_1) == 0x000038, "Member 'Trigger_lightRoot_C_ProcessKeys::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, CallFunc_getObjectFromKey_Output) == 0x000048, "Member 'Trigger_lightRoot_C_ProcessKeys::CallFunc_getObjectFromKey_Output' has a wrong offset!");
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, CallFunc_getObjectFromKey_Output_1) == 0x000050, "Member 'Trigger_lightRoot_C_ProcessKeys::CallFunc_getObjectFromKey_Output_1' has a wrong offset!");
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, K2Node_DynamicCast_AsCeiling_Lamp) == 0x000058, "Member 'Trigger_lightRoot_C_ProcessKeys::K2Node_DynamicCast_AsCeiling_Lamp' has a wrong offset!");
...
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, K2Node_DynamicCast_AsAmb_Ligh) == 0x000068, "Member 'Trigger_lightRoot_C_ProcessKeys::K2Node_DynamicCast_AsAmb_Ligh' has a wrong offset!");
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, K2Node_DynamicCast_bSuccess_1) == 0x000070, "Member 'Trigger_lightRoot_C_ProcessKeys::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, CallFunc_Array_Add_ReturnValue) == 0x000074, "Member 'Trigger_lightRoot_C_ProcessKeys::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, CallFunc_Array_Length_ReturnValue_1) == 0x000078, "Member 'Trigger_lightRoot_C_ProcessKeys::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, CallFunc_Less_IntInt_ReturnValue_1) == 0x00007C, "Member 'Trigger_lightRoot_C_ProcessKeys::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Trigger_lightRoot_C_ProcessKeys, CallFunc_Array_Add_ReturnValue_1) == 0x000080, "Member 'Trigger_lightRoot_C_ProcessKeys::CallFunc_Array_Add_ReturnValue_1' has a wrong offset!");
