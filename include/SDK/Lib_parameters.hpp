...
#include "Struct_customwall_structs.hpp"
...
public:
	...
	class FText                                   Display;                                           // 0x0020(0x0018)(Parm, OutParm)
	TArray<class FString>                         T;                                                 // 0x0038(0x0010)(Edit, BlueprintVisible)
	TArray<class FText>                           B;                                                 // 0x0048(0x0010)(Edit, BlueprintVisible)
	TArray<class FText>                           A;                                                 // 0x0058(0x0010)(Edit, BlueprintVisible)
	...
	TArray<class FString>                         K2Node_MakeArray_Array_2;                          // 0x0088(0x0010)(ReferenceParm)
...
static_assert(sizeof(Lib_C_GetSatelliteName) == 0x0000C0, "Wrong size on Lib_C_GetSatelliteName");
static_assert(offsetof(Lib_C_GetSatelliteName, Index_0) == 0x000000, "Member 'Lib_C_GetSatelliteName::Index_0' has a wrong offset!");
...
static_assert(offsetof(Lib_C_GetSatelliteName, Display) == 0x000020, "Member 'Lib_C_GetSatelliteName::Display' has a wrong offset!");
static_assert(offsetof(Lib_C_GetSatelliteName, T) == 0x000038, "Member 'Lib_C_GetSatelliteName::T' has a wrong offset!");
static_assert(offsetof(Lib_C_GetSatelliteName, B) == 0x000048, "Member 'Lib_C_GetSatelliteName::B' has a wrong offset!");
static_assert(offsetof(Lib_C_GetSatelliteName, A) == 0x000058, "Member 'Lib_C_GetSatelliteName::A' has a wrong offset!");
static_assert(offsetof(Lib_C_GetSatelliteName, K2Node_MakeArray_Array) == 0x000068, "Member 'Lib_C_GetSatelliteName::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(Lib_C_GetSatelliteName, K2Node_MakeArray_Array_1) == 0x000078, "Member 'Lib_C_GetSatelliteName::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(Lib_C_GetSatelliteName, K2Node_MakeArray_Array_2) == 0x000088, "Member 'Lib_C_GetSatelliteName::K2Node_MakeArray_Array_2' has a wrong offset!");
static_assert(offsetof(Lib_C_GetSatelliteName, CallFunc_Array_Get_Item) == 0x000098, "Member 'Lib_C_GetSatelliteName::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Lib_C_GetSatelliteName, CallFunc_Array_Get_Item_1) == 0x0000B0, "Member 'Lib_C_GetSatelliteName::CallFunc_Array_Get_Item_1' has a wrong offset!");
...
public:
	...
	class FString                                 Name_0;                                            // 0x0048(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash)
	...
	TMap<class USoundBase*, class UConstantQNRT*> K2Node_MakeVariable_MakeVariableOutput;            // 0x00B0(0x0050)()
	...
	class UConstantQNRT*                          CallFunc_Array_Get_Item;                           // 0x0118(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Lib_C_GetNRT) == 0x000140, "Wrong size on Lib_C_GetNRT");
...
static_assert(offsetof(Lib_C_GetNRT, Name_0) == 0x000048, "Member 'Lib_C_GetNRT::Name_0' has a wrong offset!");
...
static_assert(offsetof(Lib_C_GetNRT, K2Node_MakeVariable_MakeVariableOutput) == 0x0000B0, "Member 'Lib_C_GetNRT::K2Node_MakeVariable_MakeVariableOutput' has a wrong offset!");
static_assert(offsetof(Lib_C_GetNRT, CallFunc_getMainGamemode_AsMain_Gamemode) == 0x000100, "Member 'Lib_C_GetNRT::CallFunc_getMainGamemode_AsMain_Gamemode' has a wrong offset!");
static_assert(offsetof(Lib_C_GetNRT, CallFunc_getMainGameInstance_AsGame_Inst) == 0x000108, "Member 'Lib_C_GetNRT::CallFunc_getMainGameInstance_AsGame_Inst' has a wrong offset!");
static_assert(offsetof(Lib_C_GetNRT, CallFunc_Array_Find_ReturnValue) == 0x000110, "Member 'Lib_C_GetNRT::CallFunc_Array_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_GetNRT, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x000114, "Member 'Lib_C_GetNRT::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_GetNRT, CallFunc_Array_Get_Item) == 0x000118, "Member 'Lib_C_GetNRT::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Lib_C_GetNRT, CallFunc_GetDisplayName_ReturnValue) == 0x000120, "Member 'Lib_C_GetNRT::CallFunc_GetDisplayName_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_GetNRT, CallFunc_GetDisplayName_ReturnValue_1) == 0x000130, "Member 'Lib_C_GetNRT::CallFunc_GetDisplayName_ReturnValue_1' has a wrong offset!");
...
public:
	...
	int32                                         CallFunc_VictoryIntPlusEquals_IntOut_1;            // 0x0030(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_VictoryIntPlusEquals_IntOut_2;            // 0x0034(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Lib_C_AddPoints) == 0x000050, "Wrong size on Lib_C_AddPoints");
...
static_assert(offsetof(Lib_C_AddPoints, CallFunc_Abs_Int_ReturnValue) == 0x00002C, "Member 'Lib_C_AddPoints::CallFunc_Abs_Int_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_AddPoints, CallFunc_VictoryIntPlusEquals_IntOut_1) == 0x000030, "Member 'Lib_C_AddPoints::CallFunc_VictoryIntPlusEquals_IntOut_1' has a wrong offset!");
static_assert(offsetof(Lib_C_AddPoints, CallFunc_VictoryIntPlusEquals_IntOut_2) == 0x000034, "Member 'Lib_C_AddPoints::CallFunc_VictoryIntPlusEquals_IntOut_2' has a wrong offset!");
static_assert(offsetof(Lib_C_AddPoints, CallFunc_Conv_IntToText_ReturnValue) == 0x000038, "Member 'Lib_C_AddPoints::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Lib_C_WeightedRandom, Index_0) == 0x000018, "Member 'Lib_C_WeightedRandom::Index_0' has a wrong offset!");
...
public:
	...
	class FString                                 Name_0;                                            // 0x0068(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash)
...
static_assert(offsetof(Lib_C_FindNRT, Name_0) == 0x000068, "Member 'Lib_C_FindNRT::Name_0' has a wrong offset!");
...
public:
	class UObject*                                __WorldContext;                                    // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AMainGamemode_C*                        Gamemode_g;                                        // 0x0008(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AMainGamemode_C*                        K2Node_DynamicCast_AsMain_Gamemode;                // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UTexture2D*                             CallFunc_LoadImageFile_texture;                    // 0x0070(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FString                                 CallFunc_LoadImageFile_fileName;                   // 0x0078(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	int32                                         CallFunc_LoadImageFile_errorCode;                  // 0x0088(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_8C[0x4];                                       // 0x008C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 CallFunc_LoadImageFile_errorMessage;               // 0x0090(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	TScriptInterface<class IInt_coms_C>           K2Node_DynamicCast_AsInt_Coms;                     // 0x00C0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AMainPlayer_C*                          CallFunc_getMainPlayer_AsMain_Player;              // 0x00D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UUserWidget*                            CallFunc_Array_Get_Item_1;                         // 0x00F0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Less_IntInt_ReturnValue_1;                // 0x00F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_F9[0x7];                                       // 0x00F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TScriptInterface<class IInt_coms_C>           K2Node_DynamicCast_AsInt_Coms_1;                   // 0x0100(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	Enum_controllerType                           Temp_byte_Variable;                                // 0x0120(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_Conv_BoolToInt_ReturnValue;               // 0x01B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1BC[0x4];                                      // 0x01BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 CallFunc_Conv_FloatToString_ReturnValue;           // 0x01C0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_4;           // 0x01D0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_Conv_BoolToInt_ReturnValue_1;             // 0x0200(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_7;           // 0x0250(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_8;           // 0x0278(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_SelectFloat_ReturnValue_1;                // 0x02A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_SelectFloat_ReturnValue_2;                // 0x02D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_9;           // 0x02E0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_10;          // 0x02F0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_11;          // 0x0300(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_12;          // 0x0340(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Conv_BoolToFloat_ReturnValue;             // 0x0380(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Conv_IntToFloat_ReturnValue_3;            // 0x0388(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Divide_FloatFloat_ReturnValue_2;          // 0x038C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Divide_FloatFloat_ReturnValue_3;          // 0x0390(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Conv_IntToFloat_ReturnValue_4;            // 0x0394(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Divide_FloatFloat_ReturnValue_5;          // 0x03A0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Conv_IntToFloat_ReturnValue_6;            // 0x03A4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_13;          // 0x03A8(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	float                                         CallFunc_Divide_FloatFloat_ReturnValue_6;          // 0x03B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Multiply_FloatFloat_ReturnValue_4;        // 0x03D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Multiply_FloatFloat_ReturnValue_5;        // 0x03DC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_14;          // 0x03E0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Concat_StrStr_ReturnValue_19;             // 0x03F0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_15;          // 0x0400(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Concat_StrStr_ReturnValue_20;             // 0x0410(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_16;          // 0x0420(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Concat_StrStr_ReturnValue_21;             // 0x0430(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_17;          // 0x0440(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Concat_StrStr_ReturnValue_22;             // 0x0450(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_18;          // 0x0460(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Concat_StrStr_ReturnValue_23;             // 0x0470(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_19;          // 0x0480(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Concat_StrStr_ReturnValue_24;             // 0x0490(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_20;          // 0x04A0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Concat_StrStr_ReturnValue_25;             // 0x04B0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_21;          // 0x04C0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Concat_StrStr_ReturnValue_26;             // 0x04D0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class UInputSettings*                         CallFunc_GetInputSettings_ReturnValue;             // 0x04E8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UGameUserSettings*                      CallFunc_GetGameUserSettings_ReturnValue;          // 0x04F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class FName>                           CallFunc_GetAxisNames_AxisNames;                   // 0x04F8(0x0010)(ReferenceParm)
	...
	TArray<struct FInputAxisKeyMapping>           CallFunc_GetAxisMappingByName_OutMappings;         // 0x0518(0x0010)(ReferenceParm)
	...
	struct FInputAxisKeyMapping                   CallFunc_Array_Get_Item_3;                         // 0x0530(0x0028)()
	...
	struct FKey                                   Temp_struct_Variable;                              // 0x0560(0x0018)(HasGetValueTypeHash)
	bool                                          CallFunc_Less_IntInt_ReturnValue_3;                // 0x0578(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FKey                                   Temp_struct_Variable_4;                            // 0x05E8(0x0018)(HasGetValueTypeHash)
	struct FInputAxisKeyMapping                   K2Node_MakeStruct_InputAxisKeyMapping;             // 0x0600(0x0028)()
	struct FKey                                   Temp_struct_Variable_5;                            // 0x0628(0x0018)(HasGetValueTypeHash)
	struct FKey                                   K2Node_Select_Default_1;                           // 0x0640(0x0018)(HasGetValueTypeHash)
	struct FInputAxisKeyMapping                   K2Node_MakeStruct_InputAxisKeyMapping_1;           // 0x0658(0x0028)()
};
static_assert(alignof(Lib_C_SetSettings) == 0x000008, "Wrong alignment on Lib_C_SetSettings");
static_assert(sizeof(Lib_C_SetSettings) == 0x000680, "Wrong size on Lib_C_SetSettings");
...
static_assert(offsetof(Lib_C_SetSettings, Gamemode_g) == 0x000008, "Member 'Lib_C_SetSettings::Gamemode_g' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, Temp_int_Variable) == 0x000010, "Member 'Lib_C_SetSettings::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_GetGameMode_ReturnValue) == 0x000018, "Member 'Lib_C_SetSettings::CallFunc_GetGameMode_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Add_IntInt_ReturnValue) == 0x000020, "Member 'Lib_C_SetSettings::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, K2Node_DynamicCast_AsMain_Gamemode) == 0x000028, "Member 'Lib_C_SetSettings::K2Node_DynamicCast_AsMain_Gamemode' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, K2Node_DynamicCast_bSuccess) == 0x000030, "Member 'Lib_C_SetSettings::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_GetAssetFolder_path) == 0x000038, "Member 'Lib_C_SetSettings::CallFunc_GetAssetFolder_path' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_GetAllWidgetsWithInterface_FoundWidgets) == 0x000048, "Member 'Lib_C_SetSettings::CallFunc_GetAllWidgetsWithInterface_FoundWidgets' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue) == 0x000058, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Array_Length_ReturnValue) == 0x000068, "Member 'Lib_C_SetSettings::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_LoadImageFile_texture) == 0x000070, "Member 'Lib_C_SetSettings::CallFunc_LoadImageFile_texture' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_LoadImageFile_fileName) == 0x000078, "Member 'Lib_C_SetSettings::CallFunc_LoadImageFile_fileName' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_LoadImageFile_errorCode) == 0x000088, "Member 'Lib_C_SetSettings::CallFunc_LoadImageFile_errorCode' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_LoadImageFile_errorMessage) == 0x000090, "Member 'Lib_C_SetSettings::CallFunc_LoadImageFile_errorMessage' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_GetAllActorsWithInterface_OutActors) == 0x0000A0, "Member 'Lib_C_SetSettings::CallFunc_GetAllActorsWithInterface_OutActors' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Array_Get_Item) == 0x0000B0, "Member 'Lib_C_SetSettings::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Array_Length_ReturnValue_1) == 0x0000B8, "Member 'Lib_C_SetSettings::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, K2Node_DynamicCast_AsInt_Coms) == 0x0000C0, "Member 'Lib_C_SetSettings::K2Node_DynamicCast_AsInt_Coms' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, K2Node_DynamicCast_bSuccess_1) == 0x0000D0, "Member 'Lib_C_SetSettings::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Less_IntInt_ReturnValue) == 0x0000D1, "Member 'Lib_C_SetSettings::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_IsValid_ReturnValue) == 0x0000D2, "Member 'Lib_C_SetSettings::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_getMainPlayer_AsMain_Player) == 0x0000D8, "Member 'Lib_C_SetSettings::CallFunc_getMainPlayer_AsMain_Player' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, Temp_int_Variable_1) == 0x0000E0, "Member 'Lib_C_SetSettings::Temp_int_Variable_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, Temp_int_Array_Index_Variable) == 0x0000E4, "Member 'Lib_C_SetSettings::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Add_IntInt_ReturnValue_1) == 0x0000E8, "Member 'Lib_C_SetSettings::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Array_Get_Item_1) == 0x0000F0, "Member 'Lib_C_SetSettings::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Less_IntInt_ReturnValue_1) == 0x0000F8, "Member 'Lib_C_SetSettings::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, K2Node_DynamicCast_AsInt_Coms_1) == 0x000100, "Member 'Lib_C_SetSettings::K2Node_DynamicCast_AsInt_Coms_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, K2Node_DynamicCast_bSuccess_2) == 0x000110, "Member 'Lib_C_SetSettings::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, Temp_int_Loop_Counter_Variable) == 0x000114, "Member 'Lib_C_SetSettings::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Add_IntInt_ReturnValue_2) == 0x000118, "Member 'Lib_C_SetSettings::CallFunc_Add_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, Temp_int_Array_Index_Variable_1) == 0x00011C, "Member 'Lib_C_SetSettings::Temp_int_Array_Index_Variable_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, Temp_byte_Variable) == 0x000120, "Member 'Lib_C_SetSettings::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, Temp_int_Loop_Counter_Variable_1) == 0x000124, "Member 'Lib_C_SetSettings::Temp_int_Loop_Counter_Variable_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_IsValid_ReturnValue_1) == 0x000128, "Member 'Lib_C_SetSettings::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToFloat_ReturnValue) == 0x00012C, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000130, "Member 'Lib_C_SetSettings::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_SelectFloat_ReturnValue) == 0x000134, "Member 'Lib_C_SetSettings::CallFunc_SelectFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue) == 0x000138, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_1) == 0x000148, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_1) == 0x000158, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_2) == 0x000168, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_2) == 0x000178, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_3) == 0x000188, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_3) == 0x000198, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_4) == 0x0001A8, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_BoolToInt_ReturnValue) == 0x0001B8, "Member 'Lib_C_SetSettings::CallFunc_Conv_BoolToInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_FloatToString_ReturnValue) == 0x0001C0, "Member 'Lib_C_SetSettings::CallFunc_Conv_FloatToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_4) == 0x0001D0, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_5) == 0x0001E0, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_6) == 0x0001F0, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_BoolToInt_ReturnValue_1) == 0x000200, "Member 'Lib_C_SetSettings::CallFunc_Conv_BoolToInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_5) == 0x000208, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_6) == 0x000218, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_7) == 0x000228, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_7' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_8) == 0x000238, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_8' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000248, "Member 'Lib_C_SetSettings::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_7) == 0x000250, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_7' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x000260, "Member 'Lib_C_SetSettings::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_9) == 0x000268, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_9' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_8) == 0x000278, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_8' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Add_IntInt_ReturnValue_3) == 0x000288, "Member 'Lib_C_SetSettings::CallFunc_Add_IntInt_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_10) == 0x000290, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_10' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToFloat_ReturnValue_1) == 0x0002A0, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Divide_FloatFloat_ReturnValue_1) == 0x0002A4, "Member 'Lib_C_SetSettings::CallFunc_Divide_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_SelectFloat_ReturnValue_1) == 0x0002A8, "Member 'Lib_C_SetSettings::CallFunc_SelectFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_FloatToString_ReturnValue_1) == 0x0002B0, "Member 'Lib_C_SetSettings::CallFunc_Conv_FloatToString_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Multiply_FloatFloat_ReturnValue_1) == 0x0002C0, "Member 'Lib_C_SetSettings::CallFunc_Multiply_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_11) == 0x0002C8, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_11' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_SelectFloat_ReturnValue_2) == 0x0002D8, "Member 'Lib_C_SetSettings::CallFunc_SelectFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_BoolToInt_ReturnValue_2) == 0x0002DC, "Member 'Lib_C_SetSettings::CallFunc_Conv_BoolToInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_9) == 0x0002E0, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_9' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_10) == 0x0002F0, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_10' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_11) == 0x000300, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_11' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_12) == 0x000310, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_12' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_13) == 0x000320, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_13' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_14) == 0x000330, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_14' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_12) == 0x000340, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_12' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_15) == 0x000350, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_15' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_16) == 0x000360, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_16' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_17) == 0x000370, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_17' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_BoolToFloat_ReturnValue) == 0x000380, "Member 'Lib_C_SetSettings::CallFunc_Conv_BoolToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToFloat_ReturnValue_2) == 0x000384, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToFloat_ReturnValue_3) == 0x000388, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToFloat_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Divide_FloatFloat_ReturnValue_2) == 0x00038C, "Member 'Lib_C_SetSettings::CallFunc_Divide_FloatFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Divide_FloatFloat_ReturnValue_3) == 0x000390, "Member 'Lib_C_SetSettings::CallFunc_Divide_FloatFloat_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToFloat_ReturnValue_4) == 0x000394, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToFloat_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToFloat_ReturnValue_5) == 0x000398, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToFloat_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Divide_FloatFloat_ReturnValue_4) == 0x00039C, "Member 'Lib_C_SetSettings::CallFunc_Divide_FloatFloat_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Divide_FloatFloat_ReturnValue_5) == 0x0003A0, "Member 'Lib_C_SetSettings::CallFunc_Divide_FloatFloat_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToFloat_ReturnValue_6) == 0x0003A4, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToFloat_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_13) == 0x0003A8, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_13' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Divide_FloatFloat_ReturnValue_6) == 0x0003B8, "Member 'Lib_C_SetSettings::CallFunc_Divide_FloatFloat_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_18) == 0x0003C0, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_18' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Multiply_FloatFloat_ReturnValue_2) == 0x0003D0, "Member 'Lib_C_SetSettings::CallFunc_Multiply_FloatFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Multiply_FloatFloat_ReturnValue_3) == 0x0003D4, "Member 'Lib_C_SetSettings::CallFunc_Multiply_FloatFloat_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Multiply_FloatFloat_ReturnValue_4) == 0x0003D8, "Member 'Lib_C_SetSettings::CallFunc_Multiply_FloatFloat_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Multiply_FloatFloat_ReturnValue_5) == 0x0003DC, "Member 'Lib_C_SetSettings::CallFunc_Multiply_FloatFloat_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_14) == 0x0003E0, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_14' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_19) == 0x0003F0, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_19' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_15) == 0x000400, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_15' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_20) == 0x000410, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_20' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_16) == 0x000420, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_16' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_21) == 0x000430, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_21' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_17) == 0x000440, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_17' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_22) == 0x000450, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_22' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_18) == 0x000460, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_18' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_23) == 0x000470, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_23' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_19) == 0x000480, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_19' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_24) == 0x000490, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_24' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_20) == 0x0004A0, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_20' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_25) == 0x0004B0, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_25' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Conv_IntToString_ReturnValue_21) == 0x0004C0, "Member 'Lib_C_SetSettings::CallFunc_Conv_IntToString_ReturnValue_21' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Concat_StrStr_ReturnValue_26) == 0x0004D0, "Member 'Lib_C_SetSettings::CallFunc_Concat_StrStr_ReturnValue_26' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Add_IntInt_ReturnValue_4) == 0x0004E0, "Member 'Lib_C_SetSettings::CallFunc_Add_IntInt_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_GetInputSettings_ReturnValue) == 0x0004E8, "Member 'Lib_C_SetSettings::CallFunc_GetInputSettings_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_GetGameUserSettings_ReturnValue) == 0x0004F0, "Member 'Lib_C_SetSettings::CallFunc_GetGameUserSettings_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_GetAxisNames_AxisNames) == 0x0004F8, "Member 'Lib_C_SetSettings::CallFunc_GetAxisNames_AxisNames' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Array_Get_Item_2) == 0x000508, "Member 'Lib_C_SetSettings::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Array_Length_ReturnValue_2) == 0x000510, "Member 'Lib_C_SetSettings::CallFunc_Array_Length_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_GetAxisMappingByName_OutMappings) == 0x000518, "Member 'Lib_C_SetSettings::CallFunc_GetAxisMappingByName_OutMappings' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Less_IntInt_ReturnValue_2) == 0x000528, "Member 'Lib_C_SetSettings::CallFunc_Less_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Array_Get_Item_3) == 0x000530, "Member 'Lib_C_SetSettings::CallFunc_Array_Get_Item_3' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Array_Length_ReturnValue_3) == 0x000558, "Member 'Lib_C_SetSettings::CallFunc_Array_Length_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, Temp_struct_Variable) == 0x000560, "Member 'Lib_C_SetSettings::Temp_struct_Variable' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, CallFunc_Less_IntInt_ReturnValue_3) == 0x000578, "Member 'Lib_C_SetSettings::CallFunc_Less_IntInt_ReturnValue_3' has a wrong offset!");
...
static_assert(offsetof(Lib_C_SetSettings, Temp_struct_Variable_4) == 0x0005E8, "Member 'Lib_C_SetSettings::Temp_struct_Variable_4' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, K2Node_MakeStruct_InputAxisKeyMapping) == 0x000600, "Member 'Lib_C_SetSettings::K2Node_MakeStruct_InputAxisKeyMapping' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, Temp_struct_Variable_5) == 0x000628, "Member 'Lib_C_SetSettings::Temp_struct_Variable_5' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, K2Node_Select_Default_1) == 0x000640, "Member 'Lib_C_SetSettings::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetSettings, K2Node_MakeStruct_InputAxisKeyMapping_1) == 0x000658, "Member 'Lib_C_SetSettings::K2Node_MakeStruct_InputAxisKeyMapping_1' has a wrong offset!");
...
public:
	...
	class FString                                 CallFunc_returnMeshTemplateData_rstring;           // 0x0020(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	TArray<uint8>                                 CallFunc_StringToBytesUtf8_ReturnValue;            // 0x0030(0x0010)(ReferenceParm)
	class FString                                 CallFunc_makeItemNames_ReturnValue;                // 0x0040(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_ProjectDir_ReturnValue;                   // 0x0050(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	TArray<uint8>                                 CallFunc_StringToBytesUtf8_ReturnValue_1;          // 0x0060(0x0010)(ReferenceParm)
	class FString                                 CallFunc_Concat_StrStr_ReturnValue;                // 0x0070(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_makeItemNames_ReturnValue_1;              // 0x0080(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_LoadStringFromFile_Result;                // 0x0090(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	bool                                          CallFunc_LoadStringFromFile_ReturnValue;           // 0x00A0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(Lib_C_IsBuoyant_) == 0x0000A8, "Wrong size on Lib_C_IsBuoyant_");
...
static_assert(offsetof(Lib_C_IsBuoyant_, CallFunc_returnMeshTemplateData_rstring) == 0x000020, "Member 'Lib_C_IsBuoyant_::CallFunc_returnMeshTemplateData_rstring' has a wrong offset!");
static_assert(offsetof(Lib_C_IsBuoyant_, CallFunc_StringToBytesUtf8_ReturnValue) == 0x000030, "Member 'Lib_C_IsBuoyant_::CallFunc_StringToBytesUtf8_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_IsBuoyant_, CallFunc_makeItemNames_ReturnValue) == 0x000040, "Member 'Lib_C_IsBuoyant_::CallFunc_makeItemNames_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_IsBuoyant_, CallFunc_ProjectDir_ReturnValue) == 0x000050, "Member 'Lib_C_IsBuoyant_::CallFunc_ProjectDir_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_IsBuoyant_, CallFunc_StringToBytesUtf8_ReturnValue_1) == 0x000060, "Member 'Lib_C_IsBuoyant_::CallFunc_StringToBytesUtf8_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_IsBuoyant_, CallFunc_Concat_StrStr_ReturnValue) == 0x000070, "Member 'Lib_C_IsBuoyant_::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_IsBuoyant_, CallFunc_makeItemNames_ReturnValue_1) == 0x000080, "Member 'Lib_C_IsBuoyant_::CallFunc_makeItemNames_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_IsBuoyant_, CallFunc_LoadStringFromFile_Result) == 0x000090, "Member 'Lib_C_IsBuoyant_::CallFunc_LoadStringFromFile_Result' has a wrong offset!");
static_assert(offsetof(Lib_C_IsBuoyant_, CallFunc_LoadStringFromFile_ReturnValue) == 0x0000A0, "Member 'Lib_C_IsBuoyant_::CallFunc_LoadStringFromFile_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_IsBuoyant_, CallFunc_EqualEqual_StrStr_ReturnValue) == 0x0000A1, "Member 'Lib_C_IsBuoyant_::CallFunc_EqualEqual_StrStr_ReturnValue' has a wrong offset!");
...
public:
	...
	class AMainGamemode_C*                        GameMode;                                          // 0x0090(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         Fee;                                               // 0x0098(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          No_fee;                                            // 0x009C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_9D[0x3];                                       // 0x009D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 TaskStr;                                           // 0x00A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_JoinStringArray_ReturnValue;              // 0x00D8(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_Greater_IntInt_ReturnValue_2;             // 0x0118(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FStruct_task                           K2Node_SetFieldsInStruct_StructOut;                // 0x0160(0x0070)(HasGetValueTypeHash)
	...
	class FString                                 CallFunc_Conv_IntToString_ReturnValue_5;           // 0x01D8(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class FText                                   CallFunc_MakeLiteralText_ReturnValue_2;            // 0x0248(0x0018)()
	class FString                                 CallFunc_Concat_StrStr_ReturnValue_1;              // 0x0260(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_TextToString_ReturnValue_2;          // 0x0270(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class FText                                   CallFunc_MakeLiteralText_ReturnValue_3;            // 0x02A8(0x0018)()
	class FText                                   CallFunc_MakeLiteralText_ReturnValue_4;            // 0x02C0(0x0018)()
	...
	class FString                                 CallFunc_Conv_TextToString_ReturnValue_4;          // 0x0300(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_SelectString_ReturnValue_1;               // 0x0330(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_SelectString_ReturnValue_2;               // 0x0340(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FText                                   CallFunc_MakeLiteralText_ReturnValue_5;            // 0x0350(0x0018)()
	class FText                                   CallFunc_MakeLiteralText_ReturnValue_6;            // 0x0368(0x0018)()
	class FString                                 CallFunc_Conv_TextToString_ReturnValue_5;          // 0x0380(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_TextToString_ReturnValue_6;          // 0x0390(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_SelectString_ReturnValue_3;               // 0x03C0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_SelectString_ReturnValue_4;               // 0x03D0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FText                                   CallFunc_MakeLiteralText_ReturnValue_7;            // 0x03E0(0x0018)()
	class FText                                   CallFunc_MakeLiteralText_ReturnValue_8;            // 0x03F8(0x0018)()
	...
	class FText                                   CallFunc_MakeLiteralText_ReturnValue_9;            // 0x0440(0x0018)()
	class FString                                 CallFunc_SelectString_ReturnValue_5;               // 0x0458(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_TextToString_ReturnValue_9;          // 0x0468(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_Concat_StrStr_ReturnValue_9;              // 0x04A0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	int32                                         Temp_int_Variable_4;                               // 0x04B0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         Temp_int_Variable_5;                               // 0x04B4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	Enum_difficulty                               Temp_byte_Variable;                                // 0x04B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4B9[0x7];                                      // 0x04B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_MakeLiteralText_ReturnValue_10;           // 0x04C0(0x0018)()
	class FString                                 CallFunc_Conv_TextToString_ReturnValue_10;         // 0x04D8(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_Concat_StrStr_ReturnValue_10;             // 0x04F0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	int32                                         CallFunc_Multiply_IntInt_ReturnValue;              // 0x0500(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_Concat_StrStr_ReturnValue_12;             // 0x0520(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	int32                                         CallFunc_Multiply_IntInt_ReturnValue_1;            // 0x0530(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_Concat_StrStr_ReturnValue_15;             // 0x0558(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Concat_StrStr_ReturnValue_16;             // 0x0568(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Concat_StrStr_ReturnValue_17;             // 0x0578(0x0010)(ZeroConstructor, HasGetValueTypeHash)
...
static_assert(sizeof(Lib_C_Add_task) == 0x0005A0, "Wrong size on Lib_C_Add_task");
...
static_assert(offsetof(Lib_C_Add_task, GameMode) == 0x000090, "Member 'Lib_C_Add_task::GameMode' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, Fee) == 0x000098, "Member 'Lib_C_Add_task::Fee' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, No_fee) == 0x00009C, "Member 'Lib_C_Add_task::No_fee' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, TaskStr) == 0x0000A0, "Member 'Lib_C_Add_task::TaskStr' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, Temp_int_Variable) == 0x0000B0, "Member 'Lib_C_Add_task::Temp_int_Variable' has a wrong offset!");
...
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_TextToString_ReturnValue) == 0x0000C0, "Member 'Lib_C_Add_task::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, Temp_bool_Variable) == 0x0000D0, "Member 'Lib_C_Add_task::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_JoinStringArray_ReturnValue) == 0x0000D8, "Member 'Lib_C_Add_task::CallFunc_JoinStringArray_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Greater_IntInt_ReturnValue) == 0x0000E8, "Member 'Lib_C_Add_task::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_IntToString_ReturnValue) == 0x0000F0, "Member 'Lib_C_Add_task::CallFunc_Conv_IntToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Greater_IntInt_ReturnValue_1) == 0x000100, "Member 'Lib_C_Add_task::CallFunc_Greater_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_IntToString_ReturnValue_1) == 0x000108, "Member 'Lib_C_Add_task::CallFunc_Conv_IntToString_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Greater_IntInt_ReturnValue_2) == 0x000118, "Member 'Lib_C_Add_task::CallFunc_Greater_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_IntToString_ReturnValue_2) == 0x000120, "Member 'Lib_C_Add_task::CallFunc_Conv_IntToString_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Greater_IntInt_ReturnValue_3) == 0x000130, "Member 'Lib_C_Add_task::CallFunc_Greater_IntInt_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_IntToString_ReturnValue_3) == 0x000138, "Member 'Lib_C_Add_task::CallFunc_Conv_IntToString_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_IntToString_ReturnValue_4) == 0x000148, "Member 'Lib_C_Add_task::CallFunc_Conv_IntToString_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Add_IntInt_ReturnValue) == 0x000158, "Member 'Lib_C_Add_task::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, K2Node_SetFieldsInStruct_StructOut) == 0x000160, "Member 'Lib_C_Add_task::K2Node_SetFieldsInStruct_StructOut' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Multiply_IntFloat_ReturnValue) == 0x0001D0, "Member 'Lib_C_Add_task::CallFunc_Multiply_IntFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_FTrunc_ReturnValue) == 0x0001D4, "Member 'Lib_C_Add_task::CallFunc_FTrunc_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_IntToString_ReturnValue_5) == 0x0001D8, "Member 'Lib_C_Add_task::CallFunc_Conv_IntToString_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_MakeLiteralText_ReturnValue) == 0x0001E8, "Member 'Lib_C_Add_task::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, Temp_int_Variable_1) == 0x000200, "Member 'Lib_C_Add_task::Temp_int_Variable_1' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_MakeLiteralText_ReturnValue_1) == 0x000208, "Member 'Lib_C_Add_task::CallFunc_MakeLiteralText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, Temp_int_Variable_2) == 0x000220, "Member 'Lib_C_Add_task::Temp_int_Variable_2' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_TextToString_ReturnValue_1) == 0x000228, "Member 'Lib_C_Add_task::CallFunc_Conv_TextToString_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue) == 0x000238, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_MakeLiteralText_ReturnValue_2) == 0x000248, "Member 'Lib_C_Add_task::CallFunc_MakeLiteralText_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_1) == 0x000260, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_TextToString_ReturnValue_2) == 0x000270, "Member 'Lib_C_Add_task::CallFunc_Conv_TextToString_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_StringToText_ReturnValue) == 0x000280, "Member 'Lib_C_Add_task::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_2) == 0x000298, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_MakeLiteralText_ReturnValue_3) == 0x0002A8, "Member 'Lib_C_Add_task::CallFunc_MakeLiteralText_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_MakeLiteralText_ReturnValue_4) == 0x0002C0, "Member 'Lib_C_Add_task::CallFunc_MakeLiteralText_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, K2Node_Select_Default) == 0x0002D8, "Member 'Lib_C_Add_task::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_TextToString_ReturnValue_3) == 0x0002F0, "Member 'Lib_C_Add_task::CallFunc_Conv_TextToString_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_TextToString_ReturnValue_4) == 0x000300, "Member 'Lib_C_Add_task::CallFunc_Conv_TextToString_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_3) == 0x000310, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_SelectString_ReturnValue) == 0x000320, "Member 'Lib_C_Add_task::CallFunc_SelectString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_SelectString_ReturnValue_1) == 0x000330, "Member 'Lib_C_Add_task::CallFunc_SelectString_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_SelectString_ReturnValue_2) == 0x000340, "Member 'Lib_C_Add_task::CallFunc_SelectString_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_MakeLiteralText_ReturnValue_5) == 0x000350, "Member 'Lib_C_Add_task::CallFunc_MakeLiteralText_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_MakeLiteralText_ReturnValue_6) == 0x000368, "Member 'Lib_C_Add_task::CallFunc_MakeLiteralText_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_TextToString_ReturnValue_5) == 0x000380, "Member 'Lib_C_Add_task::CallFunc_Conv_TextToString_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_TextToString_ReturnValue_6) == 0x000390, "Member 'Lib_C_Add_task::CallFunc_Conv_TextToString_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_4) == 0x0003A0, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_5) == 0x0003B0, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_SelectString_ReturnValue_3) == 0x0003C0, "Member 'Lib_C_Add_task::CallFunc_SelectString_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_SelectString_ReturnValue_4) == 0x0003D0, "Member 'Lib_C_Add_task::CallFunc_SelectString_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_MakeLiteralText_ReturnValue_7) == 0x0003E0, "Member 'Lib_C_Add_task::CallFunc_MakeLiteralText_ReturnValue_7' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_MakeLiteralText_ReturnValue_8) == 0x0003F8, "Member 'Lib_C_Add_task::CallFunc_MakeLiteralText_ReturnValue_8' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_TextToString_ReturnValue_7) == 0x000410, "Member 'Lib_C_Add_task::CallFunc_Conv_TextToString_ReturnValue_7' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_TextToString_ReturnValue_8) == 0x000420, "Member 'Lib_C_Add_task::CallFunc_Conv_TextToString_ReturnValue_8' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_6) == 0x000430, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_MakeLiteralText_ReturnValue_9) == 0x000440, "Member 'Lib_C_Add_task::CallFunc_MakeLiteralText_ReturnValue_9' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_SelectString_ReturnValue_5) == 0x000458, "Member 'Lib_C_Add_task::CallFunc_SelectString_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_TextToString_ReturnValue_9) == 0x000468, "Member 'Lib_C_Add_task::CallFunc_Conv_TextToString_ReturnValue_9' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_7) == 0x000478, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_7' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, Temp_int_Variable_3) == 0x000488, "Member 'Lib_C_Add_task::Temp_int_Variable_3' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_8) == 0x000490, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_8' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_9) == 0x0004A0, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_9' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, Temp_int_Variable_4) == 0x0004B0, "Member 'Lib_C_Add_task::Temp_int_Variable_4' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, Temp_int_Variable_5) == 0x0004B4, "Member 'Lib_C_Add_task::Temp_int_Variable_5' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, Temp_byte_Variable) == 0x0004B8, "Member 'Lib_C_Add_task::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_MakeLiteralText_ReturnValue_10) == 0x0004C0, "Member 'Lib_C_Add_task::CallFunc_MakeLiteralText_ReturnValue_10' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_TextToString_ReturnValue_10) == 0x0004D8, "Member 'Lib_C_Add_task::CallFunc_Conv_TextToString_ReturnValue_10' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, K2Node_Select_Default_1) == 0x0004E8, "Member 'Lib_C_Add_task::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_10) == 0x0004F0, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_10' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Multiply_IntInt_ReturnValue) == 0x000500, "Member 'Lib_C_Add_task::CallFunc_Multiply_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_11) == 0x000508, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_11' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Add_IntInt_ReturnValue_1) == 0x000518, "Member 'Lib_C_Add_task::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_12) == 0x000520, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_12' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Multiply_IntInt_ReturnValue_1) == 0x000530, "Member 'Lib_C_Add_task::CallFunc_Multiply_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_13) == 0x000538, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_13' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_14) == 0x000548, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_14' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_15) == 0x000558, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_15' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_16) == 0x000568, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_16' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Concat_StrStr_ReturnValue_17) == 0x000578, "Member 'Lib_C_Add_task::CallFunc_Concat_StrStr_ReturnValue_17' has a wrong offset!");
static_assert(offsetof(Lib_C_Add_task, CallFunc_Conv_StringToText_ReturnValue_1) == 0x000588, "Member 'Lib_C_Add_task::CallFunc_Conv_StringToText_ReturnValue_1' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   Name_0;                                            // 0x001C(0x0008)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AMainGamemode_C*                        CallFunc_getMainGamemode_AsMain_Gamemode;          // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Lib_C_ProgressAdvancement, Name_0) == 0x00001C, "Member 'Lib_C_ProgressAdvancement::Name_0' has a wrong offset!");
...
static_assert(offsetof(Lib_C_GetCarpet, Index_0) == 0x000000, "Member 'Lib_C_GetCarpet::Index_0' has a wrong offset!");
...
public:
	...
	bool                                          ReturnValue;                                       // 0x0010(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FStruct_food                           FoodData;                                          // 0x0014(0x001C)(Parm, OutParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FStruct_prop3                          FuckYouRetard;                                     // 0x0040(0x0080)(Parm, OutParm, HasGetValueTypeHash)
	struct FStruct_prop3                          CallFunc_GetDataTableRowFromName_OutRow;           // 0x00C0(0x0080)(HasGetValueTypeHash)
	...
	struct FStruct_food                           CallFunc_GetDataTableRowFromName_OutRow_1;         // 0x0144(0x001C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Lib_C_PropToObject) == 0x000168, "Wrong size on Lib_C_PropToObject");
...
static_assert(offsetof(Lib_C_PropToObject, FuckYouRetard) == 0x000040, "Member 'Lib_C_PropToObject::FuckYouRetard' has a wrong offset!");
...
static_assert(offsetof(Lib_C_PropToObject, CallFunc_GetDataTableRowFromName_ReturnValue_1) == 0x000160, "Member 'Lib_C_PropToObject::CallFunc_GetDataTableRowFromName_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_PropToObject, CallFunc_IsValidClass_ReturnValue) == 0x000161, "Member 'Lib_C_PropToObject::CallFunc_IsValidClass_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Lib_C_GetPic, Index_0) == 0x000004, "Member 'Lib_C_GetPic::Index_0' has a wrong offset!");
...
static_assert(offsetof(Lib_C_GetCusPic, Index_0) == 0x000004, "Member 'Lib_C_GetCusPic::Index_0' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 Sender;                                            // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          DeactivateAmbientTrack;                            // 0x0010(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                __WorldContext;                                    // 0x0018(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Lib_C_SetEvent) == 0x000058, "Wrong size on Lib_C_SetEvent");
static_assert(offsetof(Lib_C_SetEvent, IsEventActive) == 0x000000, "Member 'Lib_C_SetEvent::IsEventActive' has a wrong offset!");
static_assert(offsetof(Lib_C_SetEvent, Sender) == 0x000008, "Member 'Lib_C_SetEvent::Sender' has a wrong offset!");
static_assert(offsetof(Lib_C_SetEvent, DeactivateAmbientTrack) == 0x000010, "Member 'Lib_C_SetEvent::DeactivateAmbientTrack' has a wrong offset!");
static_assert(offsetof(Lib_C_SetEvent, __WorldContext) == 0x000018, "Member 'Lib_C_SetEvent::__WorldContext' has a wrong offset!");
static_assert(offsetof(Lib_C_SetEvent, Temp_int_Variable) == 0x000020, "Member 'Lib_C_SetEvent::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(Lib_C_SetEvent, CallFunc_getMainGamemode_AsMain_Gamemode) == 0x000028, "Member 'Lib_C_SetEvent::CallFunc_getMainGamemode_AsMain_Gamemode' has a wrong offset!");
static_assert(offsetof(Lib_C_SetEvent, CallFunc_Subtract_IntInt_ReturnValue) == 0x000030, "Member 'Lib_C_SetEvent::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetEvent, CallFunc_Array_RemoveItem_ReturnValue) == 0x000034, "Member 'Lib_C_SetEvent::CallFunc_Array_RemoveItem_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetEvent, CallFunc_Array_Add_ReturnValue) == 0x000038, "Member 'Lib_C_SetEvent::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetEvent, CallFunc_Add_IntInt_ReturnValue) == 0x00003C, "Member 'Lib_C_SetEvent::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_SetEvent, CallFunc_Subtract_IntInt_ReturnValue_1) == 0x000040, "Member 'Lib_C_SetEvent::CallFunc_Subtract_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetEvent, CallFunc_Add_IntInt_ReturnValue_1) == 0x000044, "Member 'Lib_C_SetEvent::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetEvent, Temp_int_Variable_1) == 0x000048, "Member 'Lib_C_SetEvent::Temp_int_Variable_1' has a wrong offset!");
static_assert(offsetof(Lib_C_SetEvent, Temp_int_Variable_2) == 0x00004C, "Member 'Lib_C_SetEvent::Temp_int_Variable_2' has a wrong offset!");
static_assert(offsetof(Lib_C_SetEvent, Temp_int_Variable_3) == 0x000050, "Member 'Lib_C_SetEvent::Temp_int_Variable_3' has a wrong offset!");
...
static_assert(offsetof(Lib_C_GetEvent, CallFunc_Greater_IntInt_ReturnValue) == 0x00002C, "Member 'Lib_C_GetEvent::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
...
public:
	...
	class FText                                   Name_0;                                            // 0x0038(0x0018)(Parm, OutParm)
	...
	struct FStruct_prop3                          CallFunc_GetDataTableRowFromName_OutRow;           // 0x0110(0x0080)(HasGetValueTypeHash)
...
static_assert(offsetof(Lib_C_PropDescription, Name_0) == 0x000038, "Member 'Lib_C_PropDescription::Name_0' has a wrong offset!");
...
static_assert(offsetof(Lib_C_HasEquipment, Name_0) == 0x000000, "Member 'Lib_C_HasEquipment::Name_0' has a wrong offset!");
...
{
public:
	struct FStruct_prop3                          Item;                                              // 0x0000(0x0080)(BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
	...
	TArray<class FString>                         K2Node_MakeArray_Array;                            // 0x00A0(0x0010)(ReferenceParm)
	...
	bool                                          CallFunc_achievementObjects_hidden;                // 0x00B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(Lib_C_HiddenSpawnMenu, K2Node_MakeArray_Array) == 0x0000A0, "Member 'Lib_C_HiddenSpawnMenu::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(Lib_C_HiddenSpawnMenu, CallFunc_getMainGamemode_AsMain_Gamemode) == 0x0000B0, "Member 'Lib_C_HiddenSpawnMenu::CallFunc_getMainGamemode_AsMain_Gamemode' has a wrong offset!");
static_assert(offsetof(Lib_C_HiddenSpawnMenu, CallFunc_achievementObjects_hidden) == 0x0000B8, "Member 'Lib_C_HiddenSpawnMenu::CallFunc_achievementObjects_hidden' has a wrong offset!");
static_assert(offsetof(Lib_C_HiddenSpawnMenu, CallFunc_BooleanOR_ReturnValue) == 0x0000B9, "Member 'Lib_C_HiddenSpawnMenu::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
...
{
public:
	struct FStruct_prop3                          Struct_prop;                                       // 0x0000(0x0080)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
	class UObject*                                __WorldContext;                                    // 0x0080(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Hidden;                                            // 0x0088(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(Lib_C_NameToSignal, Name_0) == 0x000000, "Member 'Lib_C_NameToSignal::Name_0' has a wrong offset!");
...
static_assert(offsetof(Lib_C_IsSignalUnique, Name_0) == 0x000000, "Member 'Lib_C_IsSignalUnique::Name_0' has a wrong offset!");
...
public:
	...
	class UObject*                                __WorldContext;                                    // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          IsFlammable_0;                                     // 0x0010(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(Lib_C_IsFlammable, IsFlammable_0) == 0x000010, "Member 'Lib_C_IsFlammable::IsFlammable_0' has a wrong offset!");
...
static_assert(offsetof(Lib_C_GetKeybindFromName, Name_0) == 0x000000, "Member 'Lib_C_GetKeybindFromName::Name_0' has a wrong offset!");
...
static_assert(offsetof(Lib_C_AddGloss, Name_0) == 0x000000, "Member 'Lib_C_AddGloss::Name_0' has a wrong offset!");
...
public:
	...
	class FString                                 Name_0;                                            // 0x0008(0x0010)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
	class UObject*                                __WorldContext;                                    // 0x0018(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Lib_C_Get_Volume) == 0x000040, "Wrong size on Lib_C_Get_Volume");
static_assert(offsetof(Lib_C_Get_Volume, Mesh) == 0x000000, "Member 'Lib_C_Get_Volume::Mesh' has a wrong offset!");
static_assert(offsetof(Lib_C_Get_Volume, Name_0) == 0x000008, "Member 'Lib_C_Get_Volume::Name_0' has a wrong offset!");
...
static_assert(offsetof(Lib_C_Get_Volume, CallFunc_IsValid_ReturnValue) == 0x000024, "Member 'Lib_C_Get_Volume::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_Get_Volume, CallFunc_getMainGamemode_AsMain_Gamemode) == 0x000028, "Member 'Lib_C_Get_Volume::CallFunc_getMainGamemode_AsMain_Gamemode' has a wrong offset!");
static_assert(offsetof(Lib_C_Get_Volume, CallFunc_Array_Find_ReturnValue) == 0x000030, "Member 'Lib_C_Get_Volume::CallFunc_Array_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_Get_Volume, CallFunc_Array_Find_ReturnValue_1) == 0x000034, "Member 'Lib_C_Get_Volume::CallFunc_Array_Find_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Lib_C_Get_Volume, CallFunc_Array_Get_Item) == 0x000038, "Member 'Lib_C_Get_Volume::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Lib_C_Get_Volume, CallFunc_Array_Get_Item_1) == 0x00003C, "Member 'Lib_C_Get_Volume::CallFunc_Array_Get_Item_1' has a wrong offset!");
...
public:
	class UObject*                                __WorldContext;                                    // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          IsFunny_0;                                         // 0x0008(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(Lib_C_IsFunny, IsFunny_0) == 0x000008, "Member 'Lib_C_IsFunny::IsFunny_0' has a wrong offset!");
...
public:
	class UObject*                                __WorldContext;                                    // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<bool>                                  Hiddens_0;                                         // 0x0008(0x0010)(Parm, OutParm)
...
static_assert(offsetof(Lib_C_Hiddens, Hiddens_0) == 0x000008, "Member 'Lib_C_Hiddens::Hiddens_0' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_21[0x3];                                       // 0x0021(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Out_Row_Health_Mult;                               // 0x0024(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UClass*                                 Out_Row_Wall_Class;                                // 0x0028(0x0008)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FStruct_customwall                     CallFunc_GetDataTableRowFromName_OutRow;           // 0x0030(0x0020)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetDataTableRowFromName_ReturnValue;      // 0x0050(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_51[0x7];                                       // 0x0051(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FStruct_customwall                     CallFunc_GetDataTableRowFromName_OutRow_1;         // 0x0058(0x0020)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Lib_C_CustomWall_material) == 0x000080, "Wrong size on Lib_C_CustomWall_material");
...
static_assert(offsetof(Lib_C_CustomWall_material, Valid) == 0x000020, "Member 'Lib_C_CustomWall_material::Valid' has a wrong offset!");
static_assert(offsetof(Lib_C_CustomWall_material, Out_Row_Health_Mult) == 0x000024, "Member 'Lib_C_CustomWall_material::Out_Row_Health_Mult' has a wrong offset!");
static_assert(offsetof(Lib_C_CustomWall_material, Out_Row_Wall_Class) == 0x000028, "Member 'Lib_C_CustomWall_material::Out_Row_Wall_Class' has a wrong offset!");
static_assert(offsetof(Lib_C_CustomWall_material, CallFunc_GetDataTableRowFromName_OutRow) == 0x000030, "Member 'Lib_C_CustomWall_material::CallFunc_GetDataTableRowFromName_OutRow' has a wrong offset!");
static_assert(offsetof(Lib_C_CustomWall_material, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x000050, "Member 'Lib_C_CustomWall_material::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_CustomWall_material, CallFunc_GetDataTableRowFromName_OutRow_1) == 0x000058, "Member 'Lib_C_CustomWall_material::CallFunc_GetDataTableRowFromName_OutRow_1' has a wrong offset!");
static_assert(offsetof(Lib_C_CustomWall_material, CallFunc_GetDataTableRowFromName_ReturnValue_1) == 0x000078, "Member 'Lib_C_CustomWall_material::CallFunc_GetDataTableRowFromName_ReturnValue_1' has a wrong offset!");
...
public:
	...
	struct FStruct_prop3                          CallFunc_GetDataTableRowFromName_OutRow_1;         // 0x00B0(0x0080)(HasGetValueTypeHash)
...
public:
	...
	class UObject*                                __WorldContext;                                    // 0x0018(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class FName>                           ImmuneEffects;                                     // 0x0020(0x0010)(Edit, BlueprintVisible)
	class AMainGamemode_C*                        CallFunc_getMainGamemode_AsMain_Gamemode;          // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Array_Contains_ReturnValue;               // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_isStrong_return;                          // 0x0039(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(Lib_C_AddEffect) == 0x000050, "Wrong size on Lib_C_AddEffect");
...
static_assert(offsetof(Lib_C_AddEffect, ImmuneEffects) == 0x000020, "Member 'Lib_C_AddEffect::ImmuneEffects' has a wrong offset!");
static_assert(offsetof(Lib_C_AddEffect, CallFunc_getMainGamemode_AsMain_Gamemode) == 0x000030, "Member 'Lib_C_AddEffect::CallFunc_getMainGamemode_AsMain_Gamemode' has a wrong offset!");
static_assert(offsetof(Lib_C_AddEffect, CallFunc_Array_Contains_ReturnValue) == 0x000038, "Member 'Lib_C_AddEffect::CallFunc_Array_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(Lib_C_AddEffect, CallFunc_isStrong_return) == 0x000039, "Member 'Lib_C_AddEffect::CallFunc_isStrong_return' has a wrong offset!");
static_assert(offsetof(Lib_C_AddEffect, K2Node_MakeArray_Array) == 0x000040, "Member 'Lib_C_AddEffect::K2Node_MakeArray_Array' has a wrong offset!");
