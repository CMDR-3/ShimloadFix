...
public:
	...
	bool                                          K2Node_Event_kick;                                 // 0x00AC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_AD[0x3];                                       // 0x00AD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   K2Node_Event_name;                                 // 0x00B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AProp_rug_C*                            CallFunc_FinishSpawningActor_ReturnValue;          // 0x01A8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class IInt_player_C>         CallFunc_sendName_self_CastInput;                  // 0x01B0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	int32                                         CallFunc_VictoryIntPlusEquals_IntOut;              // 0x01C0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AProp_rug_c_C*                          CallFunc_FinishSpawningActor_ReturnValue_1;        // 0x0208(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class IInt_player_C>         CallFunc_sendName_self_CastInput_1;                // 0x0210(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_GreaterEqual_IntInt_ReturnValue_1;        // 0x0220(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, K2Node_LowEntry_LocalVariable_Value__Object) == 0x000008, "Member 'Rug_c_ExecuteUbergraph_rug::K2Node_LowEntry_LocalVariable_Value__Object' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, K2Node_Event_player_6) == 0x000018, "Member 'Rug_c_ExecuteUbergraph_rug::K2Node_Event_player_6' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, K2Node_Event_hit_2) == 0x000020, "Member 'Rug_c_ExecuteUbergraph_rug::K2Node_Event_hit_2' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, CallFunc_Array_Length_ReturnValue) == 0x0000A8, "Member 'Rug_c_ExecuteUbergraph_rug::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, K2Node_Event_kick) == 0x0000AC, "Member 'Rug_c_ExecuteUbergraph_rug::K2Node_Event_kick' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, K2Node_Event_name) == 0x0000B0, "Member 'Rug_c_ExecuteUbergraph_rug::K2Node_Event_name' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, K2Node_Event_player_5) == 0x0000B8, "Member 'Rug_c_ExecuteUbergraph_rug::K2Node_Event_player_5' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, K2Node_Event_player_4) == 0x0000C0, "Member 'Rug_c_ExecuteUbergraph_rug::K2Node_Event_player_4' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, K2Node_Event_hit_1) == 0x0000C8, "Member 'Rug_c_ExecuteUbergraph_rug::K2Node_Event_hit_1' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, K2Node_Event_damage) == 0x000150, "Member 'Rug_c_ExecuteUbergraph_rug::K2Node_Event_damage' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, K2Node_Event_player_3) == 0x000158, "Member 'Rug_c_ExecuteUbergraph_rug::K2Node_Event_player_3' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, K2Node_Event_player_2) == 0x000160, "Member 'Rug_c_ExecuteUbergraph_rug::K2Node_Event_player_2' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, K2Node_Event_player_1) == 0x000168, "Member 'Rug_c_ExecuteUbergraph_rug::K2Node_Event_player_1' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, CallFunc_GetTransform_ReturnValue) == 0x000170, "Member 'Rug_c_ExecuteUbergraph_rug::CallFunc_GetTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x0001A0, "Member 'Rug_c_ExecuteUbergraph_rug::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, CallFunc_FinishSpawningActor_ReturnValue) == 0x0001A8, "Member 'Rug_c_ExecuteUbergraph_rug::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, CallFunc_sendName_self_CastInput) == 0x0001B0, "Member 'Rug_c_ExecuteUbergraph_rug::CallFunc_sendName_self_CastInput' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, CallFunc_VictoryIntPlusEquals_IntOut) == 0x0001C0, "Member 'Rug_c_ExecuteUbergraph_rug::CallFunc_VictoryIntPlusEquals_IntOut' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, CallFunc_Percent_IntInt_ReturnValue) == 0x0001C4, "Member 'Rug_c_ExecuteUbergraph_rug::CallFunc_Percent_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x0001C8, "Member 'Rug_c_ExecuteUbergraph_rug::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, CallFunc_GetTransform_ReturnValue_1) == 0x0001D0, "Member 'Rug_c_ExecuteUbergraph_rug::CallFunc_GetTransform_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1) == 0x000200, "Member 'Rug_c_ExecuteUbergraph_rug::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, CallFunc_FinishSpawningActor_ReturnValue_1) == 0x000208, "Member 'Rug_c_ExecuteUbergraph_rug::CallFunc_FinishSpawningActor_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, CallFunc_sendName_self_CastInput_1) == 0x000210, "Member 'Rug_c_ExecuteUbergraph_rug::CallFunc_sendName_self_CastInput_1' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, CallFunc_GreaterEqual_IntInt_ReturnValue_1) == 0x000220, "Member 'Rug_c_ExecuteUbergraph_rug::CallFunc_GreaterEqual_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, K2Node_Event_player) == 0x000228, "Member 'Rug_c_ExecuteUbergraph_rug::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, K2Node_Event_hit) == 0x000230, "Member 'Rug_c_ExecuteUbergraph_rug::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, K2Node_Event_action) == 0x0002B8, "Member 'Rug_c_ExecuteUbergraph_rug::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Rug_c_ExecuteUbergraph_rug, K2Node_SwitchEnum_CmpSuccess) == 0x0002B9, "Member 'Rug_c_ExecuteUbergraph_rug::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
...
static_assert(offsetof(Rug_c_SendName, Name_0) == 0x000000, "Member 'Rug_c_SendName::Name_0' has a wrong offset!");
...
static_assert(sizeof(Rug_c_SetSkin) == 0x000018, "Wrong size on Rug_c_SetSkin");
static_assert(offsetof(Rug_c_SetSkin, CallFunc_Array_Get_Item) == 0x000000, "Member 'Rug_c_SetSkin::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Rug_c_SetSkin, CallFunc_Less_IntInt_ReturnValue) == 0x000008, "Member 'Rug_c_SetSkin::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Rug_c_SetSkin, CallFunc_getCarpet_ReturnValue) == 0x000010, "Member 'Rug_c_SetSkin::CallFunc_getCarpet_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Rug_c_NoRespawn, NoRespawn_0) == 0x000000, "Member 'Rug_c_NoRespawn::NoRespawn_0' has a wrong offset!");
