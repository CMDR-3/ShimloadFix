...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Poster_c;                           // 0x0250(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	...
	int32                                         Type;                                              // 0x0268(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	int32                                         Index_0;                                           // 0x026C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	class UMaterialInstanceDynamic*               Dynmat;                                            // 0x0270(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(APoster_c) == 0x000278, "Wrong size on APoster_c");
static_assert(offsetof(APoster_c, UberGraphFrame_Poster_c) == 0x000250, "Member 'APoster_c::UberGraphFrame_Poster_c' has a wrong offset!");
static_assert(offsetof(APoster_c, Coll) == 0x000258, "Member 'APoster_c::Coll' has a wrong offset!");
static_assert(offsetof(APoster_c, Decal) == 0x000260, "Member 'APoster_c::Decal' has a wrong offset!");
static_assert(offsetof(APoster_c, Type) == 0x000268, "Member 'APoster_c::Type' has a wrong offset!");
static_assert(offsetof(APoster_c, Index_0) == 0x00026C, "Member 'APoster_c::Index_0' has a wrong offset!");
static_assert(offsetof(APoster_c, Dynmat) == 0x000270, "Member 'APoster_c::Dynmat' has a wrong offset!");
