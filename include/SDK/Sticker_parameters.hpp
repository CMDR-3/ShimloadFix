...
public:
	...
	struct FHitResult                             K2Node_Event_hit_2;                                // 0x0170(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                          K2Node_Event_kick;                                 // 0x01F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1F9[0x3];                                      // 0x01F9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   K2Node_Event_name;                                 // 0x01FC(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AMainPlayer_C*                          K2Node_Event_player_4;                             // 0x0210(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_Event_hit_1;                                // 0x0218(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	class AMainPlayer_C*                          K2Node_Event_player_2;                             // 0x02B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AMainPlayer_C*                          K2Node_Event_player_1;                             // 0x02B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Sticker_C_ExecuteUbergraph_sticker) == 0x000360, "Wrong size on Sticker_C_ExecuteUbergraph_sticker");
...
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_key) == 0x000120, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_key' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_pressed) == 0x000138, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_pressed' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_color) == 0x00013C, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_color' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_picker) == 0x000150, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_picker' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_texture) == 0x000158, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_texture' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_index) == 0x000160, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_index' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_player_6) == 0x000168, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_player_6' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_hit_2) == 0x000170, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_hit_2' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_kick) == 0x0001F8, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_kick' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_name) == 0x0001FC, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_name' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_player_5) == 0x000208, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_player_5' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_player_4) == 0x000210, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_player_4' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_hit_1) == 0x000218, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_hit_1' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_damage) == 0x0002A0, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_damage' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_player_3) == 0x0002A8, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_player_3' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_player_2) == 0x0002B0, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_player_2' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_player_1) == 0x0002B8, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_player_1' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_player) == 0x0002C0, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_hit) == 0x0002C8, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_Event_action) == 0x000350, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_SwitchEnum_CmpSuccess) == 0x000351, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Sticker_C_ExecuteUbergraph_sticker, K2Node_CustomEvent_DestroyedActor) == 0x000358, "Member 'Sticker_C_ExecuteUbergraph_sticker::K2Node_CustomEvent_DestroyedActor' has a wrong offset!");
...
static_assert(offsetof(Sticker_C_SendName, Name_0) == 0x000000, "Member 'Sticker_C_SendName::Name_0' has a wrong offset!");
...
static_assert(offsetof(Sticker_C_TexturePickerApply, Index_0) == 0x000010, "Member 'Sticker_C_TexturePickerApply::Index_0' has a wrong offset!");
...
static_assert(offsetof(Sticker_C_AnyKey, Key_0) == 0x000000, "Member 'Sticker_C_AnyKey::Key_0' has a wrong offset!");
...
static_assert(sizeof(Sticker_C_SettingsApplied) == 0x000100, "Wrong size on Sticker_C_SettingsApplied");
...
static_assert(offsetof(Sticker_C_StuffUpgraded, GameMode_0) == 0x000000, "Member 'Sticker_C_StuffUpgraded::GameMode_0' has a wrong offset!");
...
public:
	...
	class AActor*                                 Actor_0;                                           // 0x0010(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Sticker_C_GetActionOptions, Actor_0) == 0x000010, "Member 'Sticker_C_GetActionOptions::Actor_0' has a wrong offset!");
...
static_assert(sizeof(Sticker_C_SetPoster) == 0x000018, "Wrong size on Sticker_C_SetPoster");
static_assert(offsetof(Sticker_C_SetPoster, CallFunc_Array_Find_ReturnValue) == 0x000000, "Member 'Sticker_C_SetPoster::CallFunc_Array_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(Sticker_C_SetPoster, CallFunc_CreateDynamicMaterialInstance_ReturnValue) == 0x000008, "Member 'Sticker_C_SetPoster::CallFunc_CreateDynamicMaterialInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(Sticker_C_SetPoster, CallFunc_Array_Get_Item) == 0x000010, "Member 'Sticker_C_SetPoster::CallFunc_Array_Get_Item' has a wrong offset!");
...
static_assert(sizeof(Sticker_C_ProcessKeys) == 0x000010, "Wrong size on Sticker_C_ProcessKeys");
...
static_assert(offsetof(Sticker_C_ProcessKeys, CallFunc_getObjectFromKey_Output) == 0x000008, "Member 'Sticker_C_ProcessKeys::CallFunc_getObjectFromKey_Output' has a wrong offset!");
...
static_assert(offsetof(Sticker_C_NoRespawn, NoRespawn_0) == 0x000000, "Member 'Sticker_C_NoRespawn::NoRespawn_0' has a wrong offset!");
