...
public:
	...
	class UTextureLightProfile*                   Temp_object_Variable;                              // 0x0018(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UTextureLightProfile*                   Temp_object_Variable_1;                            // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_RandomBoolWithWeight_ReturnValue_1;       // 0x0048(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UTextureLightProfile*                   K2Node_Select_Default;                             // 0x0168(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp) == 0x000178, "Wrong size on CeilingLamp_C_ExecuteUbergraph_ceilingLamp");
...
static_assert(offsetof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp, Temp_bool_Variable) == 0x000014, "Member 'CeilingLamp_C_ExecuteUbergraph_ceilingLamp::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp, Temp_object_Variable) == 0x000018, "Member 'CeilingLamp_C_ExecuteUbergraph_ceilingLamp::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp, Temp_object_Variable_1) == 0x000020, "Member 'CeilingLamp_C_ExecuteUbergraph_ceilingLamp::Temp_object_Variable_1' has a wrong offset!");
...
static_assert(offsetof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp, CallFunc_Subtract_FloatFloat_ReturnValue) == 0x00003C, "Member 'CeilingLamp_C_ExecuteUbergraph_ceilingLamp::CallFunc_Subtract_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp, CallFunc_RandomBoolWithWeight_ReturnValue) == 0x000040, "Member 'CeilingLamp_C_ExecuteUbergraph_ceilingLamp::CallFunc_RandomBoolWithWeight_ReturnValue' has a wrong offset!");
static_assert(offsetof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp, CallFunc_MultiplyMultiply_FloatFloat_ReturnValue) == 0x000044, "Member 'CeilingLamp_C_ExecuteUbergraph_ceilingLamp::CallFunc_MultiplyMultiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp, CallFunc_RandomBoolWithWeight_ReturnValue_1) == 0x000048, "Member 'CeilingLamp_C_ExecuteUbergraph_ceilingLamp::CallFunc_RandomBoolWithWeight_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp, CallFunc_Array_RemoveItem_ReturnValue) == 0x000049, "Member 'CeilingLamp_C_ExecuteUbergraph_ceilingLamp::CallFunc_Array_RemoveItem_ReturnValue' has a wrong offset!");
static_assert(offsetof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp, CallFunc_Not_PreBool_ReturnValue) == 0x00004A, "Member 'CeilingLamp_C_ExecuteUbergraph_ceilingLamp::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp, CallFunc_Not_PreBool_ReturnValue_1) == 0x00004B, "Member 'CeilingLamp_C_ExecuteUbergraph_ceilingLamp::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp, CallFunc_RandomFloatInRange_ReturnValue_1) == 0x00004C, "Member 'CeilingLamp_C_ExecuteUbergraph_ceilingLamp::CallFunc_RandomFloatInRange_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp, CallFunc_K2_GetComponentLocation_ReturnValue) == 0x000050, "Member 'CeilingLamp_C_ExecuteUbergraph_ceilingLamp::CallFunc_K2_GetComponentLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp, CallFunc_K2_GetComponentLocation_ReturnValue_1) == 0x00005C, "Member 'CeilingLamp_C_ExecuteUbergraph_ceilingLamp::CallFunc_K2_GetComponentLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp, K2Node_Event_settings) == 0x000068, "Member 'CeilingLamp_C_ExecuteUbergraph_ceilingLamp::K2Node_Event_settings' has a wrong offset!");
static_assert(offsetof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp, K2Node_Select_Default) == 0x000168, "Member 'CeilingLamp_C_ExecuteUbergraph_ceilingLamp::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(CeilingLamp_C_ExecuteUbergraph_ceilingLamp, CallFunc_Array_Add_ReturnValue) == 0x000170, "Member 'CeilingLamp_C_ExecuteUbergraph_ceilingLamp::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
...
struct CeilingLamp_C_SettingsApplied final
{
public:
	struct FStruct_settings                       Settings;                                          // 0x0000(0x0100)(BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
};
static_assert(alignof(CeilingLamp_C_SettingsApplied) == 0x000008, "Wrong alignment on CeilingLamp_C_SettingsApplied");
static_assert(sizeof(CeilingLamp_C_SettingsApplied) == 0x000100, "Wrong size on CeilingLamp_C_SettingsApplied");
static_assert(offsetof(CeilingLamp_C_SettingsApplied, Settings) == 0x000000, "Member 'CeilingLamp_C_SettingsApplied::Settings' has a wrong offset!");
...
{
public:
	bool                                          HasPower_0;                                        // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(CeilingLamp_C_Deactivate, HasPower_0) == 0x000000, "Member 'CeilingLamp_C_Deactivate::HasPower_0' has a wrong offset!");
...
static_assert(offsetof(CeilingLamp_C_SetActive, IsActive_0) == 0x000000, "Member 'CeilingLamp_C_SetActive::IsActive_0' has a wrong offset!");
