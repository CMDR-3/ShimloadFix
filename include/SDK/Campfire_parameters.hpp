...
static_assert(offsetof(Campfire_C_DreamInv, Base_0) == 0x000010, "Member 'Campfire_C_DreamInv::Base_0' has a wrong offset!");
...
static_assert(offsetof(Campfire_C_SetActiveTrigger, Active_0) == 0x000008, "Member 'Campfire_C_SetActiveTrigger::Active_0' has a wrong offset!");
...
static_assert(offsetof(Campfire_C_StuffUpgraded, GameMode_0) == 0x000000, "Member 'Campfire_C_StuffUpgraded::GameMode_0' has a wrong offset!");
...
static_assert(sizeof(Campfire_C_SettingsApplied) == 0x000100, "Wrong size on Campfire_C_SettingsApplied");
...
static_assert(offsetof(Campfire_C_AnyKey, Key_0) == 0x000000, "Member 'Campfire_C_AnyKey::Key_0' has a wrong offset!");
...
static_assert(offsetof(Campfire_C_TexturePickerApply, Index_0) == 0x000010, "Member 'Campfire_C_TexturePickerApply::Index_0' has a wrong offset!");
...
static_assert(offsetof(Campfire_C_RunTrigger, Owner_0) == 0x000000, "Member 'Campfire_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(Campfire_C_RunTrigger, Index_0) == 0x000008, "Member 'Campfire_C_RunTrigger::Index_0' has a wrong offset!");
...
public:
	...
	struct FLinearColor                           K2Node_Event_color;                                // 0x015C(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_16C[0x4];                                      // 0x016C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UUmg_texturePicker_C*                   K2Node_Event_picker;                               // 0x0170(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UTexture2D*                             K2Node_Event_texture;                              // 0x0178(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_Conv_IntToBool_ReturnValue;               // 0x0194(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(Campfire_C_ExecuteUbergraph_campfire) == 0x000198, "Wrong size on Campfire_C_ExecuteUbergraph_campfire");
...
static_assert(offsetof(Campfire_C_ExecuteUbergraph_campfire, K2Node_Event_key) == 0x000140, "Member 'Campfire_C_ExecuteUbergraph_campfire::K2Node_Event_key' has a wrong offset!");
static_assert(offsetof(Campfire_C_ExecuteUbergraph_campfire, K2Node_Event_pressed) == 0x000158, "Member 'Campfire_C_ExecuteUbergraph_campfire::K2Node_Event_pressed' has a wrong offset!");
static_assert(offsetof(Campfire_C_ExecuteUbergraph_campfire, K2Node_Event_color) == 0x00015C, "Member 'Campfire_C_ExecuteUbergraph_campfire::K2Node_Event_color' has a wrong offset!");
static_assert(offsetof(Campfire_C_ExecuteUbergraph_campfire, K2Node_Event_picker) == 0x000170, "Member 'Campfire_C_ExecuteUbergraph_campfire::K2Node_Event_picker' has a wrong offset!");
static_assert(offsetof(Campfire_C_ExecuteUbergraph_campfire, K2Node_Event_texture) == 0x000178, "Member 'Campfire_C_ExecuteUbergraph_campfire::K2Node_Event_texture' has a wrong offset!");
static_assert(offsetof(Campfire_C_ExecuteUbergraph_campfire, K2Node_Event_index_1) == 0x000180, "Member 'Campfire_C_ExecuteUbergraph_campfire::K2Node_Event_index_1' has a wrong offset!");
static_assert(offsetof(Campfire_C_ExecuteUbergraph_campfire, K2Node_Event_owner) == 0x000188, "Member 'Campfire_C_ExecuteUbergraph_campfire::K2Node_Event_owner' has a wrong offset!");
static_assert(offsetof(Campfire_C_ExecuteUbergraph_campfire, K2Node_Event_index) == 0x000190, "Member 'Campfire_C_ExecuteUbergraph_campfire::K2Node_Event_index' has a wrong offset!");
static_assert(offsetof(Campfire_C_ExecuteUbergraph_campfire, CallFunc_Conv_IntToBool_ReturnValue) == 0x000194, "Member 'Campfire_C_ExecuteUbergraph_campfire::CallFunc_Conv_IntToBool_ReturnValue' has a wrong offset!");
