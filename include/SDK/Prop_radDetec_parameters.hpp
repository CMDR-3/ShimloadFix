...
public:
	...
	float                                         CallFunc_GetWorldDeltaSeconds_ReturnValue_1;       // 0x00AC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_VictoryFloatMinusEquals_FloatOut;         // 0x00B4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(Prop_radDetec_C_ExecuteUbergraph_prop_radDetec) == 0x0000B8, "Wrong size on Prop_radDetec_C_ExecuteUbergraph_prop_radDetec");
...
static_assert(offsetof(Prop_radDetec_C_ExecuteUbergraph_prop_radDetec, CallFunc_FClamp_ReturnValue_1) == 0x000020, "Member 'Prop_radDetec_C_ExecuteUbergraph_prop_radDetec::CallFunc_FClamp_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_radDetec_C_ExecuteUbergraph_prop_radDetec, CallFunc_K2_SetRelativeRotation_SweepHitResult) == 0x000024, "Member 'Prop_radDetec_C_ExecuteUbergraph_prop_radDetec::CallFunc_K2_SetRelativeRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(Prop_radDetec_C_ExecuteUbergraph_prop_radDetec, CallFunc_GetWorldDeltaSeconds_ReturnValue_1) == 0x0000AC, "Member 'Prop_radDetec_C_ExecuteUbergraph_prop_radDetec::CallFunc_GetWorldDeltaSeconds_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_radDetec_C_ExecuteUbergraph_prop_radDetec, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x0000B0, "Member 'Prop_radDetec_C_ExecuteUbergraph_prop_radDetec::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_radDetec_C_ExecuteUbergraph_prop_radDetec, CallFunc_VictoryFloatMinusEquals_FloatOut) == 0x0000B4, "Member 'Prop_radDetec_C_ExecuteUbergraph_prop_radDetec::CallFunc_VictoryFloatMinusEquals_FloatOut' has a wrong offset!");
