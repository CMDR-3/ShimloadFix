...
{
public:
	bool                                          Isred_0;                                           // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(RedSkyEvent_C_Set, Isred_0) == 0x000000, "Member 'RedSkyEvent_C_Set::Isred_0' has a wrong offset!");
