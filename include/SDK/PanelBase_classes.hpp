...
static_assert(sizeof(APanelBase_C) == 0x000278, "Wrong size on APanelBase_C");
...
static_assert(offsetof(APanelBase_C, GameMode) == 0x000270, "Member 'APanelBase_C::GameMode' has a wrong offset!");
