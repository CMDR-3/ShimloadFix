...
public:
	...
	class AMainGamemode_C*                        GameMode;                                          // 0x0380(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ANewBlueprint14_C) == 0x000388, "Wrong size on ANewBlueprint14_C");
...
static_assert(offsetof(ANewBlueprint14_C, GameMode) == 0x000380, "Member 'ANewBlueprint14_C::GameMode' has a wrong offset!");
