...
public:
	...
	bool                                          MultVolumes;                                       // 0x0390(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	void NameToDisplayName(const class FString& Name_0, class FText* DisplayName);
	void GenDispNames();
	void SetPropNames();
	void SetObjNames();
	void GetItemIcon(const class FName& ItemToFind, class UTexture2D** Output);
...
static_assert(sizeof(APropProcessor_C) == 0x000398, "Wrong size on APropProcessor_C");
...
static_assert(offsetof(APropProcessor_C, MultVolumes) == 0x000390, "Member 'APropProcessor_C::MultVolumes' has a wrong offset!");
