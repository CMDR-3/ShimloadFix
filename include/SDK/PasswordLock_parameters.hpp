...
public:
	...
	bool                                          K2Node_CustomEvent_active_calc;                    // 0x0070(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_CustomEvent_active_downl;                   // 0x0071(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_CustomEvent_active_coords;                  // 0x0072(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_CustomEvent_active_play;                    // 0x0073(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_CustomEvent_active_light;                   // 0x0074(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_75[0x3];                                       // 0x0075(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class AMainPlayer_C*                          K2Node_Event_player_6;                             // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_Event_hit_2;                                // 0x0080(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	bool                                          K2Node_CustomEvent_active;                         // 0x0118(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          K2Node_Select_Default_1;                           // 0x0124(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AMainPlayer_C*                          K2Node_Event_player_3;                             // 0x0138(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_Event_hit_1;                                // 0x0140(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	class AMainPlayer_C*                          K2Node_Event_player_2;                             // 0x01C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_Event_owner;                                // 0x01D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_Event_index;                                // 0x01D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1DC[0x4];                                      // 0x01DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AMainPlayer_C*                          K2Node_Event_player_1;                             // 0x01E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UPrimitiveComponent*>            K2Node_MakeArray_Array;                            // 0x02B8(0x0010)(ReferenceParm, ContainsInstancedReference)
	...
	class UAudioComponent*                        CallFunc_SpawnSoundAttached_ReturnValue_3;         // 0x02F8(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BooleanOR_ReturnValue;                    // 0x0300(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_301[0x7];                                      // 0x0301(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AMainPlayer_C*                          CallFunc_getMainPlayer_AsMain_Player;              // 0x0308(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FKey                                   K2Node_CustomEvent_key;                            // 0x0310(0x0018)(HasGetValueTypeHash)
	bool                                          K2Node_CustomEvent_pressed;                        // 0x0328(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          Temp_bool_Variable_3;                              // 0x0329(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_32A[0x6];                                      // 0x032A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_Key_GetDisplayName_ReturnValue;           // 0x0330(0x0018)()
	...
	class FString                                 CallFunc_RegexReplace_ReturnValue;                 // 0x0368(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class AMainPlayer_C*                          K2Node_Event_player;                               // 0x0378(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_StrStr_ReturnValue_1;          // 0x0380(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_EqualEqual_StrStr_ReturnValue_2;          // 0x0381(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_382[0x2];                                      // 0x0382(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_Conv_StringToInt_ReturnValue;             // 0x0384(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsNumeric_ReturnValue;                    // 0x0388(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_389[0x3];                                      // 0x0389(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         K2Node_CustomEvent_num;                            // 0x038C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(bool Active_calc, bool Active_downl, bool Active_coords, bool Active_play, bool Active_light)> K2Node_CreateDelegate_OutputDelegate_1;            // 0x0390(0x0010)(ZeroConstructor, NoDestructor)
	bool                                          CallFunc_EqualEqual_StrStr_ReturnValue_3;          // 0x03A0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(PasswordLock_C_ExecuteUbergraph_passwordLock) == 0x0003A8, "Wrong size on PasswordLock_C_ExecuteUbergraph_passwordLock");
...
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_CustomEvent_active_calc) == 0x000070, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_CustomEvent_active_calc' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_CustomEvent_active_downl) == 0x000071, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_CustomEvent_active_downl' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_CustomEvent_active_coords) == 0x000072, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_CustomEvent_active_coords' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_CustomEvent_active_play) == 0x000073, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_CustomEvent_active_play' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_CustomEvent_active_light) == 0x000074, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_CustomEvent_active_light' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Event_player_6) == 0x000078, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Event_player_6' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Event_hit_2) == 0x000080, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Event_hit_2' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Event_damage) == 0x000108, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Event_damage' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Event_player_5) == 0x000110, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Event_player_5' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_CustomEvent_active) == 0x000118, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_CustomEvent_active' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Event_name) == 0x00011C, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Event_name' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Select_Default_1) == 0x000124, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Select_Default_1' has a wrong offset!");
...
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Event_kick) == 0x000130, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Event_kick' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Event_player_3) == 0x000138, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Event_player_3' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Event_hit_1) == 0x000140, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Event_hit_1' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Event_player_2) == 0x0001C8, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Event_player_2' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Event_owner) == 0x0001D0, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Event_owner' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Event_index) == 0x0001D8, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Event_index' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Event_player_1) == 0x0001E0, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Event_player_1' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Event_hit) == 0x0001E8, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Event_action) == 0x000270, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_SpawnSoundAttached_ReturnValue) == 0x000278, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_SpawnSoundAttached_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_SpawnSoundAttached_ReturnValue_1) == 0x000298, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_SpawnSoundAttached_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_SpawnSoundAttached_ReturnValue_2) == 0x0002B0, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_SpawnSoundAttached_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_MakeArray_Array) == 0x0002B8, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_GreaterEqual_IntInt_ReturnValue_1) == 0x0002C8, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_GreaterEqual_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_Conv_IntToString_ReturnValue) == 0x0002D0, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_Conv_IntToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_Concat_StrStr_ReturnValue) == 0x0002E0, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_EqualEqual_StrStr_ReturnValue) == 0x0002F0, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_EqualEqual_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_SpawnSoundAttached_ReturnValue_3) == 0x0002F8, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_SpawnSoundAttached_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_BooleanOR_ReturnValue) == 0x000300, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_getMainPlayer_AsMain_Player) == 0x000308, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_getMainPlayer_AsMain_Player' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_CustomEvent_key) == 0x000310, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_CustomEvent_key' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_CustomEvent_pressed) == 0x000328, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_CustomEvent_pressed' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, Temp_bool_Variable_3) == 0x000329, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::Temp_bool_Variable_3' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_Key_GetDisplayName_ReturnValue) == 0x000330, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_Key_GetDisplayName_ReturnValue' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Select_Default_2) == 0x000348, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Select_Default_2' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_Conv_TextToString_ReturnValue) == 0x000350, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_SpawnSoundAttached_ReturnValue_4) == 0x000360, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_SpawnSoundAttached_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_RegexReplace_ReturnValue) == 0x000368, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_RegexReplace_ReturnValue' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_Event_player) == 0x000378, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_EqualEqual_StrStr_ReturnValue_1) == 0x000380, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_EqualEqual_StrStr_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_EqualEqual_StrStr_ReturnValue_2) == 0x000381, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_EqualEqual_StrStr_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_Conv_StringToInt_ReturnValue) == 0x000384, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_Conv_StringToInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_IsNumeric_ReturnValue) == 0x000388, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_IsNumeric_ReturnValue' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_CustomEvent_num) == 0x00038C, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_CustomEvent_num' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, K2Node_CreateDelegate_OutputDelegate_1) == 0x000390, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ExecuteUbergraph_passwordLock, CallFunc_EqualEqual_StrStr_ReturnValue_3) == 0x0003A0, "Member 'PasswordLock_C_ExecuteUbergraph_passwordLock::CallFunc_EqualEqual_StrStr_ReturnValue_3' has a wrong offset!");
...
static_assert(offsetof(PasswordLock_C_InputNumber, Num_0) == 0x000000, "Member 'PasswordLock_C_InputNumber::Num_0' has a wrong offset!");
...
static_assert(offsetof(PasswordLock_C_PlayerAnykey, Key_0) == 0x000000, "Member 'PasswordLock_C_PlayerAnykey::Key_0' has a wrong offset!");
...
static_assert(offsetof(PasswordLock_C_RunTrigger, Owner_0) == 0x000000, "Member 'PasswordLock_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_RunTrigger, Index_0) == 0x000008, "Member 'PasswordLock_C_RunTrigger::Index_0' has a wrong offset!");
...
static_assert(offsetof(PasswordLock_C_SendName, Name_0) == 0x000000, "Member 'PasswordLock_C_SendName::Name_0' has a wrong offset!");
...
static_assert(offsetof(PasswordLock_C_Open, Active_0) == 0x000000, "Member 'PasswordLock_C_Open::Active_0' has a wrong offset!");
...
static_assert(offsetof(PasswordLock_C_NoRespawn, NoRespawn_0) == 0x000000, "Member 'PasswordLock_C_NoRespawn::NoRespawn_0' has a wrong offset!");
...
public:
	...
	class ADoor_C*                                K2Node_DynamicCast_AsDoor;                         // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class APasswordLock_C*                        K2Node_DynamicCast_AsPassword_Lock;                // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(PasswordLock_C_ProcessKeys) == 0x000038, "Wrong size on PasswordLock_C_ProcessKeys");
...
static_assert(offsetof(PasswordLock_C_ProcessKeys, CallFunc_getObjectFromKey_Output) == 0x000008, "Member 'PasswordLock_C_ProcessKeys::CallFunc_getObjectFromKey_Output' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ProcessKeys, K2Node_DynamicCast_AsDoor) == 0x000010, "Member 'PasswordLock_C_ProcessKeys::K2Node_DynamicCast_AsDoor' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ProcessKeys, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'PasswordLock_C_ProcessKeys::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ProcessKeys, CallFunc_getObjectFromKey_Output_1) == 0x000020, "Member 'PasswordLock_C_ProcessKeys::CallFunc_getObjectFromKey_Output_1' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ProcessKeys, K2Node_DynamicCast_AsPassword_Lock) == 0x000028, "Member 'PasswordLock_C_ProcessKeys::K2Node_DynamicCast_AsPassword_Lock' has a wrong offset!");
static_assert(offsetof(PasswordLock_C_ProcessKeys, K2Node_DynamicCast_bSuccess_1) == 0x000030, "Member 'PasswordLock_C_ProcessKeys::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
