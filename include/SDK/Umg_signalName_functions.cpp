...
// Parameters:
// class USignalSlot_C*                    Rename_0                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UUmg_signalName_C::Init(class USignalSlot_C* Rename_0)
{
	static class UFunction* Func = nullptr;
