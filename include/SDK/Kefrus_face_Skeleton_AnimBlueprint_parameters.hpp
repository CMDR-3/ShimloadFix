...
static_assert(offsetof(Kefrus_face_Skeleton_AnimBlueprint_C_AnimGraph, AnimGraph_0) == 0x000000, "Member 'Kefrus_face_Skeleton_AnimBlueprint_C_AnimGraph::AnimGraph_0' has a wrong offset!");
