...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UUmg_settings_C*                  Parent_0                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UUmg_settingsSlot_C::begin(class UUmg_settings_C* Parent_0)
{
	static class UFunction* Func = nullptr;
