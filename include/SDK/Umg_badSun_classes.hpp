...
static_assert(sizeof(UUmg_badSun_C) == 0x0002C0, "Wrong size on UUmg_badSun_C");
...
static_assert(offsetof(UUmg_badSun_C, GameMode) == 0x0002B8, "Member 'UUmg_badSun_C::GameMode' has a wrong offset!");
