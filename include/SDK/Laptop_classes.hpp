...
public:
	...
	class AMainGamemode_C*                        GameMode;                                          // 0x0280(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ALaptop_C) == 0x000288, "Wrong size on ALaptop_C");
...
static_assert(offsetof(ALaptop_C, GameMode) == 0x000280, "Member 'ALaptop_C::GameMode' has a wrong offset!");
