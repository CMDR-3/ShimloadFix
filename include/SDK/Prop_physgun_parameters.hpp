...
{
public:
	struct FVector2D                              MouseXY_0;                                         // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(Prop_physgun_C_MouseXY, MouseXY_0) == 0x000000, "Member 'Prop_physgun_C_MouseXY::MouseXY_0' has a wrong offset!");
