...
public:
	...
	static void boyoancyForce(class UPrimitiveComponent* Component, float boyoancyForce_0, float Surface, float PowerDepth, float MaxPower, float Damping);
	static bool CanBoxFitInBox(const struct FVector& big, const struct FVector& Small1);
	...
	static void MeshConvexVolume2(class UStaticMesh* StaticMesh, float* Volume);
	...
	static void ReturnMeshTemplateData(int32 Indexer, class FString* Rstring);
	...
	static void WeightedRandomV2(const TArray<float>& Weights, int32* Index_0);
	static void WeightedRandomV2_exponent(const TArray<float>& Weights, float Exponent, int32* Index_0);
	static void WeightedRandomV2_lerp(const TArray<float>& Weights, float Ulerp, int32* Index_0);
