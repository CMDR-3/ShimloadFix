...
static_assert(offsetof(Prop_landmine_C_SetPropProps, Static_0) == 0x000000, "Member 'Prop_landmine_C_SetPropProps::Static_0' has a wrong offset!");
static_assert(offsetof(Prop_landmine_C_SetPropProps, Frozen_0) == 0x000001, "Member 'Prop_landmine_C_SetPropProps::Frozen_0' has a wrong offset!");
static_assert(offsetof(Prop_landmine_C_SetPropProps, Active_0) == 0x000002, "Member 'Prop_landmine_C_SetPropProps::Active_0' has a wrong offset!");
