...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Prop_nailgun_C;                     // 0x0358(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(AProp_nailgun_C) == 0x000360, "Wrong size on AProp_nailgun_C");
static_assert(offsetof(AProp_nailgun_C, UberGraphFrame_Prop_nailgun_C) == 0x000358, "Member 'AProp_nailgun_C::UberGraphFrame_Prop_nailgun_C' has a wrong offset!");
