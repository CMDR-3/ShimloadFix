...
public:
	...
	struct FStruct_food                           CallFunc_propToObject_foodData;                    // 0x00FC(0x001C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FStruct_prop3                          CallFunc_propToObject_fuckYouRetard;               // 0x0128(0x0080)(HasGetValueTypeHash)
...
static_assert(offsetof(Prop_fishSteak_C_Cooked, Temp_name_Variable_6) == 0x000034, "Member 'Prop_fishSteak_C_Cooked::Temp_name_Variable_6' has a wrong offset!");
static_assert(offsetof(Prop_fishSteak_C_Cooked, Temp_name_Variable_7) == 0x00003C, "Member 'Prop_fishSteak_C_Cooked::Temp_name_Variable_7' has a wrong offset!");
static_assert(offsetof(Prop_fishSteak_C_Cooked, Temp_name_Variable_8) == 0x000044, "Member 'Prop_fishSteak_C_Cooked::Temp_name_Variable_8' has a wrong offset!");
static_assert(offsetof(Prop_fishSteak_C_Cooked, Temp_name_Variable_9) == 0x00004C, "Member 'Prop_fishSteak_C_Cooked::Temp_name_Variable_9' has a wrong offset!");
static_assert(offsetof(Prop_fishSteak_C_Cooked, Temp_name_Variable_10) == 0x000054, "Member 'Prop_fishSteak_C_Cooked::Temp_name_Variable_10' has a wrong offset!");
static_assert(offsetof(Prop_fishSteak_C_Cooked, Temp_name_Variable_11) == 0x00005C, "Member 'Prop_fishSteak_C_Cooked::Temp_name_Variable_11' has a wrong offset!");
static_assert(offsetof(Prop_fishSteak_C_Cooked, Temp_name_Variable_12) == 0x000064, "Member 'Prop_fishSteak_C_Cooked::Temp_name_Variable_12' has a wrong offset!");
static_assert(offsetof(Prop_fishSteak_C_Cooked, Temp_name_Variable_13) == 0x00006C, "Member 'Prop_fishSteak_C_Cooked::Temp_name_Variable_13' has a wrong offset!");
static_assert(offsetof(Prop_fishSteak_C_Cooked, Temp_name_Variable_14) == 0x000074, "Member 'Prop_fishSteak_C_Cooked::Temp_name_Variable_14' has a wrong offset!");
static_assert(offsetof(Prop_fishSteak_C_Cooked, Temp_int_Variable_1) == 0x00007C, "Member 'Prop_fishSteak_C_Cooked::Temp_int_Variable_1' has a wrong offset!");
static_assert(offsetof(Prop_fishSteak_C_Cooked, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000080, "Member 'Prop_fishSteak_C_Cooked::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fishSteak_C_Cooked, CallFunc_Add_IntInt_ReturnValue) == 0x000084, "Member 'Prop_fishSteak_C_Cooked::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fishSteak_C_Cooked, Temp_int_Variable_2) == 0x000088, "Member 'Prop_fishSteak_C_Cooked::Temp_int_Variable_2' has a wrong offset!");
static_assert(offsetof(Prop_fishSteak_C_Cooked, CallFunc_LessEqual_IntInt_ReturnValue_1) == 0x00008C, "Member 'Prop_fishSteak_C_Cooked::CallFunc_LessEqual_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fishSteak_C_Cooked, CallFunc_Add_IntInt_ReturnValue_1) == 0x000090, "Member 'Prop_fishSteak_C_Cooked::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fishSteak_C_Cooked, Temp_int_Variable_3) == 0x000094, "Member 'Prop_fishSteak_C_Cooked::Temp_int_Variable_3' has a wrong offset!");
...
static_assert(offsetof(Prop_fishSteak_C_Cooked, CallFunc_propToObject_fuckYouRetard) == 0x000128, "Member 'Prop_fishSteak_C_Cooked::CallFunc_propToObject_fuckYouRetard' has a wrong offset!");
