...
public:
	...
	bool                                          CallFunc_addFood_full;                             // 0x00B1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(Prop_arirGamerYogur_C_ExecuteUbergraph_prop_arirGamerYogur, K2Node_Event_action) == 0x0000B0, "Member 'Prop_arirGamerYogur_C_ExecuteUbergraph_prop_arirGamerYogur::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Prop_arirGamerYogur_C_ExecuteUbergraph_prop_arirGamerYogur, CallFunc_addFood_full) == 0x0000B1, "Member 'Prop_arirGamerYogur_C_ExecuteUbergraph_prop_arirGamerYogur::CallFunc_addFood_full' has a wrong offset!");
static_assert(offsetof(Prop_arirGamerYogur_C_ExecuteUbergraph_prop_arirGamerYogur, K2Node_SwitchEnum_CmpSuccess) == 0x0000B2, "Member 'Prop_arirGamerYogur_C_ExecuteUbergraph_prop_arirGamerYogur::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
...
static_assert(offsetof(Prop_arirGamerYogur_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_arirGamerYogur_C_ActionOptionIndex::Hit_0' has a wrong offset!");
static_assert(offsetof(Prop_arirGamerYogur_C_ActionOptionIndex, Action) == 0x000090, "Member 'Prop_arirGamerYogur_C_ActionOptionIndex::Action' has a wrong offset!");
