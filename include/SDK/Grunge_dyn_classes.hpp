...
// BlueprintGeneratedClass grunge_dyn.grunge_dyn_C
// 0x0008 (0x0258 - 0x0250)
class AGrunge_dyn_C final : public AGrunge_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Grunge_dyn_C;                       // 0x0250(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_grunge_dyn(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"grunge_dyn_C">();
	}
	static class AGrunge_dyn_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AGrunge_dyn_C>();
	}
};
static_assert(alignof(AGrunge_dyn_C) == 0x000008, "Wrong alignment on AGrunge_dyn_C");
static_assert(sizeof(AGrunge_dyn_C) == 0x000258, "Wrong size on AGrunge_dyn_C");
static_assert(offsetof(AGrunge_dyn_C, UberGraphFrame_Grunge_dyn_C) == 0x000250, "Member 'AGrunge_dyn_C::UberGraphFrame_Grunge_dyn_C' has a wrong offset!");
