...
public:
	...
	int32                                         CallFunc_conv_ReturnValue;                         // 0x0004(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UTableclockArrows_Skeleton_AnimBlueprint_C* K2Node_DynamicCast_AsTableclock_Arrows_Skeleton_Anim_Blueprint; // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          K2Node_SwitchString_CmpSuccess;                    // 0x010C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	int32                                         CallFunc_VictoryIntPlusEquals_IntOut;              // 0x0114(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_conv_ReturnValue_1;                       // 0x011C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_conv_ReturnValue_2;                       // 0x0120(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                   CallFunc_Conv_BoolToText_ReturnValue;              // 0x0170(0x0018)()
	...
	int32                                         CallFunc_conv_ReturnValue_3;                       // 0x0204(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock) == 0x000218, "Wrong size on Prop_tableclock_C_ExecuteUbergraph_prop_tableclock");
...
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_conv_ReturnValue) == 0x000004, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_conv_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, K2Node_MakeStruct_FormatArgumentData) == 0x000010, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, K2Node_DynamicCast_AsTableclock_Arrows_Skeleton_Anim_Blueprint) == 0x000050, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::K2Node_DynamicCast_AsTableclock_Arrows_Skeleton_Anim_Blueprint' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, K2Node_DynamicCast_bSuccess) == 0x000058, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, K2Node_Event_DeltaSeconds) == 0x00005C, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, Temp_int_Variable) == 0x000060, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, K2Node_Event_player) == 0x000068, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, K2Node_Event_hit) == 0x000070, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, K2Node_Event_name) == 0x0000F8, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::K2Node_Event_name' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_Percent_IntInt_ReturnValue) == 0x000108, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_Percent_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, K2Node_SwitchString_CmpSuccess) == 0x00010C, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::K2Node_SwitchString_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_Not_PreBool_ReturnValue) == 0x00010D, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_Add_IntInt_ReturnValue) == 0x000110, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_VictoryIntPlusEquals_IntOut) == 0x000114, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_VictoryIntPlusEquals_IntOut' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_Percent_IntInt_ReturnValue_1) == 0x000118, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_Percent_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_conv_ReturnValue_1) == 0x00011C, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_conv_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_conv_ReturnValue_2) == 0x000120, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_conv_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, K2Node_MakeStruct_FormatArgumentData_1) == 0x000128, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_Greater_IntInt_ReturnValue) == 0x000168, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_Conv_BoolToText_ReturnValue) == 0x000170, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_Conv_BoolToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, K2Node_MakeStruct_FormatArgumentData_2) == 0x000188, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::K2Node_MakeStruct_FormatArgumentData_2' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, K2Node_MakeArray_Array) == 0x0001C8, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_Format_ReturnValue) == 0x0001D8, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_Conv_TextToString_ReturnValue) == 0x0001F0, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_NotEqual_IntInt_ReturnValue) == 0x000200, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_NotEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_conv_ReturnValue_3) == 0x000204, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_conv_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000208, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x00020C, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ExecuteUbergraph_prop_tableclock, CallFunc_Conv_IntToFloat_ReturnValue_1) == 0x000210, "Member 'Prop_tableclock_C_ExecuteUbergraph_prop_tableclock::CallFunc_Conv_IntToFloat_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(Prop_tableclock_C_ActionName, Hit_0) == 0x000008, "Member 'Prop_tableclock_C_ActionName::Hit_0' has a wrong offset!");
static_assert(offsetof(Prop_tableclock_C_ActionName, Name_0) == 0x000090, "Member 'Prop_tableclock_C_ActionName::Name_0' has a wrong offset!");
...
static_assert(offsetof(Prop_tableclock_C_LookAt, Hit_0) == 0x000008, "Member 'Prop_tableclock_C_LookAt::Hit_0' has a wrong offset!");
