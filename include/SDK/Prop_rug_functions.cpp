...
void AProp_rug_C::ActionOptionIndex(class AMainPlayer_C* Player, const struct FHitResult& Hit_0, Enum_interactionActions Action)
{
	static class UFunction* Func = nullptr;
...
void AProp_rug_C::SetPropProps(bool Static_0, bool Frozen_0, bool Active)
{
	static class UFunction* Func = nullptr;
...
void AProp_rug_C::SendName(class FName Name_0)
{
	static class UFunction* Func = nullptr;
