...
public:
	...
	struct FKey                                   K2Node_Event_key;                                  // 0x0030(0x0018)(HasGetValueTypeHash)
	bool                                          K2Node_Event_pressed;                              // 0x0048(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_IsChildActor_ReturnValue;                 // 0x0170(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AActor*                                 K2Node_Event_sentFrom;                             // 0x0248(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_active;                               // 0x0250(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_251[0x7];                                      // 0x0251(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AMainGamemode_C*                        K2Node_Event_gamemode;                             // 0x0258(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ACord_C*                                K2Node_Event_cord_1;                               // 0x0268(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACordSocket_C*                          K2Node_Event_socket_1;                             // 0x0270(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACord_C*                                K2Node_Event_cord;                                 // 0x0278(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACordSocket_C*                          K2Node_Event_socket;                               // 0x0280(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_NewParam;                             // 0x0288(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_289[0x7];                                      // 0x0289(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 K2Node_Event_owner;                                // 0x0290(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(CordSocket_C_ExecuteUbergraph_cordSocket) == 0x0002A0, "Wrong size on CordSocket_C_ExecuteUbergraph_cordSocket");
...
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_picker) == 0x000008, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_picker' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_texture) == 0x000010, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_texture' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_index_1) == 0x000018, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_index_1' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_color) == 0x00001C, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_color' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_key) == 0x000030, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_key' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_pressed) == 0x000048, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_pressed' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_ComponentBoundEvent_OverlappedComponent) == 0x000050, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_ComponentBoundEvent_OverlappedComponent' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_ComponentBoundEvent_OtherActor) == 0x000058, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_ComponentBoundEvent_OtherActor' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_ComponentBoundEvent_OtherComp) == 0x000060, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_ComponentBoundEvent_OtherComp' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_ComponentBoundEvent_OtherBodyIndex) == 0x000068, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_ComponentBoundEvent_OtherBodyIndex' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_settings) == 0x000070, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_settings' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, CallFunc_IsChildActor_ReturnValue) == 0x000170, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::CallFunc_IsChildActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, CallFunc_GetParentActor_ReturnValue) == 0x000178, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::CallFunc_GetParentActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_DynamicCast_AsInt_Player) == 0x000180, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_DynamicCast_AsInt_Player' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_DynamicCast_bSuccess) == 0x000190, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_ComponentBoundEvent_OverlappedComponent_1) == 0x000198, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_ComponentBoundEvent_OverlappedComponent_1' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_ComponentBoundEvent_OtherActor_1) == 0x0001A0, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_ComponentBoundEvent_OtherActor_1' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_ComponentBoundEvent_OtherComp_1) == 0x0001A8, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_ComponentBoundEvent_OtherComp_1' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_ComponentBoundEvent_OtherBodyIndex_1) == 0x0001B0, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_ComponentBoundEvent_OtherBodyIndex_1' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_ComponentBoundEvent_bFromSweep) == 0x0001B4, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_ComponentBoundEvent_bFromSweep' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_ComponentBoundEvent_SweepResult) == 0x0001B8, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_ComponentBoundEvent_SweepResult' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, CallFunc_asProp_return) == 0x000240, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::CallFunc_asProp_return' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_sentFrom) == 0x000248, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_sentFrom' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_active) == 0x000250, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_active' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_gamemode) == 0x000258, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_gamemode' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, CallFunc_IsValid_ReturnValue) == 0x000260, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, CallFunc_Array_Add_ReturnValue) == 0x000264, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_cord_1) == 0x000268, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_cord_1' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_socket_1) == 0x000270, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_socket_1' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_cord) == 0x000278, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_cord' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_socket) == 0x000280, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_socket' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_NewParam) == 0x000288, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_NewParam' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_owner) == 0x000290, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_owner' has a wrong offset!");
static_assert(offsetof(CordSocket_C_ExecuteUbergraph_cordSocket, K2Node_Event_index) == 0x000298, "Member 'CordSocket_C_ExecuteUbergraph_cordSocket::K2Node_Event_index' has a wrong offset!");
...
static_assert(offsetof(CordSocket_C_RunTrigger, Owner_0) == 0x000000, "Member 'CordSocket_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(CordSocket_C_RunTrigger, Index_0) == 0x000008, "Member 'CordSocket_C_RunTrigger::Index_0' has a wrong offset!");
...
static_assert(offsetof(CordSocket_C_CordPlugged, Cord_0) == 0x000000, "Member 'CordSocket_C_CordPlugged::Cord_0' has a wrong offset!");
...
static_assert(offsetof(CordSocket_C_CordUnplugged, Cord_0) == 0x000000, "Member 'CordSocket_C_CordUnplugged::Cord_0' has a wrong offset!");
...
static_assert(offsetof(CordSocket_C_StuffUpgraded, GameMode_0) == 0x000000, "Member 'CordSocket_C_StuffUpgraded::GameMode_0' has a wrong offset!");
...
static_assert(sizeof(CordSocket_C_SettingsApplied) == 0x000100, "Wrong size on CordSocket_C_SettingsApplied");
...
static_assert(offsetof(CordSocket_C_AnyKey, Key_0) == 0x000000, "Member 'CordSocket_C_AnyKey::Key_0' has a wrong offset!");
...
static_assert(offsetof(CordSocket_C_TexturePickerApply, Index_0) == 0x000010, "Member 'CordSocket_C_TexturePickerApply::Index_0' has a wrong offset!");
...
static_assert(offsetof(CordSocket_C_IgnoreSave, Param_IgnoreSave_0) == 0x000000, "Member 'CordSocket_C_IgnoreSave::Param_IgnoreSave_0' has a wrong offset!");
...
// Function cordSocket.cordSocket_C.gatherDataFromKey
// 0x0001 (0x0001 - 0x0000)
struct CordSocket_C_GatherDataFromKey final
{
public:
	bool                                          Gather;                                            // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(CordSocket_C_GatherDataFromKey) == 0x000001, "Wrong alignment on CordSocket_C_GatherDataFromKey");
static_assert(sizeof(CordSocket_C_GatherDataFromKey) == 0x000001, "Wrong size on CordSocket_C_GatherDataFromKey");
static_assert(offsetof(CordSocket_C_GatherDataFromKey, Gather) == 0x000000, "Member 'CordSocket_C_GatherDataFromKey::Gather' has a wrong offset!");
