...
static_assert(sizeof(Prop_lamp_C_ExecuteUbergraph_prop_lamp) == 0x000180, "Wrong size on Prop_lamp_C_ExecuteUbergraph_prop_lamp");
...
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, K2Node_Event_DeltaSeconds) == 0x000004, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, K2Node_ComponentBoundEvent_HitComponent) == 0x000008, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::K2Node_ComponentBoundEvent_HitComponent' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, K2Node_ComponentBoundEvent_OtherActor) == 0x000010, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::K2Node_ComponentBoundEvent_OtherActor' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, K2Node_ComponentBoundEvent_OtherComp) == 0x000018, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::K2Node_ComponentBoundEvent_OtherComp' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, K2Node_ComponentBoundEvent_NormalImpulse) == 0x000020, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::K2Node_ComponentBoundEvent_NormalImpulse' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, K2Node_ComponentBoundEvent_Hit) == 0x00002C, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::K2Node_ComponentBoundEvent_Hit' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x0000B4, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, CallFunc_Divide_FloatFloat_ReturnValue) == 0x0000B8, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, CallFunc_VictoryFloatMinusEquals_FloatOut) == 0x0000BC, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::CallFunc_VictoryFloatMinusEquals_FloatOut' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, CallFunc_FMax_ReturnValue) == 0x0000C0, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::CallFunc_FMax_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, CallFunc_Conv_FloatToString_ReturnValue) == 0x0000C8, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::CallFunc_Conv_FloatToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, CallFunc_Less_FloatFloat_ReturnValue) == 0x0000D8, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::CallFunc_Less_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, CallFunc_Greater_FloatFloat_ReturnValue) == 0x0000D9, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::CallFunc_Greater_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, CallFunc_Not_PreBool_ReturnValue) == 0x0000DA, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, K2Node_Event_player_1) == 0x0000E0, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::K2Node_Event_player_1' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, K2Node_Event_hit) == 0x0000E8, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, K2Node_Event_action) == 0x000170, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, K2Node_SwitchEnum_CmpSuccess) == 0x000171, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ExecuteUbergraph_prop_lamp, K2Node_Event_player) == 0x000178, "Member 'Prop_lamp_C_ExecuteUbergraph_prop_lamp::K2Node_Event_player' has a wrong offset!");
...
static_assert(offsetof(Prop_lamp_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_lamp_C_ActionOptionIndex::Hit_0' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_ActionOptionIndex, Action) == 0x000090, "Member 'Prop_lamp_C_ActionOptionIndex::Action' has a wrong offset!");
...
static_assert(offsetof(Prop_lamp_C_BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature, Hit_0) == 0x000024, "Member 'Prop_lamp_C_BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature::Hit_0' has a wrong offset!");
...
static_assert(sizeof(Prop_lamp_C_LookAt) == 0x000128, "Wrong size on Prop_lamp_C_LookAt");
static_assert(offsetof(Prop_lamp_C_LookAt, Player) == 0x000000, "Member 'Prop_lamp_C_LookAt::Player' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_LookAt, Hit_0) == 0x000008, "Member 'Prop_lamp_C_LookAt::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_lamp_C_LookAt, Number) == 0x0000B0, "Member 'Prop_lamp_C_LookAt::Number' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_LookAt, CallFunc_MakeLiteralText_ReturnValue) == 0x0000B8, "Member 'Prop_lamp_C_LookAt::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_LookAt, CallFunc_Conv_TextToString_ReturnValue) == 0x0000D0, "Member 'Prop_lamp_C_LookAt::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_LookAt, CallFunc_Conv_FloatToText_ReturnValue) == 0x0000E0, "Member 'Prop_lamp_C_LookAt::CallFunc_Conv_FloatToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_LookAt, CallFunc_Concat_StrStr_ReturnValue) == 0x0000F8, "Member 'Prop_lamp_C_LookAt::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_LookAt, CallFunc_Conv_TextToString_ReturnValue_1) == 0x000108, "Member 'Prop_lamp_C_LookAt::CallFunc_Conv_TextToString_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_LookAt, CallFunc_Concat_StrStr_ReturnValue_1) == 0x000118, "Member 'Prop_lamp_C_LookAt::CallFunc_Concat_StrStr_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(Prop_lamp_C_GetActionOptions) == 0x000060, "Wrong size on Prop_lamp_C_GetActionOptions");
...
static_assert(offsetof(Prop_lamp_C_GetActionOptions, Number) == 0x000048, "Member 'Prop_lamp_C_GetActionOptions::Number' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_GetActionOptions, K2Node_MakeArray_Array) == 0x000050, "Member 'Prop_lamp_C_GetActionOptions::K2Node_MakeArray_Array' has a wrong offset!");

// Function prop_lamp.prop_lamp_C.gascanFuel
// 0x0010 (0x0010 - 0x0000)
struct Prop_lamp_C_GascanFuel final
{
public:
...
static_assert(alignof(Prop_lamp_C_GascanFuel) == 0x000008, "Wrong alignment on Prop_lamp_C_GascanFuel");
static_assert(sizeof(Prop_lamp_C_GascanFuel) == 0x000010, "Wrong size on Prop_lamp_C_GascanFuel");
static_assert(offsetof(Prop_lamp_C_GascanFuel, Gascan) == 0x000000, "Member 'Prop_lamp_C_GascanFuel::Gascan' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_GascanFuel, Fueled) == 0x000008, "Member 'Prop_lamp_C_GascanFuel::Fueled' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_GascanFuel, CallFunc_getFuel_hasFueled) == 0x000009, "Member 'Prop_lamp_C_GascanFuel::CallFunc_getFuel_hasFueled' has a wrong offset!");
static_assert(offsetof(Prop_lamp_C_GascanFuel, CallFunc_getFuel_changed) == 0x00000A, "Member 'Prop_lamp_C_GascanFuel::CallFunc_getFuel_changed' has a wrong offset!");
