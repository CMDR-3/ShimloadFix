...
static_assert(offsetof(Prop_coffeeMaker_C_CordUnplugged, Cord_0) == 0x000000, "Member 'Prop_coffeeMaker_C_CordUnplugged::Cord_0' has a wrong offset!");
...
static_assert(offsetof(Prop_coffeeMaker_C_CordPlugged, Cord_0) == 0x000000, "Member 'Prop_coffeeMaker_C_CordPlugged::Cord_0' has a wrong offset!");
...
static_assert(offsetof(Prop_coffeeMaker_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_coffeeMaker_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_coffeeMaker_C_BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature, Hit_0) == 0x000024, "Member 'Prop_coffeeMaker_C_BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_coffeeMaker_C_RunTrigger, Owner_0) == 0x000000, "Member 'Prop_coffeeMaker_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(Prop_coffeeMaker_C_RunTrigger, Index_0) == 0x000008, "Member 'Prop_coffeeMaker_C_RunTrigger::Index_0' has a wrong offset!");
...
public:
	...
	class ACordSocket_C*                          CallFunc_tryToConnect_AsCord_Socket;               // 0x01A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Prop_coffeeMaker_C_LoadData, CallFunc_tryToConnect_AsCord_Socket) == 0x0001A0, "Member 'Prop_coffeeMaker_C_LoadData::CallFunc_tryToConnect_AsCord_Socket' has a wrong offset!");
static_assert(offsetof(Prop_coffeeMaker_C_LoadData, CallFunc_loadData_return) == 0x0001A8, "Member 'Prop_coffeeMaker_C_LoadData::CallFunc_loadData_return' has a wrong offset!");
static_assert(offsetof(Prop_coffeeMaker_C_LoadData, CallFunc_IsValid_ReturnValue) == 0x0001A9, "Member 'Prop_coffeeMaker_C_LoadData::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Prop_coffeeMaker_C_LookAt, Hit_0) == 0x000008, "Member 'Prop_coffeeMaker_C_LookAt::Hit_0' has a wrong offset!");
