...
// Function daynightCycle.daynightCycle_C.gamemodePostKeys
// (Public, BlueprintCallable, BlueprintEvent)

void ADaynightCycle_C::GamemodePostKeys()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("daynightCycle_C", "gamemodePostKeys");

	UObject::ProcessEvent(Func, nullptr);
}


// Function daynightCycle.daynightCycle_C.NewFunction_3
// (Public, BlueprintCallable, BlueprintEvent)

void ADaynightCycle_C::NewFunction_3()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("daynightCycle_C", "NewFunction_3");

	UObject::ProcessEvent(Func, nullptr);
}


// Function daynightCycle.daynightCycle_C.NewFunction_2
// (Public, BlueprintCallable, BlueprintEvent)

void ADaynightCycle_C::NewFunction_2()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("daynightCycle_C", "NewFunction_2");
...
void ADaynightCycle_C::TexturePickerApply(class UUmg_texturePicker_C* Picker, class UTexture2D* Texture, int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
void ADaynightCycle_C::StuffUpgraded(class AMainGamemode_C* GameMode_0)
{
	static class UFunction* Func = nullptr;
...
// Function daynightCycle.daynightCycle_C.Timeline_0__UpdateFunc
// (BlueprintEvent)

void ADaynightCycle_C::Timeline_0__UpdateFunc()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("daynightCycle_C", "Timeline_0__UpdateFunc");

	UObject::ProcessEvent(Func, nullptr);
}


// Function daynightCycle.daynightCycle_C.Timeline_0__FinishedFunc
// (BlueprintEvent)

void ADaynightCycle_C::Timeline_0__FinishedFunc()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("daynightCycle_C", "Timeline_0__FinishedFunc");
...
// float                                   Day_0                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ADaynightCycle_C::Loadtime(float TotalTime_0, float Day_0)
{
	static class UFunction* Func = nullptr;
