...
public:
	...
	TArray<class FName>                           Gibs;                                              // 0x07E0(0x0010)(Edit, BlueprintVisible)
	...
	class AMainGamemode_C*                        GameMode;                                          // 0x0830(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void GrabAnimation(bool Forward_0);
	...
	void FailCar();
	void SitOnCar(class ACar1_C* OccupyCar_0);
	void GetOffCar(bool Kill_0);
...
static_assert(sizeof(AKerfurOmega_C) == 0x000840, "Wrong size on AKerfurOmega_C");
...
static_assert(offsetof(AKerfurOmega_C, GameMode) == 0x000830, "Member 'AKerfurOmega_C::GameMode' has a wrong offset!");
