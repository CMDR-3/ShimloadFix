...
void ACustomWall_C::ImpactDamageCPP(float Damage_0, const struct FHitResult& Hit, class AActor* Actor, const struct FVector& Impact)
{
	static class UFunction* Func = nullptr;
...
void ACustomWall_C::Damage(float Damage_0, const struct FVector& Location, const struct FRotator& Rotation)
{
	static class UFunction* Func = nullptr;
...
void ACustomWall_C::AddDamage(class AActor* Actor, float Damage_0, const struct FHitResult& Hit, const struct FVector& Impact, bool SkipSetting)
{
	static class UFunction* Func = nullptr;
