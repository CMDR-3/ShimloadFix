...
static_assert(offsetof(ShitDuende_rigged_Skeleton_AnimBlueprint_C_AnimGraph, AnimGraph_0) == 0x000000, "Member 'ShitDuende_rigged_Skeleton_AnimBlueprint_C_AnimGraph::AnimGraph_0' has a wrong offset!");
