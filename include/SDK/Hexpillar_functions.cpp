...
void AHexpillar_C::GetKey(class FString* Key_0)
{
	static class UFunction* Func = nullptr;
...
void AHexpillar_C::GetOnlyKey(class FString* Key_0)
{
	static class UFunction* Func = nullptr;
...
void AHexpillar_C::StuffUpgraded(class AMainGamemode_C* GameMode_0)
{
	static class UFunction* Func = nullptr;
...
void AHexpillar_C::AnyKey(const struct FKey& Key_0, bool Pressed)
{
	static class UFunction* Func = nullptr;
...
void AHexpillar_C::TexturePickerApply(class UUmg_texturePicker_C* Picker, class UTexture2D* Texture, int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
// Function hexpillar.hexpillar_C.NewFunction_2
// (Public, BlueprintCallable, BlueprintEvent)

void AHexpillar_C::NewFunction_2()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("hexpillar_C", "NewFunction_2");

	UObject::ProcessEvent(Func, nullptr);
}


// Function hexpillar.hexpillar_C.NewFunction_3
// (Public, BlueprintCallable, BlueprintEvent)

void AHexpillar_C::NewFunction_3()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("hexpillar_C", "NewFunction_3");

	UObject::ProcessEvent(Func, nullptr);
}


// Function hexpillar.hexpillar_C.gamemodePostKeys
// (Public, BlueprintCallable, BlueprintEvent)

void AHexpillar_C::GamemodePostKeys()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("hexpillar_C", "gamemodePostKeys");
...
void AHexpillar_C::ReachedByExplosion(const struct FVector& Location, float Damage)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("hexpillar_C", "reachedByExplosion");

	Params::Hexpillar_C_ReachedByExplosion Parms{};
...
void AHexpillar_C::Exploded(float Damage, const struct FVector& Location)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("hexpillar_C", "exploded");

	Params::Hexpillar_C_Exploded Parms{};
