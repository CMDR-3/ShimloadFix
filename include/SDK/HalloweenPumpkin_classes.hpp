...
// BlueprintGeneratedClass halloweenPumpkin.halloweenPumpkin_C
// 0x0018 (0x0238 - 0x0220)
class AHalloweenPumpkin_C final : public AActor
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"halloweenPumpkin_C">();
	}
	static class AHalloweenPumpkin_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AHalloweenPumpkin_C>();
	}
};
static_assert(alignof(AHalloweenPumpkin_C) == 0x000008, "Wrong alignment on AHalloweenPumpkin_C");
static_assert(sizeof(AHalloweenPumpkin_C) == 0x000238, "Wrong size on AHalloweenPumpkin_C");
static_assert(offsetof(AHalloweenPumpkin_C, UberGraphFrame) == 0x000220, "Member 'AHalloweenPumpkin_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AHalloweenPumpkin_C, StaticMesh) == 0x000228, "Member 'AHalloweenPumpkin_C::StaticMesh' has a wrong offset!");
static_assert(offsetof(AHalloweenPumpkin_C, PointLight) == 0x000230, "Member 'AHalloweenPumpkin_C::PointLight' has a wrong offset!");
