...
static_assert(offsetof(Prop_wireComponent_not_C_WireDisconnected, Wire_0) == 0x000000, "Member 'Prop_wireComponent_not_C_WireDisconnected::Wire_0' has a wrong offset!");
...
static_assert(offsetof(Prop_wireComponent_not_C_WireConnected, Wire_0) == 0x000000, "Member 'Prop_wireComponent_not_C_WireConnected::Wire_0' has a wrong offset!");
...
static_assert(offsetof(Prop_wireComponent_not_C_WirePass, Wire_0) == 0x000000, "Member 'Prop_wireComponent_not_C_WirePass::Wire_0' has a wrong offset!");
