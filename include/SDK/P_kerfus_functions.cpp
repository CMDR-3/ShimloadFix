...
void AP_kerfus_C::RunTrigger(class AActor* Owner_0, int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
void AP_kerfus_C::SetActiveTrigger(class AActor* SentFrom, bool Active_0)
{
	static class UFunction* Func = nullptr;
...
void AP_kerfus_C::ActionOptionIndex(class AMainPlayer_C* Player, const struct FHitResult& Hit_0, Enum_interactionActions Action)
{
	static class UFunction* Func = nullptr;
...
// struct FVector                          PossessLoc_0                                           (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

class AActor* AP_kerfus_C::TargetActor(struct FVector* PossessLoc_0)
{
	static class UFunction* Func = nullptr;
	...
	if (PossessLoc_0 != nullptr)
		*PossessLoc_0 = std::move(Parms.PossessLoc_0);
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FVector                          PossessLoc_0                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AP_kerfus_C::Possess(const struct FVector& PossessLoc_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.PossessLoc_0 = std::move(PossessLoc_0);
...
float AP_kerfus_C::Dtime()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("p_kerfus_C", "dtime");

	Params::P_kerfus_C_Dtime Parms{};
...
void AP_kerfus_C::ActionName(class AMainPlayer_C* Player, const struct FHitResult& Hit_0, const class FString& Name_0)
{
	static class UFunction* Func = nullptr;
...
void AP_kerfus_C::IgnoreSave(bool* Param_IgnoreSave_0)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Param_NoRespawn_0                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                                    Return                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void AP_kerfus_C::NoRespawn(bool Param_NoRespawn_0, bool* Return)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_NoRespawn_0 = Param_NoRespawn_0;
...
void AP_kerfus_C::LookAt(class AMainPlayer_C* Player, const struct FHitResult& Hit_0, bool* Return, class FString* Text, class UPrimitiveComponent** boundObjectReplace, uint8* Number)
{
	static class UFunction* Func = nullptr;
...
void AP_kerfus_C::GetKey(class FString* Key_0)
{
	static class UFunction* Func = nullptr;
