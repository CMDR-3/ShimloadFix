...
static_assert(offsetof(Prop_equipment_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_equipment_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_AddEquipment_return;                      // 0x00C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(Prop_equipment_C_Equip, CallFunc_AddEquipment_return) == 0x0000C0, "Member 'Prop_equipment_C_Equip::CallFunc_AddEquipment_return' has a wrong offset!");
