...
public:
	...
	struct FStruct_food                           CallFunc_propToObject_foodData;                    // 0x0134(0x001C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FStruct_prop3                          CallFunc_propToObject_fuckYouRetard;               // 0x0160(0x0080)(HasGetValueTypeHash)
...
static_assert(offsetof(Igetis_C_ExecuteUbergraph_igetis, CallFunc_propToObject_fuckYouRetard) == 0x000160, "Member 'Igetis_C_ExecuteUbergraph_igetis::CallFunc_propToObject_fuckYouRetard' has a wrong offset!");
