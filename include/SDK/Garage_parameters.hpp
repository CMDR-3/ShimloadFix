...
static_assert(offsetof(Garage_C_GetOnlyKey, Key_0) == 0x000000, "Member 'Garage_C_GetOnlyKey::Key_0' has a wrong offset!");
...
static_assert(offsetof(Garage_C_RunTrigger, Owner_0) == 0x000000, "Member 'Garage_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(Garage_C_RunTrigger, Index_0) == 0x000008, "Member 'Garage_C_RunTrigger::Index_0' has a wrong offset!");
...
{
public:
	bool                                          Open_0;                                            // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(Garage_C_Settime, Open_0) == 0x000000, "Member 'Garage_C_Settime::Open_0' has a wrong offset!");
