...
void AProp_food_C::ActionOptionIndex(class AMainPlayer_C* Player, const struct FHitResult& Hit_0, Enum_interactionActions Action)
{
	static class UFunction* Func = nullptr;
...
void AProp_food_C::AccumulateTemperature(float Temperature_0, float Speed)
{
	static class UFunction* Func = nullptr;
...
void AProp_food_C::AddTemperature(float Temperature_0)
{
	static class UFunction* Func = nullptr;
...
void AProp_food_C::LookAt(class AMainPlayer_C* Player, const struct FHitResult& Hit_0, bool* Return, class FString* Text, class UPrimitiveComponent** boundObjectReplace, uint8* Number)
{
	static class UFunction* Func = nullptr;
