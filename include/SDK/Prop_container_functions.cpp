...
void AProp_container_C::ActionOptionIndex(class AMainPlayer_C* Player, const struct FHitResult& Hit_0, Enum_interactionActions Action)
{
	static class UFunction* Func = nullptr;
...
void AProp_container_C::Extract(int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
void AProp_container_C::GetObject(int32 Index_0, bool CustomLoc, const struct FVector& Loc, class AActor** OutputPin)
{
	static class UFunction* Func = nullptr;
...
void AProp_container_C::LookAt(class AMainPlayer_C* Player, const struct FHitResult& Hit_0, bool* Return, class FString* Text, class UPrimitiveComponent** boundObjectReplace, uint8* Number)
{
	static class UFunction* Func = nullptr;
