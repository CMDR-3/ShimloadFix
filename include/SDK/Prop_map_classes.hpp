...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Prop_map_C;                         // 0x0358(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	...
	class UUmg_minimap_C*                         Minimap;                                           // 0x0370(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AProp_map_C) == 0x000378, "Wrong size on AProp_map_C");
static_assert(offsetof(AProp_map_C, UberGraphFrame_Prop_map_C) == 0x000358, "Member 'AProp_map_C::UberGraphFrame_Prop_map_C' has a wrong offset!");
static_assert(offsetof(AProp_map_C, RectLight) == 0x000360, "Member 'AProp_map_C::RectLight' has a wrong offset!");
static_assert(offsetof(AProp_map_C, Widget) == 0x000368, "Member 'AProp_map_C::Widget' has a wrong offset!");
static_assert(offsetof(AProp_map_C, Minimap) == 0x000370, "Member 'AProp_map_C::Minimap' has a wrong offset!");
