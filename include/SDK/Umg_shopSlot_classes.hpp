...
public:
	...
	class FName                                   Name_0;                                            // 0x02F4(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
...
public:
	...
	void Construct();
	void Filter(const class FText& Name_0);
...
static_assert(offsetof(UUmg_shopSlot_C, Name_0) == 0x0002F4, "Member 'UUmg_shopSlot_C::Name_0' has a wrong offset!");
