...
{
public:
	class AProp_C*                                Prop_0;                                            // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPrimitiveComponent*                    Component_0;                                       // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(PropThrown_C_Init, Prop_0) == 0x000000, "Member 'PropThrown_C_Init::Prop_0' has a wrong offset!");
static_assert(offsetof(PropThrown_C_Init, Component_0) == 0x000008, "Member 'PropThrown_C_Init::Component_0' has a wrong offset!");
