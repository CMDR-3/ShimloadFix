...
public:
	...
	class AProp_tv2_C*                            K2Node_CustomEvent_radio;                          // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FTimespan                              CallFunc_GetDuration_ReturnValue;                  // 0x0028(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	Enum_playlist                                 Temp_byte_Variable_4;                              // 0x004D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Pause_ReturnValue;                        // 0x004E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	Enum_playlist                                 K2Node_Select_Default;                             // 0x0078(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_setActiveInterface_return;                // 0x0080(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FTimespan                              CallFunc_GetTime_ReturnValue;                      // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_GetValue_ReturnValue;                     // 0x00D4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline) == 0x0000D8, "Wrong size on Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline");
...
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, Temp_byte_Variable) == 0x000004, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, Temp_byte_Variable_1) == 0x000005, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, Temp_byte_Variable_2) == 0x000006, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::Temp_byte_Variable_2' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, Temp_byte_Variable_3) == 0x000007, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::Temp_byte_Variable_3' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, K2Node_CustomEvent_radio) == 0x000008, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::K2Node_CustomEvent_radio' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, CallFunc_getMainPlayer_AsMain_Player) == 0x000010, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::CallFunc_getMainPlayer_AsMain_Player' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, K2Node_Event_InFocusEvent) == 0x000018, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::K2Node_Event_InFocusEvent' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, K2Node_ComponentBoundEvent_Value_1) == 0x000020, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::K2Node_ComponentBoundEvent_Value_1' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, CallFunc_GetDuration_ReturnValue) == 0x000028, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::CallFunc_GetDuration_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, CallFunc_Conv_FloatToText_ReturnValue) == 0x000030, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::CallFunc_Conv_FloatToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000048, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, CallFunc_Play_ReturnValue) == 0x00004C, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::CallFunc_Play_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, Temp_byte_Variable_4) == 0x00004D, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::Temp_byte_Variable_4' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, CallFunc_Pause_ReturnValue) == 0x00004E, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::CallFunc_Pause_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, CallFunc_GetEnumeratorUserFriendlyName_ReturnValue) == 0x000050, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::CallFunc_GetEnumeratorUserFriendlyName_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, CallFunc_Conv_StringToText_ReturnValue) == 0x000060, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, K2Node_Select_Default) == 0x000078, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, K2Node_ComponentBoundEvent_Value) == 0x00007C, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::K2Node_ComponentBoundEvent_Value' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, CallFunc_setActiveInterface_return) == 0x000080, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::CallFunc_setActiveInterface_return' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, K2Node_Event_MyGeometry) == 0x000084, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, K2Node_Event_InDeltaTime) == 0x0000BC, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, CallFunc_GetTime_ReturnValue) == 0x0000C0, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::CallFunc_GetTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, CallFunc_GetTotalSeconds_ReturnValue) == 0x0000C8, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::CallFunc_GetTotalSeconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, CallFunc_GetTotalSeconds_ReturnValue_1) == 0x0000CC, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::CallFunc_GetTotalSeconds_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, CallFunc_Divide_FloatFloat_ReturnValue_1) == 0x0000D0, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::CallFunc_Divide_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline, CallFunc_GetValue_ReturnValue) == 0x0000D4, "Member 'Umg_tvOffline_C_ExecuteUbergraph_umg_tvOffline::CallFunc_GetValue_ReturnValue' has a wrong offset!");
...
{
public:
	class AProp_tv2_C*                            Radio_0;                                           // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(Umg_tvOffline_C_Open, Radio_0) == 0x000000, "Member 'Umg_tvOffline_C_Open::Radio_0' has a wrong offset!");
...
public:
	...
	class UUmg_tvOfflineSlot_C*                   CallFunc_Array_Get_Item;                           // 0x0030(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FStruct_tv                             CallFunc_Array_Get_Item_1;                         // 0x0038(0x0028)(ZeroConstructor, HasGetValueTypeHash)
...
static_assert(offsetof(Umg_tvOffline_C_Gen, Name_0) == 0x000000, "Member 'Umg_tvOffline_C_Gen::Name_0' has a wrong offset!");
...
static_assert(offsetof(Umg_tvOffline_C_Gen, CallFunc_Array_Get_Item) == 0x000030, "Member 'Umg_tvOffline_C_Gen::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_Gen, CallFunc_Array_Get_Item_1) == 0x000038, "Member 'Umg_tvOffline_C_Gen::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_Gen, CallFunc_Array_Length_ReturnValue) == 0x000060, "Member 'Umg_tvOffline_C_Gen::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_Gen, CallFunc_Less_IntInt_ReturnValue) == 0x000064, "Member 'Umg_tvOffline_C_Gen::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_Gen, CallFunc_Array_Length_ReturnValue_1) == 0x000068, "Member 'Umg_tvOffline_C_Gen::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_Gen, CallFunc_Less_IntInt_ReturnValue_1) == 0x00006C, "Member 'Umg_tvOffline_C_Gen::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Umg_tvOffline_C_Gen, CallFunc_Array_Add_ReturnValue) == 0x000070, "Member 'Umg_tvOffline_C_Gen::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Umg_tvOffline_C_Select, Data_0) == 0x000000, "Member 'Umg_tvOffline_C_Select::Data_0' has a wrong offset!");
...
{
public:
	struct FTimespan                              Duration_0;                                        // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(Umg_tvOffline_C_SetDuration, Duration_0) == 0x000000, "Member 'Umg_tvOffline_C_SetDuration::Duration_0' has a wrong offset!");
