...
static_assert(offsetof(Prop_container_player_C_Extract, Index_0) == 0x000000, "Member 'Prop_container_player_C_Extract::Index_0' has a wrong offset!");
...
static_assert(offsetof(Prop_container_player_C_IgnoreSave, Param_IgnoreSave_0) == 0x000000, "Member 'Prop_container_player_C_IgnoreSave::Param_IgnoreSave_0' has a wrong offset!");
