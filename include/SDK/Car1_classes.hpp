...
// 0x02A8 (0x0528 - 0x0280)
class ACar1_C : public APawn
{
public:
	...
	float                                         TurnForce;                                         // 0x0520(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void InpActEvt_dismount_K2Node_InputActionEvent_0(const struct FKey& Key_0);
	void InpActEvt_jump_K2Node_InputActionEvent_1(const struct FKey& Key_0);
	void InpActEvt_alt_K2Node_InputActionEvent_2(const struct FKey& Key_0);
	void InpActEvt_alt_K2Node_InputActionEvent_3(const struct FKey& Key_0);
	void InpActEvt_zoom_K2Node_InputActionEvent_4(const struct FKey& Key_0);
	void InpActEvt_zoom_K2Node_InputActionEvent_5(const struct FKey& Key_0);
	void InpActEvt_flashlight_K2Node_InputActionEvent_6(const struct FKey& Key_0);
	void InpActEvt_run_K2Node_InputActionEvent_7(const struct FKey& Key_0);
	void InpActEvt_run_K2Node_InputActionEvent_8(const struct FKey& Key_0);
	void InpActEvt_left_K2Node_InputActionEvent_9(const struct FKey& Key_0);
	void InpActEvt_left_K2Node_InputActionEvent_10(const struct FKey& Key_0);
	void InpActEvt_right_K2Node_InputActionEvent_11(const struct FKey& Key_0);
	void InpActEvt_right_K2Node_InputActionEvent_12(const struct FKey& Key_0);
	void InpActEvt_back_K2Node_InputActionEvent_13(const struct FKey& Key_0);
	void InpActEvt_back_K2Node_InputActionEvent_14(const struct FKey& Key_0);
	void InpActEvt_forward_K2Node_InputActionEvent_15(const struct FKey& Key_0);
	void InpActEvt_forward_K2Node_InputActionEvent_16(const struct FKey& Key_0);
...
static_assert(sizeof(ACar1_C) == 0x000528, "Wrong size on ACar1_C");
...
static_assert(offsetof(ACar1_C, GameMode) == 0x000518, "Member 'ACar1_C::GameMode' has a wrong offset!");
static_assert(offsetof(ACar1_C, TurnForce) == 0x000520, "Member 'ACar1_C::TurnForce' has a wrong offset!");
