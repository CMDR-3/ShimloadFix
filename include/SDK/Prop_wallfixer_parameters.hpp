...
static_assert(offsetof(Prop_wallfixer_C_PlayerHandRelease_RMB, Player_0) == 0x000000, "Member 'Prop_wallfixer_C_PlayerHandRelease_RMB::Player_0' has a wrong offset!");
...
static_assert(offsetof(Prop_wallfixer_C_PlayerHandUse_RMB, Player_0) == 0x000000, "Member 'Prop_wallfixer_C_PlayerHandUse_RMB::Player_0' has a wrong offset!");
