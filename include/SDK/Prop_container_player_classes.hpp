...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"prop_container_player_C">();
	}
	static class AProp_container_player_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AProp_container_player_C>();
	}
};
static_assert(alignof(AProp_container_player_C) == 0x000008, "Wrong alignment on AProp_container_player_C");
static_assert(sizeof(AProp_container_player_C) == 0x0003D8, "Wrong size on AProp_container_player_C");
