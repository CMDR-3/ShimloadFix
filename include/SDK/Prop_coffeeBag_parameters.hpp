...
static_assert(sizeof(Prop_coffeeBag_C_LookAt) == 0x000110, "Wrong size on Prop_coffeeBag_C_LookAt");
static_assert(offsetof(Prop_coffeeBag_C_LookAt, Player) == 0x000000, "Member 'Prop_coffeeBag_C_LookAt::Player' has a wrong offset!");
static_assert(offsetof(Prop_coffeeBag_C_LookAt, Hit_0) == 0x000008, "Member 'Prop_coffeeBag_C_LookAt::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_coffeeBag_C_LookAt, Number) == 0x0000B0, "Member 'Prop_coffeeBag_C_LookAt::Number' has a wrong offset!");
static_assert(offsetof(Prop_coffeeBag_C_LookAt, CallFunc_MakeLiteralText_ReturnValue) == 0x0000B8, "Member 'Prop_coffeeBag_C_LookAt::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_coffeeBag_C_LookAt, CallFunc_Conv_TextToString_ReturnValue) == 0x0000D0, "Member 'Prop_coffeeBag_C_LookAt::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_coffeeBag_C_LookAt, CallFunc_Conv_IntToString_ReturnValue) == 0x0000E0, "Member 'Prop_coffeeBag_C_LookAt::CallFunc_Conv_IntToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_coffeeBag_C_LookAt, CallFunc_Concat_StrStr_ReturnValue) == 0x0000F0, "Member 'Prop_coffeeBag_C_LookAt::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_coffeeBag_C_LookAt, CallFunc_Concat_StrStr_ReturnValue_1) == 0x000100, "Member 'Prop_coffeeBag_C_LookAt::CallFunc_Concat_StrStr_ReturnValue_1' has a wrong offset!");
