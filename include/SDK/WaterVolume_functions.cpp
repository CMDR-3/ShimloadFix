...
void AWaterVolume_C::StuffUpgraded(class AMainGamemode_C* GameMode_0)
{
	static class UFunction* Func = nullptr;
...
void AWaterVolume_C::TexturePickerApply(class UUmg_texturePicker_C* Picker, class UTexture2D* Texture, int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
// Function waterVolume.waterVolume_C.NewFunction_2
// (Public, BlueprintCallable, BlueprintEvent)

void AWaterVolume_C::NewFunction_2()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("waterVolume_C", "NewFunction_2");

	UObject::ProcessEvent(Func, nullptr);
}


// Function waterVolume.waterVolume_C.NewFunction_3
// (Public, BlueprintCallable, BlueprintEvent)

void AWaterVolume_C::NewFunction_3()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("waterVolume_C", "NewFunction_3");

	UObject::ProcessEvent(Func, nullptr);
}


// Function waterVolume.waterVolume_C.gamemodePostKeys
// (Public, BlueprintCallable, BlueprintEvent)

void AWaterVolume_C::GamemodePostKeys()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("waterVolume_C", "gamemodePostKeys");
...
void AWaterVolume_C::Freeze(bool Frozen_0)
{
	static class UFunction* Func = nullptr;
