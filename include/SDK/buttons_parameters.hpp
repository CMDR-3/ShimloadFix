...
static_assert(offsetof(buttons_C_NoRespawn, NoRespawn_0) == 0x000000, "Member 'buttons_C_NoRespawn::NoRespawn_0' has a wrong offset!");
...
static_assert(offsetof(buttons_C_SendName, Name_0) == 0x000000, "Member 'buttons_C_SendName::Name_0' has a wrong offset!");
