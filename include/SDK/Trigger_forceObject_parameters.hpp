...
static_assert(offsetof(Trigger_forceObject_C_RunTrigger, Owner_0) == 0x000000, "Member 'Trigger_forceObject_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(Trigger_forceObject_C_RunTrigger, Index_0) == 0x000008, "Member 'Trigger_forceObject_C_RunTrigger::Index_0' has a wrong offset!");
...
static_assert(sizeof(Trigger_forceObject_C_ExecuteUbergraph_trigger_forceObject) == 0x000018, "Wrong size on Trigger_forceObject_C_ExecuteUbergraph_trigger_forceObject");
...
static_assert(offsetof(Trigger_forceObject_C_ExecuteUbergraph_trigger_forceObject, K2Node_Event_owner) == 0x000008, "Member 'Trigger_forceObject_C_ExecuteUbergraph_trigger_forceObject::K2Node_Event_owner' has a wrong offset!");
static_assert(offsetof(Trigger_forceObject_C_ExecuteUbergraph_trigger_forceObject, K2Node_Event_index) == 0x000010, "Member 'Trigger_forceObject_C_ExecuteUbergraph_trigger_forceObject::K2Node_Event_index' has a wrong offset!");
static_assert(offsetof(Trigger_forceObject_C_ExecuteUbergraph_trigger_forceObject, CallFunc_Array_Add_ReturnValue) == 0x000014, "Member 'Trigger_forceObject_C_ExecuteUbergraph_trigger_forceObject::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
