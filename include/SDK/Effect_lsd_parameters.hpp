...
public:
	...
	struct FWeightedBlendables                    K2Node_MakeStruct_WeightedBlendables;              // 0x01D0(0x0010)()
	...
	class UMaterialInstanceDynamic*               CallFunc_CreateDynamicMaterialInstance_ReturnValue_2; // 0x01E8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_GetFOVAngle_ReturnValue;                  // 0x01F8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AMainPlayer_C*                          CallFunc_getMainPlayer_AsMain_Player;              // 0x0210(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Multiply_FloatFloat_ReturnValue_4;        // 0x021C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FRotator                               CallFunc_K2_GetActorRotation_ReturnValue;          // 0x0230(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FRotator                               CallFunc_K2_GetComponentRotation_ReturnValue;      // 0x023C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	float                                         CallFunc_MultiplyMultiply_FloatFloat_ReturnValue_2; // 0x024C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FRotator                               CallFunc_RInterpTo_ReturnValue;                    // 0x0264(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FHitResult                             CallFunc_K2_SetWorldRotation_SweepHitResult;       // 0x0270(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	class AMainPlayer_C*                          CallFunc_getMainPlayer_AsMain_Player_2;            // 0x02F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Effect_lsd_C_ExecuteUbergraph_effect_lsd) == 0x000308, "Wrong size on Effect_lsd_C_ExecuteUbergraph_effect_lsd");
...
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, K2Node_MakeStruct_WeightedBlendables) == 0x0001D0, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::K2Node_MakeStruct_WeightedBlendables' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_CreateDynamicMaterialInstance_ReturnValue_1) == 0x0001E0, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_CreateDynamicMaterialInstance_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_CreateDynamicMaterialInstance_ReturnValue_2) == 0x0001E8, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_CreateDynamicMaterialInstance_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_GetPlayerCameraManager_ReturnValue_1) == 0x0001F0, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_GetPlayerCameraManager_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_GetFOVAngle_ReturnValue) == 0x0001F8, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_GetFOVAngle_ReturnValue' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_Subtract_FloatFloat_ReturnValue) == 0x0001FC, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_Subtract_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_Conv_FloatToString_ReturnValue) == 0x000200, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_Conv_FloatToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_getMainPlayer_AsMain_Player) == 0x000210, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_getMainPlayer_AsMain_Player' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_GetWorldDeltaSeconds_ReturnValue) == 0x000218, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_GetWorldDeltaSeconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_Multiply_FloatFloat_ReturnValue_4) == 0x00021C, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_Multiply_FloatFloat_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_VictoryFloatPlusEquals_FloatOut_1) == 0x000220, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_VictoryFloatPlusEquals_FloatOut_1' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_GetPlayerCameraManager_ReturnValue_2) == 0x000228, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_GetPlayerCameraManager_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_K2_GetActorRotation_ReturnValue) == 0x000230, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_K2_GetActorRotation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_K2_GetComponentRotation_ReturnValue) == 0x00023C, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_K2_GetComponentRotation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_GetWorldDeltaSeconds_ReturnValue_1) == 0x000248, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_GetWorldDeltaSeconds_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_MultiplyMultiply_FloatFloat_ReturnValue_2) == 0x00024C, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_MultiplyMultiply_FloatFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000250, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_getMainPlayer_AsMain_Player_1) == 0x000258, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_getMainPlayer_AsMain_Player_1' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_Divide_FloatFloat_ReturnValue_1) == 0x000260, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_Divide_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_RInterpTo_ReturnValue) == 0x000264, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_RInterpTo_ReturnValue' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_K2_SetWorldRotation_SweepHitResult) == 0x000270, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_K2_SetWorldRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_getMainPlayer_AsMain_Player_2) == 0x0002F8, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_getMainPlayer_AsMain_Player_2' has a wrong offset!");
static_assert(offsetof(Effect_lsd_C_ExecuteUbergraph_effect_lsd, CallFunc_Array_Add_ReturnValue) == 0x000300, "Member 'Effect_lsd_C_ExecuteUbergraph_effect_lsd::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(Effect_lsd_C_SettingsApplied) == 0x000100, "Wrong size on Effect_lsd_C_SettingsApplied");
...
static_assert(offsetof(Effect_lsd_C_StuffUpgraded, GameMode_0) == 0x000000, "Member 'Effect_lsd_C_StuffUpgraded::GameMode_0' has a wrong offset!");
...
static_assert(offsetof(Effect_lsd_C_TexturePickerApply, Index_0) == 0x000010, "Member 'Effect_lsd_C_TexturePickerApply::Index_0' has a wrong offset!");
...
static_assert(offsetof(Effect_lsd_C_AnyKey, Key_0) == 0x000000, "Member 'Effect_lsd_C_AnyKey::Key_0' has a wrong offset!");
