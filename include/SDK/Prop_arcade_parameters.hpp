...
public:
	...
	struct FVector                                CallFunc_K2_GetComponentLocation_ReturnValue_4;    // 0x016C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetActorUpVector_ReturnValue;             // 0x0178(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class USoundBase* Sound, float Volume, float Pitch)> K2Node_CreateDelegate_OutputDelegate;              // 0x0188(0x0010)(ZeroConstructor, NoDestructor)
	bool                                          CallFunc_Greater_FloatFloat_ReturnValue;           // 0x0198(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_WasRecentlyRendered_ReturnValue;          // 0x0199(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, K2Node_Event_action) == 0x000098, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, K2Node_SwitchEnum_CmpSuccess) == 0x000099, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, CallFunc_GetComponentVelocity_ReturnValue) == 0x00009C, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::CallFunc_GetComponentVelocity_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, CallFunc_VSize_ReturnValue) == 0x0000A8, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::CallFunc_VSize_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, CallFunc_K2_GetComponentLocation_ReturnValue) == 0x0000AC, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::CallFunc_K2_GetComponentLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, CallFunc_LessEqual_FloatFloat_ReturnValue) == 0x0000B8, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::CallFunc_LessEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, CallFunc_K2_GetComponentLocation_ReturnValue_1) == 0x0000BC, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::CallFunc_K2_GetComponentLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, CallFunc_K2_GetComponentLocation_ReturnValue_2) == 0x0000C8, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::CallFunc_K2_GetComponentLocation_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, CallFunc_K2_SetActorLocation_SweepHitResult) == 0x0000D4, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::CallFunc_K2_SetActorLocation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, CallFunc_K2_SetActorLocation_ReturnValue) == 0x00015C, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::CallFunc_K2_SetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, CallFunc_K2_GetComponentLocation_ReturnValue_3) == 0x000160, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::CallFunc_K2_GetComponentLocation_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, CallFunc_K2_GetComponentLocation_ReturnValue_4) == 0x00016C, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::CallFunc_K2_GetComponentLocation_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, CallFunc_GetActorUpVector_ReturnValue) == 0x000178, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::CallFunc_GetActorUpVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, CallFunc_Dot_VectorVector_ReturnValue) == 0x000184, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::CallFunc_Dot_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, K2Node_CreateDelegate_OutputDelegate) == 0x000188, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, CallFunc_Greater_FloatFloat_ReturnValue) == 0x000198, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::CallFunc_Greater_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ExecuteUbergraph_prop_arcade, CallFunc_WasRecentlyRendered_ReturnValue) == 0x000199, "Member 'Prop_arcade_C_ExecuteUbergraph_prop_arcade::CallFunc_WasRecentlyRendered_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Prop_arcade_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_arcade_C_ActionOptionIndex::Hit_0' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_ActionOptionIndex, Action) == 0x000090, "Member 'Prop_arcade_C_ActionOptionIndex::Action' has a wrong offset!");
...
static_assert(sizeof(Prop_arcade_C_Ini) == 0x000018, "Wrong size on Prop_arcade_C_Ini");
...
static_assert(sizeof(Prop_arcade_C_LookAt) == 0x0000E0, "Wrong size on Prop_arcade_C_LookAt");
static_assert(offsetof(Prop_arcade_C_LookAt, Player) == 0x000000, "Member 'Prop_arcade_C_LookAt::Player' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_LookAt, Hit_0) == 0x000008, "Member 'Prop_arcade_C_LookAt::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_arcade_C_LookAt, Number) == 0x0000B0, "Member 'Prop_arcade_C_LookAt::Number' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_LookAt, CallFunc_MakeLiteralText_ReturnValue) == 0x0000B8, "Member 'Prop_arcade_C_LookAt::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_LookAt, CallFunc_Conv_TextToString_ReturnValue) == 0x0000D0, "Member 'Prop_arcade_C_LookAt::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Prop_arcade_C_GetActionOptions, Number) == 0x000048, "Member 'Prop_arcade_C_GetActionOptions::Number' has a wrong offset!");
static_assert(offsetof(Prop_arcade_C_GetActionOptions, Temp_bool_Variable) == 0x000049, "Member 'Prop_arcade_C_GetActionOptions::Temp_bool_Variable' has a wrong offset!");
