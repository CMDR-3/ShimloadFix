...
public:
	...
	class FString                                 Name_0;                                            // 0x0290(0x0010)(Edit, BlueprintVisible, ZeroConstructor, ExposeOnSpawn, HasGetValueTypeHash)
...
static_assert(offsetof(UUmg_objectActionButton_C, Name_0) == 0x000290, "Member 'UUmg_objectActionButton_C::Name_0' has a wrong offset!");
