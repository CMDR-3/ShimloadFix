...
static_assert(sizeof(ADroneSellBox_C) == 0x000248, "Wrong size on ADroneSellBox_C");
...
static_assert(offsetof(ADroneSellBox_C, GameMode) == 0x000240, "Member 'ADroneSellBox_C::GameMode' has a wrong offset!");
