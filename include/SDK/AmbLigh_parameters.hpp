...
static_assert(sizeof(AmbLigh_C_Upd) == 0x000018, "Wrong size on AmbLigh_C_Upd");
...
static_assert(offsetof(AmbLigh_C_Upd, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x000014, "Member 'AmbLigh_C_Upd::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
