...
void ACustomPlank_C::Cut(const struct FHitResult& Hit_0)
{
	static class UFunction* Func = nullptr;
...
void ACustomPlank_C::AddDamage(class AActor* Actor, float Damage, const struct FHitResult& Hit_0, const struct FVector& Impact, bool SkipSetting)
{
	static class UFunction* Func = nullptr;
...
void ACustomPlank_C::NoRespawn(bool Param_NoRespawn_0, bool* Return)
{
	static class UFunction* Func = nullptr;
...
void ACustomPlank_C::LookAt(class AMainPlayer_C* Player, const struct FHitResult& Hit_0, bool* Return, class FString* Text, class UPrimitiveComponent** boundObjectReplace, uint8* Number)
{
	static class UFunction* Func = nullptr;
