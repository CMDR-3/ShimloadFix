...
static_assert(sizeof(ADreamBase_C) == 0x000278, "Wrong size on ADreamBase_C");
...
static_assert(offsetof(ADreamBase_C, GameMode) == 0x000270, "Member 'ADreamBase_C::GameMode' has a wrong offset!");
