...
public:
	...
	class UMaterialInstanceDynamic*               Dynmat_bhole;                                      // 0x02E0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UMaterialInstanceDynamic*               Dynmat_sun;                                        // 0x02E8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ANewsky_C) == 0x0002F0, "Wrong size on ANewsky_C");
...
static_assert(offsetof(ANewsky_C, GameMode) == 0x0002D8, "Member 'ANewsky_C::GameMode' has a wrong offset!");
static_assert(offsetof(ANewsky_C, Dynmat_bhole) == 0x0002E0, "Member 'ANewsky_C::Dynmat_bhole' has a wrong offset!");
static_assert(offsetof(ANewsky_C, Dynmat_sun) == 0x0002E8, "Member 'ANewsky_C::Dynmat_sun' has a wrong offset!");
