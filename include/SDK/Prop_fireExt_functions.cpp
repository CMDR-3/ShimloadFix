...
void AProp_fireExt_C::Fire(bool Firing_0)
{
	static class UFunction* Func = nullptr;
...
void AProp_fireExt_C::AddDamage(class AActor* Actor, float Damage, const struct FHitResult& Hit_0, const struct FVector& Impact, bool SkipSetting)
{
	static class UFunction* Func = nullptr;
...
void AProp_fireExt_C::ReceivedPhyiscsDamage(float Damage, const struct FHitResult& Hot)
{
	static class UFunction* Func = nullptr;
	...
	Params::Prop_fireExt_C_ReceivedPhyiscsDamage Parms{};
