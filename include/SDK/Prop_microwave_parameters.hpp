...
static_assert(offsetof(Prop_microwave_C_CordUnplugged, Cord_0) == 0x000000, "Member 'Prop_microwave_C_CordUnplugged::Cord_0' has a wrong offset!");
...
static_assert(offsetof(Prop_microwave_C_CordPlugged, Cord_0) == 0x000000, "Member 'Prop_microwave_C_CordPlugged::Cord_0' has a wrong offset!");
...
static_assert(offsetof(Prop_microwave_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_microwave_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_microwave_C_SetActiveTrigger, Active_0) == 0x000008, "Member 'Prop_microwave_C_SetActiveTrigger::Active_0' has a wrong offset!");
...
static_assert(offsetof(Prop_microwave_C_RunTrigger, Owner_0) == 0x000000, "Member 'Prop_microwave_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(Prop_microwave_C_RunTrigger, Index_0) == 0x000008, "Member 'Prop_microwave_C_RunTrigger::Index_0' has a wrong offset!");
...
static_assert(offsetof(Prop_microwave_C_AddDamage, Hit_0) == 0x00000C, "Member 'Prop_microwave_C_AddDamage::Hit_0' has a wrong offset!");
...
public:
	...
	class ACordSocket_C*                          CallFunc_tryToConnect_AsCord_Socket;               // 0x00C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x00D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_D1[0x7];                                       // 0x00D1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FStruct_mVector                        CallFunc_Array_Get_Item;                           // 0x00D8(0x0010)(HasGetValueTypeHash)
...
static_assert(sizeof(Prop_microwave_C_LoadData) == 0x0001A0, "Wrong size on Prop_microwave_C_LoadData");
...
static_assert(offsetof(Prop_microwave_C_LoadData, CallFunc_tryToConnect_AsCord_Socket) == 0x0000C8, "Member 'Prop_microwave_C_LoadData::CallFunc_tryToConnect_AsCord_Socket' has a wrong offset!");
static_assert(offsetof(Prop_microwave_C_LoadData, CallFunc_IsValid_ReturnValue) == 0x0000D0, "Member 'Prop_microwave_C_LoadData::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_microwave_C_LoadData, CallFunc_Array_Get_Item) == 0x0000D8, "Member 'Prop_microwave_C_LoadData::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Prop_microwave_C_LoadData, CallFunc_Array_Get_Item_1) == 0x0000E8, "Member 'Prop_microwave_C_LoadData::CallFunc_Array_Get_Item_1' has a wrong offset!");
...
static_assert(offsetof(Prop_microwave_C_LoadData, CallFunc_Conv_VectorToRotator_ReturnValue) == 0x000100, "Member 'Prop_microwave_C_LoadData::CallFunc_Conv_VectorToRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_microwave_C_LoadData, CallFunc_Array_IsValidIndex_ReturnValue) == 0x00010C, "Member 'Prop_microwave_C_LoadData::CallFunc_Array_IsValidIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_microwave_C_LoadData, CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult) == 0x000110, "Member 'Prop_microwave_C_LoadData::CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult' has a wrong offset!");
...
static_assert(offsetof(Prop_microwave_C_IgnoreSave, Param_IgnoreSave_0) == 0x000000, "Member 'Prop_microwave_C_IgnoreSave::Param_IgnoreSave_0' has a wrong offset!");
...
static_assert(offsetof(Prop_microwave_C_LookAt, Hit_0) == 0x000008, "Member 'Prop_microwave_C_LookAt::Hit_0' has a wrong offset!");
