...
void ATrigger_eventer_C::SettingsApplied(const struct FStruct_settings& Settings)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("trigger_eventer_C", "settingsApplied");

	Params::Trigger_eventer_C_SettingsApplied Parms{};
