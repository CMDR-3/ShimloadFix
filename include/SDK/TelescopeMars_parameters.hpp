...
{
public:
	bool                                          Fast_0;                                            // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(TelescopeMars_C_LaunchBuild, Fast_0) == 0x000000, "Member 'TelescopeMars_C_LaunchBuild::Fast_0' has a wrong offset!");
...
static_assert(offsetof(TelescopeMars_C_SendName, Name_0) == 0x000000, "Member 'TelescopeMars_C_SendName::Name_0' has a wrong offset!");
...
static_assert(offsetof(TelescopeMars_C_NoRespawn, NoRespawn_0) == 0x000000, "Member 'TelescopeMars_C_NoRespawn::NoRespawn_0' has a wrong offset!");
