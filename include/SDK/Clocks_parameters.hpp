...
public:
	...
	float                                         CallFunc_Percent_FloatFloat_ReturnValue_1;         // 0x0054(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Clocks_C_ExecuteUbergraph_clocks) == 0x000060, "Wrong size on Clocks_C_ExecuteUbergraph_clocks");
...
static_assert(offsetof(Clocks_C_ExecuteUbergraph_clocks, CallFunc_IsValid_ReturnValue) == 0x000004, "Member 'Clocks_C_ExecuteUbergraph_clocks::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Clocks_C_ExecuteUbergraph_clocks, CallFunc_CreateDynamicMaterialInstance_ReturnValue) == 0x000020, "Member 'Clocks_C_ExecuteUbergraph_clocks::CallFunc_CreateDynamicMaterialInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(Clocks_C_ExecuteUbergraph_clocks, CallFunc_CreateDynamicMaterialInstance_ReturnValue_1) == 0x000028, "Member 'Clocks_C_ExecuteUbergraph_clocks::CallFunc_CreateDynamicMaterialInstance_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Clocks_C_ExecuteUbergraph_clocks, Temp_bool_Variable) == 0x000030, "Member 'Clocks_C_ExecuteUbergraph_clocks::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(Clocks_C_ExecuteUbergraph_clocks, K2Node_Select_Default) == 0x000038, "Member 'Clocks_C_ExecuteUbergraph_clocks::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(Clocks_C_ExecuteUbergraph_clocks, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000040, "Member 'Clocks_C_ExecuteUbergraph_clocks::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Clocks_C_ExecuteUbergraph_clocks, CallFunc_Subtract_FloatFloat_ReturnValue) == 0x000044, "Member 'Clocks_C_ExecuteUbergraph_clocks::CallFunc_Subtract_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Clocks_C_ExecuteUbergraph_clocks, CallFunc_Add_FloatFloat_ReturnValue) == 0x000048, "Member 'Clocks_C_ExecuteUbergraph_clocks::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Clocks_C_ExecuteUbergraph_clocks, CallFunc_Percent_FloatFloat_ReturnValue_1) == 0x000054, "Member 'Clocks_C_ExecuteUbergraph_clocks::CallFunc_Percent_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Clocks_C_ExecuteUbergraph_clocks, CallFunc_Divide_FloatFloat_ReturnValue_1) == 0x000058, "Member 'Clocks_C_ExecuteUbergraph_clocks::CallFunc_Divide_FloatFloat_ReturnValue_1' has a wrong offset!");
...
public:
	...
	class FText                                   CallFunc_Array_Get_Item;                           // 0x00E0(0x0018)()
...
static_assert(offsetof(Clocks_C_LookAt, Hit_0) == 0x000008, "Member 'Clocks_C_LookAt::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Clocks_C_LookAt, CallFunc_Add_IntInt_ReturnValue) == 0x0000D8, "Member 'Clocks_C_LookAt::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Clocks_C_LookAt, CallFunc_Array_Get_Item) == 0x0000E0, "Member 'Clocks_C_LookAt::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Clocks_C_LookAt, CallFunc_Conv_IntToString_ReturnValue) == 0x0000F8, "Member 'Clocks_C_LookAt::CallFunc_Conv_IntToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Clocks_C_LookAt, CallFunc_Conv_TextToString_ReturnValue) == 0x000108, "Member 'Clocks_C_LookAt::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Clocks_C_LookAt, CallFunc_MakeLiteralText_ReturnValue) == 0x000118, "Member 'Clocks_C_LookAt::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(Clocks_C_LookAt, CallFunc_Conv_TextToString_ReturnValue_1) == 0x000130, "Member 'Clocks_C_LookAt::CallFunc_Conv_TextToString_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Clocks_C_LookAt, CallFunc_Concat_StrStr_ReturnValue) == 0x000140, "Member 'Clocks_C_LookAt::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(Clocks_C_LookAt, CallFunc_Concat_StrStr_ReturnValue_1) == 0x000150, "Member 'Clocks_C_LookAt::CallFunc_Concat_StrStr_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Clocks_C_LookAt, CallFunc_Concat_StrStr_ReturnValue_2) == 0x000160, "Member 'Clocks_C_LookAt::CallFunc_Concat_StrStr_ReturnValue_2' has a wrong offset!");
