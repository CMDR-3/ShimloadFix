...
// Parameters:
// class AActor*                           Weld_A_0                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AActor*                           Weld_B_0                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FVector                          WeldB_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AWeld_C::Weld(class AActor* Weld_A_0, class AActor* Weld_B_0, const struct FVector& WeldB_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Weld_A_0 = Weld_A_0;
	Parms.Weld_B_0 = Weld_B_0;
	Parms.WeldB_0 = std::move(WeldB_0);
