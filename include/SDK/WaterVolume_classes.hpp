...
static_assert(sizeof(AWaterVolume_C) == 0x0002C0, "Wrong size on AWaterVolume_C");
...
static_assert(offsetof(AWaterVolume_C, GameMode) == 0x0002B8, "Member 'AWaterVolume_C::GameMode' has a wrong offset!");
