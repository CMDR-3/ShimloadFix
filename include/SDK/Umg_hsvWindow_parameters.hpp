...
public:
	...
	struct FLinearColor                           InColor_0;                                         // 0x0008(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Umg_hsvWindow_C_Init, Actor_0) == 0x000000, "Member 'Umg_hsvWindow_C_Init::Actor_0' has a wrong offset!");
static_assert(offsetof(Umg_hsvWindow_C_Init, InColor_0) == 0x000008, "Member 'Umg_hsvWindow_C_Init::InColor_0' has a wrong offset!");
