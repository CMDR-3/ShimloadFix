...
static_assert(offsetof(Prop_batteryCharger_C_CordUnplugged, Cord_0) == 0x000000, "Member 'Prop_batteryCharger_C_CordUnplugged::Cord_0' has a wrong offset!");
...
static_assert(offsetof(Prop_batteryCharger_C_CordPlugged, Cord_0) == 0x000000, "Member 'Prop_batteryCharger_C_CordPlugged::Cord_0' has a wrong offset!");
...
static_assert(offsetof(Prop_batteryCharger_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_batteryCharger_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_batteryCharger_C_RunTrigger, Owner_0) == 0x000000, "Member 'Prop_batteryCharger_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(Prop_batteryCharger_C_RunTrigger, Index_0) == 0x000008, "Member 'Prop_batteryCharger_C_RunTrigger::Index_0' has a wrong offset!");
...
static_assert(offsetof(Prop_batteryCharger_C_PlayerUsedOn, Hit_0) == 0x000008, "Member 'Prop_batteryCharger_C_PlayerUsedOn::Hit_0' has a wrong offset!");
...
public:
	...
	struct FStruct_mFloat                         CallFunc_Array_Get_Item_5;                         // 0x0118(0x0010)(HasGetValueTypeHash)
	float                                         CallFunc_Array_Get_Item_6;                         // 0x0128(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult; // 0x012C(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	float                                         CallFunc_Array_Get_Item_7;                         // 0x01B4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Array_Get_Item_8;                         // 0x01B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Array_Get_Item_9;                         // 0x01BC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACordSocket_C*                          CallFunc_tryToConnect_AsCord_Socket;               // 0x01C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Prop_batteryCharger_C_LoadData, CallFunc_Array_Get_Item_5) == 0x000118, "Member 'Prop_batteryCharger_C_LoadData::CallFunc_Array_Get_Item_5' has a wrong offset!");
static_assert(offsetof(Prop_batteryCharger_C_LoadData, CallFunc_Array_Get_Item_6) == 0x000128, "Member 'Prop_batteryCharger_C_LoadData::CallFunc_Array_Get_Item_6' has a wrong offset!");
static_assert(offsetof(Prop_batteryCharger_C_LoadData, CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult) == 0x00012C, "Member 'Prop_batteryCharger_C_LoadData::CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(Prop_batteryCharger_C_LoadData, CallFunc_Array_Get_Item_7) == 0x0001B4, "Member 'Prop_batteryCharger_C_LoadData::CallFunc_Array_Get_Item_7' has a wrong offset!");
static_assert(offsetof(Prop_batteryCharger_C_LoadData, CallFunc_Array_Get_Item_8) == 0x0001B8, "Member 'Prop_batteryCharger_C_LoadData::CallFunc_Array_Get_Item_8' has a wrong offset!");
static_assert(offsetof(Prop_batteryCharger_C_LoadData, CallFunc_Array_Get_Item_9) == 0x0001BC, "Member 'Prop_batteryCharger_C_LoadData::CallFunc_Array_Get_Item_9' has a wrong offset!");
static_assert(offsetof(Prop_batteryCharger_C_LoadData, CallFunc_tryToConnect_AsCord_Socket) == 0x0001C0, "Member 'Prop_batteryCharger_C_LoadData::CallFunc_tryToConnect_AsCord_Socket' has a wrong offset!");
static_assert(offsetof(Prop_batteryCharger_C_LoadData, CallFunc_IsValid_ReturnValue) == 0x0001C8, "Member 'Prop_batteryCharger_C_LoadData::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_batteryCharger_C_LoadData, CallFunc_loadData_return) == 0x0001C9, "Member 'Prop_batteryCharger_C_LoadData::CallFunc_loadData_return' has a wrong offset!");
...
static_assert(offsetof(Prop_batteryCharger_C_LookAt, Hit_0) == 0x000008, "Member 'Prop_batteryCharger_C_LookAt::Hit_0' has a wrong offset!");
