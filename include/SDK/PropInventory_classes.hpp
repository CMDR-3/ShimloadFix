...
public:
	...
	class AMainGamemode_C*                        Gam;                                               // 0x0118(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

public:
	void Init(class UStaticMeshComponent* Target, class AProp_container_C* Owner_0);
	void AddObject(class AActor* Actor, int32 InsertIndex1, bool* Return, class FString* Err);
	void TakeObj(int32 Index_0, bool RemoveVol_0, bool* Return, struct FStruct_save* Output, class AActor** Object);
	void RemoveVol(class UStaticMeshComponent* Target);
	void MoveIndex(int32 ID, int32 Add, bool* Return);
	void AddLoot();
	void GetObj(int32 Index_0, bool* Return, struct FStruct_save* Output);
...
static_assert(sizeof(UPropInventory_C) == 0x000120, "Wrong size on UPropInventory_C");
static_assert(offsetof(UPropInventory_C, Index_0) == 0x0000B0, "Member 'UPropInventory_C::Index_0' has a wrong offset!");
...
static_assert(offsetof(UPropInventory_C, Gam) == 0x000118, "Member 'UPropInventory_C::Gam' has a wrong offset!");
