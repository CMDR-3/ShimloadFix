...
static_assert(sizeof(Prop_argbl_C_Setmats) == 0x000010, "Wrong size on Prop_argbl_C_Setmats");
static_assert(offsetof(Prop_argbl_C_Setmats, CallFunc_Array_Get_Item) == 0x000000, "Member 'Prop_argbl_C_Setmats::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Prop_argbl_C_Setmats, CallFunc_Array_Get_Item_1) == 0x000008, "Member 'Prop_argbl_C_Setmats::CallFunc_Array_Get_Item_1' has a wrong offset!");
