...
public:
	...
	class UWallclockArrows_Skeleton_AnimBlueprint_C* K2Node_DynamicCast_AsWallclock_Arrows_Skeleton_Anim_Blueprint; // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Prop_wallclock_C_ExecuteUbergraph_prop_wallclock) == 0x000028, "Wrong size on Prop_wallclock_C_ExecuteUbergraph_prop_wallclock");
...
static_assert(offsetof(Prop_wallclock_C_ExecuteUbergraph_prop_wallclock, K2Node_DynamicCast_AsWallclock_Arrows_Skeleton_Anim_Blueprint) == 0x000010, "Member 'Prop_wallclock_C_ExecuteUbergraph_prop_wallclock::K2Node_DynamicCast_AsWallclock_Arrows_Skeleton_Anim_Blueprint' has a wrong offset!");
static_assert(offsetof(Prop_wallclock_C_ExecuteUbergraph_prop_wallclock, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'Prop_wallclock_C_ExecuteUbergraph_prop_wallclock::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Prop_wallclock_C_ExecuteUbergraph_prop_wallclock, CallFunc_Conv_IntToFloat_ReturnValue) == 0x00001C, "Member 'Prop_wallclock_C_ExecuteUbergraph_prop_wallclock::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_wallclock_C_ExecuteUbergraph_prop_wallclock, CallFunc_Conv_IntToFloat_ReturnValue_1) == 0x000020, "Member 'Prop_wallclock_C_ExecuteUbergraph_prop_wallclock::CallFunc_Conv_IntToFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_wallclock_C_ExecuteUbergraph_prop_wallclock, K2Node_Event_DeltaSeconds) == 0x000024, "Member 'Prop_wallclock_C_ExecuteUbergraph_prop_wallclock::K2Node_Event_DeltaSeconds' has a wrong offset!");
...
static_assert(sizeof(Prop_wallclock_C_LookAt) == 0x0001A0, "Wrong size on Prop_wallclock_C_LookAt");
static_assert(offsetof(Prop_wallclock_C_LookAt, Player) == 0x000000, "Member 'Prop_wallclock_C_LookAt::Player' has a wrong offset!");
static_assert(offsetof(Prop_wallclock_C_LookAt, Hit_0) == 0x000008, "Member 'Prop_wallclock_C_LookAt::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_wallclock_C_LookAt, CallFunc_Conv_IntToText_ReturnValue) == 0x0000B8, "Member 'Prop_wallclock_C_LookAt::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_wallclock_C_LookAt, CallFunc_Conv_IntToText_ReturnValue_1) == 0x0000D0, "Member 'Prop_wallclock_C_LookAt::CallFunc_Conv_IntToText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_wallclock_C_LookAt, K2Node_MakeStruct_FormatArgumentData) == 0x0000E8, "Member 'Prop_wallclock_C_LookAt::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(Prop_wallclock_C_LookAt, K2Node_MakeStruct_FormatArgumentData_1) == 0x000128, "Member 'Prop_wallclock_C_LookAt::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(Prop_wallclock_C_LookAt, K2Node_MakeArray_Array) == 0x000168, "Member 'Prop_wallclock_C_LookAt::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(Prop_wallclock_C_LookAt, CallFunc_Format_ReturnValue) == 0x000178, "Member 'Prop_wallclock_C_LookAt::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_wallclock_C_LookAt, CallFunc_Conv_TextToString_ReturnValue) == 0x000190, "Member 'Prop_wallclock_C_LookAt::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
