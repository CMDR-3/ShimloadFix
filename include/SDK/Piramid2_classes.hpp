...
public:
	...
	class AMainGamemode_C*                        GameMode;                                          // 0x03F0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void WalkTo(const struct FVector& WalkSpot_0, class AActor* WalkActor_0, bool SkipProjection);
...
static_assert(sizeof(APiramid2_C) == 0x0003F8, "Wrong size on APiramid2_C");
...
static_assert(offsetof(APiramid2_C, GameMode) == 0x0003F0, "Member 'APiramid2_C::GameMode' has a wrong offset!");
