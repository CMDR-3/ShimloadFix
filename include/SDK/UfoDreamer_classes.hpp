...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_UfoDreamer_C;                       // 0x0250(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(AUfoDreamer_C) == 0x000258, "Wrong size on AUfoDreamer_C");
static_assert(offsetof(AUfoDreamer_C, UberGraphFrame_UfoDreamer_C) == 0x000250, "Member 'AUfoDreamer_C::UberGraphFrame_UfoDreamer_C' has a wrong offset!");
