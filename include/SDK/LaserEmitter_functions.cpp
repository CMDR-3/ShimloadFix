...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor*                           DaamgedActor_0                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ALaserEmitter_C::DamageActor(class AActor* DaamgedActor_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.DaamgedActor_0 = DaamgedActor_0;
