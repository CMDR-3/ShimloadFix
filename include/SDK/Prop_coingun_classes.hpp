...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Prop_coingun_C;                     // 0x0358(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_prop_coingun(int32 EntryPoint);
	void Sell(int32 Index_0, class UPrimitiveComponent* Comp);
...
static_assert(sizeof(AProp_coingun_C) == 0x000360, "Wrong size on AProp_coingun_C");
static_assert(offsetof(AProp_coingun_C, UberGraphFrame_Prop_coingun_C) == 0x000358, "Member 'AProp_coingun_C::UberGraphFrame_Prop_coingun_C' has a wrong offset!");
