...
static_assert(offsetof(Prop_clipboard_paper_fp_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_clipboard_paper_fp_C_ActionOptionIndex::Hit_0' has a wrong offset!");
