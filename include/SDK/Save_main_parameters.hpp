...
static_assert(alignof(Save_main_C_Save) == 0x000004, "Wrong alignment on Save_main_C_Save");
static_assert(sizeof(Save_main_C_Save) == 0x000008, "Wrong size on Save_main_C_Save");
...
static_assert(offsetof(Save_main_C_Save, CallFunc_Less_IntInt_ReturnValue) == 0x000001, "Member 'Save_main_C_Save::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Save_main_C_Save, CallFunc_SelectInt_ReturnValue) == 0x000004, "Member 'Save_main_C_Save::CallFunc_SelectInt_ReturnValue' has a wrong offset!");
...
public:
	...
	struct FStruct_settings                       Output;                                            // 0x0008(0x0100)(Parm, OutParm, HasGetValueTypeHash)
};
static_assert(alignof(Save_main_C_SetDefaultSettings) == 0x000008, "Wrong alignment on Save_main_C_SetDefaultSettings");
static_assert(sizeof(Save_main_C_SetDefaultSettings) == 0x000108, "Wrong size on Save_main_C_SetDefaultSettings");
...
public:
	...
	class APlayerController*                      Controller_0;                                      // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(Save_main_C_SetObjects, GameMode_0) == 0x000000, "Member 'Save_main_C_SetObjects::GameMode_0' has a wrong offset!");
static_assert(offsetof(Save_main_C_SetObjects, Controller_0) == 0x000008, "Member 'Save_main_C_SetObjects::Controller_0' has a wrong offset!");
