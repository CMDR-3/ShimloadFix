...
static_assert(offsetof(Trigger_tpChamberSpawn_C_RunTrigger, Owner_0) == 0x000000, "Member 'Trigger_tpChamberSpawn_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(Trigger_tpChamberSpawn_C_RunTrigger, Index_0) == 0x000008, "Member 'Trigger_tpChamberSpawn_C_RunTrigger::Index_0' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_K2_AttachToComponent_ReturnValue;         // 0x0148(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_149[0x7];                                      // 0x0149(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AProp_teleportChamber_C*                CallFunc_GetActorOfClass_ReturnValue;              // 0x0150(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Trigger_tpChamberSpawn_C_ExecuteUbergraph_trigger_tpChamberSpawn) == 0x000160, "Wrong size on Trigger_tpChamberSpawn_C_ExecuteUbergraph_trigger_tpChamberSpawn");
...
static_assert(offsetof(Trigger_tpChamberSpawn_C_ExecuteUbergraph_trigger_tpChamberSpawn, CallFunc_K2_AttachToComponent_ReturnValue) == 0x000148, "Member 'Trigger_tpChamberSpawn_C_ExecuteUbergraph_trigger_tpChamberSpawn::CallFunc_K2_AttachToComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(Trigger_tpChamberSpawn_C_ExecuteUbergraph_trigger_tpChamberSpawn, CallFunc_GetActorOfClass_ReturnValue) == 0x000150, "Member 'Trigger_tpChamberSpawn_C_ExecuteUbergraph_trigger_tpChamberSpawn::CallFunc_GetActorOfClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(Trigger_tpChamberSpawn_C_ExecuteUbergraph_trigger_tpChamberSpawn, CallFunc_IsValid_ReturnValue) == 0x000158, "Member 'Trigger_tpChamberSpawn_C_ExecuteUbergraph_trigger_tpChamberSpawn::CallFunc_IsValid_ReturnValue' has a wrong offset!");
