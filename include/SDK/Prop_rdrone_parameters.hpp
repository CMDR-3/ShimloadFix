...
public:
	...
	struct FVector                                CallFunc_RandomUnitVector_ReturnValue;             // 0x007C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetUpVector_ReturnValue_2;                // 0x0088(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Dot_VectorVector_ReturnValue_2;           // 0x00A0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_FClamp_ReturnValue;                       // 0x00A4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_VLerp_ReturnValue;                        // 0x00A8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetComponentVelocity_ReturnValue;         // 0x00B4(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetForwardVector_ReturnValue_2;           // 0x00C0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetComponentVelocity_ReturnValue_1;       // 0x00CC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Dot_VectorVector_ReturnValue_3;           // 0x00D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_GetRightVector_ReturnValue_2;             // 0x00E0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_FClamp_ReturnValue_1;                     // 0x00EC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Dot_VectorVector_ReturnValue_4;           // 0x00F0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_GetPhysicsAngularVelocityInDegrees_ReturnValue; // 0x00F8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Dot_VectorVector_ReturnValue_5;           // 0x0104(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Divide_FloatFloat_ReturnValue_3;          // 0x0110(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Add_FloatFloat_ReturnValue;               // 0x0114(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_VictoryFloatMinusEquals_FloatOut;         // 0x0118(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                 K2Node_Event_sentFrom;                             // 0x0268(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_active;                               // 0x0270(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_Less_FloatFloat_ReturnValue_1;            // 0x0271(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_NewParam;                             // 0x0272(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_273[0x1];                                      // 0x0273(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                CallFunc_GetRightVector_ReturnValue_3;             // 0x0274(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_Event_owner;                                // 0x0280(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_Event_index;                                // 0x0288(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetForwardVector_ReturnValue_3;           // 0x028C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Dot_VectorVector_ReturnValue_6;           // 0x0298(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ANewBlueprint16_C*                      CallFunc_GetActorOfClass_ReturnValue;              // 0x02A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Multiply_VectorFloat_ReturnValue_3;       // 0x02A8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_Add_VectorVector_ReturnValue_2;           // 0x02CC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AMainPlayer_C*                          K2Node_Event_player;                               // 0x02D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_Event_hit;                                  // 0x02E0(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	Enum_interactionActions                       K2Node_Event_action;                               // 0x0368(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ACord_C*                                K2Node_Event_cord_1;                               // 0x0370(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACordSocket_C*                          K2Node_Event_socket_1;                             // 0x0378(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACord_C*                                K2Node_Event_cord;                                 // 0x0380(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACordSocket_C*                          K2Node_Event_socket;                               // 0x0388(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetWorldDeltaSeconds_ReturnValue_1;       // 0x0390(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_FClamp_ReturnValue_3;                     // 0x03A0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ACord_C*                                CallFunc_FinishSpawningActor_ReturnValue;          // 0x03E8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Array_RemoveItem_ReturnValue) == 0x000078, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Array_RemoveItem_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Not_PreBool_ReturnValue) == 0x000079, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_RandomUnitVector_ReturnValue) == 0x00007C, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_RandomUnitVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_GetUpVector_ReturnValue_2) == 0x000088, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_GetUpVector_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Multiply_VectorFloat_ReturnValue_2) == 0x000094, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Multiply_VectorFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Dot_VectorVector_ReturnValue_2) == 0x0000A0, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Dot_VectorVector_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_FClamp_ReturnValue) == 0x0000A4, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_FClamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_VLerp_ReturnValue) == 0x0000A8, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_VLerp_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_GetComponentVelocity_ReturnValue) == 0x0000B4, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_GetComponentVelocity_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_GetForwardVector_ReturnValue_2) == 0x0000C0, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_GetForwardVector_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_GetComponentVelocity_ReturnValue_1) == 0x0000CC, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_GetComponentVelocity_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Dot_VectorVector_ReturnValue_3) == 0x0000D8, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Dot_VectorVector_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Divide_FloatFloat_ReturnValue) == 0x0000DC, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_GetRightVector_ReturnValue_2) == 0x0000E0, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_GetRightVector_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_FClamp_ReturnValue_1) == 0x0000EC, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_FClamp_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Dot_VectorVector_ReturnValue_4) == 0x0000F0, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Dot_VectorVector_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Divide_FloatFloat_ReturnValue_1) == 0x0000F4, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Divide_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_GetPhysicsAngularVelocityInDegrees_ReturnValue) == 0x0000F8, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_GetPhysicsAngularVelocityInDegrees_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Dot_VectorVector_ReturnValue_5) == 0x000104, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Dot_VectorVector_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_GetWorldDeltaSeconds_ReturnValue) == 0x000108, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_GetWorldDeltaSeconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Divide_FloatFloat_ReturnValue_2) == 0x00010C, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Divide_FloatFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Divide_FloatFloat_ReturnValue_3) == 0x000110, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Divide_FloatFloat_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Add_FloatFloat_ReturnValue) == 0x000114, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_VictoryFloatMinusEquals_FloatOut) == 0x000118, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_VictoryFloatMinusEquals_FloatOut' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_FClamp_ReturnValue_2) == 0x00011C, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_FClamp_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Less_FloatFloat_ReturnValue) == 0x000120, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Less_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_MakeRotator_ReturnValue) == 0x000124, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_MakeRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_K2_SetRelativeRotation_SweepHitResult) == 0x000130, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_K2_SetRelativeRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_ComponentBoundEvent_HitComponent) == 0x0001B8, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_ComponentBoundEvent_HitComponent' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_ComponentBoundEvent_OtherActor) == 0x0001C0, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_ComponentBoundEvent_OtherActor' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_ComponentBoundEvent_OtherComp) == 0x0001C8, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_ComponentBoundEvent_OtherComp' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_ComponentBoundEvent_NormalImpulse) == 0x0001D0, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_ComponentBoundEvent_NormalImpulse' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_ComponentBoundEvent_Hit) == 0x0001DC, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_ComponentBoundEvent_Hit' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_Event_DeltaSeconds) == 0x000264, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_Event_sentFrom) == 0x000268, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_Event_sentFrom' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_Event_active) == 0x000270, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_Event_active' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Less_FloatFloat_ReturnValue_1) == 0x000271, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Less_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_Event_NewParam) == 0x000272, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_Event_NewParam' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_GetRightVector_ReturnValue_3) == 0x000274, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_GetRightVector_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_Event_owner) == 0x000280, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_Event_owner' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_Event_index) == 0x000288, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_Event_index' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_GetForwardVector_ReturnValue_3) == 0x00028C, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_GetForwardVector_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Dot_VectorVector_ReturnValue_6) == 0x000298, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Dot_VectorVector_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Multiply_FloatFloat_ReturnValue_3) == 0x00029C, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Multiply_FloatFloat_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_GetActorOfClass_ReturnValue) == 0x0002A0, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_GetActorOfClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Multiply_VectorFloat_ReturnValue_3) == 0x0002A8, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Multiply_VectorFloat_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Add_VectorVector_ReturnValue) == 0x0002B4, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Add_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Add_VectorVector_ReturnValue_1) == 0x0002C0, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Add_VectorVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Add_VectorVector_ReturnValue_2) == 0x0002CC, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Add_VectorVector_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_Event_player) == 0x0002D8, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_Event_hit) == 0x0002E0, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_Event_action) == 0x000368, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_SwitchEnum_CmpSuccess) == 0x000369, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_Event_cord_1) == 0x000370, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_Event_cord_1' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_Event_socket_1) == 0x000378, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_Event_socket_1' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_Event_cord) == 0x000380, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_Event_cord' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, K2Node_Event_socket) == 0x000388, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::K2Node_Event_socket' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_GetWorldDeltaSeconds_ReturnValue_1) == 0x000390, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_GetWorldDeltaSeconds_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Divide_FloatFloat_ReturnValue_4) == 0x000394, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Divide_FloatFloat_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_IsValid_ReturnValue) == 0x000398, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_VictoryFloatPlusEquals_FloatOut) == 0x00039C, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_VictoryFloatPlusEquals_FloatOut' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_FClamp_ReturnValue_3) == 0x0003A0, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_FClamp_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_K2_GetComponentToWorld_ReturnValue) == 0x0003B0, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_K2_GetComponentToWorld_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x0003E0, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_FinishSpawningActor_ReturnValue) == 0x0003E8, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_ExecuteUbergraph_prop_rdrone, CallFunc_Array_Add_ReturnValue) == 0x0003F0, "Member 'Prop_rdrone_C_ExecuteUbergraph_prop_rdrone::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Prop_rdrone_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_rdrone_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_rdrone_C_RunTrigger, Owner_0) == 0x000000, "Member 'Prop_rdrone_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(Prop_rdrone_C_RunTrigger, Index_0) == 0x000008, "Member 'Prop_rdrone_C_RunTrigger::Index_0' has a wrong offset!");
...
static_assert(offsetof(Prop_rdrone_C_SetActiveTrigger, Active_0) == 0x000008, "Member 'Prop_rdrone_C_SetActiveTrigger::Active_0' has a wrong offset!");
...
static_assert(offsetof(Prop_rdrone_C_BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature, Hit_0) == 0x000024, "Member 'Prop_rdrone_C_BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature::Hit_0' has a wrong offset!");
...
{
public:
	bool                                          LightActive_0;                                     // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(Prop_rdrone_C_ALight, LightActive_0) == 0x000000, "Member 'Prop_rdrone_C_ALight::LightActive_0' has a wrong offset!");
