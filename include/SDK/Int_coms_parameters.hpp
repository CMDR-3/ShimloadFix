...
static_assert(sizeof(Int_coms_C_SettingsApplied) == 0x000100, "Wrong size on Int_coms_C_SettingsApplied");
...
static_assert(offsetof(Int_coms_C_TexturePickerApply, Index_0) == 0x000010, "Member 'Int_coms_C_TexturePickerApply::Index_0' has a wrong offset!");
