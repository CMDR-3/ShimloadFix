...
static_assert(sizeof(AUndergroundGarbageSpawner_C) == 0x000360, "Wrong size on AUndergroundGarbageSpawner_C");
...
static_assert(offsetof(AUndergroundGarbageSpawner_C, GameMode) == 0x000358, "Member 'AUndergroundGarbageSpawner_C::GameMode' has a wrong offset!");
