...
void AProp_rune_C::ActionOptionIndex(class AMainPlayer_C* Player, const struct FHitResult& Hit_0, Enum_interactionActions Action)
{
	static class UFunction* Func = nullptr;
...
void AProp_rune_C::SetActive(bool Active_0)
{
	static class UFunction* Func = nullptr;
