...
// class AProp_container_C*                Owner_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UPropInventory_C::Init(class UStaticMeshComponent* Target, class AProp_container_C* Owner_0)
{
...
// bool                                    RemoveVol_0                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                                    Return                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UPropInventory_C::TakeObj(int32 Index_0, bool RemoveVol_0, bool* Return, struct FStruct_save* Output, class AActor** Object)
{
	static class UFunction* Func = nullptr;
...
void UPropInventory_C::GetObj(int32 Index_0, bool* Return, struct FStruct_save* Output)
{
	static class UFunction* Func = nullptr;
...
void UPropInventory_C::CheckObjectsVolume()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("propInventory_C", "checkObjectsVolume");
