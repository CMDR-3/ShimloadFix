...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_RelativeField_C;                    // 0x0358(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	...
	TArray<class AActor*>                         Objs;                                              // 0x0368(0x0010)(Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance)
	uint8                                         Pad_378[0x8];                                      // 0x0378(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             Prev;                                              // 0x0380(0x0030)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          Active;                                            // 0x03B0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(ARelativeField_C) == 0x0003C0, "Wrong size on ARelativeField_C");
static_assert(offsetof(ARelativeField_C, UberGraphFrame_RelativeField_C) == 0x000358, "Member 'ARelativeField_C::UberGraphFrame_RelativeField_C' has a wrong offset!");
static_assert(offsetof(ARelativeField_C, Box) == 0x000360, "Member 'ARelativeField_C::Box' has a wrong offset!");
static_assert(offsetof(ARelativeField_C, Objs) == 0x000368, "Member 'ARelativeField_C::Objs' has a wrong offset!");
static_assert(offsetof(ARelativeField_C, Prev) == 0x000380, "Member 'ARelativeField_C::Prev' has a wrong offset!");
static_assert(offsetof(ARelativeField_C, Active) == 0x0003B0, "Member 'ARelativeField_C::Active' has a wrong offset!");
