...
public:
	...
	float                                         CallFunc_RandomFloatInRange_ReturnValue_3;         // 0x01B4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FStruct_settings                       K2Node_Event_settings;                             // 0x01C0(0x0100)(HasGetValueTypeHash)
	class FText                                   CallFunc_Conv_StringToText_ReturnValue;            // 0x02C0(0x0018)()
	class AMainGamemode_C*                        K2Node_Event_gamemode;                             // 0x02D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AProp_usb_C*                            K2Node_DynamicCast_AsProp_Usb;                     // 0x0388(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UUmg_texturePicker_C*                   K2Node_Event_picker;                               // 0x03D8(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UTexture2D*                             K2Node_Event_texture;                              // 0x03E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_Event_index;                                // 0x03E8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                           K2Node_Event_color;                                // 0x0450(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_SelectFloat_ReturnValue_1;                // 0x0570(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_LessEqual_FloatFloat_ReturnValue;         // 0x0574(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_575[0x3];                                      // 0x0575(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_GetWorldDeltaSeconds_ReturnValue;         // 0x0578(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_VictoryFloatMinusEquals_FloatOut;         // 0x057C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_SetStaticMesh_ReturnValue;                // 0x0580(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_581[0x3];                                      // 0x0581(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHitResult                             CallFunc_K2_SetWorldTransform_SweepHitResult_1;    // 0x0584(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                          CallFunc_BooleanOR_ReturnValue_1;                  // 0x060C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_Not_PreBool_ReturnValue;                  // 0x060D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BooleanAND_ReturnValue;                   // 0x060E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AMainPlayer_C*                          K2Node_Event_player;                               // 0x0630(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_Event_hit;                                  // 0x0638(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	Enum_interactionActions                       K2Node_Event_action;                               // 0x06C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_SwitchEnum_CmpSuccess;                      // 0x06C1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_isExhausted_exhausted;                    // 0x06C2(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_CustomEvent_active_calc;                    // 0x06C3(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_CustomEvent_active_downl;                   // 0x06C4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_CustomEvent_active_coords;                  // 0x06C5(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_CustomEvent_active_play;                    // 0x06C6(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_CustomEvent_active_light;                   // 0x06C7(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	class UUmg_serverMinigame_C*                  CallFunc_launchServerMinigame_Output_Get;          // 0x06C8(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AMainGamemode_C*                        CallFunc_getMainGamemode_AsMain_Gamemode_1;        // 0x06D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(ServerBox_C_ExecuteUbergraph_serverBox) == 0x0006E0, "Wrong size on ServerBox_C_ExecuteUbergraph_serverBox");
...
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_VLerp_ReturnValue) == 0x000014, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_VLerp_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_Ease_ReturnValue) == 0x000020, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_Ease_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_player_6) == 0x000050, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_player_6' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_hit_2) == 0x000058, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_hit_2' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_kick) == 0x0000E0, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_kick' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_name) == 0x0000E4, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_name' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_player_5) == 0x0000F0, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_player_5' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_player_4) == 0x0000F8, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_player_4' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_hit_1) == 0x000100, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_hit_1' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_damage) == 0x000188, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_damage' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_player_3) == 0x000190, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_player_3' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_player_2) == 0x000198, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_player_2' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_player_1) == 0x0001A0, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_player_1' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_RandomFloatInRange_ReturnValue) == 0x0001A8, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_RandomFloatInRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_RandomFloatInRange_ReturnValue_1) == 0x0001AC, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_RandomFloatInRange_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_RandomFloatInRange_ReturnValue_2) == 0x0001B0, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_RandomFloatInRange_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_RandomFloatInRange_ReturnValue_3) == 0x0001B4, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_RandomFloatInRange_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_SelectFloat_ReturnValue) == 0x0001B8, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_SelectFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_settings) == 0x0001C0, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_settings' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_Conv_StringToText_ReturnValue) == 0x0002C0, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_gamemode) == 0x0002D8, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_gamemode' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_ComponentBoundEvent_OverlappedComponent) == 0x0002E0, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_ComponentBoundEvent_OverlappedComponent' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_ComponentBoundEvent_OtherActor) == 0x0002E8, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_ComponentBoundEvent_OtherActor' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_ComponentBoundEvent_OtherComp) == 0x0002F0, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_ComponentBoundEvent_OtherComp' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_ComponentBoundEvent_OtherBodyIndex) == 0x0002F8, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_ComponentBoundEvent_OtherBodyIndex' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_ComponentBoundEvent_bFromSweep) == 0x0002FC, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_ComponentBoundEvent_bFromSweep' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_ComponentBoundEvent_SweepResult) == 0x000300, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_ComponentBoundEvent_SweepResult' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_DynamicCast_AsProp_Usb) == 0x000388, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_DynamicCast_AsProp_Usb' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_DynamicCast_bSuccess) == 0x000390, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_K2_GetRootComponent_ReturnValue) == 0x000398, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_K2_GetRootComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_K2_GetComponentToWorld_ReturnValue) == 0x0003A0, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_K2_GetComponentToWorld_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_BooleanOR_ReturnValue) == 0x0003D0, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_picker) == 0x0003D8, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_picker' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_texture) == 0x0003E0, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_texture' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_index) == 0x0003E8, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_index' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_K2_GetComponentToWorld_ReturnValue_1) == 0x0003F0, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_K2_GetComponentToWorld_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_TLerp_ReturnValue) == 0x000420, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_TLerp_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_color) == 0x000450, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_color' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_K2_SetWorldTransform_SweepHitResult) == 0x000460, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_K2_SetWorldTransform_SweepHitResult' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_K2_SetRelativeLocation_SweepHitResult) == 0x0004E8, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_K2_SetRelativeLocation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_SelectFloat_ReturnValue_1) == 0x000570, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_SelectFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_LessEqual_FloatFloat_ReturnValue) == 0x000574, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_LessEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_GetWorldDeltaSeconds_ReturnValue) == 0x000578, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_GetWorldDeltaSeconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_VictoryFloatMinusEquals_FloatOut) == 0x00057C, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_VictoryFloatMinusEquals_FloatOut' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_SetStaticMesh_ReturnValue) == 0x000580, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_SetStaticMesh_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_K2_SetWorldTransform_SweepHitResult_1) == 0x000584, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_K2_SetWorldTransform_SweepHitResult_1' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_BooleanOR_ReturnValue_1) == 0x00060C, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_BooleanOR_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_Not_PreBool_ReturnValue) == 0x00060D, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_BooleanAND_ReturnValue) == 0x00060E, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_key) == 0x000610, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_key' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_pressed) == 0x000628, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_pressed' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_player) == 0x000630, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_hit) == 0x000638, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_Event_action) == 0x0006C0, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_SwitchEnum_CmpSuccess) == 0x0006C1, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_isExhausted_exhausted) == 0x0006C2, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_isExhausted_exhausted' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_CustomEvent_active_calc) == 0x0006C3, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_CustomEvent_active_calc' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_CustomEvent_active_downl) == 0x0006C4, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_CustomEvent_active_downl' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_CustomEvent_active_coords) == 0x0006C5, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_CustomEvent_active_coords' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_CustomEvent_active_play) == 0x0006C6, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_CustomEvent_active_play' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, K2Node_CustomEvent_active_light) == 0x0006C7, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::K2Node_CustomEvent_active_light' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_launchServerMinigame_Output_Get) == 0x0006C8, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_launchServerMinigame_Output_Get' has a wrong offset!");
static_assert(offsetof(ServerBox_C_ExecuteUbergraph_serverBox, CallFunc_getMainGamemode_AsMain_Gamemode_1) == 0x0006D0, "Member 'ServerBox_C_ExecuteUbergraph_serverBox::CallFunc_getMainGamemode_AsMain_Gamemode_1' has a wrong offset!");
...
static_assert(offsetof(ServerBox_C_AnyKey, Key_0) == 0x000000, "Member 'ServerBox_C_AnyKey::Key_0' has a wrong offset!");
...
static_assert(offsetof(ServerBox_C_TexturePickerApply, Index_0) == 0x000010, "Member 'ServerBox_C_TexturePickerApply::Index_0' has a wrong offset!");
...
static_assert(offsetof(ServerBox_C_StuffUpgraded, GameMode_0) == 0x000000, "Member 'ServerBox_C_StuffUpgraded::GameMode_0' has a wrong offset!");
...
static_assert(sizeof(ServerBox_C_SettingsApplied) == 0x000100, "Wrong size on ServerBox_C_SettingsApplied");
...
static_assert(offsetof(ServerBox_C_SendName, Name_0) == 0x000000, "Member 'ServerBox_C_SendName::Name_0' has a wrong offset!");
...
static_assert(alignof(ServerBox_C_breakServer) == 0x000004, "Wrong alignment on ServerBox_C_breakServer");
static_assert(sizeof(ServerBox_C_breakServer) == 0x000008, "Wrong size on ServerBox_C_breakServer");
static_assert(offsetof(ServerBox_C_breakServer, CallFunc_Add_IntInt_ReturnValue) == 0x000000, "Member 'ServerBox_C_breakServer::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_breakServer, Temp_int_Variable) == 0x000004, "Member 'ServerBox_C_breakServer::Temp_int_Variable' has a wrong offset!");
...
static_assert(alignof(ServerBox_C_Fix) == 0x000004, "Wrong alignment on ServerBox_C_Fix");
static_assert(sizeof(ServerBox_C_Fix) == 0x00000C, "Wrong size on ServerBox_C_Fix");
static_assert(offsetof(ServerBox_C_Fix, CallFunc_Subtract_IntInt_ReturnValue) == 0x000000, "Member 'ServerBox_C_Fix::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_Fix, Temp_int_Variable) == 0x000004, "Member 'ServerBox_C_Fix::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(ServerBox_C_Fix, CallFunc_Array_RemoveItem_ReturnValue) == 0x000008, "Member 'ServerBox_C_Fix::CallFunc_Array_RemoveItem_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ServerBox_C_Check, CallFunc_getMainGamemode_AsMain_Gamemode) == 0x000058, "Member 'ServerBox_C_Check::CallFunc_getMainGamemode_AsMain_Gamemode' has a wrong offset!");
static_assert(offsetof(ServerBox_C_Check, CallFunc_BooleanAND_ReturnValue) == 0x000060, "Member 'ServerBox_C_Check::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_Check, CallFunc_BooleanAND_ReturnValue_1) == 0x000061, "Member 'ServerBox_C_Check::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(ServerBox_C_Check, K2Node_Select_Default) == 0x000068, "Member 'ServerBox_C_Check::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(ServerBox_C_Check, K2Node_Select_Default_1) == 0x000070, "Member 'ServerBox_C_Check::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(ServerBox_C_Check, Temp_bool_Variable_4) == 0x000078, "Member 'ServerBox_C_Check::Temp_bool_Variable_4' has a wrong offset!");
static_assert(offsetof(ServerBox_C_Check, CallFunc_IsValid_ReturnValue) == 0x000079, "Member 'ServerBox_C_Check::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(alignof(ServerBox_C_break_type) == 0x000004, "Wrong alignment on ServerBox_C_break_type");
static_assert(sizeof(ServerBox_C_break_type) == 0x000010, "Wrong size on ServerBox_C_break_type");
static_assert(offsetof(ServerBox_C_break_type, Type_0) == 0x000000, "Member 'ServerBox_C_break_type::Type_0' has a wrong offset!");
static_assert(offsetof(ServerBox_C_break_type, CallFunc_Add_IntInt_ReturnValue) == 0x000004, "Member 'ServerBox_C_break_type::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_break_type, Temp_int_Variable) == 0x000008, "Member 'ServerBox_C_break_type::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(ServerBox_C_break_type, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x00000C, "Member 'ServerBox_C_break_type::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
...
{
public:
	bool                                          Active_0;                                          // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(ServerBox_C_Visual, Active_0) == 0x000000, "Member 'ServerBox_C_Visual::Active_0' has a wrong offset!");
...
static_assert(offsetof(ServerBox_C_NoRespawn, NoRespawn_0) == 0x000000, "Member 'ServerBox_C_NoRespawn::NoRespawn_0' has a wrong offset!");
...
public:
	...
	class ADish_C*                                CallFunc_Array_Get_Item_9;                         // 0x0130(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ServerBox_C_LoadData, CallFunc_Array_Get_Item_9) == 0x000130, "Member 'ServerBox_C_LoadData::CallFunc_Array_Get_Item_9' has a wrong offset!");
static_assert(offsetof(ServerBox_C_LoadData, CallFunc_Array_Length_ReturnValue) == 0x000138, "Member 'ServerBox_C_LoadData::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_LoadData, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x00013C, "Member 'ServerBox_C_LoadData::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBox_C_LoadData, Temp_int_Loop_Counter_Variable) == 0x000140, "Member 'ServerBox_C_LoadData::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(ServerBox_C_LoadData, CallFunc_Less_IntInt_ReturnValue) == 0x000144, "Member 'ServerBox_C_LoadData::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
