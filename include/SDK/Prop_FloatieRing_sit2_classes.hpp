...
static_assert(sizeof(AProp_FloatieRing_sit2_C) == 0x000368, "Wrong size on AProp_FloatieRing_sit2_C");
static_assert(offsetof(AProp_FloatieRing_sit2_C, ChildActor_0) == 0x000360, "Member 'AProp_FloatieRing_sit2_C::ChildActor_0' has a wrong offset!");
