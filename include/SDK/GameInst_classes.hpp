...
public:
	...
	class AMainGamemode_C*                        Gamemode_;                                         // 0x02A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGameInst_C) == 0x0002B8, "Wrong size on UGameInst_C");
...
static_assert(offsetof(UGameInst_C, Gamemode_) == 0x0002A8, "Member 'UGameInst_C::Gamemode_' has a wrong offset!");
static_assert(offsetof(UGameInst_C, NewVar_0) == 0x0002B0, "Member 'UGameInst_C::NewVar_0' has a wrong offset!");
