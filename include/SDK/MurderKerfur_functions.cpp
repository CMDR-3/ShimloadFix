...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor*                           SpikeAt_0                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FRotator                         NewRotation                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void AMurderKerfur_C::Attack(class AActor* SpikeAt_0, const struct FRotator& NewRotation)
{
	static class UFunction* Func = nullptr;
...
void AMurderKerfur_C::SetActiveTrigger(class AActor* SentFrom, bool Active_0)
{
	static class UFunction* Func = nullptr;
...
void AMurderKerfur_C::RunTrigger(class AActor* Owner_0, int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
void AMurderKerfur_C::GetSettings()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("murderKerfur_C", "getSettings");
...
void AMurderKerfur_C::SettingsApplied(const struct FStruct_settings& Settings)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("murderKerfur_C", "settingsApplied");

	Params::MurderKerfur_C_SettingsApplied Parms{};
...
void AMurderKerfur_C::IgnoreSave(bool* Param_IgnoreSave_0)
{
	static class UFunction* Func = nullptr;
...
void AMurderKerfur_C::NoRespawn(bool Param_NoRespawn_0, bool* Return)
{
	static class UFunction* Func = nullptr;
...
void AMurderKerfur_C::LookAt(class AMainPlayer_C* Player, const struct FHitResult& Hit_0, bool* Return, class FString* Text, class UPrimitiveComponent** boundObjectReplace, uint8* Number)
{
	static class UFunction* Func = nullptr;
...
void AMurderKerfur_C::GetKey(class FString* Key_0)
{
	static class UFunction* Func = nullptr;
