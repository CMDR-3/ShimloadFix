...
struct Prop_vaccine_C_ActionOptionIndex final
{
public:
...
static_assert(offsetof(Prop_vaccine_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_vaccine_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
struct Prop_vaccine_C_PlayerHandUse_RMB final
{
public:
	class AMainPlayer_C*                          Player;                                            // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(Prop_vaccine_C_PlayerHandUse_RMB) == 0x000008, "Wrong alignment on Prop_vaccine_C_PlayerHandUse_RMB");
static_assert(sizeof(Prop_vaccine_C_PlayerHandUse_RMB) == 0x000008, "Wrong size on Prop_vaccine_C_PlayerHandUse_RMB");
static_assert(offsetof(Prop_vaccine_C_PlayerHandUse_RMB, Player) == 0x000000, "Member 'Prop_vaccine_C_PlayerHandUse_RMB::Player' has a wrong offset!");

// Function prop_vaccine.prop_vaccine_C.Init
// 0x001C (0x001C - 0x0000)
struct Prop_vaccine_C_Init final
{
public:
...
static_assert(alignof(Prop_vaccine_C_Init) == 0x000004, "Wrong alignment on Prop_vaccine_C_Init");
static_assert(sizeof(Prop_vaccine_C_Init) == 0x00001C, "Wrong size on Prop_vaccine_C_Init");
static_assert(offsetof(Prop_vaccine_C_Init, Temp_bool_Variable) == 0x000000, "Member 'Prop_vaccine_C_Init::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(Prop_vaccine_C_Init, Temp_name_Variable) == 0x000004, "Member 'Prop_vaccine_C_Init::Temp_name_Variable' has a wrong offset!");
static_assert(offsetof(Prop_vaccine_C_Init, Temp_name_Variable_1) == 0x00000C, "Member 'Prop_vaccine_C_Init::Temp_name_Variable_1' has a wrong offset!");
static_assert(offsetof(Prop_vaccine_C_Init, K2Node_Select_Default) == 0x000014, "Member 'Prop_vaccine_C_Init::K2Node_Select_Default' has a wrong offset!");

// Function prop_vaccine.prop_vaccine_C.loadData
// 0x00E0 (0x00E0 - 0x0000)
struct Prop_vaccine_C_LoadData final
{
public:
...
static_assert(alignof(Prop_vaccine_C_LoadData) == 0x000010, "Wrong alignment on Prop_vaccine_C_LoadData");
static_assert(sizeof(Prop_vaccine_C_LoadData) == 0x0000E0, "Wrong size on Prop_vaccine_C_LoadData");
static_assert(offsetof(Prop_vaccine_C_LoadData, Data) == 0x000000, "Member 'Prop_vaccine_C_LoadData::Data' has a wrong offset!");
static_assert(offsetof(Prop_vaccine_C_LoadData, Return) == 0x0000C0, "Member 'Prop_vaccine_C_LoadData::Return' has a wrong offset!");
static_assert(offsetof(Prop_vaccine_C_LoadData, CallFunc_loadData_return) == 0x0000C1, "Member 'Prop_vaccine_C_LoadData::CallFunc_loadData_return' has a wrong offset!");
static_assert(offsetof(Prop_vaccine_C_LoadData, CallFunc_Array_Get_Item) == 0x0000C8, "Member 'Prop_vaccine_C_LoadData::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Prop_vaccine_C_LoadData, CallFunc_Array_Get_Item_1) == 0x0000D8, "Member 'Prop_vaccine_C_LoadData::CallFunc_Array_Get_Item_1' has a wrong offset!");

// Function prop_vaccine.prop_vaccine_C.getData
// 0x0280 (0x0280 - 0x0000)
struct Prop_vaccine_C_GetData final
{
public:
...
static_assert(alignof(Prop_vaccine_C_GetData) == 0x000010, "Wrong alignment on Prop_vaccine_C_GetData");
static_assert(sizeof(Prop_vaccine_C_GetData) == 0x000280, "Wrong size on Prop_vaccine_C_GetData");
static_assert(offsetof(Prop_vaccine_C_GetData, Data) == 0x000000, "Member 'Prop_vaccine_C_GetData::Data' has a wrong offset!");
static_assert(offsetof(Prop_vaccine_C_GetData, CallFunc_getData_data) == 0x0000C0, "Member 'Prop_vaccine_C_GetData::CallFunc_getData_data' has a wrong offset!");
static_assert(offsetof(Prop_vaccine_C_GetData, K2Node_MakeArray_Array) == 0x000180, "Member 'Prop_vaccine_C_GetData::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(Prop_vaccine_C_GetData, K2Node_MakeStruct_struct_mBool) == 0x000190, "Member 'Prop_vaccine_C_GetData::K2Node_MakeStruct_struct_mBool' has a wrong offset!");
static_assert(offsetof(Prop_vaccine_C_GetData, CallFunc_Array_Get_Item) == 0x0001A0, "Member 'Prop_vaccine_C_GetData::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Prop_vaccine_C_GetData, K2Node_MakeArray_Array_1) == 0x0001B0, "Member 'Prop_vaccine_C_GetData::K2Node_MakeArray_Array_1' has a wrong offset!");
