...
public:
	...
	class FText                                   CallFunc_nameToDisplayName_displayName;            // 0x0190(0x0018)()
	...
	class AProp_clipboard_paper_C*                CallFunc_FinishSpawningActor_ReturnValue;          // 0x01C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class FString>                         K2Node_MakeArray_Array;                            // 0x01C8(0x0010)(ReferenceParm)
	...
	class AActor*                                 CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1; // 0x0220(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AProp_pencil_C*                         CallFunc_FinishSpawningActor_ReturnValue_1;        // 0x0230(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_SetStaticMesh_ReturnValue;                // 0x025D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_SetStaticMesh_ReturnValue_1;              // 0x025E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_EqualEqual_NameName_ReturnValue_1;        // 0x025F(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_SetStaticMesh_ReturnValue_2;              // 0x0260(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_261[0x3];                                      // 0x0261(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_VictoryIntMinusEquals_IntOut;             // 0x0264(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AMainPlayer_C*                          K2Node_Event_player;                               // 0x0278(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_Event_hit;                                  // 0x0280(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	Enum_interactionActions                       K2Node_Event_action;                               // 0x0308(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_309[0x3];                                      // 0x0309(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_Lerp_ReturnValue;                         // 0x030C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_FMax_ReturnValue;                         // 0x031C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Divide_FloatFloat_ReturnValue_2;          // 0x0330(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_nameToDisplayName_displayName) == 0x000190, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_nameToDisplayName_displayName' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x0001A8, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_Conv_TextToString_ReturnValue) == 0x0001B0, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_FinishSpawningActor_ReturnValue) == 0x0001C0, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, K2Node_MakeArray_Array) == 0x0001C8, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_MakeTransform_ReturnValue_1) == 0x0001E0, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_MakeTransform_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_K2_GetActorLocation_ReturnValue_1) == 0x000210, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_K2_GetActorLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1) == 0x000220, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_GetPlayerCameraManager_ReturnValue) == 0x000228, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_GetPlayerCameraManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_FinishSpawningActor_ReturnValue_1) == 0x000230, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_FinishSpawningActor_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_K2_GetActorLocation_ReturnValue_2) == 0x000238, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_K2_GetActorLocation_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_Subtract_VectorVector_ReturnValue) == 0x000244, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_Subtract_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_SetVectorLength_ReturnValue) == 0x000250, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_SetVectorLength_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_EqualEqual_NameName_ReturnValue) == 0x00025C, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_EqualEqual_NameName_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_SetStaticMesh_ReturnValue) == 0x00025D, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_SetStaticMesh_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_SetStaticMesh_ReturnValue_1) == 0x00025E, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_SetStaticMesh_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_EqualEqual_NameName_ReturnValue_1) == 0x00025F, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_EqualEqual_NameName_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_SetStaticMesh_ReturnValue_2) == 0x000260, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_SetStaticMesh_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_VictoryIntMinusEquals_IntOut) == 0x000264, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_VictoryIntMinusEquals_IntOut' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000268, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_Divide_FloatFloat_ReturnValue) == 0x00026C, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_MultiplyMultiply_FloatFloat_ReturnValue) == 0x000270, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_MultiplyMultiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, K2Node_Event_player) == 0x000278, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, K2Node_Event_hit) == 0x000280, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, K2Node_Event_action) == 0x000308, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_Lerp_ReturnValue) == 0x00030C, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_Lerp_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_Divide_FloatFloat_ReturnValue_1) == 0x000310, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_Divide_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, Temp_int_Variable_1) == 0x000314, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::Temp_int_Variable_1' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_RandomFloatInRange_ReturnValue_2) == 0x000318, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_RandomFloatInRange_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_FMax_ReturnValue) == 0x00031C, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_FMax_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000320, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_Add_FloatFloat_ReturnValue) == 0x000324, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_Add_IntInt_ReturnValue_1) == 0x000328, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_Conv_IntToFloat_ReturnValue_1) == 0x00032C, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_Conv_IntToFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_Divide_FloatFloat_ReturnValue_2) == 0x000330, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_Divide_FloatFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_Lerp_ReturnValue_1) == 0x000334, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_Lerp_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_Less_IntInt_ReturnValue) == 0x000338, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush, CallFunc_K2_GetComponentLocation_ReturnValue_1) == 0x00033C, "Member 'Prop_eriePlush_C_ExecuteUbergraph_prop_eriePlush::CallFunc_K2_GetComponentLocation_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(Prop_eriePlush_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_eriePlush_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_eriePlush_C_BndEvt__prop_eriePlush_StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature, Hit_0) == 0x000024, "Member 'Prop_eriePlush_C_BndEvt__prop_eriePlush_StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature::Hit_0' has a wrong offset!");
