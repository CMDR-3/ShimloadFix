...
static_assert(offsetof(Prop_bombBarrel_C_BndEvt__prop_bombBarrel_StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature, Hit_0) == 0x000024, "Member 'Prop_bombBarrel_C_BndEvt__prop_bombBarrel_StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_bombBarrel_C_AddDamage, Hit_0) == 0x00000C, "Member 'Prop_bombBarrel_C_AddDamage::Hit_0' has a wrong offset!");
static_assert(offsetof(Prop_bombBarrel_C_AddDamage, Impact_0) == 0x000094, "Member 'Prop_bombBarrel_C_AddDamage::Impact_0' has a wrong offset!");
