...
// bool                                    Step_0                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void ATentacleBall_C::Step(const struct FVector& Location, bool Step_0)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// TArray<class ATentacleBall_C*>          buddies_0                                              (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void ATentacleBall_C::SetBuddies(TArray<class ATentacleBall_C*>& buddies_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.buddies_0 = std::move(buddies_0);

	UObject::ProcessEvent(Func, &Parms);

	buddies_0 = std::move(Parms.buddies_0);
}
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// int32                                   ITalk_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ATentacleBall_C::Talk(int32 ITalk_0)
{
	static class UFunction* Func = nullptr;
