...
public:
	static class URealTimeImportAsyncNodeCreateSoundWaveFromBytes* CreateSoundWaveFromBytesAsyncNode(const class FString& Name_0, const TArray<uint8>& bytes, float MaxFileSize, ERTISoundFileType SoundFileType);
...
public:
	static class URealTimeImportAsyncNodeLoadImageBytes* LoadImageBytesAsyncNode(const class FString& Name_0, const TArray<uint8>& bytes, ETextureCompressionSettings CompressionSettings, bool SRGB, bool CreateMipMaps, ERTIERGBFormat RgbFormat);
...
public:
	...
	static void breakModelStruct(const struct FRTIModelStruct& ModelStruct, class FString* Name_0, struct FTransform* RelativeTransform, TArray<struct FRTIMeshStruct>* MeshStructs);
	...
	static void CreateSoundWaveFromBytes(const class FString& Name_0, const TArray<uint8>& bytes, float MaxFileSize, ERTISoundFileType SoundFileType, class USoundWaveProcedural** Sound, int32* ErrorCode, class FString* ErrorMessage);
	static class URealTimeImportBPLibrary* CreateSoundWaveFromBytesAsync(const class FString& Name_0, const TArray<uint8>& bytes, float MaxFileSize, ERTISoundFileType SoundFileType, const class FString& EventID);
	...
	static void GetSoundInfo(ERTIDirectoryType DirectoryType, const class FString& FilePath, class FString* Name_0, class FString* FileNameExtension, int64* FileSize, float* Duration, int64* NumChannels, int32* Quality, int64* SampleDataSize, int64* SampleRate);
	...
	static void LoadImageBytes(const class FString& Name_0, const TArray<uint8>& bytes, class UTexture2D** Texture, int32* ErrorCode, class FString* ErrorMessage, ETextureCompressionSettings CompressionSettings, bool SRGB, bool CreateMipMaps, ERTIERGBFormat RgbFormat);
	static class URealTimeImportBPLibrary* LoadImageBytesAsync(const class FString& Name_0, const TArray<uint8>& bytes, const class FString& EventID, ETextureCompressionSettings CompressionSettings, bool SRGB, bool CreateMipMaps, ERTIERGBFormat RgbFormat);
