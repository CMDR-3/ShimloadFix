...
static_assert(offsetof(Umg_shopOrderSlot_C_SetIndex, Index_0) == 0x000000, "Member 'Umg_shopOrderSlot_C_SetIndex::Index_0' has a wrong offset!");
...
static_assert(offsetof(Umg_shopOrderSlot_C_Updtime, Time_0) == 0x000000, "Member 'Umg_shopOrderSlot_C_Updtime::Time_0' has a wrong offset!");
...
static_assert(sizeof(Umg_shopOrderSlot_C_Upd) == 0x000050, "Wrong size on Umg_shopOrderSlot_C_Upd");
...
static_assert(offsetof(Umg_shopOrderSlot_C_Upd, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000031, "Member 'Umg_shopOrderSlot_C_Upd::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_shopOrderSlot_C_Upd, CallFunc_IsValid_ReturnValue) == 0x000032, "Member 'Umg_shopOrderSlot_C_Upd::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_shopOrderSlot_C_Upd, CallFunc_BooleanAND_ReturnValue) == 0x000033, "Member 'Umg_shopOrderSlot_C_Upd::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_shopOrderSlot_C_Upd, K2Node_Select_Default) == 0x000038, "Member 'Umg_shopOrderSlot_C_Upd::K2Node_Select_Default' has a wrong offset!");
