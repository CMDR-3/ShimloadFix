...
public:
	...
	class AMainGamemode_C*                        GameMode;                                          // 0x02E0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UUmg_damageIndicator_C) == 0x0002E8, "Wrong size on UUmg_damageIndicator_C");
...
static_assert(offsetof(UUmg_damageIndicator_C, GameMode) == 0x0002E0, "Member 'UUmg_damageIndicator_C::GameMode' has a wrong offset!");
