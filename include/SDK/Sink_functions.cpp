...
void ASink_C::CleanSponge(float Clean_0, class AMainPlayer_C* Player)
{
	static class UFunction* Func = nullptr;
...
void ASink_C::SendName(class FName Name_0)
{
	static class UFunction* Func = nullptr;
...
void ASink_C::NoRespawn(bool NoRespawn_0, bool* Return)
{
	static class UFunction* Func = nullptr;
