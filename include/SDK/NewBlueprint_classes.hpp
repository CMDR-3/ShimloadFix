...
public:
	...
	class FString                                 NewVar_2;                                          // 0x02A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash)
...
static_assert(sizeof(ANewBlueprint_C) == 0x0002B0, "Wrong size on ANewBlueprint_C");
...
static_assert(offsetof(ANewBlueprint_C, Results) == 0x000290, "Member 'ANewBlueprint_C::Results' has a wrong offset!");
static_assert(offsetof(ANewBlueprint_C, NewVar_2) == 0x0002A0, "Member 'ANewBlueprint_C::NewVar_2' has a wrong offset!");
