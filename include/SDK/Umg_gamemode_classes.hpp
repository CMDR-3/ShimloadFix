...
public:
	...
	struct FStruct_settings                       SettingsCopy;                                      // 0x02F0(0x0100)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	TArray<class FText>                           Desc;                                              // 0x03F0(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
	class AMainGamemode_C*                        GameMode;                                          // 0x0400(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UUmg_gamemode_C) == 0x000408, "Wrong size on UUmg_gamemode_C");
...
static_assert(offsetof(UUmg_gamemode_C, Desc) == 0x0003F0, "Member 'UUmg_gamemode_C::Desc' has a wrong offset!");
static_assert(offsetof(UUmg_gamemode_C, GameMode) == 0x000400, "Member 'UUmg_gamemode_C::GameMode' has a wrong offset!");
