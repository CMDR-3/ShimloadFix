...
static_assert(sizeof(LowEntryExtendedStandardLibrary_RandomDelay) == 0x000028, "Wrong size on LowEntryExtendedStandardLibrary_RandomDelay");
...
static_assert(sizeof(LowEntryExtendedStandardLibrary_RetriggerableRandomDelay) == 0x000028, "Wrong size on LowEntryExtendedStandardLibrary_RetriggerableRandomDelay");
...
static_assert(sizeof(LowEntryExtendedStandardLibrary_TickSeconds) == 0x000030, "Wrong size on LowEntryExtendedStandardLibrary_TickSeconds");
...
static_assert(offsetof(LowEntryExtendedStandardLibrary_TickSeconds, SecondsInterval) == 0x000024, "Member 'LowEntryExtendedStandardLibrary_TickSeconds::SecondsInterval' has a wrong offset!");
static_assert(offsetof(LowEntryExtendedStandardLibrary_TickSeconds, Tick) == 0x000028, "Member 'LowEntryExtendedStandardLibrary_TickSeconds::Tick' has a wrong offset!");
