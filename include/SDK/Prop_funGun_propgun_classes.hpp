...
{
public:
	class FName                                   Prop;                                              // 0x0440(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AProp_funGun_propgun_C) == 0x000448, "Wrong size on AProp_funGun_propgun_C");
static_assert(offsetof(AProp_funGun_propgun_C, Prop) == 0x000440, "Member 'AProp_funGun_propgun_C::Prop' has a wrong offset!");
