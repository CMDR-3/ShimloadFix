...
public:
	...
	TArray<class FString>                         NewVar_0;                                          // 0x0390(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(sizeof(UUmg_patronList_C) == 0x0003A0, "Wrong size on UUmg_patronList_C");
...
static_assert(offsetof(UUmg_patronList_C, NewVar_0) == 0x000390, "Member 'UUmg_patronList_C::NewVar_0' has a wrong offset!");
