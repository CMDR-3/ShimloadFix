...
public:
	...
	class AMainGamemode_C*                        GameMode;                                          // 0x0250(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AKerfusPossessor_C) == 0x000258, "Wrong size on AKerfusPossessor_C");
...
static_assert(offsetof(AKerfusPossessor_C, GameMode) == 0x000250, "Member 'AKerfusPossessor_C::GameMode' has a wrong offset!");
