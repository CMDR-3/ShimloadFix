...
public:
	...
	struct FIntVector                             K2Node_CustomEvent_time;                           // 0x0010(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(const struct FIntVector& Time)> K2Node_CreateDelegate_OutputDelegate;              // 0x0028(0x0010)(ZeroConstructor, NoDestructor)
	...
	bool                                          CallFunc_EqualEqual_BoolBool_ReturnValue;          // 0x0051(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(TriggerTimer_C_ExecuteUbergraph_triggerTimer) == 0x000058, "Wrong size on TriggerTimer_C_ExecuteUbergraph_triggerTimer");
...
static_assert(offsetof(TriggerTimer_C_ExecuteUbergraph_triggerTimer, Temp_int_Loop_Counter_Variable) == 0x000004, "Member 'TriggerTimer_C_ExecuteUbergraph_triggerTimer::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(TriggerTimer_C_ExecuteUbergraph_triggerTimer, Temp_int_Array_Index_Variable) == 0x000008, "Member 'TriggerTimer_C_ExecuteUbergraph_triggerTimer::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(TriggerTimer_C_ExecuteUbergraph_triggerTimer, CallFunc_Add_IntInt_ReturnValue) == 0x00000C, "Member 'TriggerTimer_C_ExecuteUbergraph_triggerTimer::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(TriggerTimer_C_ExecuteUbergraph_triggerTimer, K2Node_CustomEvent_time) == 0x000010, "Member 'TriggerTimer_C_ExecuteUbergraph_triggerTimer::K2Node_CustomEvent_time' has a wrong offset!");
static_assert(offsetof(TriggerTimer_C_ExecuteUbergraph_triggerTimer, CallFunc_Array_Get_Item) == 0x000020, "Member 'TriggerTimer_C_ExecuteUbergraph_triggerTimer::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(TriggerTimer_C_ExecuteUbergraph_triggerTimer, K2Node_CreateDelegate_OutputDelegate) == 0x000028, "Member 'TriggerTimer_C_ExecuteUbergraph_triggerTimer::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(TriggerTimer_C_ExecuteUbergraph_triggerTimer, K2Node_DynamicCast_AsInt_Ttrigger) == 0x000038, "Member 'TriggerTimer_C_ExecuteUbergraph_triggerTimer::K2Node_DynamicCast_AsInt_Ttrigger' has a wrong offset!");
static_assert(offsetof(TriggerTimer_C_ExecuteUbergraph_triggerTimer, K2Node_DynamicCast_bSuccess) == 0x000048, "Member 'TriggerTimer_C_ExecuteUbergraph_triggerTimer::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(TriggerTimer_C_ExecuteUbergraph_triggerTimer, CallFunc_Array_Length_ReturnValue) == 0x00004C, "Member 'TriggerTimer_C_ExecuteUbergraph_triggerTimer::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(TriggerTimer_C_ExecuteUbergraph_triggerTimer, CallFunc_Less_IntInt_ReturnValue) == 0x000050, "Member 'TriggerTimer_C_ExecuteUbergraph_triggerTimer::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(TriggerTimer_C_ExecuteUbergraph_triggerTimer, CallFunc_EqualEqual_BoolBool_ReturnValue) == 0x000051, "Member 'TriggerTimer_C_ExecuteUbergraph_triggerTimer::CallFunc_EqualEqual_BoolBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(TriggerTimer_C_ExecuteUbergraph_triggerTimer, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000052, "Member 'TriggerTimer_C_ExecuteUbergraph_triggerTimer::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
