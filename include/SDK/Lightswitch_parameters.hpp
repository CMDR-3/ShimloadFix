...
static_assert(offsetof(Lightswitch_C_SendName, Name_0) == 0x000000, "Member 'Lightswitch_C_SendName::Name_0' has a wrong offset!");
...
static_assert(offsetof(Lightswitch_C_NoRespawn, NoRespawn_0) == 0x000000, "Member 'Lightswitch_C_NoRespawn::NoRespawn_0' has a wrong offset!");
