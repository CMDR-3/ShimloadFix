...
static_assert(offsetof(Prop_food_potatoCooked_C_ExecuteUbergraph_prop_food_potatoCooked, CallFunc_propToObject_fuckYouRetard) == 0x0000B8, "Member 'Prop_food_potatoCooked_C_ExecuteUbergraph_prop_food_potatoCooked::CallFunc_propToObject_fuckYouRetard' has a wrong offset!");
