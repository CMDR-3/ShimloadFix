...
public:
	...
	int32                                         MatType;                                           // 0x0258(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
...
public:
	...
	void ProcessBuriedItem(const struct FStruct_save& InputPin, class AProp_C* Actor);
...
static_assert(sizeof(ADirthole_C) == 0x000260, "Wrong size on ADirthole_C");
...
static_assert(offsetof(ADirthole_C, MatType) == 0x000258, "Member 'ADirthole_C::MatType' has a wrong offset!");
