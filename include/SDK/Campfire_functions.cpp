...
// class ADreamBase_C*                     Base_0                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ACampfire_C::DreamInv(TArray<struct FStruct_save>& Invv, class ADreamBase_C** Base_0)
{
	static class UFunction* Func = nullptr;
...
void ACampfire_C::SetActiveTrigger(class AActor* SentFrom, bool Active_0)
{
	static class UFunction* Func = nullptr;
...
void ACampfire_C::StuffUpgraded(class AMainGamemode_C* GameMode_0)
{
	static class UFunction* Func = nullptr;
...
void ACampfire_C::AnyKey(const struct FKey& Key_0, bool Pressed)
{
	static class UFunction* Func = nullptr;
...
void ACampfire_C::TexturePickerApply(class UUmg_texturePicker_C* Picker, class UTexture2D* Texture, int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
// Function campfire.campfire_C.NewFunction_2
// (Public, BlueprintCallable, BlueprintEvent)

void ACampfire_C::NewFunction_2()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("campfire_C", "NewFunction_2");

	UObject::ProcessEvent(Func, nullptr);
}


// Function campfire.campfire_C.NewFunction_3
// (Public, BlueprintCallable, BlueprintEvent)

void ACampfire_C::NewFunction_3()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("campfire_C", "NewFunction_3");

	UObject::ProcessEvent(Func, nullptr);
}


// Function campfire.campfire_C.gamemodePostKeys
// (Public, BlueprintCallable, BlueprintEvent)

void ACampfire_C::GamemodePostKeys()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("campfire_C", "gamemodePostKeys");
...
void ACampfire_C::RunTrigger(class AActor* Owner_0, int32 Index_0)
{
	static class UFunction* Func = nullptr;
