...
public:
	...
	bool                                          CallFunc_EqualEqual_ObjectObject_ReturnValue_3;    // 0x01F9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class FName                                   CallFunc_Conv_StringToName_ReturnValue_2;          // 0x0250(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	Enum_interactionActions                       K2Node_Event_action;                               // 0x0338(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FName                                   K2Node_Select_Default_1;                           // 0x03EC(0x0008)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(Panel_computer_C_ExecuteUbergraph_panel_computer) == 0x000400, "Wrong size on Panel_computer_C_ExecuteUbergraph_panel_computer");
...
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, Temp_int_Variable) == 0x000004, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::Temp_int_Variable' has a wrong offset!");
...
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, Temp_name_Variable) == 0x0001D4, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::Temp_name_Variable' has a wrong offset!");
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, CallFunc_getMainPlayer_AsMain_Player) == 0x0001E0, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::CallFunc_getMainPlayer_AsMain_Player' has a wrong offset!");
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, K2Node_Event_DeltaSeconds) == 0x0001E8, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, Temp_int_Variable_1) == 0x0001EC, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::Temp_int_Variable_1' has a wrong offset!");
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, CallFunc_IsValid_ReturnValue) == 0x0001F0, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, CallFunc_Percent_IntInt_ReturnValue) == 0x0001F4, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::CallFunc_Percent_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, CallFunc_EqualEqual_ObjectObject_ReturnValue_3) == 0x0001F9, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::CallFunc_EqualEqual_ObjectObject_ReturnValue_3' has a wrong offset!");
...
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, CallFunc_Add_IntInt_ReturnValue) == 0x00020C, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, CallFunc_Concat_StrStr_ReturnValue) == 0x000210, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, CallFunc_Conv_StringToName_ReturnValue) == 0x000220, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, CallFunc_Concat_StrStr_ReturnValue_2) == 0x000238, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::CallFunc_Concat_StrStr_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, CallFunc_Conv_StringToName_ReturnValue_1) == 0x000248, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::CallFunc_Conv_StringToName_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, CallFunc_Conv_StringToName_ReturnValue_2) == 0x000250, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::CallFunc_Conv_StringToName_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, CallFunc_getSaveSlot_saveSlot) == 0x000260, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::CallFunc_getSaveSlot_saveSlot' has a wrong offset!");
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, K2Node_Select_Default) == 0x000268, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::K2Node_Select_Default' has a wrong offset!");
...
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, K2Node_Event_action) == 0x000338, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::K2Node_Event_action' has a wrong offset!");
...
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, Temp_bool_Variable) == 0x0003E8, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, CallFunc_IsValid_ReturnValue_2) == 0x0003E9, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Panel_computer_C_ExecuteUbergraph_panel_computer, K2Node_Select_Default_1) == 0x0003EC, "Member 'Panel_computer_C_ExecuteUbergraph_panel_computer::K2Node_Select_Default_1' has a wrong offset!");
...
static_assert(offsetof(Panel_computer_C_ActionOptionIndex, Action) == 0x000090, "Member 'Panel_computer_C_ActionOptionIndex::Action' has a wrong offset!");
...
static_assert(offsetof(Panel_computer_C_StuffUpgraded, GameMode_0) == 0x000000, "Member 'Panel_computer_C_StuffUpgraded::GameMode_0' has a wrong offset!");
...
static_assert(offsetof(Panel_computer_C_LookAt, Number) == 0x0000B0, "Member 'Panel_computer_C_LookAt::Number' has a wrong offset!");
static_assert(offsetof(Panel_computer_C_LookAt, CallFunc_BreakHitResult_bBlockingHit) == 0x0000B1, "Member 'Panel_computer_C_LookAt::CallFunc_BreakHitResult_bBlockingHit' has a wrong offset!");
static_assert(offsetof(Panel_computer_C_LookAt, CallFunc_BreakHitResult_bInitialOverlap) == 0x0000B2, "Member 'Panel_computer_C_LookAt::CallFunc_BreakHitResult_bInitialOverlap' has a wrong offset!");
...
static_assert(sizeof(Panel_computer_C_GetActionOptions) == 0x000060, "Wrong size on Panel_computer_C_GetActionOptions");
...
static_assert(offsetof(Panel_computer_C_GetActionOptions, Number) == 0x000048, "Member 'Panel_computer_C_GetActionOptions::Number' has a wrong offset!");
static_assert(offsetof(Panel_computer_C_GetActionOptions, K2Node_MakeArray_Array) == 0x000050, "Member 'Panel_computer_C_GetActionOptions::K2Node_MakeArray_Array' has a wrong offset!");
