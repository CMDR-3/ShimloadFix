...
void UUmg_paperDraw_C::ApplyColor(const struct FLinearColor& Color_0)
{
	static class UFunction* Func = nullptr;
...
void UUmg_paperDraw_C::TexturePickerApply(class UUmg_texturePicker_C* Picker, class UTexture2D* Texture, int32 Index_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("umg_paperDraw_C", "texturePickerApply");

	Params::Umg_paperDraw_C_TexturePickerApply Parms{};
...
// Function umg_paperDraw.umg_paperDraw_C.NewFunction_2
// (Public, BlueprintCallable, BlueprintEvent)

void UUmg_paperDraw_C::NewFunction_2()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("umg_paperDraw_C", "NewFunction_2");

	UObject::ProcessEvent(Func, nullptr);
}


// Function umg_paperDraw.umg_paperDraw_C.NewFunction_3
// (Public, BlueprintCallable, BlueprintEvent)

void UUmg_paperDraw_C::NewFunction_3()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("umg_paperDraw_C", "NewFunction_3");

	UObject::ProcessEvent(Func, nullptr);
}


// Function umg_paperDraw.umg_paperDraw_C.gamemodePostKeys
// (Public, BlueprintCallable, BlueprintEvent)

void UUmg_paperDraw_C::GamemodePostKeys()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("umg_paperDraw_C", "gamemodePostKeys");
...
void UUmg_paperDraw_C::Init(class AProp_paper_drawable_C* PaperDraw_0, float Angle_0, class AProp_pencil_C* Pencil)
{
	static class UFunction* Func = nullptr;
