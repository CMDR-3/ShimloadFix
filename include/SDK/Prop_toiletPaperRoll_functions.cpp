...
void AProp_toiletPaperRoll_C::BndEvt__prop_poo_physicsImpact_K2Node_ComponentBoundEvent_1_hitEvent__DelegateSignature(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("prop_toiletPaperRoll_C", "BndEvt__prop_poo_physicsImpact_K2Node_ComponentBoundEvent_1_hitEvent__DelegateSignature");

	Params::Prop_toiletPaperRoll_C_BndEvt__prop_poo_physicsImpact_K2Node_ComponentBoundEvent_1_hitEvent__DelegateSignature Parms{};
...
void AProp_toiletPaperRoll_C::Player_use(class AMainPlayer_C* Player, const struct FHitResult& Hit_0)
{
	static class UFunction* Func = nullptr;
