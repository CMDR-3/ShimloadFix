...
public:
	...
	bool                                          Reverse_17_FF574DE14D51000F2D3913849A26EE8B;       // 0x0040(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(FStruct_crafting) == 0x000008, "Wrong alignment on FStruct_crafting");
static_assert(sizeof(FStruct_crafting) == 0x000048, "Wrong size on FStruct_crafting");
...
static_assert(offsetof(FStruct_crafting, Reverse_17_FF574DE14D51000F2D3913849A26EE8B) == 0x000040, "Member 'FStruct_crafting::Reverse_17_FF574DE14D51000F2D3913849A26EE8B' has a wrong offset!");
