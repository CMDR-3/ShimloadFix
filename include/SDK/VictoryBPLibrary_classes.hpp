...
public:
	...
	static bool Array_IsValidIndex(const TArray<int32>& TargetArray, int32 Index_0);
	...
	static class UPrimitiveComponent* CreatePrimitiveComponent(class UObject* WorldContextObject, TSubclassOf<class UPrimitiveComponent> CompClass, class FName Name_0, const struct FVector& Location, const struct FRotator& Rotation);
