...
public:
	...
	class UClass*                                 Temp_class_Variable_15;                            // 0x00C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_GetPhysicsAngularVelocityInDegrees_ReturnValue; // 0x0128(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_RandomUnitVector_ReturnValue;             // 0x0158(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         Temp_int_Variable_18;                              // 0x0178(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_GetVelocity_ReturnValue;                  // 0x0184(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetVelocity_ReturnValue_1;                // 0x0190(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_GetActorRightVector_ReturnValue_1;        // 0x01BC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Dot_VectorVector_ReturnValue_2;           // 0x01D4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_Multiply_VectorFloat_ReturnValue_5;       // 0x01F0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_RandomFloat_ReturnValue;                  // 0x01FC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Ease_ReturnValue;                         // 0x020C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_Multiply_VectorFloat_ReturnValue_6;       // 0x0244(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_GetActorRightVector_ReturnValue_2;        // 0x0280(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_28C[0x4];                                      // 0x028C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UPrimitiveComponent*                    K2Node_ComponentBoundEvent_HitComponent;           // 0x0290(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                K2Node_ComponentBoundEvent_NormalImpulse;          // 0x02A8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_ComponentBoundEvent_Hit;                    // 0x02B4(0x0088)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue_2;        // 0x033C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_Normal_ReturnValue_1;                     // 0x0360(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetActorForwardVector_ReturnValue_2;      // 0x036C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Dot_VectorVector_ReturnValue_3;           // 0x0378(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Multiply_VectorFloat_ReturnValue_7;       // 0x037C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_Multiply_VectorFloat_ReturnValue_8;       // 0x038C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	Enum_interactionActions                       K2Node_Event_action;                               // 0x0428(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_429[0x7];                                      // 0x0429(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 K2Node_Event_actor;                                // 0x0430(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_Event_damage;                               // 0x0438(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_Event_hit;                                  // 0x043C(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FVector                                K2Node_Event_impact;                               // 0x04C4(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_skipSetting;                          // 0x04D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_Greater_FloatFloat_ReturnValue_1;         // 0x04D1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_4D2[0x2];                                      // 0x04D2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_VictoryFloatMinusEquals_FloatOut;         // 0x04D4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Less_FloatFloat_ReturnValue;              // 0x04D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_clean;                                // 0x04D9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, Temp_int_Variable_16) == 0x000044, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::Temp_int_Variable_16' has a wrong offset!");
...
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, Temp_class_Variable_15) == 0x0000C0, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::Temp_class_Variable_15' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_Select_Default) == 0x0000C8, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_Event_DeltaSeconds) == 0x0000D0, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_GetActorRightVector_ReturnValue) == 0x0000D4, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_GetActorRightVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_GetActorForwardVector_ReturnValue) == 0x0000E0, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_GetActorForwardVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Dot_VectorVector_ReturnValue) == 0x0000EC, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Dot_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Dot_VectorVector_ReturnValue_1) == 0x0000F0, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Dot_VectorVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x0000F4, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_FloatFloat_ReturnValue_1) == 0x0000F8, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_VectorFloat_ReturnValue) == 0x0000FC, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_VectorFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_VectorFloat_ReturnValue_1) == 0x000108, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_VectorFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, Temp_int_Variable_17) == 0x000114, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::Temp_int_Variable_17' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Add_VectorVector_ReturnValue) == 0x000118, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Add_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_Select_Default_1) == 0x000124, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_GetPhysicsAngularVelocityInDegrees_ReturnValue) == 0x000128, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_GetPhysicsAngularVelocityInDegrees_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_GetComponentVelocity_ReturnValue) == 0x000134, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_GetComponentVelocity_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_VectorFloat_ReturnValue_2) == 0x000140, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_VectorFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_VectorFloat_ReturnValue_3) == 0x00014C, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_VectorFloat_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_RandomUnitVector_ReturnValue) == 0x000158, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_RandomUnitVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_RandomFloatInRange_ReturnValue) == 0x000164, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_RandomFloatInRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_VectorFloat_ReturnValue_4) == 0x000168, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_VectorFloat_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_RandomFloatInRange_ReturnValue_1) == 0x000174, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_RandomFloatInRange_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, Temp_int_Variable_18) == 0x000178, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::Temp_int_Variable_18' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_LessEqual_IntInt_ReturnValue) == 0x00017C, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Add_IntInt_ReturnValue) == 0x000180, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_GetVelocity_ReturnValue) == 0x000184, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_GetVelocity_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_GetVelocity_ReturnValue_1) == 0x000190, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_GetVelocity_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_VectorVector_ReturnValue) == 0x00019C, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_VSize_ReturnValue) == 0x0001A8, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_VSize_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Normal_ReturnValue) == 0x0001AC, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Normal_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Greater_FloatFloat_ReturnValue) == 0x0001B8, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Greater_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_GetActorRightVector_ReturnValue_1) == 0x0001BC, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_GetActorRightVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_GetActorForwardVector_ReturnValue_1) == 0x0001C8, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_GetActorForwardVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Dot_VectorVector_ReturnValue_2) == 0x0001D4, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Dot_VectorVector_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_FloatFloat_ReturnValue_2) == 0x0001D8, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_FloatFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, Temp_object_Variable) == 0x0001E0, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_VectorFloat_ReturnValue_5) == 0x0001F0, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_VectorFloat_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_RandomFloat_ReturnValue) == 0x0001FC, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_RandomFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_SelectVector_ReturnValue) == 0x000200, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_SelectVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Ease_ReturnValue) == 0x00020C, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Ease_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Add_VectorVector_ReturnValue_1) == 0x000210, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Add_VectorVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_RandomFloatInRange_ReturnValue_2) == 0x00021C, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_RandomFloatInRange_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Add_VectorVector_ReturnValue_2) == 0x000220, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Add_VectorVector_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_SignOfFloat_ReturnValue) == 0x00022C, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_SignOfFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_FloatFloat_ReturnValue_3) == 0x000230, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_FloatFloat_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_MakeVector_ReturnValue) == 0x000234, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_MakeVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_FloatFloat_ReturnValue_4) == 0x000240, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_FloatFloat_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_VectorFloat_ReturnValue_6) == 0x000244, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_VectorFloat_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000250, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_obj_pawn_obj) == 0x000260, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_obj_pawn_obj' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_K2_GetActorLocation_ReturnValue_1) == 0x000270, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_K2_GetActorLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_IsValid_ReturnValue) == 0x00027C, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_GetActorRightVector_ReturnValue_2) == 0x000280, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_GetActorRightVector_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_ComponentBoundEvent_HitComponent) == 0x000290, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_ComponentBoundEvent_HitComponent' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_ComponentBoundEvent_OtherActor) == 0x000298, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_ComponentBoundEvent_OtherActor' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_ComponentBoundEvent_OtherComp) == 0x0002A0, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_ComponentBoundEvent_OtherComp' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_ComponentBoundEvent_NormalImpulse) == 0x0002A8, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_ComponentBoundEvent_NormalImpulse' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_ComponentBoundEvent_Hit) == 0x0002B4, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_ComponentBoundEvent_Hit' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_K2_GetActorLocation_ReturnValue_2) == 0x00033C, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_K2_GetActorLocation_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Subtract_VectorVector_ReturnValue) == 0x000348, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Subtract_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_VectorVector_ReturnValue_1) == 0x000354, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_VectorVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Normal_ReturnValue_1) == 0x000360, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Normal_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_GetActorForwardVector_ReturnValue_2) == 0x00036C, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_GetActorForwardVector_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Dot_VectorVector_ReturnValue_3) == 0x000378, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Dot_VectorVector_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_VectorFloat_ReturnValue_7) == 0x00037C, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_VectorFloat_ReturnValue_7' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_FloatFloat_ReturnValue_5) == 0x000388, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_FloatFloat_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Multiply_VectorFloat_ReturnValue_8) == 0x00038C, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Multiply_VectorFloat_ReturnValue_8' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_Event_player) == 0x000398, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_Event_hit_1) == 0x0003A0, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_Event_hit_1' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_Event_action) == 0x000428, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_Event_actor) == 0x000430, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_Event_actor' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_Event_damage) == 0x000438, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_Event_damage' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_Event_hit) == 0x00043C, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_Event_impact) == 0x0004C4, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_Event_impact' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_Event_skipSetting) == 0x0004D0, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_Event_skipSetting' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Greater_FloatFloat_ReturnValue_1) == 0x0004D1, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Greater_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_VictoryFloatMinusEquals_FloatOut) == 0x0004D4, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_VictoryFloatMinusEquals_FloatOut' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, CallFunc_Less_FloatFloat_ReturnValue) == 0x0004D8, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::CallFunc_Less_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_ExecuteUbergraph_prop_fish, K2Node_Event_clean) == 0x0004D9, "Member 'Prop_fish_C_ExecuteUbergraph_prop_fish::K2Node_Event_clean' has a wrong offset!");
...
static_assert(offsetof(Prop_fish_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_fish_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_fish_C_BndEvt__prop_fish_StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature, Hit_0) == 0x000024, "Member 'Prop_fish_C_BndEvt__prop_fish_StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_fish_C_AddDamage, Hit_0) == 0x00000C, "Member 'Prop_fish_C_AddDamage::Hit_0' has a wrong offset!");
...
static_assert(sizeof(Prop_fish_C_Init) == 0x00008C, "Wrong size on Prop_fish_C_Init");
...
static_assert(offsetof(Prop_fish_C_Init, Temp_name_Variable_15) == 0x00007C, "Member 'Prop_fish_C_Init::Temp_name_Variable_15' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_Init, K2Node_Select_Default) == 0x000084, "Member 'Prop_fish_C_Init::K2Node_Select_Default' has a wrong offset!");
...
// Function prop_fish.prop_fish_C.lookAt
// 0x00D8 (0x00D8 - 0x0000)
struct Prop_fish_C_LookAt final
{
public:
	class AMainPlayer_C*                          Player;                                            // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             Hit_0;                                             // 0x0008(0x0088)(BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	bool                                          CallFunc_lookAt_return;                            // 0x00B1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_B2[0x6];                                       // 0x00B2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 CallFunc_lookAt_text;                              // 0x00B8(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class UPrimitiveComponent*                    CallFunc_lookAt_boundObjectReplace;                // 0x00C8(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         CallFunc_lookAt_number;                            // 0x00D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         CallFunc_Conv_BoolToByte_ReturnValue;              // 0x00D1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(Prop_fish_C_LookAt) == 0x000008, "Wrong alignment on Prop_fish_C_LookAt");
static_assert(sizeof(Prop_fish_C_LookAt) == 0x0000D8, "Wrong size on Prop_fish_C_LookAt");
static_assert(offsetof(Prop_fish_C_LookAt, Player) == 0x000000, "Member 'Prop_fish_C_LookAt::Player' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_LookAt, Hit_0) == 0x000008, "Member 'Prop_fish_C_LookAt::Hit_0' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_LookAt, Return) == 0x000090, "Member 'Prop_fish_C_LookAt::Return' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_LookAt, Text) == 0x000098, "Member 'Prop_fish_C_LookAt::Text' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_LookAt, boundObjectReplace) == 0x0000A8, "Member 'Prop_fish_C_LookAt::boundObjectReplace' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_LookAt, Number) == 0x0000B0, "Member 'Prop_fish_C_LookAt::Number' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_LookAt, CallFunc_lookAt_return) == 0x0000B1, "Member 'Prop_fish_C_LookAt::CallFunc_lookAt_return' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_LookAt, CallFunc_lookAt_text) == 0x0000B8, "Member 'Prop_fish_C_LookAt::CallFunc_lookAt_text' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_LookAt, CallFunc_lookAt_boundObjectReplace) == 0x0000C8, "Member 'Prop_fish_C_LookAt::CallFunc_lookAt_boundObjectReplace' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_LookAt, CallFunc_lookAt_number) == 0x0000D0, "Member 'Prop_fish_C_LookAt::CallFunc_lookAt_number' has a wrong offset!");
static_assert(offsetof(Prop_fish_C_LookAt, CallFunc_Conv_BoolToByte_ReturnValue) == 0x0000D1, "Member 'Prop_fish_C_LookAt::CallFunc_Conv_BoolToByte_ReturnValue' has a wrong offset!");
