...
{
public:
	class UMaterialInstanceDynamic*               Dynmat_0;                                          // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(KerfusFace_C_Gen, Dynmat_0) == 0x000000, "Member 'KerfusFace_C_Gen::Dynmat_0' has a wrong offset!");
