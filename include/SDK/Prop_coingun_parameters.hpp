...
public:
	...
	struct FRotator                               CallFunc_arm_rotation;                             // 0x0038(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_IsChildActor_ReturnValue;                 // 0x0179(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_17A[0x6];                                      // 0x017A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class AProp_C*                                CallFunc_asProp_return;                            // 0x0180(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_sellObject_points;                        // 0x018C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_sellObject_sold;                          // 0x0190(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(Prop_coingun_C_ExecuteUbergraph_prop_coingun) == 0x000198, "Wrong size on Prop_coingun_C_ExecuteUbergraph_prop_coingun");
...
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_arm_rotation) == 0x000038, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_arm_rotation' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, Temp_object_Variable) == 0x000048, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_LineTraceSingleForObjects_OutHit) == 0x000058, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_LineTraceSingleForObjects_OutHit' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_LineTraceSingleForObjects_ReturnValue) == 0x0000E0, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_LineTraceSingleForObjects_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_bBlockingHit) == 0x0000E1, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_bBlockingHit' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_bInitialOverlap) == 0x0000E2, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_bInitialOverlap' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_Time) == 0x0000E4, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_Time' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_Distance) == 0x0000E8, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_Distance' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_Location) == 0x0000EC, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_Location' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_ImpactPoint) == 0x0000F8, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_ImpactPoint' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_Normal) == 0x000104, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_Normal' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_ImpactNormal) == 0x000110, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_ImpactNormal' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_PhysMat) == 0x000120, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_PhysMat' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_HitActor) == 0x000128, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_HitActor' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_HitComponent) == 0x000130, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_HitComponent' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_HitBoneName) == 0x000138, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_HitBoneName' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_HitItem) == 0x000140, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_HitItem' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_ElementIndex) == 0x000144, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_ElementIndex' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_FaceIndex) == 0x000148, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_FaceIndex' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_TraceStart) == 0x00014C, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_TraceStart' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BreakHitResult_TraceEnd) == 0x000158, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BreakHitResult_TraceEnd' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, K2Node_DynamicCast_AsInt_Player) == 0x000168, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::K2Node_DynamicCast_AsInt_Player' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, K2Node_DynamicCast_bSuccess) == 0x000178, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_IsChildActor_ReturnValue) == 0x000179, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_IsChildActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_asProp_return) == 0x000180, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_asProp_return' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_Not_PreBool_ReturnValue) == 0x000188, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_IsValid_ReturnValue) == 0x000189, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_sellObject_points) == 0x00018C, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_sellObject_points' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_sellObject_sold) == 0x000190, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_sellObject_sold' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_DoesImplementInterface_ReturnValue) == 0x000191, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_DoesImplementInterface_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_coingun_C_ExecuteUbergraph_prop_coingun, CallFunc_BooleanAND_ReturnValue) == 0x000192, "Member 'Prop_coingun_C_ExecuteUbergraph_prop_coingun::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Prop_coingun_C_Sell, Index_0) == 0x000000, "Member 'Prop_coingun_C_Sell::Index_0' has a wrong offset!");
