...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_AriralNoTaker_C;                    // 0x0290(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class USphereComponent*                       DragAway;                                          // 0x0298(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class USphereComponent*                       Counter;                                           // 0x02A0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	TArray<class AActor*>                         AffectedObjects;                                   // 0x02A8(0x0010)(Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance)
...
static_assert(sizeof(AAriralNoTaker_C) == 0x0002C0, "Wrong size on AAriralNoTaker_C");
static_assert(offsetof(AAriralNoTaker_C, UberGraphFrame_AriralNoTaker_C) == 0x000290, "Member 'AAriralNoTaker_C::UberGraphFrame_AriralNoTaker_C' has a wrong offset!");
static_assert(offsetof(AAriralNoTaker_C, DragAway) == 0x000298, "Member 'AAriralNoTaker_C::DragAway' has a wrong offset!");
static_assert(offsetof(AAriralNoTaker_C, Counter) == 0x0002A0, "Member 'AAriralNoTaker_C::Counter' has a wrong offset!");
static_assert(offsetof(AAriralNoTaker_C, AffectedObjects) == 0x0002A8, "Member 'AAriralNoTaker_C::AffectedObjects' has a wrong offset!");
static_assert(offsetof(AAriralNoTaker_C, Active) == 0x0002B8, "Member 'AAriralNoTaker_C::Active' has a wrong offset!");
