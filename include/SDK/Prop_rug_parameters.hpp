...
public:
	...
	class FName                                   K2Node_Event_name;                                 // 0x0004(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_static;                               // 0x000C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_frozen;                               // 0x000D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_active;                               // 0x000E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UMaterialInterface*                     CallFunc_getCarpet_ReturnValue;                    // 0x0038(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AMainPlayer_C*                          K2Node_Event_player_3;                             // 0x0048(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_Event_hit;                                  // 0x0050(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	Enum_interactionActions                       K2Node_Event_action;                               // 0x00D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_Vector_SnappedToGrid_ReturnValue;         // 0x0180(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_ProjectPointOnToPlane_ReturnValue;        // 0x0198(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GridSnap_Float_ReturnValue;               // 0x01A4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                               CallFunc_MakeRotator_ReturnValue;                  // 0x01A8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FHitResult                             CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult; // 0x01B4(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	uint8                                         Pad_23C[0x4];                                      // 0x023C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AMainPlayer_C*                          K2Node_Event_player_1;                             // 0x0240(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AMainPlayer_C*                          K2Node_Event_player;                               // 0x0248(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Prop_rug_C_ExecuteUbergraph_prop_rug) == 0x000258, "Wrong size on Prop_rug_C_ExecuteUbergraph_prop_rug");
...
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, K2Node_Event_name) == 0x000004, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::K2Node_Event_name' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, K2Node_Event_static) == 0x00000C, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::K2Node_Event_static' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, K2Node_Event_frozen) == 0x00000D, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::K2Node_Event_frozen' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, K2Node_Event_active) == 0x00000E, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::K2Node_Event_active' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_Conv_NameToString_ReturnValue) == 0x000010, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_Conv_NameToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_FindSubstring_ReturnValue) == 0x000020, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_FindSubstring_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_Subtract_IntInt_ReturnValue) == 0x000024, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_RightChop_ReturnValue) == 0x000028, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_RightChop_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_getCarpet_ReturnValue) == 0x000038, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_getCarpet_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_Conv_StringToInt_ReturnValue) == 0x000040, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_Conv_StringToInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, K2Node_Event_player_3) == 0x000048, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::K2Node_Event_player_3' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, K2Node_Event_hit) == 0x000050, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, K2Node_Event_action) == 0x0000D8, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, K2Node_Event_DeltaSeconds) == 0x0000DC, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, K2Node_SwitchEnum_CmpSuccess) == 0x0000E0, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, K2Node_Event_player_2) == 0x0000E8, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::K2Node_Event_player_2' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_bBlockingHit) == 0x0000F0, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_bBlockingHit' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_bInitialOverlap) == 0x0000F1, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_bInitialOverlap' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_Time) == 0x0000F4, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_Time' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_Distance) == 0x0000F8, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_Distance' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_Location) == 0x0000FC, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_Location' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_ImpactPoint) == 0x000108, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_ImpactPoint' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_Normal) == 0x000114, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_Normal' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_ImpactNormal) == 0x000120, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_ImpactNormal' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_PhysMat) == 0x000130, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_PhysMat' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_HitActor) == 0x000138, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_HitActor' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_HitComponent) == 0x000140, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_HitComponent' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_HitBoneName) == 0x000148, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_HitBoneName' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_HitItem) == 0x000150, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_HitItem' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_ElementIndex) == 0x000154, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_ElementIndex' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_FaceIndex) == 0x000158, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_FaceIndex' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_TraceStart) == 0x00015C, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_TraceStart' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakHitResult_TraceEnd) == 0x000168, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakHitResult_TraceEnd' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_K2_GetActorRotation_ReturnValue) == 0x000174, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_K2_GetActorRotation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_Vector_SnappedToGrid_ReturnValue) == 0x000180, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_Vector_SnappedToGrid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakRotator_Roll) == 0x00018C, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakRotator_Roll' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakRotator_Pitch) == 0x000190, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakRotator_Pitch' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_BreakRotator_Yaw) == 0x000194, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_BreakRotator_Yaw' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_ProjectPointOnToPlane_ReturnValue) == 0x000198, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_ProjectPointOnToPlane_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_GridSnap_Float_ReturnValue) == 0x0001A4, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_GridSnap_Float_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_MakeRotator_ReturnValue) == 0x0001A8, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_MakeRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult) == 0x0001B4, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, K2Node_Event_player_1) == 0x000240, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::K2Node_Event_player_1' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, K2Node_Event_player) == 0x000248, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_ExecuteUbergraph_prop_rug, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x000250, "Member 'Prop_rug_C_ExecuteUbergraph_prop_rug::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Prop_rug_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_rug_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_rug_C_PlaceFromHand, CallFunc_Less_IntInt_ReturnValue) == 0x000000, "Member 'Prop_rug_C_PlaceFromHand::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_PlaceFromHand, CallFunc_SelectInt_ReturnValue) == 0x000004, "Member 'Prop_rug_C_PlaceFromHand::CallFunc_SelectInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Prop_rug_C_SetPropProps, Static_0) == 0x000000, "Member 'Prop_rug_C_SetPropProps::Static_0' has a wrong offset!");
static_assert(offsetof(Prop_rug_C_SetPropProps, Frozen_0) == 0x000001, "Member 'Prop_rug_C_SetPropProps::Frozen_0' has a wrong offset!");
...
static_assert(offsetof(Prop_rug_C_SendName, Name_0) == 0x000000, "Member 'Prop_rug_C_SendName::Name_0' has a wrong offset!");
