...
public:
	...
	class AProp_rocket_C*                         CallFunc_FinishSpawningActor_ReturnValue;          // 0x0058(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(Prop_funGun_rpg_C_FireBulletPrimary) == 0x000060, "Wrong size on Prop_funGun_rpg_C_FireBulletPrimary");
static_assert(offsetof(Prop_funGun_rpg_C_FireBulletPrimary, CallFunc_GetActorEyesViewPoint_OutLocation) == 0x000000, "Member 'Prop_funGun_rpg_C_FireBulletPrimary::CallFunc_GetActorEyesViewPoint_OutLocation' has a wrong offset!");
static_assert(offsetof(Prop_funGun_rpg_C_FireBulletPrimary, CallFunc_GetActorEyesViewPoint_OutRotation) == 0x00000C, "Member 'Prop_funGun_rpg_C_FireBulletPrimary::CallFunc_GetActorEyesViewPoint_OutRotation' has a wrong offset!");
static_assert(offsetof(Prop_funGun_rpg_C_FireBulletPrimary, CallFunc_MakeTransform_ReturnValue) == 0x000020, "Member 'Prop_funGun_rpg_C_FireBulletPrimary::CallFunc_MakeTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_funGun_rpg_C_FireBulletPrimary, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x000050, "Member 'Prop_funGun_rpg_C_FireBulletPrimary::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_funGun_rpg_C_FireBulletPrimary, CallFunc_FinishSpawningActor_ReturnValue) == 0x000058, "Member 'Prop_funGun_rpg_C_FireBulletPrimary::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
...
public:
	...
	TArray<EObjectTypeQuery>                      CallFunc_obj_statDyn_obj;                          // 0x00B8(0x0010)(ReferenceParm)
...
static_assert(sizeof(Prop_funGun_rpg_C_Look) == 0x000178, "Wrong size on Prop_funGun_rpg_C_Look");
...
static_assert(offsetof(Prop_funGun_rpg_C_Look, Temp_object_Variable) == 0x000090, "Member 'Prop_funGun_rpg_C_Look::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(Prop_funGun_rpg_C_Look, CallFunc_GetActorEyesViewPoint_OutLocation) == 0x0000A0, "Member 'Prop_funGun_rpg_C_Look::CallFunc_GetActorEyesViewPoint_OutLocation' has a wrong offset!");
static_assert(offsetof(Prop_funGun_rpg_C_Look, CallFunc_GetActorEyesViewPoint_OutRotation) == 0x0000AC, "Member 'Prop_funGun_rpg_C_Look::CallFunc_GetActorEyesViewPoint_OutRotation' has a wrong offset!");
static_assert(offsetof(Prop_funGun_rpg_C_Look, CallFunc_obj_statDyn_obj) == 0x0000B8, "Member 'Prop_funGun_rpg_C_Look::CallFunc_obj_statDyn_obj' has a wrong offset!");
static_assert(offsetof(Prop_funGun_rpg_C_Look, CallFunc_GetForwardVector_ReturnValue) == 0x0000C8, "Member 'Prop_funGun_rpg_C_Look::CallFunc_GetForwardVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_funGun_rpg_C_Look, CallFunc_Multiply_VectorFloat_ReturnValue) == 0x0000D4, "Member 'Prop_funGun_rpg_C_Look::CallFunc_Multiply_VectorFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_funGun_rpg_C_Look, CallFunc_Add_VectorVector_ReturnValue) == 0x0000E0, "Member 'Prop_funGun_rpg_C_Look::CallFunc_Add_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_funGun_rpg_C_Look, CallFunc_LineTraceSingleForObjects_OutHit) == 0x0000EC, "Member 'Prop_funGun_rpg_C_Look::CallFunc_LineTraceSingleForObjects_OutHit' has a wrong offset!");
static_assert(offsetof(Prop_funGun_rpg_C_Look, CallFunc_LineTraceSingleForObjects_ReturnValue) == 0x000174, "Member 'Prop_funGun_rpg_C_Look::CallFunc_LineTraceSingleForObjects_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Prop_funGun_rpg_C_PlayerHandUse_RMB, Player_0) == 0x000000, "Member 'Prop_funGun_rpg_C_PlayerHandUse_RMB::Player_0' has a wrong offset!");
