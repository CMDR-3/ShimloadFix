...
{
public:
	class AActor*                                 DaamgedActor_0;                                    // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(LaserEmitter_C_DamageActor, DaamgedActor_0) == 0x000000, "Member 'LaserEmitter_C_DamageActor::DaamgedActor_0' has a wrong offset!");
...
public:
	...
	class UComp_disintegrate_C*                   CallFunc_AddComponent_ReturnValue;                 // 0x0358(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
