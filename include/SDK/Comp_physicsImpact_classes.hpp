...
public:
	void HitEvent__DelegateSignature(class UPrimitiveComponent* HitComponent_0, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit_0);
	void HitOverThreshold__DelegateSignature(const struct FHitResult& Hit_0, const struct FVector& Impact_0);
	void ExecuteUbergraph_comp_physicsImpact(int32 EntryPoint);
	void ResetGround();
	void StopScraping();
	void CustomEvent(class UPrimitiveComponent* HitComponent_0, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit_0);
	void RestoreHit();
	void HitCpp(class UPrimitiveComponent* HitComponent_0, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit_0);
	void SetHit();
	void ResetOnGround();
	void FireDamage(float Damage_0);
	void UpdateMaterial();
	void RetargetHit(class UPrimitiveComponent* HitComponent_0);
	void StartScraping();
	void ImpactDamage(float Damage_0, const struct FHitResult& Hit_0, class AActor* Actor, const struct FVector& Impact_0);
	void Init();
	void Hit(class UPrimitiveComponent* HitComponent_0, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit_0);
	...
	void bitten();
	void ReachedByExplosion(const struct FVector& Location, float Damage_0);
	...
	void AddDamage(class AActor* Actor, float Damage_0, const struct FHitResult& Hit, const struct FVector& Impact_0, bool SkipSetting);
	void SetPropProps(bool Static, bool Frozen, bool Active);
	void Virus(bool Activate_0);
	void Eaten();
