...
{
public:
	struct FStruct_achievement                    Data_0;                                            // 0x0000(0x0050)(BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
...
static_assert(offsetof(Umg_achievementPopup_C_Upd, Data_0) == 0x000000, "Member 'Umg_achievementPopup_C_Upd::Data_0' has a wrong offset!");
