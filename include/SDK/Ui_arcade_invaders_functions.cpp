...
// Function ui_arcade_invaders.ui_arcade_invaders_C.gamemodePostKeys
// (Public, BlueprintCallable, BlueprintEvent)

void UUi_arcade_invaders_C::GamemodePostKeys()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ui_arcade_invaders_C", "gamemodePostKeys");

	UObject::ProcessEvent(Func, nullptr);
}


// Function ui_arcade_invaders.ui_arcade_invaders_C.NewFunction_3
// (Public, BlueprintCallable, BlueprintEvent)

void UUi_arcade_invaders_C::NewFunction_3()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ui_arcade_invaders_C", "NewFunction_3");

	UObject::ProcessEvent(Func, nullptr);
}


// Function ui_arcade_invaders.ui_arcade_invaders_C.NewFunction_2
// (Public, BlueprintCallable, BlueprintEvent)

void UUi_arcade_invaders_C::NewFunction_2()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ui_arcade_invaders_C", "NewFunction_2");
...
void UUi_arcade_invaders_C::TexturePickerApply(class UUmg_texturePicker_C* Picker, class UTexture2D* Texture, int32 Index_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ui_arcade_invaders_C", "texturePickerApply");

	Params::Ui_arcade_invaders_C_TexturePickerApply Parms{};
