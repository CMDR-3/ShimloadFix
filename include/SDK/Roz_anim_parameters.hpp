...
public:
	...
	struct FKey                                   K2Node_Event_key_1;                                // 0x0450(0x0018)(HasGetValueTypeHash)
	bool                                          K2Node_Event_pressed_1;                            // 0x0468(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AMainGamemode_C*                        K2Node_Event_gamemode;                             // 0x05F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FStruct_settings                       K2Node_Event_settings;                             // 0x05F8(0x0100)(HasGetValueTypeHash)
	...
	struct FLinearColor                           K2Node_Event_color;                                // 0x0714(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_724[0x4];                                      // 0x0724(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UUmg_texturePicker_C*                   K2Node_Event_picker;                               // 0x0728(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UTexture2D*                             K2Node_Event_texture;                              // 0x0730(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_Event_index_1;                              // 0x0738(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_ignore;                               // 0x073C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_NewParam;                             // 0x073D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_73E[0x2];                                      // 0x073E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class ACord_C*                                K2Node_Event_cord_1;                               // 0x0740(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACordSocket_C*                          K2Node_Event_socket_1;                             // 0x0748(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACord_C*                                K2Node_Event_cord;                                 // 0x0750(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACordSocket_C*                          K2Node_Event_socket;                               // 0x0758(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_Event_sentFrom;                             // 0x0760(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_active;                               // 0x0768(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_769[0x7];                                      // 0x0769(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPlayMontageCallbackProxy*              CallFunc_CreateProxyObjectForPlayMontage_ReturnValue; // 0x0770(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetSocketLocation_ReturnValue;            // 0x0778(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_784[0x4];                                      // 0x0784(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UAudioComponent*                        CallFunc_SpawnSoundAtLocation_ReturnValue;         // 0x0788(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UParticleSystemComponent*               CallFunc_SpawnEmitterAtLocation_ReturnValue;       // 0x0790(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         K2Node_Event_DeltaSeconds;                         // 0x079C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_VictoryFloatPlusEquals_FloatOut;          // 0x07A0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GreaterEqual_FloatFloat_ReturnValue;      // 0x07A4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_7A5[0x3];                                      // 0x07A5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_Percent_FloatFloat_ReturnValue;           // 0x07A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         Temp_int_Variable;                                 // 0x07AC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FTransform                             CallFunc_K2_GetComponentToWorld_ReturnValue;       // 0x07B0(0x0030)(IsPlainOldData, NoDestructor)
	...
	class UParticleSystemComponent*               CallFunc_SpawnEmitterAtLocation_ReturnValue_1;     // 0x0808(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Round_ReturnValue;                        // 0x0810(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_GetSocketLocation_ReturnValue_1;          // 0x0818(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             CallFunc_K2_SetWorldLocation_SweepHitResult;       // 0x0824(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FHitResult                             K2Node_ComponentBoundEvent_SweepResult;            // 0x08D0(0x0088)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	class AMainPlayer_C*                          K2Node_DynamicCast_AsMain_Player;                  // 0x0958(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_GetTimeAlive_ReturnValue;                 // 0x0964(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Lerp_ReturnValue_5;                       // 0x0968(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Multiply_FloatFloat_ReturnValue;          // 0x096C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_DegSin_ReturnValue;                       // 0x0970(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Add_FloatFloat_ReturnValue;               // 0x0974(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Divide_FloatFloat_ReturnValue;            // 0x0978(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         K2Node_Event_index;                                // 0x0988(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_LessEqual_FloatFloat_ReturnValue;         // 0x098C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_98D[0x3];                                      // 0x098D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_GetWorldDeltaSeconds_ReturnValue;         // 0x0990(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_VictoryFloatMinusEquals_FloatOut;         // 0x0994(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_LessEqual_FloatFloat_ReturnValue_1;       // 0x0998(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_999[0x3];                                      // 0x0999(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_RandomFloatInRange_ReturnValue;           // 0x099C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACharacter*                             CallFunc_GetPlayerCharacter_ReturnValue;           // 0x09A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Multiply_FloatFloat_ReturnValue_1;        // 0x09A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue;          // 0x09AC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Lerp_ReturnValue_6;                       // 0x09B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Lerp_ReturnValue_7;                       // 0x09BC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Lerp_ReturnValue_8;                       // 0x09C0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Lerp_ReturnValue_9;                       // 0x09C4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACharacter*                             CallFunc_GetPlayerCharacter_ReturnValue_1;         // 0x09C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue_1;        // 0x09D0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_LessEqual_FloatFloat_ReturnValue_2;       // 0x09DC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_Not_PreBool_ReturnValue;                  // 0x09DD(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_Not_PreBool_ReturnValue_1;                // 0x09DE(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BooleanAND_ReturnValue;                   // 0x09DF(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AMainGamemode_C*                        CallFunc_getMainGamemode_AsMain_Gamemode;          // 0x09E8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AMainGamemode_C*                        CallFunc_getMainGamemode_AsMain_Gamemode_1;        // 0x09F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_NearlyEqual_FloatFloat_ReturnValue;       // 0x09F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_9F9[0x7];                                      // 0x09F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AActor*>                         CallFunc_GetOverlappingActors_OverlappingActors;   // 0x0A00(0x0010)(ReferenceParm)
	int32                                         CallFunc_Array_Length_ReturnValue;                 // 0x0A10(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Greater_IntInt_ReturnValue;               // 0x0A14(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_BooleanAND_ReturnValue_2;                 // 0x0A20(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_A21[0x7];                                      // 0x0A21(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UGameInst_C*                            CallFunc_getMainGameInstance_AsGame_Inst;          // 0x0A28(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_NotEqual_ByteByte_ReturnValue;            // 0x0A30(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(Roz_anim_C_ExecuteUbergraph_roz_anim) == 0x000A40, "Wrong size on Roz_anim_C_ExecuteUbergraph_roz_anim");
...
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_damage_5) == 0x0000B0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_damage_5' has a wrong offset!");
...
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_damage_4) == 0x000188, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_damage_4' has a wrong offset!");
...
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_player_12) == 0x000238, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_player_12' has a wrong offset!");
...
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_damage_3) == 0x0002C8, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_damage_3' has a wrong offset!");
...
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_damage_2) == 0x0002D0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_damage_2' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_hot) == 0x0002D4, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_hot' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_player_11) == 0x000360, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_player_11' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_hit_2) == 0x000368, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_hit_2' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_action) == 0x0003F0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_player_10) == 0x0003F8, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_player_10' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_player_9) == 0x000400, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_player_9' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_damage_1) == 0x000408, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_damage_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_location_1) == 0x00040C, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_location_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_player_8) == 0x000418, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_player_8' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_player_7) == 0x000420, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_player_7' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_player_6) == 0x000428, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_player_6' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_wheelDelta) == 0x000430, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_wheelDelta' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_player_5) == 0x000438, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_player_5' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_mouse) == 0x000440, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_mouse' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_player_4) == 0x000448, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_player_4' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_key_1) == 0x000450, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_key_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_pressed_1) == 0x000468, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_pressed_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_temperature_1) == 0x00046C, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_temperature_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_temperature) == 0x000470, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_temperature' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_speed) == 0x000474, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_speed' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_player_3) == 0x000478, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_player_3' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_hit_1) == 0x000480, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_hit_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_name) == 0x000508, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_name' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_volume) == 0x000518, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_volume' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_player_2) == 0x000520, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_player_2' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_location) == 0x000528, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_location' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_damage) == 0x000534, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_damage' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_clean_1) == 0x000538, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_clean_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_player_1) == 0x000540, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_player_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_hit) == 0x000548, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_hook_1) == 0x0005D0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_hook_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_clean) == 0x0005D8, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_clean' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_player) == 0x0005E0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_hook) == 0x0005E8, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_hook' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_gamemode) == 0x0005F0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_gamemode' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_settings) == 0x0005F8, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_settings' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_key) == 0x0006F8, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_key' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_pressed) == 0x000710, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_pressed' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_color) == 0x000714, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_color' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_picker) == 0x000728, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_picker' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_texture) == 0x000730, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_texture' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_index_1) == 0x000738, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_index_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_ignore) == 0x00073C, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_ignore' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_NewParam) == 0x00073D, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_NewParam' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_cord_1) == 0x000740, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_cord_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_socket_1) == 0x000748, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_socket_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_cord) == 0x000750, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_cord' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_socket) == 0x000758, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_socket' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_sentFrom) == 0x000760, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_sentFrom' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_active) == 0x000768, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_active' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_CreateProxyObjectForPlayMontage_ReturnValue) == 0x000770, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_CreateProxyObjectForPlayMontage_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_GetSocketLocation_ReturnValue) == 0x000778, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_GetSocketLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_SpawnSoundAtLocation_ReturnValue) == 0x000788, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_SpawnSoundAtLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_SpawnEmitterAtLocation_ReturnValue) == 0x000790, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_SpawnEmitterAtLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_IsValid_ReturnValue) == 0x000798, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_DeltaSeconds) == 0x00079C, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_VictoryFloatPlusEquals_FloatOut) == 0x0007A0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_VictoryFloatPlusEquals_FloatOut' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_GreaterEqual_FloatFloat_ReturnValue) == 0x0007A4, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_GreaterEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_Percent_FloatFloat_ReturnValue) == 0x0007A8, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_Percent_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, Temp_int_Variable) == 0x0007AC, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_K2_GetComponentToWorld_ReturnValue) == 0x0007B0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_K2_GetComponentToWorld_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_BreakTransform_Location) == 0x0007E0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_BreakTransform_Location' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_BreakTransform_Rotation) == 0x0007EC, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_BreakTransform_Rotation' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_BreakTransform_Scale) == 0x0007F8, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_BreakTransform_Scale' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_Add_IntInt_ReturnValue) == 0x000804, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_SpawnEmitterAtLocation_ReturnValue_1) == 0x000808, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_SpawnEmitterAtLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_Round_ReturnValue) == 0x000810, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_Round_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000814, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_GetSocketLocation_ReturnValue_1) == 0x000818, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_GetSocketLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_K2_SetWorldLocation_SweepHitResult) == 0x000824, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_K2_SetWorldLocation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_ComponentBoundEvent_OverlappedComponent) == 0x0008B0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_ComponentBoundEvent_OverlappedComponent' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_ComponentBoundEvent_OtherActor) == 0x0008B8, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_ComponentBoundEvent_OtherActor' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_ComponentBoundEvent_OtherComp) == 0x0008C0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_ComponentBoundEvent_OtherComp' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_ComponentBoundEvent_OtherBodyIndex) == 0x0008C8, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_ComponentBoundEvent_OtherBodyIndex' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_ComponentBoundEvent_bFromSweep) == 0x0008CC, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_ComponentBoundEvent_bFromSweep' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_ComponentBoundEvent_SweepResult) == 0x0008D0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_ComponentBoundEvent_SweepResult' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_DynamicCast_AsMain_Player) == 0x000958, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_DynamicCast_AsMain_Player' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_DynamicCast_bSuccess) == 0x000960, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_GetTimeAlive_ReturnValue) == 0x000964, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_GetTimeAlive_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_Lerp_ReturnValue_5) == 0x000968, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_Lerp_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x00096C, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_DegSin_ReturnValue) == 0x000970, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_DegSin_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_Add_FloatFloat_ReturnValue) == 0x000974, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000978, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_owner) == 0x000980, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_owner' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, K2Node_Event_index) == 0x000988, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::K2Node_Event_index' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_LessEqual_FloatFloat_ReturnValue) == 0x00098C, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_LessEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_GetWorldDeltaSeconds_ReturnValue) == 0x000990, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_GetWorldDeltaSeconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_VictoryFloatMinusEquals_FloatOut) == 0x000994, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_VictoryFloatMinusEquals_FloatOut' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_LessEqual_FloatFloat_ReturnValue_1) == 0x000998, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_LessEqual_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_RandomFloatInRange_ReturnValue) == 0x00099C, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_RandomFloatInRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_GetPlayerCharacter_ReturnValue) == 0x0009A0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_GetPlayerCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_Multiply_FloatFloat_ReturnValue_1) == 0x0009A8, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_Multiply_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_K2_GetActorLocation_ReturnValue) == 0x0009AC, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_Lerp_ReturnValue_6) == 0x0009B8, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_Lerp_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_Lerp_ReturnValue_7) == 0x0009BC, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_Lerp_ReturnValue_7' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_Lerp_ReturnValue_8) == 0x0009C0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_Lerp_ReturnValue_8' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_Lerp_ReturnValue_9) == 0x0009C4, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_Lerp_ReturnValue_9' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_GetPlayerCharacter_ReturnValue_1) == 0x0009C8, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_GetPlayerCharacter_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_K2_GetActorLocation_ReturnValue_1) == 0x0009D0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_K2_GetActorLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_LessEqual_FloatFloat_ReturnValue_2) == 0x0009DC, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_LessEqual_FloatFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_Not_PreBool_ReturnValue) == 0x0009DD, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_Not_PreBool_ReturnValue_1) == 0x0009DE, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_BooleanAND_ReturnValue) == 0x0009DF, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_BooleanAND_ReturnValue_1) == 0x0009E0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_getMainGamemode_AsMain_Gamemode) == 0x0009E8, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_getMainGamemode_AsMain_Gamemode' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_getMainGamemode_AsMain_Gamemode_1) == 0x0009F0, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_getMainGamemode_AsMain_Gamemode_1' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_NearlyEqual_FloatFloat_ReturnValue) == 0x0009F8, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_NearlyEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_GetOverlappingActors_OverlappingActors) == 0x000A00, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_GetOverlappingActors_OverlappingActors' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_Array_Length_ReturnValue) == 0x000A10, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_Greater_IntInt_ReturnValue) == 0x000A14, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_CreateDynamicMaterialInstance_ReturnValue) == 0x000A18, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_CreateDynamicMaterialInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_BooleanAND_ReturnValue_2) == 0x000A20, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_BooleanAND_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_getMainGameInstance_AsGame_Inst) == 0x000A28, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_getMainGameInstance_AsGame_Inst' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ExecuteUbergraph_roz_anim, CallFunc_NotEqual_ByteByte_ReturnValue) == 0x000A30, "Member 'Roz_anim_C_ExecuteUbergraph_roz_anim::CallFunc_NotEqual_ByteByte_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Roz_anim_C_RunTrigger, Owner_0) == 0x000000, "Member 'Roz_anim_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_RunTrigger, Index_0) == 0x000008, "Member 'Roz_anim_C_RunTrigger::Index_0' has a wrong offset!");
...
static_assert(offsetof(Roz_anim_C_SetActiveTrigger, Active_0) == 0x000008, "Member 'Roz_anim_C_SetActiveTrigger::Active_0' has a wrong offset!");
...
struct Roz_anim_C_TexturePickerApply final
{
public:
...
static_assert(alignof(Roz_anim_C_TexturePickerApply) == 0x000008, "Wrong alignment on Roz_anim_C_TexturePickerApply");
static_assert(sizeof(Roz_anim_C_TexturePickerApply) == 0x000018, "Wrong size on Roz_anim_C_TexturePickerApply");
static_assert(offsetof(Roz_anim_C_TexturePickerApply, Picker) == 0x000000, "Member 'Roz_anim_C_TexturePickerApply::Picker' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_TexturePickerApply, Texture) == 0x000008, "Member 'Roz_anim_C_TexturePickerApply::Texture' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_TexturePickerApply, Index_0) == 0x000010, "Member 'Roz_anim_C_TexturePickerApply::Index_0' has a wrong offset!");
...
static_assert(alignof(Roz_anim_C_SettingsApplied) == 0x000008, "Wrong alignment on Roz_anim_C_SettingsApplied");
static_assert(sizeof(Roz_anim_C_SettingsApplied) == 0x000100, "Wrong size on Roz_anim_C_SettingsApplied");
...
// 0x0008 (0x0008 - 0x0000)
struct Roz_anim_C_HookTension final
{
public:
...
static_assert(alignof(Roz_anim_C_HookTension) == 0x000008, "Wrong alignment on Roz_anim_C_HookTension");
static_assert(sizeof(Roz_anim_C_HookTension) == 0x000008, "Wrong size on Roz_anim_C_HookTension");
static_assert(offsetof(Roz_anim_C_HookTension, Hook) == 0x000000, "Member 'Roz_anim_C_HookTension::Hook' has a wrong offset!");

// Function roz_anim.roz_anim_C.cleanSponge
// 0x0010 (0x0010 - 0x0000)
struct Roz_anim_C_CleanSponge final
{
public:
...
static_assert(alignof(Roz_anim_C_CleanSponge) == 0x000008, "Wrong alignment on Roz_anim_C_CleanSponge");
static_assert(sizeof(Roz_anim_C_CleanSponge) == 0x000010, "Wrong size on Roz_anim_C_CleanSponge");
static_assert(offsetof(Roz_anim_C_CleanSponge, Clean) == 0x000000, "Member 'Roz_anim_C_CleanSponge::Clean' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_CleanSponge, Player) == 0x000008, "Member 'Roz_anim_C_CleanSponge::Player' has a wrong offset!");
...
static_assert(offsetof(Roz_anim_C_ActionName, Name_0) == 0x000090, "Member 'Roz_anim_C_ActionName::Name_0' has a wrong offset!");
...
static_assert(offsetof(Roz_anim_C_ActionOptionIndex, Action) == 0x000090, "Member 'Roz_anim_C_ActionOptionIndex::Action' has a wrong offset!");

// Function roz_anim.roz_anim_C.receivedPhyiscsDamage
// 0x008C (0x008C - 0x0000)
struct Roz_anim_C_ReceivedPhyiscsDamage final
{
public:
	float                                         Damage;                                            // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(Roz_anim_C_ReceivedPhyiscsDamage) == 0x000004, "Wrong alignment on Roz_anim_C_ReceivedPhyiscsDamage");
static_assert(sizeof(Roz_anim_C_ReceivedPhyiscsDamage) == 0x00008C, "Wrong size on Roz_anim_C_ReceivedPhyiscsDamage");
static_assert(offsetof(Roz_anim_C_ReceivedPhyiscsDamage, Damage) == 0x000000, "Member 'Roz_anim_C_ReceivedPhyiscsDamage::Damage' has a wrong offset!");
static_assert(offsetof(Roz_anim_C_ReceivedPhyiscsDamage, Hot) == 0x000004, "Member 'Roz_anim_C_ReceivedPhyiscsDamage::Hot' has a wrong offset!");
...
static_assert(offsetof(Roz_anim_C_SetPropProps, Active_0) == 0x000002, "Member 'Roz_anim_C_SetPropProps::Active_0' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct Roz_anim_C_GatherDataFromKeyT final
{
public:
	bool                                          Gather;                                            // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(Roz_anim_C_GatherDataFromKeyT) == 0x000001, "Wrong alignment on Roz_anim_C_GatherDataFromKeyT");
static_assert(sizeof(Roz_anim_C_GatherDataFromKeyT) == 0x000001, "Wrong size on Roz_anim_C_GatherDataFromKeyT");
static_assert(offsetof(Roz_anim_C_GatherDataFromKeyT, Gather) == 0x000000, "Member 'Roz_anim_C_GatherDataFromKeyT::Gather' has a wrong offset!");
...
static_assert(offsetof(Roz_anim_C_IgnoreSave, IgnoreSave_0) == 0x000000, "Member 'Roz_anim_C_IgnoreSave::IgnoreSave_0' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct Roz_anim_C_GatherDataFromKey final
{
public:
	bool                                          Gather;                                            // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(Roz_anim_C_GatherDataFromKey) == 0x000001, "Wrong alignment on Roz_anim_C_GatherDataFromKey");
static_assert(sizeof(Roz_anim_C_GatherDataFromKey) == 0x000001, "Wrong size on Roz_anim_C_GatherDataFromKey");
static_assert(offsetof(Roz_anim_C_GatherDataFromKey, Gather) == 0x000000, "Member 'Roz_anim_C_GatherDataFromKey::Gather' has a wrong offset!");
...
static_assert(sizeof(Roz_anim_C_GetActionOptions) == 0x000050, "Wrong size on Roz_anim_C_GetActionOptions");
...
static_assert(offsetof(Roz_anim_C_GetActionOptions, Number) == 0x000048, "Member 'Roz_anim_C_GetActionOptions::Number' has a wrong offset!");
...
// 0x0004 (0x0004 - 0x0000)
struct Roz_anim_C_GetPriceMultiplier final
{
public:
	float                                         PriceMult;                                         // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(Roz_anim_C_GetPriceMultiplier) == 0x000004, "Wrong alignment on Roz_anim_C_GetPriceMultiplier");
static_assert(sizeof(Roz_anim_C_GetPriceMultiplier) == 0x000004, "Wrong size on Roz_anim_C_GetPriceMultiplier");
static_assert(offsetof(Roz_anim_C_GetPriceMultiplier, PriceMult) == 0x000000, "Member 'Roz_anim_C_GetPriceMultiplier::PriceMult' has a wrong offset!");
