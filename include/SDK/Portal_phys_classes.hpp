...
static_assert(sizeof(APortal_phys_C) == 0x000340, "Wrong size on APortal_phys_C");
...
static_assert(offsetof(APortal_phys_C, GameMode) == 0x000338, "Member 'APortal_phys_C::GameMode' has a wrong offset!");
