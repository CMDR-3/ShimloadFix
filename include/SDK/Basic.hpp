...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04C969A0;
	constexpr int32 AppendString      = 0x011DC080;
	constexpr int32 GNames            = 0x04C5A640;
	constexpr int32 GWorld            = 0x04DDE340;
	constexpr int32 ProcessEvent      = 0x013CC590;
