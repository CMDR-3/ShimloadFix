...
static_assert(sizeof(Umg_radar_C_ExecuteUbergraph_umg_radar) == 0x000158, "Wrong size on Umg_radar_C_ExecuteUbergraph_umg_radar");
...
static_assert(offsetof(Umg_radar_C_ExecuteUbergraph_umg_radar, K2Node_Event_key) == 0x000110, "Member 'Umg_radar_C_ExecuteUbergraph_umg_radar::K2Node_Event_key' has a wrong offset!");
static_assert(offsetof(Umg_radar_C_ExecuteUbergraph_umg_radar, K2Node_Event_pressed) == 0x000128, "Member 'Umg_radar_C_ExecuteUbergraph_umg_radar::K2Node_Event_pressed' has a wrong offset!");
static_assert(offsetof(Umg_radar_C_ExecuteUbergraph_umg_radar, K2Node_Event_color) == 0x00012C, "Member 'Umg_radar_C_ExecuteUbergraph_umg_radar::K2Node_Event_color' has a wrong offset!");
static_assert(offsetof(Umg_radar_C_ExecuteUbergraph_umg_radar, K2Node_Event_picker) == 0x000140, "Member 'Umg_radar_C_ExecuteUbergraph_umg_radar::K2Node_Event_picker' has a wrong offset!");
static_assert(offsetof(Umg_radar_C_ExecuteUbergraph_umg_radar, K2Node_Event_texture) == 0x000148, "Member 'Umg_radar_C_ExecuteUbergraph_umg_radar::K2Node_Event_texture' has a wrong offset!");
static_assert(offsetof(Umg_radar_C_ExecuteUbergraph_umg_radar, K2Node_Event_index) == 0x000150, "Member 'Umg_radar_C_ExecuteUbergraph_umg_radar::K2Node_Event_index' has a wrong offset!");
...
static_assert(offsetof(Umg_radar_C_TexturePickerApply, Index_0) == 0x000010, "Member 'Umg_radar_C_TexturePickerApply::Index_0' has a wrong offset!");
...
static_assert(sizeof(Umg_radar_C_SettingsApplied) == 0x000100, "Wrong size on Umg_radar_C_SettingsApplied");
