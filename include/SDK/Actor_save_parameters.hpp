...
public:
	...
	bool                                          K2Node_Event_ignore;                               // 0x0548(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_549[0x7];                                      // 0x0549(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AMainGamemode_C*                        CallFunc_getMainGamemode_AsMain_Gamemode;          // 0x0550(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(Actor_save_C_ExecuteUbergraph_actor_save) == 0x000558, "Wrong size on Actor_save_C_ExecuteUbergraph_actor_save");
...
static_assert(offsetof(Actor_save_C_ExecuteUbergraph_actor_save, CallFunc_IsValid_ReturnValue) == 0x000004, "Member 'Actor_save_C_ExecuteUbergraph_actor_save::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Actor_save_C_ExecuteUbergraph_actor_save, K2Node_Event_ignore) == 0x000548, "Member 'Actor_save_C_ExecuteUbergraph_actor_save::K2Node_Event_ignore' has a wrong offset!");
static_assert(offsetof(Actor_save_C_ExecuteUbergraph_actor_save, CallFunc_getMainGamemode_AsMain_Gamemode) == 0x000550, "Member 'Actor_save_C_ExecuteUbergraph_actor_save::CallFunc_getMainGamemode_AsMain_Gamemode' has a wrong offset!");
...
static_assert(offsetof(Actor_save_C_ActionName, Name_0) == 0x000090, "Member 'Actor_save_C_ActionName::Name_0' has a wrong offset!");
...
static_assert(offsetof(Actor_save_C_PlayerHandAnyKey, Key_0) == 0x000008, "Member 'Actor_save_C_PlayerHandAnyKey::Key_0' has a wrong offset!");
...
static_assert(offsetof(Actor_save_C_SetKey, Key_0) == 0x000000, "Member 'Actor_save_C_SetKey::Key_0' has a wrong offset!");
...
public:
	...
	class FString                                 CallFunc_getKey_key;                               // 0x0008(0x0010)(ZeroConstructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(Actor_save_C_UserConstructionScript) == 0x000018, "Wrong size on Actor_save_C_UserConstructionScript");
static_assert(offsetof(Actor_save_C_UserConstructionScript, CallFunc_getMainGamemode_AsMain_Gamemode) == 0x000000, "Member 'Actor_save_C_UserConstructionScript::CallFunc_getMainGamemode_AsMain_Gamemode' has a wrong offset!");
static_assert(offsetof(Actor_save_C_UserConstructionScript, CallFunc_getKey_key) == 0x000008, "Member 'Actor_save_C_UserConstructionScript::CallFunc_getKey_key' has a wrong offset!");
...
static_assert(offsetof(Actor_save_C_IgnoreSave, IgnoreSave_0) == 0x000000, "Member 'Actor_save_C_IgnoreSave::IgnoreSave_0' has a wrong offset!");
...
static_assert(offsetof(Actor_save_C_GetOnlyKey, Key_0) == 0x000000, "Member 'Actor_save_C_GetOnlyKey::Key_0' has a wrong offset!");
...
static_assert(sizeof(Actor_save_C_GetKey) == 0x000050, "Wrong size on Actor_save_C_GetKey");
static_assert(offsetof(Actor_save_C_GetKey, Key_0) == 0x000000, "Member 'Actor_save_C_GetKey::Key_0' has a wrong offset!");
...
static_assert(offsetof(Actor_save_C_GetKey, CallFunc_IsValid_ReturnValue) == 0x000018, "Member 'Actor_save_C_GetKey::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Actor_save_C_GetKey, CallFunc_Array_Add_ReturnValue) == 0x00001C, "Member 'Actor_save_C_GetKey::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(Actor_save_C_GetKey, CallFunc_Array_Add_ReturnValue_1) == 0x000020, "Member 'Actor_save_C_GetKey::CallFunc_Array_Add_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Actor_save_C_GetKey, CallFunc_Array_Find_ReturnValue) == 0x000024, "Member 'Actor_save_C_GetKey::CallFunc_Array_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(Actor_save_C_GetKey, CallFunc_GenerateRandomBytes_ByteArray) == 0x000028, "Member 'Actor_save_C_GetKey::CallFunc_GenerateRandomBytes_ByteArray' has a wrong offset!");
static_assert(offsetof(Actor_save_C_GetKey, CallFunc_BytesToBase64Url_ReturnValue) == 0x000038, "Member 'Actor_save_C_GetKey::CallFunc_BytesToBase64Url_ReturnValue' has a wrong offset!");
static_assert(offsetof(Actor_save_C_GetKey, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x000048, "Member 'Actor_save_C_GetKey::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Actor_save_C_GetKey, CallFunc_IsEmpty_ReturnValue) == 0x000049, "Member 'Actor_save_C_GetKey::CallFunc_IsEmpty_ReturnValue' has a wrong offset!");
