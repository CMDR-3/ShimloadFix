...
public:
	...
	class UFlammable_C*                           FlameBase;                                         // 0x0698(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Life;                                              // 0x06A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void OnSuccess_DCE7784940FB5975BAAAE7AF85ACC838(EPathFollowingResult MovementResult);
	void OnFail_DCE7784940FB5975BAAAE7AF85ACC838(EPathFollowingResult MovementResult);
	...
	void SkipPreDelete(bool* Skip_0);
...
static_assert(sizeof(AEriePlushLive_C) == 0x0006B0, "Wrong size on AEriePlushLive_C");
...
static_assert(offsetof(AEriePlushLive_C, FlameBase) == 0x000698, "Member 'AEriePlushLive_C::FlameBase' has a wrong offset!");
static_assert(offsetof(AEriePlushLive_C, Life) == 0x0006A0, "Member 'AEriePlushLive_C::Life' has a wrong offset!");
