...
static_assert(offsetof(Prop_pizza_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_pizza_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_pizza_C_LookAt, Hit_0) == 0x000008, "Member 'Prop_pizza_C_LookAt::Hit_0' has a wrong offset!");
