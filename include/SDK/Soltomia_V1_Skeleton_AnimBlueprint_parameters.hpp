...
static_assert(offsetof(Soltomia_V1_Skeleton_AnimBlueprint_C_AnimGraph, AnimGraph_0) == 0x000010, "Member 'Soltomia_V1_Skeleton_AnimBlueprint_C_AnimGraph::AnimGraph_0' has a wrong offset!");
