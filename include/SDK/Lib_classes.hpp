...
public:
	...
	static void GetSatelliteName(int32 Index_0, class UObject* __WorldContext, class FString* Techname, class FText* Display);
	...
	static void WeightedRandom(TArray<float>& Weights, class UObject* __WorldContext, int32* Index_0);
	...
	static void ProgressAdvancement(const class FName Advancement, bool DisablePopup, class UObject* __WorldContext, bool* Finished, class FName* Name_0);
	...
	static class UMaterialInterface* GetCarpet(int32 Index_0, class UObject* __WorldContext);
	static bool PropToObject(class FName Prop, class UObject* __WorldContext, struct FStruct_food* FoodData, class UClass** Object, bool* Isfood, struct FStruct_prop3* FuckYouRetard);
	static void GetPic(int32 Dim, int32 Index_0, class UObject* __WorldContext, class UTexture2D** Tex);
	static void GetCusPic(int32 Dim, int32 Index_0, class UObject* __WorldContext, class UTexture2D** Tex, TArray<class UTexture2D*>* Arra);
	...
	static void SetEvent(bool IsEventActive, class AActor* Sender, bool DeactivateAmbientTrack, class UObject* __WorldContext);
	...
	static void PropDescription(const class FString& Prop, bool AddName, class UObject* __WorldContext, class FText* Desc, class FText* Name_0);
	...
	static void HasEquipment(class FName Name_0, class UObject* __WorldContext, bool* Return);
	...
	static void HiddenSpawnMenu(const struct FStruct_prop3& Item, class UObject* __WorldContext, bool* Hidden, bool* Key);
	static void UpdateCollision(class UPrimitiveComponent* Component, class UObject* __WorldContext);
	static void AchievementObjects(const struct FStruct_prop3& Struct_prop, class UObject* __WorldContext, bool* Hidden);
	...
	static void NameToSignal(class FName Name_0, class UObject* __WorldContext, struct FStruct_signal_data1* Data);
	...
	static void IsSignalUnique(class FName Name_0, class UObject* __WorldContext, bool* Unique);
	...
	static void IsFlammable(const class UPhysicalMaterial*& Phys, class UObject* __WorldContext, bool* IsFlammable_0);
	...
	static void GetKeybindFromName(const class FName Name_0, class UObject* __WorldContext, struct FKey* bind);
	static void AddGloss(class FName Name_0, int32 Level, class UObject* __WorldContext);
	static void GenerateAssetDirectory(class UObject* __WorldContext, class FString* Path);
	static void Get_Volume(const class UStaticMesh* Mesh, const class FString& Name_0, class UObject* __WorldContext, float* Volume);
	...
	static void IsFunny(class UObject* __WorldContext, bool* IsFunny_0);
	...
	static class FString Hiddens(class UObject* __WorldContext, TArray<bool>* Hiddens_0);
	...
	static void CustomWall_material(class FName Type, class UObject* __WorldContext, class UMaterialInterface** Material, class FName* Drop, bool* Valid, float* Out_Row_Health_Mult, class UClass** Out_Row_Wall_Class);
