...
struct Prop_microwaveDoor_C_ExecuteUbergraph_prop_microwaveDoor final
{
public:
...
struct Prop_microwaveDoor_C_ActionOptionIndex final
{
public:
...
static_assert(offsetof(Prop_microwaveDoor_C_ActionOptionIndex, Player_0) == 0x000000, "Member 'Prop_microwaveDoor_C_ActionOptionIndex::Player_0' has a wrong offset!");
static_assert(offsetof(Prop_microwaveDoor_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_microwaveDoor_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_microwaveDoor_C_GetActionOptions, Player_0) == 0x000000, "Member 'Prop_microwaveDoor_C_GetActionOptions::Player_0' has a wrong offset!");
