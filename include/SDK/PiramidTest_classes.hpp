...
public:
	...
	class AMainGamemode_C*                        GameMode;                                          // 0x06C8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(APiramidTest_C, GameMode) == 0x0006C8, "Member 'APiramidTest_C::GameMode' has a wrong offset!");
