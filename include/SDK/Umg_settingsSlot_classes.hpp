...
public:
	...
	void Upd();
	void Set();
	void begin(class UUmg_settings_C* Parent_0);
...
static_assert(offsetof(UUmg_settingsSlot_C, Index_0) == 0x000298, "Member 'UUmg_settingsSlot_C::Index_0' has a wrong offset!");
...
static_assert(offsetof(UUmg_settingsSlot_C, Name_0) == 0x0002B0, "Member 'UUmg_settingsSlot_C::Name_0' has a wrong offset!");
