...
{
public:
	int32                                         Action_0;                                          // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Umg_mess_C_Upd, Action_0) == 0x000000, "Member 'Umg_mess_C_Upd::Action_0' has a wrong offset!");
static_assert(offsetof(Umg_mess_C_Upd, Slot_0) == 0x000008, "Member 'Umg_mess_C_Upd::Slot_0' has a wrong offset!");
