...
{
public:
	class AActor*                                 Weld_A_0;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 Weld_B_0;                                          // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                WeldB_0;                                           // 0x0010(0x000C)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Weld_C_Weld, Weld_A_0) == 0x000000, "Member 'Weld_C_Weld::Weld_A_0' has a wrong offset!");
static_assert(offsetof(Weld_C_Weld, Weld_B_0) == 0x000008, "Member 'Weld_C_Weld::Weld_B_0' has a wrong offset!");
static_assert(offsetof(Weld_C_Weld, WeldB_0) == 0x000010, "Member 'Weld_C_Weld::WeldB_0' has a wrong offset!");
...
static_assert(sizeof(Weld_C_ProcessKeys) == 0x000020, "Wrong size on Weld_C_ProcessKeys");
static_assert(offsetof(Weld_C_ProcessKeys, Return) == 0x000000, "Member 'Weld_C_ProcessKeys::Return' has a wrong offset!");
static_assert(offsetof(Weld_C_ProcessKeys, CallFunc_getObjectFromKey_Output) == 0x000008, "Member 'Weld_C_ProcessKeys::CallFunc_getObjectFromKey_Output' has a wrong offset!");
static_assert(offsetof(Weld_C_ProcessKeys, CallFunc_getObjectFromKey_Output_1) == 0x000010, "Member 'Weld_C_ProcessKeys::CallFunc_getObjectFromKey_Output_1' has a wrong offset!");
static_assert(offsetof(Weld_C_ProcessKeys, CallFunc_processKeys_return) == 0x000018, "Member 'Weld_C_ProcessKeys::CallFunc_processKeys_return' has a wrong offset!");
