...
public:
	...
	const class UTexture2D*                       Temp_object_Variable;                              // 0x0010(0x0008)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FStruct_byteImage                      Temp_struct_Variable;                              // 0x0018(0x0010)(ConstParm, HasGetValueTypeHash)
};
...
static_assert(sizeof(Umg_photoSlot_C_ExecuteUbergraph_umg_photoSlot) == 0x000028, "Wrong size on Umg_photoSlot_C_ExecuteUbergraph_umg_photoSlot");
...
static_assert(offsetof(Umg_photoSlot_C_ExecuteUbergraph_umg_photoSlot, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000008, "Member 'Umg_photoSlot_C_ExecuteUbergraph_umg_photoSlot::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_photoSlot_C_ExecuteUbergraph_umg_photoSlot, Temp_object_Variable) == 0x000010, "Member 'Umg_photoSlot_C_ExecuteUbergraph_umg_photoSlot::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(Umg_photoSlot_C_ExecuteUbergraph_umg_photoSlot, Temp_struct_Variable) == 0x000018, "Member 'Umg_photoSlot_C_ExecuteUbergraph_umg_photoSlot::Temp_struct_Variable' has a wrong offset!");
...
static_assert(offsetof(Umg_photoSlot_C_GoPrint, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000010, "Member 'Umg_photoSlot_C_GoPrint::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Umg_photoSlot_C_GoPrint, CallFunc_getSaveSlot_saveSlot) == 0x000020, "Member 'Umg_photoSlot_C_GoPrint::CallFunc_getSaveSlot_saveSlot' has a wrong offset!");
