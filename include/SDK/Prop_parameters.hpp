...
public:
	...
	struct FStruct_settings                       K2Node_Event_settings;                             // 0x05D8(0x0100)(HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x06D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_static;                               // 0x06D9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_frozen;                               // 0x06DA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_active;                               // 0x06DB(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_6DC[0x4];                                      // 0x06DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 K2Node_Event_actor_1;                              // 0x06E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_Event_damage_2;                             // 0x06E8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_Event_hit_2;                                // 0x06EC(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FVector                                K2Node_Event_impact_1;                             // 0x0774(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_skipSetting;                          // 0x0780(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_781[0x3];                                      // 0x0781(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                CallFunc_Divide_VectorFloat_ReturnValue;           // 0x0784(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPrimitiveComponent*                    K2Node_Event_component;                            // 0x0790(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class IInt_objects_C>        CallFunc_impactDamage_self_CastInput;              // 0x0798(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_ignore;                               // 0x07A8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AActor*                                 K2Node_CustomEvent_SelfActor;                      // 0x07C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_CustomEvent_OtherActor;                     // 0x07C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                K2Node_CustomEvent_NormalImpulse;                  // 0x07D0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_CustomEvent_Hit;                            // 0x07DC(0x0088)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	float                                         K2Node_Event_damage_1;                             // 0x0868(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_Event_fuel;                                 // 0x086C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class IInt_objects_C>        CallFunc_fireDamage_self_CastInput;                // 0x0870(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue_1;                    // 0x0880(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_881[0x7];                                      // 0x0881(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AMainPlayer_C*                          K2Node_Event_player;                               // 0x0888(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_Event_hit_1;                                // 0x0890(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	Enum_interactionActions                       K2Node_Event_action;                               // 0x0918(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_919[0x3];                                      // 0x0919(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(class AActor* SelfActor, class AActor* OtherActor, const struct FVector& NormalImpulse, struct FHitResult& Hit)> K2Node_CreateDelegate_OutputDelegate;              // 0x091C(0x0010)(ZeroConstructor, NoDestructor)
	bool                                          K2Node_SwitchEnum_CmpSuccess;                      // 0x092C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_92D[0x3];                                      // 0x092D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         K2Node_Event_damage;                               // 0x0930(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_Event_hit;                                  // 0x0934(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	uint8                                         Pad_9BC[0x4];                                      // 0x09BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 K2Node_Event_actor;                                // 0x09C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                K2Node_Event_impact;                               // 0x09C8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue_2;                    // 0x09D4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_9D5[0x3];                                      // 0x09D5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                CallFunc_Divide_VectorFloat_ReturnValue_1;         // 0x09D8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_9E4[0x4];                                      // 0x09E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TScriptInterface<class IInt_objects_C>        CallFunc_impactDamage_self_CastInput_1;            // 0x09E8(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	class AMainGamemode_C*                        CallFunc_getMainGamemode_AsMain_Gamemode;          // 0x09F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Array_Add_ReturnValue;                    // 0x0A00(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Array_RemoveItem_ReturnValue;             // 0x0A04(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, CallFunc_IsValid_ReturnValue) == 0x0006D8, "Member 'Prop_C_ExecuteUbergraph_prop::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_static) == 0x0006D9, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_static' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_frozen) == 0x0006DA, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_frozen' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_active) == 0x0006DB, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_active' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_actor_1) == 0x0006E0, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_actor_1' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_damage_2) == 0x0006E8, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_damage_2' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_hit_2) == 0x0006EC, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_hit_2' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_impact_1) == 0x000774, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_impact_1' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_skipSetting) == 0x000780, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_skipSetting' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, CallFunc_Divide_VectorFloat_ReturnValue) == 0x000784, "Member 'Prop_C_ExecuteUbergraph_prop::CallFunc_Divide_VectorFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_component) == 0x000790, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_component' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, CallFunc_impactDamage_self_CastInput) == 0x000798, "Member 'Prop_C_ExecuteUbergraph_prop::CallFunc_impactDamage_self_CastInput' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_ignore) == 0x0007A8, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_ignore' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_key) == 0x0007B0, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_key' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_CustomEvent_SelfActor) == 0x0007C0, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_CustomEvent_SelfActor' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_CustomEvent_OtherActor) == 0x0007C8, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_CustomEvent_OtherActor' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_CustomEvent_NormalImpulse) == 0x0007D0, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_CustomEvent_NormalImpulse' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_CustomEvent_Hit) == 0x0007DC, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_CustomEvent_Hit' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, CallFunc_BooleanOR_ReturnValue) == 0x000864, "Member 'Prop_C_ExecuteUbergraph_prop::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_damage_1) == 0x000868, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_damage_1' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_fuel) == 0x00086C, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_fuel' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, CallFunc_fireDamage_self_CastInput) == 0x000870, "Member 'Prop_C_ExecuteUbergraph_prop::CallFunc_fireDamage_self_CastInput' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, CallFunc_IsValid_ReturnValue_1) == 0x000880, "Member 'Prop_C_ExecuteUbergraph_prop::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_player) == 0x000888, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_hit_1) == 0x000890, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_hit_1' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_action) == 0x000918, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_CreateDelegate_OutputDelegate) == 0x00091C, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_SwitchEnum_CmpSuccess) == 0x00092C, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_damage) == 0x000930, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_damage' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_hit) == 0x000934, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_actor) == 0x0009C0, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_actor' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, K2Node_Event_impact) == 0x0009C8, "Member 'Prop_C_ExecuteUbergraph_prop::K2Node_Event_impact' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, CallFunc_IsValid_ReturnValue_2) == 0x0009D4, "Member 'Prop_C_ExecuteUbergraph_prop::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, CallFunc_Divide_VectorFloat_ReturnValue_1) == 0x0009D8, "Member 'Prop_C_ExecuteUbergraph_prop::CallFunc_Divide_VectorFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, CallFunc_impactDamage_self_CastInput_1) == 0x0009E8, "Member 'Prop_C_ExecuteUbergraph_prop::CallFunc_impactDamage_self_CastInput_1' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, CallFunc_getMainGamemode_AsMain_Gamemode) == 0x0009F8, "Member 'Prop_C_ExecuteUbergraph_prop::CallFunc_getMainGamemode_AsMain_Gamemode' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, CallFunc_Array_Add_ReturnValue) == 0x000A00, "Member 'Prop_C_ExecuteUbergraph_prop::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_C_ExecuteUbergraph_prop, CallFunc_Array_RemoveItem_ReturnValue) == 0x000A04, "Member 'Prop_C_ExecuteUbergraph_prop::CallFunc_Array_RemoveItem_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Prop_C_ImpactDamageCPP, Hit_0) == 0x000004, "Member 'Prop_C_ImpactDamageCPP::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
public:
	...
	struct FHitResult                             Hit_0;                                             // 0x001C(0x0088)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
...
static_assert(offsetof(Prop_C_Hittedd123, Hit_0) == 0x00001C, "Member 'Prop_C_Hittedd123::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_SetKey, Key_0) == 0x000000, "Member 'Prop_C_SetKey::Key_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_AddDamage, Hit_0) == 0x00000C, "Member 'Prop_C_AddDamage::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_SetPropProps, Static_0) == 0x000000, "Member 'Prop_C_SetPropProps::Static_0' has a wrong offset!");
static_assert(offsetof(Prop_C_SetPropProps, Frozen_0) == 0x000001, "Member 'Prop_C_SetPropProps::Frozen_0' has a wrong offset!");
...
static_assert(sizeof(Prop_C_SettingsApplied) == 0x000100, "Wrong size on Prop_C_SettingsApplied");
...
static_assert(offsetof(Prop_C_DamageByPlayer, Hit_0) == 0x000008, "Member 'Prop_C_DamageByPlayer::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_SendName, Name_0) == 0x000000, "Member 'Prop_C_SendName::Name_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_Player_use, Hit_0) == 0x000008, "Member 'Prop_C_Player_use::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_TexturePickerApply, Index_0) == 0x000010, "Member 'Prop_C_TexturePickerApply::Index_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_AnyKey, Key_0) == 0x000000, "Member 'Prop_C_AnyKey::Key_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_StuffUpgraded, GameMode_0) == 0x000000, "Member 'Prop_C_StuffUpgraded::GameMode_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_PlayerUsedOn, Hit_0) == 0x000008, "Member 'Prop_C_PlayerUsedOn::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_ActionName, Hit_0) == 0x000008, "Member 'Prop_C_ActionName::Hit_0' has a wrong offset!");
static_assert(offsetof(Prop_C_ActionName, Name_0) == 0x000090, "Member 'Prop_C_ActionName::Name_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_PlayerHandAnyKey, Key_0) == 0x000008, "Member 'Prop_C_PlayerHandAnyKey::Key_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_SteppedOn, Hit_0) == 0x000008, "Member 'Prop_C_SteppedOn::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_ImpactDamage, Hit_0) == 0x000004, "Member 'Prop_C_ImpactDamage::Hit_0' has a wrong offset!");
...
// 0x0008 (0x0008 - 0x0000)
struct Prop_C_UserConstructionScript final
{
public:
...
static_assert(alignof(Prop_C_UserConstructionScript) == 0x000008, "Wrong alignment on Prop_C_UserConstructionScript");
static_assert(sizeof(Prop_C_UserConstructionScript) == 0x000008, "Wrong size on Prop_C_UserConstructionScript");
static_assert(offsetof(Prop_C_UserConstructionScript, CallFunc_getMainGamemode_AsMain_Gamemode) == 0x000000, "Member 'Prop_C_UserConstructionScript::CallFunc_getMainGamemode_AsMain_Gamemode' has a wrong offset!");
...
public:
	...
	struct FStruct_dangerProp                     CallFunc_GetDataTableRowFromName_OutRow_1;         // 0x00B4(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetDataTableRowFromName_ReturnValue_1;    // 0x00C4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ECollisionChannel                             Temp_byte_Variable_1;                              // 0x00C5(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ECollisionChannel                             K2Node_Select_Default;                             // 0x00C6(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BooleanOR_ReturnValue_1;                  // 0x00C7(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BooleanOR_ReturnValue_2;                  // 0x00C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_Not_PreBool_ReturnValue;                  // 0x00C9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_CA[0x6];                                       // 0x00CA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FStruct_prop3                          CallFunc_GetDataTableRowFromName_OutRow_2;         // 0x00D0(0x0080)(HasGetValueTypeHash)
	bool                                          CallFunc_GetDataTableRowFromName_ReturnValue_2;    // 0x0150(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(Prop_C_Init) == 0x000008, "Wrong alignment on Prop_C_Init");
static_assert(sizeof(Prop_C_Init) == 0x000158, "Wrong size on Prop_C_Init");
static_assert(offsetof(Prop_C_Init, Temp_byte_Variable) == 0x000000, "Member 'Prop_C_Init::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, CallFunc_IsValid_ReturnValue) == 0x000001, "Member 'Prop_C_Init::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Prop_C_Init, CallFunc_IsValid_ReturnValue_1) == 0x000010, "Member 'Prop_C_Init::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, CallFunc_IsValid_ReturnValue_2) == 0x000011, "Member 'Prop_C_Init::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, CallFunc_getKey_key) == 0x000018, "Member 'Prop_C_Init::CallFunc_getKey_key' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, CallFunc_SetStaticMesh_ReturnValue) == 0x000028, "Member 'Prop_C_Init::CallFunc_SetStaticMesh_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, CallFunc_IsValid_ReturnValue_3) == 0x000029, "Member 'Prop_C_Init::CallFunc_IsValid_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, CallFunc_SetStaticMesh_ReturnValue_1) == 0x00002A, "Member 'Prop_C_Init::CallFunc_SetStaticMesh_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, Temp_bool_Variable) == 0x00002B, "Member 'Prop_C_Init::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, CallFunc_GetDataTableRowFromName_OutRow) == 0x000030, "Member 'Prop_C_Init::CallFunc_GetDataTableRowFromName_OutRow' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x0000B0, "Member 'Prop_C_Init::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, CallFunc_BooleanOR_ReturnValue) == 0x0000B1, "Member 'Prop_C_Init::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, CallFunc_GetDataTableRowFromName_OutRow_1) == 0x0000B4, "Member 'Prop_C_Init::CallFunc_GetDataTableRowFromName_OutRow_1' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, CallFunc_GetDataTableRowFromName_ReturnValue_1) == 0x0000C4, "Member 'Prop_C_Init::CallFunc_GetDataTableRowFromName_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, Temp_byte_Variable_1) == 0x0000C5, "Member 'Prop_C_Init::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, K2Node_Select_Default) == 0x0000C6, "Member 'Prop_C_Init::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, CallFunc_BooleanOR_ReturnValue_1) == 0x0000C7, "Member 'Prop_C_Init::CallFunc_BooleanOR_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, CallFunc_BooleanOR_ReturnValue_2) == 0x0000C8, "Member 'Prop_C_Init::CallFunc_BooleanOR_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, CallFunc_Not_PreBool_ReturnValue) == 0x0000C9, "Member 'Prop_C_Init::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, CallFunc_GetDataTableRowFromName_OutRow_2) == 0x0000D0, "Member 'Prop_C_Init::CallFunc_GetDataTableRowFromName_OutRow_2' has a wrong offset!");
static_assert(offsetof(Prop_C_Init, CallFunc_GetDataTableRowFromName_ReturnValue_2) == 0x000150, "Member 'Prop_C_Init::CallFunc_GetDataTableRowFromName_ReturnValue_2' has a wrong offset!");
...
// Function prop.prop_C.GetName
// 0x00A0 (0x00A0 - 0x0000)
struct Prop_C_GetName final
{
public:
	class FText                                   Name_0;                                            // 0x0000(0x0018)(Parm, OutParm)
	struct FStruct_prop3                          CallFunc_GetDataTableRowFromName_OutRow;           // 0x0018(0x0080)(HasGetValueTypeHash)
	bool                                          CallFunc_GetDataTableRowFromName_ReturnValue;      // 0x0098(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(Prop_C_GetName) == 0x000008, "Wrong alignment on Prop_C_GetName");
static_assert(sizeof(Prop_C_GetName) == 0x0000A0, "Wrong size on Prop_C_GetName");
static_assert(offsetof(Prop_C_GetName, Name_0) == 0x000000, "Member 'Prop_C_GetName::Name_0' has a wrong offset!");
static_assert(offsetof(Prop_C_GetName, CallFunc_GetDataTableRowFromName_OutRow) == 0x000018, "Member 'Prop_C_GetName::CallFunc_GetDataTableRowFromName_OutRow' has a wrong offset!");
static_assert(offsetof(Prop_C_GetName, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x000098, "Member 'Prop_C_GetName::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
...
public:
	...
	struct FStruct_mBool                          K2Node_MakeStruct_struct_mBool;                    // 0x0150(0x0010)(HasGetValueTypeHash)
	...
	TArray<struct FStruct_mBool>                  K2Node_MakeArray_Array_3;                          // 0x0168(0x0010)(ReferenceParm)
	TArray<class FString>                         K2Node_MakeArray_Array_4;                          // 0x0178(0x0010)(ReferenceParm)
	struct FStruct_mString                        K2Node_MakeStruct_struct_mString;                  // 0x0188(0x0010)(HasGetValueTypeHash)
	TArray<struct FStruct_mString>                K2Node_MakeArray_Array_5;                          // 0x0198(0x0010)(ReferenceParm)
	uint8                                         Pad_1A8[0x8];                                      // 0x01A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FStruct_save                           K2Node_MakeStruct_struct_save;                     // 0x01B0(0x00C0)(HasGetValueTypeHash)
};
static_assert(alignof(Prop_C_GetData) == 0x000010, "Wrong alignment on Prop_C_GetData");
static_assert(sizeof(Prop_C_GetData) == 0x000270, "Wrong size on Prop_C_GetData");
...
static_assert(offsetof(Prop_C_GetData, K2Node_MakeArray_Array) == 0x0000C8, "Member 'Prop_C_GetData::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(Prop_C_GetData, K2Node_MakeStruct_struct_mFloat) == 0x0000D8, "Member 'Prop_C_GetData::K2Node_MakeStruct_struct_mFloat' has a wrong offset!");
static_assert(offsetof(Prop_C_GetData, K2Node_MakeArray_Array_1) == 0x0000E8, "Member 'Prop_C_GetData::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(Prop_C_GetData, CallFunc_Conv_NameToString_ReturnValue) == 0x0000F8, "Member 'Prop_C_GetData::CallFunc_Conv_NameToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_C_GetData, CallFunc_GetTransform_ReturnValue) == 0x000110, "Member 'Prop_C_GetData::CallFunc_GetTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_C_GetData, K2Node_MakeArray_Array_2) == 0x000140, "Member 'Prop_C_GetData::K2Node_MakeArray_Array_2' has a wrong offset!");
static_assert(offsetof(Prop_C_GetData, K2Node_MakeStruct_struct_mBool) == 0x000150, "Member 'Prop_C_GetData::K2Node_MakeStruct_struct_mBool' has a wrong offset!");
static_assert(offsetof(Prop_C_GetData, CallFunc_GetObjectClass_ReturnValue) == 0x000160, "Member 'Prop_C_GetData::CallFunc_GetObjectClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_C_GetData, K2Node_MakeArray_Array_3) == 0x000168, "Member 'Prop_C_GetData::K2Node_MakeArray_Array_3' has a wrong offset!");
static_assert(offsetof(Prop_C_GetData, K2Node_MakeArray_Array_4) == 0x000178, "Member 'Prop_C_GetData::K2Node_MakeArray_Array_4' has a wrong offset!");
static_assert(offsetof(Prop_C_GetData, K2Node_MakeStruct_struct_mString) == 0x000188, "Member 'Prop_C_GetData::K2Node_MakeStruct_struct_mString' has a wrong offset!");
static_assert(offsetof(Prop_C_GetData, K2Node_MakeArray_Array_5) == 0x000198, "Member 'Prop_C_GetData::K2Node_MakeArray_Array_5' has a wrong offset!");
static_assert(offsetof(Prop_C_GetData, K2Node_MakeStruct_struct_save) == 0x0001B0, "Member 'Prop_C_GetData::K2Node_MakeStruct_struct_save' has a wrong offset!");
...
public:
	...
	class FString                                 CallFunc_Array_Get_Item_4;                         // 0x0100(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	struct FStruct_mBool                          CallFunc_Array_Get_Item_5;                         // 0x0110(0x0010)(HasGetValueTypeHash)
	...
	bool                                          CallFunc_Array_Get_Item_8;                         // 0x012A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_Array_Get_Item_9;                         // 0x012B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(Prop_C_LoadData) == 0x000150, "Wrong size on Prop_C_LoadData");
...
static_assert(offsetof(Prop_C_LoadData, CallFunc_Array_Get_Item_2) == 0x0000E8, "Member 'Prop_C_LoadData::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(Prop_C_LoadData, CallFunc_Array_Get_Item_3) == 0x0000F8, "Member 'Prop_C_LoadData::CallFunc_Array_Get_Item_3' has a wrong offset!");
static_assert(offsetof(Prop_C_LoadData, CallFunc_Array_Get_Item_4) == 0x000100, "Member 'Prop_C_LoadData::CallFunc_Array_Get_Item_4' has a wrong offset!");
static_assert(offsetof(Prop_C_LoadData, CallFunc_Array_Get_Item_5) == 0x000110, "Member 'Prop_C_LoadData::CallFunc_Array_Get_Item_5' has a wrong offset!");
static_assert(offsetof(Prop_C_LoadData, CallFunc_Conv_StringToName_ReturnValue) == 0x000120, "Member 'Prop_C_LoadData::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_C_LoadData, CallFunc_Array_Get_Item_6) == 0x000128, "Member 'Prop_C_LoadData::CallFunc_Array_Get_Item_6' has a wrong offset!");
static_assert(offsetof(Prop_C_LoadData, CallFunc_Array_Get_Item_7) == 0x000129, "Member 'Prop_C_LoadData::CallFunc_Array_Get_Item_7' has a wrong offset!");
static_assert(offsetof(Prop_C_LoadData, CallFunc_Array_Get_Item_8) == 0x00012A, "Member 'Prop_C_LoadData::CallFunc_Array_Get_Item_8' has a wrong offset!");
static_assert(offsetof(Prop_C_LoadData, CallFunc_Array_Get_Item_9) == 0x00012B, "Member 'Prop_C_LoadData::CallFunc_Array_Get_Item_9' has a wrong offset!");
static_assert(offsetof(Prop_C_LoadData, CallFunc_BreakTransform_Location) == 0x00012C, "Member 'Prop_C_LoadData::CallFunc_BreakTransform_Location' has a wrong offset!");
static_assert(offsetof(Prop_C_LoadData, CallFunc_BreakTransform_Rotation) == 0x000138, "Member 'Prop_C_LoadData::CallFunc_BreakTransform_Rotation' has a wrong offset!");
static_assert(offsetof(Prop_C_LoadData, CallFunc_BreakTransform_Scale) == 0x000144, "Member 'Prop_C_LoadData::CallFunc_BreakTransform_Scale' has a wrong offset!");
...
static_assert(offsetof(Prop_C_IgnoreSave, IgnoreSave_0) == 0x000000, "Member 'Prop_C_IgnoreSave::IgnoreSave_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_LookAt, Hit_0) == 0x000008, "Member 'Prop_C_LookAt::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_NoRespawn, NoRespawn_0) == 0x000000, "Member 'Prop_C_NoRespawn::NoRespawn_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_GetKey, Key_0) == 0x000000, "Member 'Prop_C_GetKey::Key_0' has a wrong offset!");
...
static_assert(offsetof(Prop_C_GetOnlyKey, Key_0) == 0x000000, "Member 'Prop_C_GetOnlyKey::Key_0' has a wrong offset!");
