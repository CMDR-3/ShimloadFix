...
public:
	...
	class AMainGamemode_C*                        GameMode;                                          // 0x02A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void SignalSaved();
	void SignalDeleted();
	void Gen(TArray<class AProp_beacon_C*>& beacons_0);
...
static_assert(sizeof(UUmg_carmap_C) == 0x0002B0, "Wrong size on UUmg_carmap_C");
...
static_assert(offsetof(UUmg_carmap_C, GameMode) == 0x0002A8, "Member 'UUmg_carmap_C::GameMode' has a wrong offset!");
