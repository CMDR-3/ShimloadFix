...
static_assert(sizeof(Prop_rug_c_C_ExecuteUbergraph_prop_rug_c) == 0x0000C0, "Wrong size on Prop_rug_c_C_ExecuteUbergraph_prop_rug_c");
...
static_assert(offsetof(Prop_rug_c_C_ExecuteUbergraph_prop_rug_c, K2Node_LowEntry_LocalVariable_Value__Object) == 0x000008, "Member 'Prop_rug_c_C_ExecuteUbergraph_prop_rug_c::K2Node_LowEntry_LocalVariable_Value__Object' has a wrong offset!");
static_assert(offsetof(Prop_rug_c_C_ExecuteUbergraph_prop_rug_c, CallFunc_Array_Length_ReturnValue) == 0x000018, "Member 'Prop_rug_c_C_ExecuteUbergraph_prop_rug_c::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rug_c_C_ExecuteUbergraph_prop_rug_c, CallFunc_CreateDynamicMaterialInstance_ReturnValue) == 0x000020, "Member 'Prop_rug_c_C_ExecuteUbergraph_prop_rug_c::CallFunc_CreateDynamicMaterialInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rug_c_C_ExecuteUbergraph_prop_rug_c, CallFunc_VictoryIntPlusEquals_IntOut) == 0x000028, "Member 'Prop_rug_c_C_ExecuteUbergraph_prop_rug_c::CallFunc_VictoryIntPlusEquals_IntOut' has a wrong offset!");
static_assert(offsetof(Prop_rug_c_C_ExecuteUbergraph_prop_rug_c, CallFunc_Percent_IntInt_ReturnValue) == 0x00002C, "Member 'Prop_rug_c_C_ExecuteUbergraph_prop_rug_c::CallFunc_Percent_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_rug_c_C_ExecuteUbergraph_prop_rug_c, K2Node_Event_player) == 0x000030, "Member 'Prop_rug_c_C_ExecuteUbergraph_prop_rug_c::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(Prop_rug_c_C_ExecuteUbergraph_prop_rug_c, K2Node_Event_hit) == 0x000038, "Member 'Prop_rug_c_C_ExecuteUbergraph_prop_rug_c::K2Node_Event_hit' has a wrong offset!");
...
static_assert(sizeof(Prop_rug_c_C_SetSkin) == 0x000008, "Wrong size on Prop_rug_c_C_SetSkin");
static_assert(offsetof(Prop_rug_c_C_SetSkin, CallFunc_Array_Get_Item) == 0x000000, "Member 'Prop_rug_c_C_SetSkin::CallFunc_Array_Get_Item' has a wrong offset!");
...
static_assert(offsetof(Prop_rug_c_C_Player_use, Hit_0) == 0x000008, "Member 'Prop_rug_c_C_Player_use::Hit_0' has a wrong offset!");
