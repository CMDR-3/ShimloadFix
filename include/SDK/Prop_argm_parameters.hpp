...
static_assert(offsetof(Prop_argm_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_argm_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_argm_C_RunTrigger, Owner_0) == 0x000000, "Member 'Prop_argm_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(Prop_argm_C_RunTrigger, Index_0) == 0x000008, "Member 'Prop_argm_C_RunTrigger::Index_0' has a wrong offset!");
...
public:
	...
	class UTexture2D*                             CallFunc_Array_Get_Item_1;                         // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(Prop_argm_C_Setmats) == 0x000008, "Wrong alignment on Prop_argm_C_Setmats");
static_assert(sizeof(Prop_argm_C_Setmats) == 0x000010, "Wrong size on Prop_argm_C_Setmats");
static_assert(offsetof(Prop_argm_C_Setmats, CallFunc_Array_Get_Item) == 0x000000, "Member 'Prop_argm_C_Setmats::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Prop_argm_C_Setmats, CallFunc_Array_Get_Item_1) == 0x000008, "Member 'Prop_argm_C_Setmats::CallFunc_Array_Get_Item_1' has a wrong offset!");
