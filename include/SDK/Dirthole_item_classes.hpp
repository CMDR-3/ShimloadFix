...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Dirthole_item_C;                    // 0x0250(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class USphereComponent*                       Sphere1;                                           // 0x0258(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	class FName                                   Name_0;                                            // 0x0268(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	class UClass*                                 Object;                                            // 0x0270(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	bool                                          Grab;                                              // 0x0278(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
...
public:
	...
	void SignalDeleted();
	void PullOut();
	void buryItem(class AActor* Ac_0);
...
static_assert(offsetof(ADirthole_item_C, UberGraphFrame_Dirthole_item_C) == 0x000250, "Member 'ADirthole_item_C::UberGraphFrame_Dirthole_item_C' has a wrong offset!");
static_assert(offsetof(ADirthole_item_C, Sphere1) == 0x000258, "Member 'ADirthole_item_C::Sphere1' has a wrong offset!");
static_assert(offsetof(ADirthole_item_C, Sphere) == 0x000260, "Member 'ADirthole_item_C::Sphere' has a wrong offset!");
static_assert(offsetof(ADirthole_item_C, Name_0) == 0x000268, "Member 'ADirthole_item_C::Name_0' has a wrong offset!");
static_assert(offsetof(ADirthole_item_C, Object) == 0x000270, "Member 'ADirthole_item_C::Object' has a wrong offset!");
static_assert(offsetof(ADirthole_item_C, Grab) == 0x000278, "Member 'ADirthole_item_C::Grab' has a wrong offset!");
