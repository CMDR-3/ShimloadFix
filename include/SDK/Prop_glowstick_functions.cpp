...
void AProp_glowstick_C::ActionOptionIndex(class AMainPlayer_C* Player, const struct FHitResult& Hit_0, Enum_interactionActions Action)
{
	static class UFunction* Func = nullptr;
...
void AProp_glowstick_C::StickTo(const struct FHitResult& Hit_0)
{
	static class UFunction* Func = nullptr;
