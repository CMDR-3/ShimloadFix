...
public:
	...
	class AMainGamemode_C*                        GameMode;                                          // 0x0458(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

public:
	void ExecuteUbergraph_drone(int32 EntryPoint);
	void ReceiveBeginPlay();
	void ReceiveTick(float DeltaSeconds);
	void SendShop(const struct FStruct_storeOrder1& Order_0);
	...
	void LoadData(const struct FStruct_save& Data_0);
	void SpawnOrderbox();
	void GetTriggerData(struct FStruct_triggerSave* Data_0);
	void LoadTriggerData(const struct FStruct_triggerSave& Data_0, bool* Return);
...
static_assert(offsetof(ADrone_C, GameMode) == 0x000458, "Member 'ADrone_C::GameMode' has a wrong offset!");
