...
public:
	...
	class ADish_C*                                CallFunc_Array_Get_Item_1;                         // 0x0108(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Trigger_fakeLmaos_C_LoadTriggerData) == 0x000120, "Wrong size on Trigger_fakeLmaos_C_LoadTriggerData");
...
static_assert(offsetof(Trigger_fakeLmaos_C_LoadTriggerData, CallFunc_Array_Length_ReturnValue) == 0x000104, "Member 'Trigger_fakeLmaos_C_LoadTriggerData::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Trigger_fakeLmaos_C_LoadTriggerData, CallFunc_Array_Get_Item_1) == 0x000108, "Member 'Trigger_fakeLmaos_C_LoadTriggerData::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(Trigger_fakeLmaos_C_LoadTriggerData, CallFunc_Less_IntInt_ReturnValue) == 0x000110, "Member 'Trigger_fakeLmaos_C_LoadTriggerData::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Trigger_fakeLmaos_C_LoadTriggerData, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000111, "Member 'Trigger_fakeLmaos_C_LoadTriggerData::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Trigger_fakeLmaos_C_RunTrigger, Owner_0) == 0x000000, "Member 'Trigger_fakeLmaos_C_RunTrigger::Owner_0' has a wrong offset!");
static_assert(offsetof(Trigger_fakeLmaos_C_RunTrigger, Index_0) == 0x000008, "Member 'Trigger_fakeLmaos_C_RunTrigger::Index_0' has a wrong offset!");
