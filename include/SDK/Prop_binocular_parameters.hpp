...
static_assert(sizeof(Prop_binocular_C_ExecuteUbergraph_prop_binocular) == 0x000048, "Wrong size on Prop_binocular_C_ExecuteUbergraph_prop_binocular");
...
static_assert(offsetof(Prop_binocular_C_ExecuteUbergraph_prop_binocular, CallFunc_Percent_IntInt_ReturnValue) == 0x000008, "Member 'Prop_binocular_C_ExecuteUbergraph_prop_binocular::CallFunc_Percent_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_binocular_C_ExecuteUbergraph_prop_binocular, Temp_float_Variable) == 0x00000C, "Member 'Prop_binocular_C_ExecuteUbergraph_prop_binocular::Temp_float_Variable' has a wrong offset!");
...
static_assert(offsetof(Prop_binocular_C_ExecuteUbergraph_prop_binocular, K2Node_Select_Default) == 0x000040, "Member 'Prop_binocular_C_ExecuteUbergraph_prop_binocular::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(Prop_binocular_C_ExecuteUbergraph_prop_binocular, CallFunc_SelectFloat_ReturnValue) == 0x000044, "Member 'Prop_binocular_C_ExecuteUbergraph_prop_binocular::CallFunc_SelectFloat_ReturnValue' has a wrong offset!");
