...
public:
	...
	class AMainGamemode_C*                        GameMode;                                          // 0x0338(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UUmg_handradar_C) == 0x000340, "Wrong size on UUmg_handradar_C");
...
static_assert(offsetof(UUmg_handradar_C, GameMode) == 0x000338, "Member 'UUmg_handradar_C::GameMode' has a wrong offset!");
