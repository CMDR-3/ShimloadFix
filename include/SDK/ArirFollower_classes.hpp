...
public:
	...
	float                                         Pickupanim_a_B369E0A8455FD4AD89AFEDB368A07C09;     // 0x0500(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ETimelineDirection                            Pickupanim__Direction_B369E0A8455FD4AD89AFEDB368A07C09; // 0x0504(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_505[0x3];                                      // 0x0505(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UTimelineComponent*                     Pickupanim;                                        // 0x0508(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CanMove;                                           // 0x0510(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_511[0x7];                                      // 0x0511(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<EObjectTypeQuery>                      Obj;                                               // 0x0518(0x0010)(Edit, BlueprintVisible)
	float                                         Step_0;                                            // 0x0528(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                LastStep;                                          // 0x052C(0x000C)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Slapped;                                           // 0x0538(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	uint8                                         Pad_539[0x7];                                      // 0x0539(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<EObjectTypeQuery>                      ObjD;                                              // 0x0540(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                          Done;                                              // 0x0550(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          IsInRad;                                           // 0x0551(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          Throwing;                                          // 0x0552(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_553[0x5];                                      // 0x0553(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<EObjectTypeQuery>                      ObjPhys;                                           // 0x0558(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
	class AProp_C*                                ThrowingProp;                                      // 0x0568(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPrimitiveComponent*                    ThrowingComp;                                      // 0x0570(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                 SpecificTarget;                                    // 0x0618(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	class UClass*                                 ThrowingPropClass;                                 // 0x0620(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void Re_throw();
	void PlayerSwing();
	void ReputationChanged(int32 Rep_0);
	void RunAway();
	void Throw();
	void PickupAnimm();
	void MoveToPlayer();
...
static_assert(sizeof(AArirFollower_C) == 0x000630, "Wrong size on AArirFollower_C");
...
static_assert(offsetof(AArirFollower_C, Pickupanim_a_B369E0A8455FD4AD89AFEDB368A07C09) == 0x000500, "Member 'AArirFollower_C::Pickupanim_a_B369E0A8455FD4AD89AFEDB368A07C09' has a wrong offset!");
static_assert(offsetof(AArirFollower_C, Pickupanim__Direction_B369E0A8455FD4AD89AFEDB368A07C09) == 0x000504, "Member 'AArirFollower_C::Pickupanim__Direction_B369E0A8455FD4AD89AFEDB368A07C09' has a wrong offset!");
static_assert(offsetof(AArirFollower_C, Pickupanim) == 0x000508, "Member 'AArirFollower_C::Pickupanim' has a wrong offset!");
static_assert(offsetof(AArirFollower_C, CanMove) == 0x000510, "Member 'AArirFollower_C::CanMove' has a wrong offset!");
static_assert(offsetof(AArirFollower_C, Obj) == 0x000518, "Member 'AArirFollower_C::Obj' has a wrong offset!");
static_assert(offsetof(AArirFollower_C, Step_0) == 0x000528, "Member 'AArirFollower_C::Step_0' has a wrong offset!");
static_assert(offsetof(AArirFollower_C, LastStep) == 0x00052C, "Member 'AArirFollower_C::LastStep' has a wrong offset!");
static_assert(offsetof(AArirFollower_C, Slapped) == 0x000538, "Member 'AArirFollower_C::Slapped' has a wrong offset!");
static_assert(offsetof(AArirFollower_C, ObjD) == 0x000540, "Member 'AArirFollower_C::ObjD' has a wrong offset!");
static_assert(offsetof(AArirFollower_C, Done) == 0x000550, "Member 'AArirFollower_C::Done' has a wrong offset!");
static_assert(offsetof(AArirFollower_C, IsInRad) == 0x000551, "Member 'AArirFollower_C::IsInRad' has a wrong offset!");
static_assert(offsetof(AArirFollower_C, Throwing) == 0x000552, "Member 'AArirFollower_C::Throwing' has a wrong offset!");
static_assert(offsetof(AArirFollower_C, ObjPhys) == 0x000558, "Member 'AArirFollower_C::ObjPhys' has a wrong offset!");
static_assert(offsetof(AArirFollower_C, ThrowingProp) == 0x000568, "Member 'AArirFollower_C::ThrowingProp' has a wrong offset!");
static_assert(offsetof(AArirFollower_C, ThrowingComp) == 0x000570, "Member 'AArirFollower_C::ThrowingComp' has a wrong offset!");
...
static_assert(offsetof(AArirFollower_C, SpecificTarget) == 0x000618, "Member 'AArirFollower_C::SpecificTarget' has a wrong offset!");
static_assert(offsetof(AArirFollower_C, ThrowingPropClass) == 0x000620, "Member 'AArirFollower_C::ThrowingPropClass' has a wrong offset!");
