...
public:
	...
	class AProp_batts_C*                          CallFunc_FinishSpawningActor_ReturnValue_1;        // 0x0200(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_putObjectInventory2_return;               // 0x0208(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsValidClass_ReturnValue;                 // 0x0209(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_GetPlayerCharacter_ReturnValue) == 0x000008, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_GetPlayerCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_getMainPlayer_AsMain_Player) == 0x000010, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_getMainPlayer_AsMain_Player' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000018, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_MakeTransform_ReturnValue) == 0x000030, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_MakeTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_GetCenterOfMass_ReturnValue) == 0x000060, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_GetCenterOfMass_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, K2Node_Event_player_2) == 0x000070, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::K2Node_Event_player_2' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, K2Node_Event_hit) == 0x000078, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, K2Node_Event_action) == 0x000100, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_MakeTransform_ReturnValue_1) == 0x000110, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_MakeTransform_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, K2Node_SwitchEnum_CmpSuccess) == 0x000140, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x000148, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, K2Node_Event_player_1) == 0x000150, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::K2Node_Event_player_1' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_FinishSpawningActor_ReturnValue) == 0x000158, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, K2Node_Event_player) == 0x000160, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_GetObjectClass_ReturnValue) == 0x000168, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_GetObjectClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_bBlockingHit) == 0x000170, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_bBlockingHit' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_bInitialOverlap) == 0x000171, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_bInitialOverlap' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_Time) == 0x000174, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_Time' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_Distance) == 0x000178, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_Distance' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_Location) == 0x00017C, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_Location' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_ImpactPoint) == 0x000188, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_ImpactPoint' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_Normal) == 0x000194, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_Normal' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_ImpactNormal) == 0x0001A0, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_ImpactNormal' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_PhysMat) == 0x0001B0, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_PhysMat' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_HitActor) == 0x0001B8, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_HitActor' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_HitComponent) == 0x0001C0, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_HitComponent' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_HitBoneName) == 0x0001C8, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_HitBoneName' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_HitItem) == 0x0001D0, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_HitItem' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_ElementIndex) == 0x0001D4, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_ElementIndex' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_FaceIndex) == 0x0001D8, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_FaceIndex' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_TraceStart) == 0x0001DC, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_TraceStart' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BreakHitResult_TraceEnd) == 0x0001E8, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BreakHitResult_TraceEnd' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1) == 0x0001F8, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_FinishSpawningActor_ReturnValue_1) == 0x000200, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_FinishSpawningActor_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_putObjectInventory2_return) == 0x000208, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_putObjectInventory2_return' has a wrong offset!");
static_assert(offsetof(Prop_batts_C_ExecuteUbergraph_prop_batts, CallFunc_IsValidClass_ReturnValue) == 0x000209, "Member 'Prop_batts_C_ExecuteUbergraph_prop_batts::CallFunc_IsValidClass_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Prop_batts_C_ActionOptionIndex, Hit_0) == 0x000008, "Member 'Prop_batts_C_ActionOptionIndex::Hit_0' has a wrong offset!");
...
static_assert(offsetof(Prop_batts_C_LookAt, Hit_0) == 0x000008, "Member 'Prop_batts_C_LookAt::Hit_0' has a wrong offset!");
