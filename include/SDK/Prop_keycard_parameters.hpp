...
{
public:
	class AHook_C*                                Hook_0;                                            // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(Prop_keycard_C_Hooked, Hook_0) == 0x000000, "Member 'Prop_keycard_C_Hooked::Hook_0' has a wrong offset!");
...
static_assert(offsetof(Prop_keycard_C_LookAt, Hit_0) == 0x000008, "Member 'Prop_keycard_C_LookAt::Hit_0' has a wrong offset!");
