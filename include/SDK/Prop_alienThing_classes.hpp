...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Prop_alienThing_C;                  // 0x0358(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	...
	float                                         Radius;                                            // 0x0380(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_384[0x4];                                      // 0x0384(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UPrimitiveComponent*>            Comps;                                             // 0x0388(0x0010)(Edit, BlueprintVisible, ContainsInstancedReference)
...
static_assert(sizeof(AProp_alienThing_C) == 0x000398, "Wrong size on AProp_alienThing_C");
static_assert(offsetof(AProp_alienThing_C, UberGraphFrame_Prop_alienThing_C) == 0x000358, "Member 'AProp_alienThing_C::UberGraphFrame_Prop_alienThing_C' has a wrong offset!");
static_assert(offsetof(AProp_alienThing_C, Sphere) == 0x000360, "Member 'AProp_alienThing_C::Sphere' has a wrong offset!");
static_assert(offsetof(AProp_alienThing_C, Audio) == 0x000368, "Member 'AProp_alienThing_C::Audio' has a wrong offset!");
static_assert(offsetof(AProp_alienThing_C, PointLight) == 0x000370, "Member 'AProp_alienThing_C::PointLight' has a wrong offset!");
static_assert(offsetof(AProp_alienThing_C, RadarPoint) == 0x000378, "Member 'AProp_alienThing_C::RadarPoint' has a wrong offset!");
static_assert(offsetof(AProp_alienThing_C, Radius) == 0x000380, "Member 'AProp_alienThing_C::Radius' has a wrong offset!");
static_assert(offsetof(AProp_alienThing_C, Comps) == 0x000388, "Member 'AProp_alienThing_C::Comps' has a wrong offset!");
